...
static void MergeVertsFast(int * piCurNrUniqueVertices, int * piRemapTable, 
        float * pfVertexDataOut, int * piVertexIDs, const float pfVertexDataIn[],
        const int iNrVerticesIn, const int iFloatsPerVert,
