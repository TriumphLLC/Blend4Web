...
Трехмерные сцены должны подготавливаться в пакете моделирования :ref:`Blender <about_blender>` (отсюда название), или переноситься в него из других инструментов (таких как 3ds Max®). Отображение контента осуществляется средствами :ref:`WebGL <about_webgl>` и других :ref:`браузерных технологий <about_browser_tech>`, без использования плагинов.

Технически Blend4Web представляет собой JavaScript библиотеку, подключаемую в web-странице, аддон (дополнение) к программе :ref:`Blender <about_blender>`, а также инструменты для отладки и оптимизации.

3D движок Blend4Web разрабатывается сотрудниками ООО «Триумф» с 2010 г. По функциональности и качеству изображения 3D движок Blend4Web превосходит все имеющиеся на рынке движки, работающие на веб-платформе (такие как Three.js).
