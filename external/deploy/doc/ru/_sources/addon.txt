...
.. index:: инициализация; совместимость; ошибки
...
.. image:: src_images/blender_ui/init_error_message.jpg
   :alt: Сообщение об ошибке при инициализации
   :align: center
   :width: 100%
...
+-------------------------------------+-------------------------------------------+
| Blend4Web initialization error!     | Ошибка загрузки аддона. Для работы        |
| Blender version VER_REQUIRED is     | требуется версия Blender'а VER_REQUIRED,  |
| required for the Blend4Web addon.   | в то время как текущей версией является   |
| The current version is VER_CURRENT. | VER_CURRENT.                              |
+-------------------------------------+-------------------------------------------+
