...
#. ``Frames`` - длина воспроизводимого фрагмента видеозаписи в кадрах.
#. ``Start`` - задержка воспроизведения видеозаписи в кадрах при использовании нелинейной анимации (опция ``Scene > Blend4Web > Use NLA``).
#. ``Offset`` - номер кадра, с которого будет начинаться воспроизведение видеозаписи.
#. ``Auto refresh`` - воспроизводить видеозапись сразу после загрузки. Не актуальна при использовании нелинейной анимации: воспроизведение видео определяется остальными параметрами.
#. ``Cyclic`` - начинать воспроизводить видеозапись заново каждый раз после ее завершения.
