...
exports.init = function() {
    ...
    if (url_params)
        m_storage.init("b4w_embed:" + url_params["load"]);
    else
        m_storage.init("b4w_embed:" + window.location.href);
    set_quality_config();
...
function check_device() {
    if (navigator.userAgent.match(/Android/i) ||
        ...
        navigator.userAgent.match(/iPad/i)) {
            ...
            closed_button.style.cssText = "height: 70px; width: 30px; background-size: 30px 70px; background-image: url('data:image/png;base64,');";
            opened_button.style.cssText = "height: 70px; width: 30px; background-size: 30px 70px; background-image: url('data:image/png;base64,');";
...
function check_menu() {
    var menu_state = m_storage.get("menu");
