 ...
 (function($) {
    var ColorPicker = function() {
        ...
        fillRGBFields = function(hsb, cal) {
            ...
            /*
            // ----- display normalized RGB ---------
            rgb = {
                r: Math.round(1000*rgb.r/255)/1000, 
                g: Math.round(1000*rgb.g/255)/1000, 
                b: Math.round(1000*rgb.b/255)/1000
            };
            // --------------------------------------
            */

            // B2W viewer: convert from sRGB to linear
            rgb.r = Math.round(1000*Math.pow(rgb.r/255, 2.2))/1000;
            rgb.g = Math.round(1000*Math.pow(rgb.g/255, 2.2))/1000;
            rgb.b = Math.round(1000*Math.pow(rgb.b/255, 2.2))/1000;
