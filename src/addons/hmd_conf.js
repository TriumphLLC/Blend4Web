...
function restore_params(ignore_storage) {
    ...
    _param_values["first_distortion"] = !ignore_storage &&
            parseFloat(hmd_conf_data["first_distortion"]) || DEFAULT_FIRST_DISTORTION;
    _param_values["second_distortion"] = !ignore_storage &&
            parseFloat(hmd_conf_data["second_distortion"]) || DEFAULT_SECOND_DISTORTION;
    _param_values["bevel_size"] = !ignore_storage &&
            parseFloat(hmd_conf_data["bevel_size"]) || bevel_mm ||
            DEFAULT_BEVEL_SIZE;
    _param_values["screen_width"] = !ignore_storage &&
            parseFloat(hmd_conf_data["screen_width"]) || width_dpmm ||
            DEFAULT_SCREEN_WIDTH;
    _param_values["screen_height"] = !ignore_storage &&
            parseFloat(hmd_conf_data["screen_height"]) || height_dpmm ||
            DEFAULT_SCREEN_HEIGHT;
    _param_values["screen_lense"] = !ignore_storage &&
            parseFloat(hmd_conf_data["screen_lense"]) ||
            DEFAULT_SCREEN_LENSE_DIST;
    _param_values["ipd"] = !ignore_storage &&
            parseFloat(hmd_conf_data["ipd"]) || DEFAULT_EYE_DISTANCE;
    _param_values["baseline"] = !ignore_storage &&
