...
function enable_movements(elem, character, motion_cb, settings) {
    ...
    var move_forward_cb = function(value) {
        ...
        if (move_dir_cd && for_back_pr != for_back)
            move_dir_cd(for_back, right_left);
    }
 ...
 * @param {number[]}  [options.forward_sens=[{@link module:controls.KEY_W|KEY_W}, {@link module:input.GMPD_BUTTON_12|GMPD_BUTTON_12}]] Array of sensor types used for foward motion.
 ...
 * @method module:fps.add_state_to_state_machine
 ...
 *     console.log(old_state_id, new_state_id);  
 * }
 * m_fps.add_state_to_state_machine(new_state, [m_fps.CS_WALK, m_fps.CS_RUN], state_changing_cb);
 */
exports.add_state_to_state_machine = function(new_state, enabled_transitions, change_state_cb) {
    var sm = get_state_machine();
 ...
 * @method module:fps.state_machine_switch_state
 * @param {CharacterState} state Character's state
 * @example var m_fps = require("fps");
 *
 * m_fps.state_machine_switch_state(m_fps.CS_WALK);
 */
exports.state_machine_switch_state = function(state) {
    var sm = get_state_machine();
    state_machine_switch_state(sm, state);
}
exports.lock_character_state_machine = function() {
    var sm = get_state_machine();
    sm.lock = true;
}
exports.unlock_character_state_machine = function() {
    var sm = get_state_machine();
    sm.lock = false;
}
exports.is_state_machine_locked = function() {
    var sm = get_state_machine();
    return sm.lock;
}
exports.get_last_state = function() {
    var sm = get_state_machine();
...
exports.CD_NONE = CD_NONE;
exports.CD_FORWARD = CD_FORWARD;
exports.CD_BACKWARD = CD_BACKWARD;
exports.CD_RIGHT = CD_RIGHT;
exports.CD_LEFT = CD_LEFT;
