...
var SHADERS = [
    ...
    {  
        vert: "shadeless.glslv",
        frag: "shadeless.glslf",
        directives: {
            bool: [
                "SKINNED", 
                "FRAMES_BLENDING",
            ...
            enumerated: [
                ["TEXTURE_BLEND_TYPE", ["TEXTURE_BLEND_TYPE_MIX", "TEXTURE_BLEND_TYPE_MULTIPLY"]]
            ]
        }
    },
    {  
...
function analyze_shaders(vshader, fshader) {
    ...
    if (!ext_ds) {
        m_print.error("B2W Error: WEBGL_debug_shaders not found" + 
