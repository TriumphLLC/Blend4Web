 ...
 * have at least 2 elements ["Mat","Node"]. For world material name is missing
...
exports.set_nodemat_value = function(obj, name_list, value) {
    ...
    if (m_obj_util.is_dynamic_mesh(obj)) {
    ...
    } else if(m_obj_util.is_world(obj)) {
        ...
        if (mat_batch === null) {
            m_print.error("Sky node material was not found in the world object \"" + obj.name + "\".");
            return;
        }
        ...
        m_print.error("The type of the object \"" + obj.name +
            "\" is not \"MESH\" or \"WORLD\" or it is not dynamic.");
        return;
    }

    var ind = m_batch.get_node_ind_by_name_list(mat_batch.node_value_inds,
...
exports.get_nodemat_value = function(obj, name_list) {
    ...
    return m_batch.get_nodemat_value(mat_batch, ind);
}
 ...
 * For world material name is missing
...
exports.set_nodemat_rgb = function(obj, name_list, r, g, b) {
    ...
    var ind = m_batch.get_node_ind_by_name_list(mat_batch.node_rgb_inds,
                                                name_list, node_name_prefix_offset);
    if (ind === null) {
...
exports.get_nodemat_rgb = function(obj, name_list, dest) {
    ...
    return m_batch.get_nodemat_rgb(mat_batch, ind, dest);
}
