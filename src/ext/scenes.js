 ...
 * @cc_externs csm_num csm_first_cascade_border first_cascade_blur_radius
...
exports.get_shadow_params = function() {
    ...
    if (subs)
        shadow_params.self_shadow_normal_offset = subs.self_shadow_normal_offset;
...
exports.set_shadow_params = function(shadow_params) {
    ...
    for (var i = 0; i < upd_cameras.length; i++)
        m_cam.update_camera_csm(upd_cameras[i], shs);
