...
*MinY и MaxY*
    Размеры ограничивающего объёма по оси Y. Поумолчанию *MinY* = -1, *MaxY* = 1.
...
:b4wref:`scenes.get_object_name_hierarchy()`
    Возвращает список (массив) предков объекта, начиная от старшего предка и заканчивая самим объектом.

    .. code-block:: javascript

        // ...
        var obj = m_scenes.get_object_name_hierarchy("Object");
        // ...
...
Удаление объектов
-----------------
Для удаления объектов, созданных копированием, в модуле ``scenes.js`` предусмотрена функция ``remove_object``, куда надо передать объект. Возможно удаление динамических mesh- и empty-объектов.
