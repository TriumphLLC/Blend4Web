...
по API <https://www.blend4web.com/api_doc/index.html>`_.

Файлы со скомпилированным кодом движка находятся в директории SDK
``deploy/apps/common``. Файл ``b4w.min.js`` содержит в себе базовую
...
В целях оптимизации работы приложения существует возможность использования min50 и dds текстур.
