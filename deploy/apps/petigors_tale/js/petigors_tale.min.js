...
show_fps:b,autoresize:!0})},!1)}var q=b("main"),k=b("app"),g=b("camera"),G=b("data"),v=b("controls"),z=b("scenes"),N=b("config"),fa=b("print"),E=b("sfx");b("time");var d=b("assets"),P=b("objects"),Q=b("container");b("util");var M=b("nla"),J=b("transform"),K=b("version"),ca=b("physics"),H=b("math"),O=b("vec3");b("quat");var I=b("game_config"),U=b("game_main"),L=!1,ba=!1,R=null,f={},da=!1,T=null,W=[],V=null,Z=null,ia=new Float32Array(3),X=new Float32Array(3),aa=H.create_pline(),S=null,Y=0,ga=0,ea=new Float32Array(2),
