...
a.preventDefault();a=a.changedTouches[0];D(a.clientX,a.clientY)}function u(a){a.preventDefault&&a.preventDefault();D(a.clientX,a.clientY)}function D(a,b){var d=z.pick_object(a,b);if(d&&(R=d,f[d.name])){var e=f[d.name].level_name;e?(p(),setTimeout(function(){l(e)},1E3*I.LEVEL_LOAD_DELAY)):q.detect_mobile()||(c(),p(),y())}}function p(){ba=!0;q.detect_mobile()?S.removeEventListener("touchstart",B,!1):(S.removeEventListener("mousedown",u),S.removeEventListener("mousemove",t))}function y(){L||n();v.remove_sensor_manifold(null,
"ROT_CAMERA");v.remove_sensor_manifold(null,"BUTTON_HOVER");v.create_sensor_manifold(null,"TIMELINE_CHECK",v.CT_SHOT,[v.create_elapsed_sensor()],function(a){return M.get_frame()>=M.get_frame_end()},function(){l("level_01")})}function n(){E.duck(null,0,1);var a=z.get_object_by_name("environment_LQ");document.getElementById("preloader_cont").style.visibility="visible";G.load(ma+"intro_HQ_environment.json",function(){z.hide_object(a);E.duck(null,1,1);L=!0},h,!0,!1)}function c(a){for(a=0;a<W.length;a++){var b=
W[a];E.is_play(b)&&E.duck(b,0,1)}E.duck(T,0,1);setTimeout(function(){E.clear_playlist();da=!0;E.play_def(V)},1E3)}function l(a){if("quest"==a)window.open("quest.html","_self");else{G.unload(G.DATA_ID_ALL);var b=ma+a+".json";document.getElementById("preloader_cont").style.visibility="visible";G.load(b,function(b){U.level_load_cb(b,a,h,x,l)},h,!0)}}function h(a){var b=document.getElementById("prelod_dynamic_path"),c=b.nextElementSibling;b.style.width=a+"%";c.innerHTML=a+"%";100==a&&e()}function e(){var a=
document.getElementById("preloader_cont");setTimeout(function(){a.style.visibility="hidden"},1E3)}function A(){function a(b){y.setAttribute("lang",b);l.setAttribute("src","interface/start_game_"+b+".png");pa=b}function b(a){n.setAttribute("quality",a);document.location.hash="quality="+a}function c(){m.style.display="inline-block"}function d(){v.className="brand hover"}function e(){w.className="soc hover"}function f(){m.style.display=""}function g(){v.className="brand"}function h(){w.className="soc"}
var l=document.getElementById("start_game"),m=document.getElementById("start_game_hover"),n=document.getElementById("quality"),p=document.getElementById("start_cont"),r=document.getElementById("lang_ru"),t=document.getElementById("lang_en"),u=document.getElementById("low_qual"),x=document.getElementById("high_qual"),y=document.body,v=document.getElementsByClassName("brand")[0],w=document.getElementsByClassName("soc")[0];p.style.display="block";p.style.opacity=1;document.location.hash="quality=high";
r.addEventListener("click",function(){a("ru")},!1);t.addEventListener("click",function(){a("en")},!1);u.addEventListener("click",function(){b("low")},!1);x.addEventListener("click",function(){b("high")},!1);q.detect_mobile()?(l.addEventListener("touchstart",c),l.addEventListener("touchend",f),v.addEventListener("touchstart",d),v.addEventListener("touchend",g),w.addEventListener("touchstart",e),w.addEventListener("touchend",h),b("low")):(l.addEventListener("mousedown",c),l.addEventListener("mouseup",
f),l.addEventListener("mouseleave",f),v.addEventListener("mousedown",d),v.addEventListener("mouseup",g),v.addEventListener("mouseleave",g),w.addEventListener("mousedown",e),w.addEventListener("mouseup",h),w.addEventListener("mouseleave",h));l.addEventListener("click",function(){p.style.visibility="hidden";var a=q.detect_mobile(),b="DEBUG"==K.type(),c="high"!=document.getElementById("quality").getAttribute("quality")||a?N.P_LOW:N.P_HIGH;k.init({canvas_container_id:"canvas3d",callback:C,quality:c,physics_enabled:!0,
console_verbose:!0,alpha:!1,physics_use_workers:!a,assets_dds_available:!b,assets_pvr_available:!b,assets_min50_available:!b,show_fps:b,autoresize:!0})},!1)}var q=b("main"),k=b("app"),g=b("camera"),G=b("data"),v=b("controls"),z=b("scenes"),N=b("config"),fa=b("print"),E=b("sfx");b("time");var d=b("assets"),P=b("material"),Q=b("container");b("util");var M=b("nla"),J=b("transform"),K=b("version"),ca=b("physics"),H=b("math"),O=b("vec3");b("quat");var I=b("game_config"),U=b("game_main"),L=!1,ba=!1,R=null,
f={},da=!1,T=null,W=[],V=null,Z=null,ia=new Float32Array(3),X=new Float32Array(3),aa=H.create_pline(),S=null,Y=0,ga=0,ea=new Float32Array(2),ha=null,ka=new Float32Array(3),oa=0,la=new Float32Array(3),pa="en",ra=null,sa=new Float32Array(2),ma=N.get_std_assets_path()+"petigors_tale/";a.init=function(){window.addEventListener("load",A)}});b4w.require("start_menu").init("en");
