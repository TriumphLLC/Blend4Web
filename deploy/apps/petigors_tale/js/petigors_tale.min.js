...
null,n=null,c=null,l=null,h=null;a.init=function(b,A,q,k,g,G,v){function z(){m.resume();x(H,.5);x(ea);g()}function N(){C(V)}function u(a){a.preventDefault();a.stopPropagation();C(Z)}function E(){C(aa)}function d(){m.resume();B.unload();x(Y);x(ga);x(H);x(ea);x(F);x(da);x(f);x(S);C(R);ha.removeEventListener("mouseup",g);m.detect_mobile()?(document.getElementById("canvas3d").removeEventListener("touchstart",y),document.getElementById("control_jump").removeEventListener("touchstart",n),document.getElementById("control_attack").removeEventListener("touchstart",
c),document.getElementById("canvas3d").removeEventListener("touchmove",l),document.getElementById("canvas3d").removeEventListener("touchend",h),B.load(p+"intro_LQ.json",q,k,!0)):B.load(p+"intro_HQ.json",q,k,!0)}function w(){m.resume();x(H);x(ea);b(A);g()}function t(){x(K);x(W);b(A);g()}function M(){"visible"!=H.style.visibility&&(m.pause(),x(K),C(H),C(ea))}function J(a){a.stopPropagation();a.preventDefault();x(W);x(F);x(f);x(S);switch(G){case "level_01":v("level_02");break;case "level_02":v("under_construction")}}
var K=document.getElementById("replay"),F=document.getElementById("life_bar"),H=document.getElementById("game_menu"),O=document.getElementById("menu_resume"),I=document.getElementById("menu_help"),U=document.getElementById("menu_restart"),L=document.getElementById("menu_exit"),ba=document.getElementById("menu_credits"),S=document.getElementById("control_circle"),f=document.getElementById("controls"),da=document.getElementById("game_menu_calling"),T=document.getElementById("next_level"),W=document.getElementById("victory"),
V=document.getElementById("credits_panel"),Z=document.getElementById("authors_list"),ia=document.getElementById("authors_list_exit"),X=document.getElementById("authors_click_area"),aa=document.getElementById("help_panel"),R=document.getElementById("preloader_cont"),Y=document.getElementById("back_to_menu"),ga=document.getElementById("under_construct"),ea=document.getElementById("canvas_shadow"),ha=D.get_canvas();m.detect_mobile()?(O.addEventListener("touchstart",z,!1),I.addEventListener("touchstart",
...
g),lifetime:w.BONUS_LIFETIME,type:k,is_spawned:!1};u.push(q)}}var w=b("game_config"),F=b("transform"),r=b("controls"),m=b("scenes"),t=b("sfx"),B=b("character"),u=[],D=null,p=null,y=null,n=0,c=0;new Float32Array(3);a.init=function(a,b){D=m.get_object_by_dupli_name(w.CHAR_EMPTY,w.CHAR_HEAL_SPEAKER);p=m.get_object_by_dupli_name(w.CHAR_EMPTY,w.CHAR_LAVA_SPEAKER);y=m.get_object_by_dupli_name(w.CHAR_EMPTY,w.CHAR_SHIELD_SPEAKER);u.length=0;x(w.HP_BONUSES_EMPTIES,w.BTYPE_HP,"potion_HP");x(w.LAVA_BONUSES_EMPTIES,
w.BTYPE_LAVA,"potion_LAVA");x(w.SHIELD_BONUSES_EMPTIES,w.BTYPE_SHIELD,"potion_SHIELD");C(a);r.create_sensor_manifold(null,"BONUS_TIMER",r.CT_CONTINUOUS,[a],null,function(a,b){var l=r.get_sensor_value(a,b,0);0<n&&(n-l<w.SHIELD_FLASH_LENGTH&&B.remove_shield(),n-=l);0<c&&(c-l<w.LAVA_FALL_LENGTH&&B.remove_lava_protect(),c-=l)})};a.spawn=function(a){for(var b=Math.floor(3*Math.random()),e=0;e<u.length;e++){var c=u[e];if(!c.is_spawned&&c.type==b)return a[1]+=.05,F.set_translation_v(c.empty,a),c.lifetime=
w.BONUS_LIFETIME,c.is_spawned=!0,m.show_object(c.body),!0}return!1};a.reset=function(){for(var a=0;a<u.length;a++)F.set_translation_v(u[a].empty,w.DEFAULT_POS)};a.set_shield_time=function(a){n=a};a.set_lava_protect_time=function(a){c=a};a.lava_protect_time_left=function(){return c};a.shield_time_left=function(){return n}});if(b4w.module_check("enemies"))throw"Failed to register module: enemies";
...
["golem_atack_01","golem_atack_02","golem_atack_03"];a.getout_anim="golem_"+b+"_getout";a.death_empty_name="golem_"+b+"_death";d=e.get_object_bounding_box(a.body);a.height=d.max_y-d.min_y}function x(a,b,k){if(0>=a.hp){b=a.empty;k=c.get_object_by_name(a.death_empty_name);var q=c.get_object_by_dupli_name(a.death_empty_name,g.GOLEM_DEATH_RIG),p=c.get_object_by_dupli_name(a.death_empty_name,g.GOLEM_DEATH_BLOW),f=Q,u=K;e.get_translation(b,f);e.get_rotation(b,u);e.set_translation_v(k,f);e.set_rotation_v(k,
...
E.set_nodemat_value(f.lava_shield_prot,["lava_shield_prot","lava_prot_switcher"],0)}function D(){M.set_shield_time(0);E.set_nodemat_value(f.lava_shield_prot,["lava_shield_prot","shield_switcher"],0)}function p(a){if(!(0>=f.hp)){var b=q.get_timeline();if(0>a&&V<b-.5){var c=Math.floor(S.length*Math.random());A.play_def(S[c]);V=b}f.hp+=a;f.hp=Math.min(f.hp,d.MAX_CHAR_HP);0>=f.hp&&(t(),J.MUSIC_SPEAKERS&&(A.clear_playlist(),a=l.get_object_by_dupli_name_list(J.MUSIC_INTRO_SPEAKER),b=l.get_object_by_dupli_name_list(J.MUSIC_END_SPEAKER),
...
["petigor",d.CHAR_SWORD_SWITCHER],1):E.set_nodemat_value(f.body,["petigor",d.CHAR_SWORD_SWITCHER],0);L.length=0;ba.length=0;S.length=0;T.length=0;W.length=0;K=l.get_object_by_dupli_name(d.CHAR_EMPTY,d.CHAR_RUN_SPEAKER);ca=l.get_object_by_dupli_name(d.CHAR_EMPTY,d.CHAR_ATTACK_SPEAKER);H=l.get_object_by_dupli_name(d.CHAR_EMPTY,d.CHAR_SWORD_SPEAKER);O=l.get_object_by_dupli_name(d.CHAR_EMPTY,d.CHAR_LANDING_SPEAKER);U=l.get_object_by_dupli_name(d.CHAR_EMPTY,d.CHAR_WIN_SPEAKER);I=l.get_object_by_dupli_name(d.CHAR_EMPTY,
...
a[0];k[2]=a[2];k[1]=-10;y.append_ray_test_ext(null,a,c,"GROUND",b,!0,!1,!0,!1)})}function x(a,b){function r(a,b,d,e){var g=t.get_sensor_value(a,b,0);b=e.mark;u.set_scale(b,0);e.falling_time+=g;if(e.falling_time<=h.ROCK_FALL_DELAY)e.terrain_type=-1;else{d=q;var v=k;u.get_translation(a,d);u.get_translation(b,v);d[1]-=h.ROCK_SPEED*g;u.set_translation_v(a,d);a=1-Math.abs(d[1]-v[1])/h.ROCK_RAY_LENGTH;u.set_scale(b,a);if(d[1]<=v[1]){g=q;d=e.burst;a=e.speaker;var G=e.mark,v=n.get_wrapper();u.get_translation(v.phys_body,
...
h.ROCK_NAMES[y]),d=B.get_object_by_dupli_name(x,d),A=B.get_object_by_dupli_name(x,A),Q=B.get_object_by_dupli_name(x,h.ROCK_HIT_SPEAKERS[y]),d={rock:C,mark:d,burst:A,speaker:Q,lava_height:h.ROCK_RAY_LENGTH,ground_height:h.ROCK_RAY_LENGTH,terrain_type:-1,falling_time:0};t.create_sensor_manifold(C,"ROCK_FALL",t.CT_CONTINUOUS,[a],null,r,d);F(d);w(d);e.push(d)}}function w(a){var b=a.rock,c=a.mark,e=[0,-h.ROCK_RAY_LENGTH,0];y.append_ray_test_ext(b,A,e,"LAVA",function(b,e,k,d,h,l){a.lava_height=h[1];-1==
a.terrain_type&&(a.terrain_type=0,h[1]+=.1,u.set_translation_v(c,h),u.set_scale(c,1-e))},!1,!1,!0,!0);y.append_ray_test_ext(b,A,e,"GROUND",function(b,e,k,d,h,l){a.ground_height=h[1];1!=a.terrain_type&&(a.terrain_type=1,h[1]+=.1,u.set_translation_v(c,h),u.set_scale(c,1-e))},!1,!1,!0,!0)}function F(a){var b=q,c=a.rock;b[0]=32*Math.random()-16;b[1]=16*Math.random()+8;b[2]=32*Math.random()-16;u.set_translation_v(c,b);a.falling_time=0;a.terrain_type=-1}function r(a){var b=0,e=n.get_wrapper(),k=t.create_ray_sensor(e.phys_body,
[0,0,0],[0,-c.CHAR_RAY_LENGTH,0],"LAVA",!0);t.remove_sensor_manifold(e.phys_body,"LAVA_COLLISION");t.create_sensor_manifold(e.phys_body,"LAVA_COLLISION",t.CT_CONTINUOUS,[k,a],function(a){return a[0]},function(a,g,k){1==k?(B.show_object(e.foot_smoke),a=t.get_sensor_value(a,g,1),b+=a,b>=c.LAVA_DAMAGE_INTERVAL&&(a=a<c.LAVA_DAMAGE_INTERVAL?1:Math.floor(a/c.LAVA_DAMAGE_INTERVAL),0>=l.lava_protect_time_left()&&n.change_hp(-a),b=0)):(B.hide_object(e.foot_smoke),b=0)});"dungeon"==h.LEVEL_NAME&&(a=B.get_object_by_dupli_name("level_02_enviroment",
...
(a=z.get_active_camera(),c=R.width/2,b=R.height/2,g.get_camera_angles(a,sa),c=ea[0]-(c-Y)/R.width*oa,b=-ea[1]-(b-ga)/R.height*oa,la[0]=ka[0]+ha*Math.sin(c),la[1]=ka[1]+ha*Math.sin(b),la[2]=ka[2]+ha*Math.cos(c),g.static_set_look_at(a,la,ka),g.correct_up(a))}function t(a){a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;Y=b;ga=a;if(null!==Z){var c=z.get_active_camera();g.calc_ray(c,b,a,aa);H.get_pline_directional_vec(aa,X);O.scale(X,100,X);ca.change_ray_test_from_to(Z,ia,X)}}function B(a){a.preventDefault&&
a.preventDefault();a=a.changedTouches[0];D(a.clientX,a.clientY)}function u(a){a.preventDefault&&a.preventDefault();D(a.clientX,a.clientY)}function D(a,b){var d=z.pick_object(a,b);if(d&&f[d.name]){var e=f[d.name];e.level_name?(p(),setTimeout(function(){l(e.level_name)},1E3*I.LEVEL_LOAD_DELAY)):q.detect_mobile()||(c(),p(),y())}}function p(){ba=!0;q.detect_mobile()?R.removeEventListener("touchstart",B,!1):(R.removeEventListener("mousedown",u),R.removeEventListener("mousemove",t))}function y(){L||n();
v.remove_sensor_manifold(null,"ROT_CAMERA");v.remove_sensor_manifold(null,"BUTTON_HOVER");v.create_sensor_manifold(null,"TIMELINE_CHECK",v.CT_SHOT,[v.create_elapsed_sensor()],function(a){return M.get_frame()>=M.get_frame_end()},function(){l("level_01")})}function n(){E.duck(null,0,1);var a=z.get_object_by_name("environment_LQ");document.getElementById("preloader_cont").style.visibility="visible";G.load(ma+"intro_HQ_environment.json",function(){z.hide_object(a);E.duck(null,1,1);L=!0},h,!0,!1)}function c(a){for(a=
...
show_fps:b,autoresize:!0})},!1)}var q=b("main"),k=b("app"),g=b("camera"),G=b("data"),v=b("controls"),z=b("scenes"),N=b("config"),fa=b("print"),E=b("sfx");b("time");var d=b("assets"),P=b("objects"),Q=b("container");b("util");var M=b("nla"),J=b("transform"),K=b("version"),ca=b("physics"),H=b("math"),O=b("vec3");b("quat");var I=b("game_config"),U=b("game_main"),L=!1,ba=!1,S=null,f={},da=!1,T=null,W=[],V=null,Z=null,ia=new Float32Array(3),X=new Float32Array(3),aa=H.create_pline(),R=null,Y=0,ga=0,ea=new Float32Array(2),
ha=null,ka=new Float32Array(3),oa=0,la=new Float32Array(3),pa="en",ra=null,sa=new Float32Array(2),ma=N.get_std_assets_path()+"petigors_tale/";a.init=function(){window.addEventListener("load",A)}});b4w.require("start_menu").init("en");
