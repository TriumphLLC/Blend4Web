...
"#"+ha(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,p=6-m.length;if(0<p){for(var q=[],n=0;n<p;n++)q.push("0");q.push(m);m=q.join("")}m=N(na(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=T({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
...
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=N(na(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=N(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=T(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};H.enable_controls();window.addEventListener("resize",T,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);ua.detect_mobile()||z(["gyro_use"],"disable");var g=H.get_url_params();Ua.enqueue([["manifest",
Ua.AT_JSON,"assets.json"]],function(a,b,c,Ja){Y=a;Ca=document.getElementById("info_left_down");O=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Va.date_str();r(y,"quality","string");switch(K.get("quality")){case K.P_ULTRA:var k=0;break;case K.P_HIGH:k=1;break;case K.P_LOW:k=2;break;case K.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");H.set_onclick("reset",A);H.set_onclick("auto_rotate_cam",kb);H.set_onclick("pause",
v);H.set_onclick("resume",D);H.set_onclick("auto_view",Ha);H.set_onclick("home",C);a=document.getElementById("manifest");if(Y){c="";b=(b=H.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home - "+b[b.length-1];c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<Y.length;b++){k=Y[b];Ja=k.name;for(var k=k.items,R="",R=R+"<div data-role='collapsible' data-mini='true' >",
R=R+("<h6>"+Ja+"</h6>"),R=R+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,R=R+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+Ja)+'">'+m+"</a></li>");R+="</ul>";R+="</div>";c+=R}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";f();r(ma,"anim_active_object",
"string");r(ma,"animation","string");r(ma,"anim_mix_factor","number");r(ma,"anim_slot","number");r(ma,"anim_cyclic","bool");r(ma,"anim_frame_current","number");H.set_onclick("anim_play",na);H.set_onclick("anim_stop",N);H.set_onclick("anim_play_all",Z);H.set_onclick("anim_stop_all",da);r(ib,"nla_frame_current","number");H.set_onclick("nla_play",ha);H.set_onclick("nla_stop",Fa);r(Ba,"shape_key_obj","string");r(Ba,"shape_key_name","string");r(Ba,"shape_key_value","number");r(oa,"material_name","string");
aa(oa,"material_diffuse_color");r(oa,"material_reflectivity","number");r(oa,"material_fresnel","number");r(oa,"material_fresnel_factor","number");r(oa,"material_parallax_scale","number");r(oa,"material_parallax_steps","number");r(G,"material_name","string");r(G,"shore_smoothing","bool");r(G,"absorb_factor","number");r(G,"sss_strength","number");r(G,"sss_width","number");aa(G,"water_fog_color");r(G,"water_fog_density","number");aa(G,"shallow_water_col");r(G,"shallow_water_col_fac","number");aa(G,"shore_water_col");
...
"waves_hor_fac","number");r(Ka,"environment_energy","string");aa(Ka,"horizon_color");aa(Ka,"zenith_color");r(pa,"light_name","string");aa(pa,"light_color");r(pa,"pre_light_energy","number");r(pa,"rude_light_energy","number");r(pa,"light_spot_size","number");r(pa,"light_spot_blend","number");r(pa,"light_distance","number");aa(ba,"sky_color");r(ba,"rayleigh_brightness","number");r(ba,"mie_brightness","number");r(ba,"spot_brightness","number");r(ba,"scatter_strength","number");r(ba,"rayleigh_strength",
"number");r(ba,"mie_strength","number");r(ba,"rayleigh_collection_power","number");r(ba,"mie_collection_power","number");r(ba,"mie_distribution","number");r(La,"date","string");r(La,"day_time","number");r(Wa,"sun_horizontal_position","number");r(Wa,"sun_vertical_position","number");r(lb,"max_sun_angle","number");H.set_onclick("run_sun",mb);H.set_onclick("stop_sun",nb);r(ra,"csm_first_cascade_border","number");r(ra,"csm_last_cascade_border","number");r(ra,"self_shadow_polygon_offset","number");r(ra,
"self_shadow_normal_offset","number");r(ra,"first_cascade_blur_radius","number");r(ra,"last_cascade_blur_radius","number");r(ea,"ssao_quality","string");r(ea,"ssao_hemisphere","bool");r(ea,"ssao_blur_depth","bool");r(ea,"ssao_blur_discard_value","number");r(ea,"ssao_radius_increase","number");r(ea,"ssao_influence","number");r(ea,"ssao_dist_factor","number");r(ea,"ssao_only","bool");r(ea,"ssao_white","bool");r(Ma,"fog_density","number");r(Ma,"fog_density1000","number");aa(Ma,"fog_color");r(va,"dof_distance",
"number");r(va,"dof_front","number");r(va,"dof_rear","number");r(va,"dof_power","number");r(va,"dof_on","bool");r(Na,"god_rays_intensity","number");r(Na,"god_rays_max_ray_length","number");r(Na,"god_rays_steps","number");r(Da,"brightness","number");r(Da,"contrast","number");r(Da,"exposure","number");r(Da,"saturation","number");r(M,"sfx_mix_mode","bool");a=Number("true"===I.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(ia,
"stereo","string");a=I.get("stereo")||"NONE";wa.check_browser_support()||(document.getElementById("stereo").options[2].setAttribute("disabled","disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(I.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);"HMD"==a&&wa.enable_hmd(wa.HMD_ALL_AXES_MOUSE_NONE);r(ja,"gyro_use","bool");a=Number("true"===I.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");
r(Xa,"wind_dir","number");r(Xa,"wind_strength","number");r(Ya,"mb_factor","number");r(Ya,"mb_decay_threshold","number");r(Oa,"bloom_key","number");r(Oa,"bloom_blur","number");r(Oa,"bloom_edge_lum","number");r(Ea,"small_glow_mask_coeff","number");r(Ea,"large_glow_mask_coeff","number");r(Ea,"small_glow_mask_width","number");r(Ea,"large_glow_mask_width","number");r(ob,"canvas_rf","number");r(Za,"wireframe_mode","string");aa(Za,"wireframe_edge_color","object");r(Q,"show_hud_debug_info","bool");r(X,"outlining_overview_mode",
"bool");a=""==I.get("outlining_overview_mode")?1:Number("true"===I.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");H.set_onclick("make_screenshot",pb);a=Number("true"===I.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");
$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ca&&x.can_select_objects()){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=U;d&&x.outlining_is_enabled(d)&&x.clear_outline_anim(d);
b=x.pick_object(b,a);b&&qb.is_empty(b)||((U=b)?$a(b):ab(),c(),ka||(b?(ka=b,c(),H.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ka=null;c();H.disable_object_controls(a)})):g()))}}function g(){var a=x.get_active_camera();ka=a;c();H.enable_camera_controls();J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ka=null;c();H.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),
d=J.create_keyboard_sensor(J.KEY_DEC_POINT);J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&bb.target_zoom_object(a,b)})}function c(){if(Ca){var a=ka?la(ka):"NONE",b=U?la(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=U)&&(b=x.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=ka;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+cb);Ca.innerHTML=a}}function d(){var a=I.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];
if(xa.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){ya=!1;clearTimeout(Pa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=
a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];ya=!1;clearTimeout(Pa);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<O.children.length;f++)O.children[f].style.visibility="hidden";if((f=H.get_url_params())&&f.load){var g=f.load.split("/");sa={load_file:f.load,name:g[g.length-1].split(".")[0],animated_objects:[]}}else sa={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ca=F=null;if(!e)if(b){e=xa.keyfind("name",b.category,
Y)[0];e=xa.keyfind("name",b.item,e.items)[0];for(var h in e)sa[h]="load_file"==h?K.get_std_assets_path()+e[h]:e[h];I.set("last_item_name",b.item)}else I.set("last_item_name","");c&&(ua.clear_render_callback(),Qa.cleanup());Ra.get_canvas().removeEventListener("mousedown",a);L.clear_errors_warnings();b=sa.name;c=sa.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Qa.load(c,l,p,d)}function l(b){Ra.get_canvas().addEventListener("mousedown",a,!1);U=
null;q(sa);g();H.enable_debug_controls();P()&&rb.enable_mixer_controls();K.get("gyro_use")&&sb.enable_camera_rotation();"HMD"==K.get("stereo")&&wa.enable_hmd(wa.HMD_ALL_AXES_MOUSE_NONE);ua.set_render_callback(w);ya&&(Pa=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(x.get_active_camera(),"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&U){if(d=U)b=tb,ub.get_object_center(d,!0,b),a=bb.get_translation(a,vb),cb=wb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();
if(a){var b=a.item,a=xa.keyfind("name",a.category,Y)[0],b=xa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=Y.indexOf(a);b=null;do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{ya=!1;return}}}else a=Y[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),
d=L.get_warning_quantity();if(Qa.is_primary_loaded()){T();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML=
"Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=L.get_error_quantity();(f=L.get_warning_quantity())||e?O.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):O.setAttribute("title","Loaded OK");d||c||(O.children[0].style.visibility="hidden",O.children[1].style.visibility="hidden",O.children[2].style.visibility="visible")}d&&!c&&(O.children[0].style.visibility=
"hidden",O.children[1].style.visibility="visible",O.children[2].style.visibility="hidden");c&&(O.children[0].style.visibility="visible",O.children[1].style.visibility="hidden",O.children[2].style.visibility="hidden")}function q(a){for(var c=x.get_active(),d=x.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=ga(f,a);E(f,g)}}g=ga(c,a);E(c,g);$a=function(a){var c=qa.get_materials_names(a);b("material_name",c);db(a,c[0]);a=qa.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):z(c,"disable")};xb();a=x.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(la(a[e]));b("light_name",c);0<a.length&&eb(a[0]);yb();jb();zb();Ab();Bb();Cb();Db();Eb();Fb();Gb();Hb();Ib();Jb();ab();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);La({date:e})}function ga(a,b){function c(a,b){for(var d in a)b[d]=
a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function E(a,c){x.set_active(a);x.get_active_camera();for(var d=[],e=x.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(F||(F=g),d.push(la(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");F?(z(f,"enable"),b("anim_active_object",d),ma({anim_active_object:la(F)})):z(f,"disable");
...
d=[];for(f=0;f<e.length;f++)g=e[f],za.check_shape_keys(g)&&(ca||(ca=g),d.push(la(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ca?(z(e,"enable"),b("shape_key_obj",d),Ba({shape_key_obj:la(ca)})):z(e,"disable")}function w(a,b){x.get_active_camera();if(F){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(F,d)?(d=Math.round(B.get_frame(F,d)),parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):
...
!0,!1,!0)}function v(){ua.pause()}function D(){ua.resume()}function P(){return"true"===I.get("sfx_mix_mode")?!0:!1}function Q(a){I.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function M(a){I.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function ia(a){I.set("stereo",a.stereo);window.location.reload()}function ja(a){I.set("gyro_use",a.gyro_use);window.location.reload()}function X(a){I.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}
function Ha(){ya=!0;m()}function T(a){H.resize_to_container();a=Ra.get_canvas();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)"}function na(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&B.play(F,null,b)}function N(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);B.stop(F,a)}function Z(){for(var a=document.getElementById("anim_active_object").children,
b=0;b<a.length;b++){var c=ta(a[b].value);B.play(c,null,B.SLOT_ALL)}}function da(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ta(a[b].value);B.stop(c,null,B.SLOT_ALL)}}function ha(){S.play()}function Fa(){S.stop()}function Ba(a){if("shape_key_obj"in a){ca=ta(a.shape_key_obj);var c=za.get_shape_keys_names(ca);c.length?(b("shape_key_name",c),Aa=c[0],c=za.get_shape_key_value(ca,Aa),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&
(Aa=a.shape_key_name,c=za.get_shape_key_value(ca,Aa),u("shape_key_value",c));"shape_key_value"in a&&za.set_shape_key_value(ca,Aa,a.shape_key_value)}function ib(a){"nla_frame_current"in a&&!S.is_play()&&(a=parseInt(a.nla_frame_current),S.set_frame(a))}function ma(a){if("anim_active_object"in a){F=ta(a.anim_active_object);var c=B.get_anim_names(F);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);
Ta(F,c);Ga(F,c)}else b("animation",["N/A"]);Ia(F)}if("anim_slot"in a){if(!F)return;c=a.anim_slot;Ta(F,c);Ga(F,c);Ia(F)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.get_current_anim_name(F,c),"None"==a.animation?B.remove_slot_animation(F,c):(B.apply(F,a.animation,c),B.play(F,null,c)),Ga(F,c),Ia(F));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=B.get_slot_num_by_anim(F,c),B.set_behavior(F,a.anim_cyclic?B.AB_CYCLIC:B.AB_FINISH_RESET,c));"anim_frame_current"in
a&&(c=parseInt(document.getElementById("anim_slot").value),B.is_play(F,c)||(d=parseInt(a.anim_frame_current),B.set_frame(F,d,c)));"anim_mix_factor"in a&&B.set_skel_mix_factor(F,a.anim_mix_factor)}function Ta(a,b){for(var c=B.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Ga(a,b){u("anim_cyclic",Number(B.get_behavior(a,b)==B.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),
d=B.get_anim_start_frame(a,b),e=B.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Ia(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),d=B.get_anim_type(a,c),c=0;c<b.length;c++){d=B.get_anim_type(a,c);switch(d){case B.OBJ_ANIM_TYPE_ARMATURE:d="ARMATURE";break;case B.OBJ_ANIM_TYPE_OBJECT:d="OBJECT";break;case B.OBJ_ANIM_TYPE_PARTICLES:d=
"PARTICLES";break;case B.OBJ_ANIM_TYPE_VERTEX:d="VERTEX";break;case B.OBJ_ANIM_TYPE_MATERIAL:d="MATERIAL";break;case B.OBJ_ANIM_TYPE_STATIC:d="STATIC";break;default:d="NONE"}b.eq(c);d=c+" ("+d+")";$("#anim_slot").children().eq(c).text(d)}$("#anim_slot").selectmenu();$("#anim_slot").selectmenu("refresh")}function jb(){var a=x.get_ssao_params(),b="ssao_quality ssao_hemisphere ssao_blur_depth ssao_blur_discard_value ssao_radius_increase ssao_influence ssao_dist_factor ssao_only ssao_white".split(" ");
...
x.set_ssao_params(b)}function Cb(){var a=x.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(z(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):z(b,"disable")}function Da(a){var b=x.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),x.set_color_correction_params(b))}function fb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function zb(){var a=x.get_fog_color_density();.2<a[3]?u("fog_density",a[3]):u("fog_density1000",1E3*a[3]);fa("fog_color",a)}function Ma(a){var b=x.get_fog_color_density();"fog_density"in a&&(b[3]=a.fog_density);"fog_density1000"in a&&(b[3]=a.fog_density1000/1E3);"fog_color"in a&&(b[0]=a.fog_color[0],b[1]=a.fog_color[1],b[2]=a.fog_color[2]);
x.set_fog_color_density(b)}function yb(){var a=x.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return z(b,"disable"),document.getElementById("csm_resolution").innerHTML="",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML=
"",null;z(b,"enable");gb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",a.last_cascade_blur_radius)):z(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):z(["csm_first_cascade_border",
...
"none"}function xb(){var a=x.get_environment_colors();u("environment_energy",a[0]);fa("horizon_color",a[1]);fa("zenith_color",a[2])}function Ka(a){"environment_energy"in a&&x.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&x.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&x.set_environment_colors(null,null,a.zenith_color)}function Za(a){var b={};if("string"==typeof a.wireframe_mode)switch(fb(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=
L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function pb(){Kb.shot()}function Fb(){var a=x.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
...
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean(a.dof_on));x.set_dof_params(b)}function Bb(){var a=x.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(z(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):z(b,"disable")}function Na(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=
a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);x.set_god_rays_params(b)}function ob(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),T())}function Gb(){var a=x.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(z(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",a.mb_decay_threshold))):z(b,"disable")}function Ya(a){var b={};"mb_factor"in a&&(b.mb_factor=
a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);x.set_mb_params(b)}function Hb(){var a=x.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(z(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):z(b,"disable")}function Oa(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);x.set_bloom_params(b)}
function Ib(){var a=x.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(z(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):z(b,"disable")}function Ea(a){var b={};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in
a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);x.set_glow_material_params(b)}function fa(a,b){var c=Sa.rgb_to_css(b),d=Sa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",d)}function Db(){var a=x.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),
u("wind_strength",a.wind_strength)):z(b,"disable")}function Xa(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);x.set_wind_params(b)}function u(a,b){$("#"+a).val(b);$("#"+a).slider("refresh");$("#"+a).trigger("change")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),
null}a(e)})}function aa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Sa.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function kb(){Nb.auto_rotate(.3)}function z(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function la(a){return x.get_object_name_hierarchy(a).join("->")}function ta(a){return x.get_object_by_dupli_name_list(a.split("->"))}
var B=n("animation"),H=n("app"),Ua=n("assets"),bb=n("camera"),Nb=n("camera_anim"),K=n("config");n("constraints");var Ra=n("container"),J=n("controls"),Qa=n("data"),L=n("debug"),za=n("geometry"),sb=n("gyroscope"),V=n("lights"),ua=n("main"),wa=n("hmd"),rb=n("mixer"),qa=n("material"),S=n("nla"),qb=n("objects"),Sa=n("rgb"),Kb=n("screenshooter"),x=n("scenes"),I=n("storage"),ub=n("transform"),xa=n("util"),Va=n("version"),wb=n("vec3"),hb="DEBUG"===Va.type(),Mb=Math.PI/180,Lb=180/Math.PI,tb=new Float32Array(3),
vb=new Float32Array(3),ya=!1,Pa,Y=null,F=null,ca=null,Aa="",sa=null,Ca=null,O=null,U=null,$a=function(){},ka=null,cb=null;k.init=function(){I.init("b4w_viewer");var a=I.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("stereo",I.get("stereo")||"NONE");K.set("gyro_use","true"===I.get("gyro_use"));""==I.get("outlining_overview_mode")?K.set("outlining_overview_mode",!0):K.set("outlining_overview_mode",
"true"===I.get("outlining_overview_mode"));H.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===I.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:P(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!hb,assets_min50_available:!hb,console_verbose:!0,physics_enabled:!0,wireframe_debug:!0})}});b4w.require("viewer_main").init();
