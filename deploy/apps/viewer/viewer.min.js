(function(k,n,t){"function"===typeof define&&define.amd?define(["jquery"],function(da){t(da,k,n);return da.mobile}):t(k.jQuery,k,n)})(this,document,function(k,n,t,da){k.mobile={};(function(a,g){function c(b,f){var c,m;c=b.nodeName.toLowerCase();if("area"===c){c=b.parentNode;m=c.name;if(!b.href||!m||"map"!==c.nodeName.toLowerCase())return!1;c=a("img[usemap=#"+m+"]")[0];return!!c&&d(c)}return(/input|select|textarea|button|object/.test(c)?!b.disabled:"a"===c?b.href||f:f)&&d(b)}function d(b){return a.expr.filters.visible(b)&&
...
!0!==m.options.disabled&&!a(this).hasClass("ui-state-disabled"))return("string"===typeof h?m[h]:h).apply(m,arguments)}"string"!==typeof h&&(g.guid=h.guid=h.guid||g.guid||a.guid++);var k=c.match(/^(\w+)\s*(.*)$/),w=k[1]+m.eventNamespace;(k=k[2])?d.delegate(k,w,g):e.bind(w,g)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"===typeof a?c[a]:a).apply(c,arguments)},
...
{setup:function(){if(h)return!1;a(b.start)},teardown:function(){if(h)return!1;a(b.stop)}});b=function(){function b(){var f=d(),c=w(q);f!==q?(D(q=f,c),a(g).trigger("hashchange")):c!==q&&(location.href=location.href.replace(/#.*/,"")+c);e=setTimeout(b,a.fn.hashchange.delay)}var f={},e,q=d(),k=function(a){return a},D=k,w=k;f.start=function(){e||b()};f.stop=function(){e&&clearTimeout(e);e=c};g.attachEvent&&!g.addEventListener&&!h&&function(){var c,e;f.start=function(){c||(e=(e=a.fn.hashchange.src)&&e+
d(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){e||D(d());b()}).attr("src",e||"javascript:0").insertAfter("body")[0].contentWindow,t.onpropertychange=function(){try{"title"===event.propertyName&&(c.document.title=t.title)}catch(a){}})};f.stop=k;w=function(){return d(c.location.href)};D=function(b,f){var e=c.document,d=a.fn.hashchange.domain;b!==f&&(e.title=t.title,e.open(),d&&e.write('<script>document.domain="'+d+'"\x3c/script>'),e.close(),c.location.hash=b)}}();return f}()})(k,
...
function l(b){var f=a.data(b.target,"virtualTouchID");ka||M&&M===f||!(f=h("v"+b.type,b))||(f.isDefaultPrevented()&&b.preventDefault(),f.isPropagationStopped()&&b.stopPropagation(),f.isImmediatePropagationStopped()&&b.stopImmediatePropagation())}function m(c){var e=b(c).touches,d;e&&1===e.length&&(d=c.target,e=f(d),e.hasVirtualBinding&&(M=da++,a.data(d,"virtualTouchID",M),B&&(clearTimeout(B),B=0),L=W=!1,d=b(c).touches[0],R=d.pageX,O=d.pageY,h("vmouseover",c,e),h("vmousedown",c,e)))}function p(a){W||
(L||h("vmousecancel",a,f(a.target)),L=!0,e())}function q(c){if(!W){var d=b(c).touches[0],m=L,l=a.vmouse.moveDistanceThreshold,p=f(c.target);(L=L||Math.abs(d.pageX-R)>l||Math.abs(d.pageY-O)>l)&&!m&&h("vmousecancel",c,p);h("vmousemove",c,p);e()}}function k(a){if(!W){W=!0;var c=f(a.target),d;h("vmouseup",a,c);L||(d=h("vclick",a,c))&&d.isDefaultPrevented()&&(d=b(a).changedTouches[0],ja.push({touchID:M,x:d.clientX,y:d.clientY}),ka=!0);h("vmouseout",a,c);L=!1;e()}}function D(b){b=a.data(b,"virtualMouseBindings");
var f;if(b)for(f in b)if(b[f])return!0;return!1}function w(){}function n(b){var f=b.substr(1);return{setup:function(){D(this)||a.data(this,"virtualMouseBindings",{});a.data(this,"virtualMouseBindings")[b]=!0;v[b]=(v[b]||0)+1;1===v[b]&&Y.bind(f,l);a(this).bind(f,w);la&&(v.touchstart=(v.touchstart||0)+1,1===v.touchstart&&Y.bind("touchstart",m).bind("touchend",k).bind("touchmove",q).bind("scroll",p))},teardown:function(){--v[b];v[b]||Y.unbind(f,l);la&&(--v.touchstart,v.touchstart||Y.unbind("touchstart",
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,w);D(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var t="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},B=0,R=0,O=0,L=!1,ja=[],ka=!1,W=!1,la="addEventListener"in c,Y=a(c),da=1,M=0,Z,S;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(S=0;S<g.length;S++)a.event.special[g[S]]=n(g[S]);la&&c.addEventListener("click",function(b){var f=ja.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ja[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
"body"!==t.activeElement.nodeName.toLowerCase()?a(t.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(C){}y=!1;w&&p&&(p.url&&-1<p.url.indexOf(a.mobile.dialogHashKey)&&this.activePage&&!this.activePage.hasClass("ui-dialog")&&0<a.mobile.navigate.history.activeIndex&&(e.changeHash=!1,y=!0),l=p.url||"",l=!y&&-1<l.indexOf("#")?l+a.mobile.dialogHashKey:l+("#"+a.mobile.dialogHashKey));(A=p?b.jqmData("title")||b.children(":jqmData(role='header')").find(".ui-title").text():
n)&&n===t.title&&(n=A);b.jqmData("title")||b.jqmData("title",n);e.transition=e.transition||(k&&!q?p.transition:g)||(w?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);!k&&y&&(a.mobile.navigate.history.getActive().pageUrl=m);l&&!e.fromHashChange&&(!a.mobile.path.isPath(l)&&0>l.indexOf("#")&&(l="#"+l),m={transition:e.transition,title:n,pageUrl:m,role:e.role},!1!==e.changeHash&&a.mobile.hashListeningEnabled?a.mobile.navigate(this.window[0].encodeURI(l),m,!0):b[0]!==a.mobile.firstPage[0]&&
...
_afterListviewRefresh:a.noop,refresh:function(d){var b,f,e,h,l,g,k,q,n,t,w,y=this.options;f=this.element;var A=!!a.nodeName(f[0],"ol");e=f.attr("start");var C={},v=f.find(".ui-li-count"),B=c(f[0],"counttheme")||this.options.countTheme,B=B?"ui-body-"+B:"ui-body-inherit";y.theme&&f.addClass("ui-group-theme-"+y.theme);A&&(e||0===e)&&(e=parseInt(e,10)-1,f.css("counter-reset","listnumbering "+e));this._beforeListviewRefresh();w=this._getChildrenByTagName(f[0],"li","LI");f=0;for(e=w.length;f<e;f++){h=w.eq(f);
...
t+k,g.attr("title",a.trim(g.getEncodedText())).addClass(k).empty(),q=q.first()):k&&(b+=" ui-btn-icon-right ui-icon-"+k),q.addClass(b)):b?(l=c(h[0],"theme")||y.dividerTheme||y.theme,l="ui-li-divider ui-bar-"+(l?l:"inherit"),h.attr("role","heading")):0>=q.length&&(l="ui-li-static ui-body-"+(g?g:"inherit")),A&&n&&(n=parseInt(n,10)-1,h.css("counter-reset","listnumbering "+n));C[l]||(C[l]=[]);C[l].push(h[0])}for(l in C)a(C[l]).addClass(l);v.each(function(){a(this).closest("li").addClass("ui-li-has-count")});
B&&v.not("[class*='ui-body-']").addClass(B);this._addThumbClasses(w);this._addThumbClasses(w.find(".ui-btn"));this._afterListviewRefresh();this._addFirstLastClasses(w,this._getVisibles(w,d),d)}},a.mobile.behaviors.addFirstLastClasses))})(k);(function(a,g){a.widget("mobile.listview",a.mobile.listview,{options:{autodividers:!1,autodividersSelector:function(c){c=a.trim(c.text())||null;return c?c=c.slice(0,1).toUpperCase():null}},_beforeListviewRefresh:function(){this.options.autodividers&&(this._replaceDividers(),
...
ha=q.attr("id")||k+"-label",D=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),y=n.parseFloat(c.attr("step")||1),A=t.createElement("a"),C=a(A),k=t.createElement("div"),v=a(k),B=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(v)}():!1;q.attr("id",ha);this.isToggleSwitch=d;A.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");A.className="ui-slider-handle";k.appendChild(A);C.attr({role:"slider","aria-valuemin":D,"aria-valuemax":w,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":ha});a.extend(this,{slider:v,handle:C,control:c,type:h,step:y,max:w,min:D,valuebg:B,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
...
h?parseFloat(e.attr("min")):0;w=h?parseFloat(e.attr("max")):n.length-1;y=h&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1;if("object"===typeof c){k=c;l=this.slider.offset().left;g=this.slider.width();q=g/((w-D)/y);if(!this.dragging||k.pageX<l-8||k.pageX>l+g+8)return;l=1<q?(k.pageX-l)/g*100:Math.round((k.pageX-l)/g*100)}else null==c&&(c=h?parseFloat(e.val()||0):e[0].selectedIndex),l=(parseFloat(c)-D)/(w-D)*100;if(!isNaN(l)&&(k=l/100*(w-D)+D,A=(k-D)%y,k-=A,2*Math.abs(A)>=y&&(k+=0<A?y:-y),
A=100/((w-D)/y),k=parseFloat(k.toFixed(5)),"undefined"===typeof q&&(q=g/((w-D)/y)),1<q&&h&&(l=1/y*A*(k-D)),0>l&&(l=0),100<l&&(l=100),k<D&&(k=D),k>w&&(k=w),this.handle.css("left",l+"%"),this.handle[0].setAttribute("aria-valuenow",h?k:n.eq(k).attr("value")),this.handle[0].setAttribute("aria-valuetext",h?k:n.eq(k).getEncodedText()),this.handle[0].setAttribute("title",h?k:n.eq(k).getEncodedText()),this.valuebg&&this.valuebg.css("width",l+"%"),this._labels&&(g=this.handle.width()/this.slider.width()*100,
...
this.listbox.one({popupafteropen:a.proxy(this,"_focusMenuItem")})},_buildList:function(){var c=this.options,b=this.placeholder,f=!0,e,h,g;e="data-"+a.mobile.ns;var k=e+"option-index",p=e+"icon",q=e+"role",n=e+"placeholder",D=t.createDocumentFragment(),w=!1,y,A,C,v,B,R,O,L;this.list.empty().filter(".ui-listview").listview("destroy");e=this._selectOptions();h=e.length;g=this.select[0];for(A=0;A<h;A++,w=!1)C=e[A],v=a(C),v.hasClass("ui-screen-hidden")||(B=C.parentNode,L=[],R=v.text(),O=t.createElement("a"),
O.setAttribute("href","#"),O.appendChild(t.createTextNode(R)),B!==g&&"optgroup"===B.nodeName.toLowerCase()&&(B=B.getAttribute("label"),B!==y&&(y=t.createElement("li"),y.setAttribute(q,"list-divider"),y.setAttribute("role","option"),y.setAttribute("tabindex","-1"),y.appendChild(t.createTextNode(B)),D.appendChild(y),y=B)),!f||C.getAttribute("value")&&0!==R.length&&!v.jqmData("placeholder")||(f=!1,w=!0,null===C.getAttribute(n)&&(this._removePlaceholderAttr=!0),C.setAttribute(n,!0),c.hidePlaceholderMenuItems&&
L.push("ui-screen-hidden"),b!==R&&(b=this.placeholder=R)),v=t.createElement("li"),C.disabled&&(L.push("ui-state-disabled"),v.setAttribute("aria-disabled",!0)),v.setAttribute(k,A),v.setAttribute(p,"false"),w&&v.setAttribute(n,!0),v.className=L.join(" "),v.setAttribute("role","option"),O.setAttribute("tabindex","-1"),this.isMultiple&&a(O).addClass("ui-btn ui-checkbox-off ui-btn-icon-right"),v.appendChild(O),D.appendChild(v));this.list[0].appendChild(D);this.isMultiple||b.length?this.headerTitle.text(this.placeholder):
...
else{w=p.className;var y=k=q=void 0,A=!1,C=!0,v={icon:"",inline:!1,shadow:!1,corners:!1,iconshadow:!1,mini:!1},B=[];w=w.split(" ");for(q=0;q<w.length;q++)y=!0,k=d[w[q]],k!==g?(y=!1,v[k]=!0):0===w[q].indexOf("ui-btn-icon-")?(C=y=!1,v.iconpos=w[q].substring(12)):0===w[q].indexOf("ui-icon-")?(y=!1,v.icon=w[q].substring(8)):0===w[q].indexOf("ui-btn-")&&8===w[q].length?(y=!1,v.theme=w[q].substring(7)):"ui-btn"===w[q]&&(y=!1,A=!0),y&&B.push(w[q]);C&&(v.icon="");w={options:v,unknownClasses:B,alreadyEnhanced:A}}k=
...
{transition:"none",reverse:!0,changeHash:!1,fromHashChange:!0}))}}),a(function(){a.support.inlineSVG();a.mobile.hideUrlBar&&g.scrollTo(0,1);a.mobile.defaultHomeScroll=a.support.scrollTop&&1!==a.mobile.window.scrollTop()?1:0;a.mobile.autoInitializePage&&a.mobile.initializePage();a.mobile.hideUrlBar&&f.load(a.mobile.silentScroll);a.support.cssPointerEvents||a.mobile.document.delegate(".ui-state-disabled,.ui-disabled","vclick",function(a){a.preventDefault();a.stopImmediatePropagation()})}))})(k,this)});(function(k){var n=function(){var n=65,da={eventName:"click",onShow:function(){},onBeforeShow:function(){},onHide:function(){},onChange:function(){},onSubmit:function(){},color:"ff0000",livePreview:!0,flat:!1},a=function(a,b){var c=Z(a);c.r=Math.round(1E3*Math.pow(c.r/255,2.2))/1E3;c.g=Math.round(1E3*Math.pow(c.g/255,2.2))/1E3;c.b=Math.round(1E3*Math.pow(c.b/255,2.2))/1E3;k(b).data("colorpicker").fields.eq(1).val(c.r).end().eq(2).val(c.g).end().eq(3).val(c.b).end()},g=function(a,b){k(b).data("colorpicker").fields.eq(4).val(a.h).end().eq(5).val(a.s).end().eq(6).val(a.b).end()},
...
"#"+ia(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,p=6-m.length;if(0<p){for(var q=[],n=0;n<p;n++)q.push("0");q.push(m);m=q.join("")}m=M(ta(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=Y({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
10),s:parseInt(h.data("colorpicker").fields.eq(5).val(),10),b:parseInt(h.data("colorpicker").fields.eq(6).val(),10)}):(l=h.data("colorpicker"),m=parseInt(h.data("colorpicker").fields.eq(1).val(),10),p=parseInt(h.data("colorpicker").fields.eq(2).val(),10),q=parseInt(h.data("colorpicker").fields.eq(3).val(),10),m={r:Math.min(255,Math.max(0,m)),g:Math.min(255,Math.max(0,p)),b:Math.min(255,Math.max(0,q))},l.color=l=M(m));f&&(a(l,h.get(0)),c(l,h.get(0)),g(l,h.get(0)));d(l,h.get(0));b(l,h.get(0));e(l,h.get(0));
h.data("colorpicker").onChange.apply(h,[l,ia(l),Z(l)])},m=function(a){k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},p=function(){n=0<this.parentNode.className.indexOf("_hex")?70:65;k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");k(this).parent().addClass("colorpicker_focus")},q=function(a){var b=k(this).parent().find("input").focus();a={el:k(this).parent().addClass("colorpicker_slider"),max:0<this.parentNode.className.indexOf("_hsb_h")?
360:0<this.parentNode.className.indexOf("_hsb")?100:255,y:a.pageY,field:b,val:parseInt(b.val(),10),preview:k(this).parent().parent().data("colorpicker").livePreview};k(document).bind("mouseup",a,D);k(document).bind("mousemove",a,ha)},ha=function(a){a.data.field.val(Math.max(0,Math.min(a.data.max,parseInt(a.data.val+a.pageY-a.data.y,10))));a.data.preview&&l.apply(a.data.field.get(0),[!0]);return!1},D=function(a){l.apply(a.data.field.get(0),[!0]);a.data.el.removeClass("colorpicker_slider").find("input").focus();
k(document).unbind("mouseup",D);k(document).unbind("mousemove",ha);return!1},w=function(a){a.preventDefault();a={cal:k(this).parent(),y:k(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,A);k(document).bind("mousemove touchmove",a,y)},y=function(a){var b=a;"undefined"!==typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,b.pageY-a.data.y)))/150,10)).get(0),
[a.data.preview]);return!1},A=function(b){a(b.data.cal.data("colorpicker").color,b.data.cal.get(0));c(b.data.cal.data("colorpicker").color,b.data.cal.get(0));k(document).unbind("mouseup touchend",A);k(document).unbind("mousemove touchmove",y);return!1},C=function(a){a.preventDefault();a={cal:k(this).parent(),pos:k(this).offset()};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,B);k(document).bind("mousemove touchmove",a,v)},v=function(a){var b=a;"undefined"!==
typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(6).val(parseInt(100*(150-Math.max(0,Math.min(150,b.pageY-a.data.pos.top)))/150,10)).end().eq(5).val(parseInt(100*Math.max(0,Math.min(150,b.pageX-a.data.pos.left))/150,10)).get(0),[a.data.preview]);return!1},B=function(b){a(b.data.cal.data("colorpicker").color,b.data.cal.get(0));c(b.data.cal.data("colorpicker").color,b.data.cal.get(0));k(document).unbind("mouseup touchend",B);k(document).unbind("mousemove touchmove",
v);return!1},R=function(a){k(this).addClass("colorpicker_focus")},O=function(a){k(this).removeClass("colorpicker_focus")},L=function(a){a=k(this).parent();var b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;f(b,a.get(0));a.data("colorpicker").onSubmit(b,ia(b),Z(b),a.data("colorpicker").el)},ja=function(a){var b=k("body"),c=b.data("colorpickerId"),d=k(this).data("colorpickerId");c&&c===d?(k(document).trigger("mousedown"),b.data("colorpickerId",null)):(ka.call(this,a),b.data("colorpickerId",
d))},ka=function(a){var b,c,d=k("#"+k(this).data("colorpickerId"));d.data("colorpicker").onBeforeShow.apply(this,[d.get(0)]);var e=k(this).offset(),f="CSS1Compat"==document.compatMode;a=window.pageXOffset||(f?document.documentElement.scrollLeft:document.body.scrollLeft);b=window.pageYOffset||(f?document.documentElement.scrollTop:document.body.scrollTop);c=window.innerWidth||(f?document.documentElement.clientWidth:document.body.clientWidth);var g=e.top+this.offsetHeight,e=e.left;g+176>b+(window.innerHeight||
(f?document.documentElement.clientHeight:document.body.clientHeight))&&(g-=this.offsetHeight+176);e+356>a+c&&(e=Math.max(0,e-356));d.css({left:e+"px",top:g+"px"});0!=d.data("colorpicker").onShow.apply(this,[d.get(0)])&&d.show();k(document).bind("mousedown",{cal:d},W);return!1},W=function(a){la(a.data.cal.get(0),a.target,a.data.cal.get(0))||(0!=a.data.cal.data("colorpicker").onHide.apply(this,[a.data.cal.get(0)])&&a.data.cal.hide(),k(document).unbind("mousedown",W))},la=function(a,b,c){if(a==b)return!0;
if(a.contains)return a.contains(b);if(a.compareDocumentPosition)return!!(a.compareDocumentPosition(b)&16);for(b=b.parentNode;b&&b!=c;){if(b==a)return!0;b=b.parentNode}return!1},Y=function(a){return{h:Math.round(Math.min(360,Math.max(0,a.h))),s:Math.round(Math.min(100,Math.max(0,a.s))),b:Math.round(Math.min(100,Math.max(0,a.b)))}},ta=function(a){a=parseInt(-1<a.indexOf("#")?a.substring(1):a,16);return{r:a>>16,g:(a&65280)>>8,b:a&255}},M=function(a){var b={h:0,s:0,b:0},c=Math.min(a.r,a.g,a.b),d=Math.max(a.r,
a.g,a.b),c=d-c;b.b=d;b.s=0!=d?255*c/d:0;b.h=0!=b.s?a.r==d?(a.g-a.b)/c:a.g==d?2+(a.b-a.r)/c:4+(a.r-a.g)/c:-1;b.h*=60;0>b.h&&(b.h+=360);b.s*=100/255;b.b*=100/255;b.h=Math.round(b.h);b.s=Math.round(b.s);b.b=Math.round(b.b);return b},Z=function(a){var b,c,d;b=Math.round(a.h);var e=Math.round(255*a.s/100);a=Math.round(255*a.b/100);if(0==e)b=c=d=a;else{var e=(255-e)*a/255,f=b%60*(a-e)/60;360==b&&(b=0);60>b?(b=a,d=e,c=e+f):120>b?(c=a,d=e,b=a-f):180>b?(c=a,b=e,d=e+f):240>b?(d=a,b=e,c=a-f):300>b?(d=a,c=e,
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},S=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ia=function(a){return S(Z(a))},ea=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},da,n||{});
if("string"==typeof n.color)n.color=M(ta(n.color));else if(void 0!=n.color.r&&void 0!=n.color.g&&void 0!=n.color.b)n.color=M(n.color);else if(void 0!=n.color.h&&void 0!=n.color.s&&void 0!=n.color.b)n.color=Y(n.color);else return this;return this.each(function(){if(!k(this).data("colorpickerId")){var t=k.extend({},n);t.origColor=n.color;var v="collorpicker_"+parseInt(1E3*Math.random());k(this).data("colorpickerId",v);v=k('<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>').attr("id",
v);t.flat?v.appendTo(this).show():v.appendTo(document.body);t.fields=v.find("input").bind("keyup",h).bind("change",l).bind("blur",m).bind("focus",p);v.find("span").bind("mousedown touchstart",q).end().find(">div.colorpicker_current_color").bind("click",ea);t.selector=v.find("div.colorpicker_color").bind("touchstart mousedown",C);t.selectorIndic=t.selector.find("div div");t.el=this;t.hue=v.find("div.colorpicker_hue div");v.find("div.colorpicker_hue").bind("mousedown touchstart",w);t.newColor=v.find("div.colorpicker_new_color");
t.currentColor=v.find("div.colorpicker_current_color");v.data("colorpicker",t);v.find("div.colorpicker_submit").bind("mouseenter touchstart",R).bind("mouseleave touchend",O).bind("click",L);a(t.color,v.get(0));g(t.color,v.get(0));c(t.color,v.get(0));b(t.color,v.get(0));d(t.color,v.get(0));f(t.color,v.get(0));e(t.color,v.get(0));t.flat?v.css({position:"relative",display:"block"}):k(this).bind(t.eventName,ja)}})},showPicker:function(){return this.each(function(){k(this).data("colorpickerId")&&ka.apply(this)})},
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=M(ta(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=M(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=Y(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};I.enable_controls();window.addEventListener("resize",la,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);ma.detect_mobile()||z(["gyro_use"],"disable");var g=I.get_url_params();Oa.enqueue([["manifest",
Oa.AT_JSON,"assets.json"]],function(a,b,c,Ea){X=a;Aa=document.getElementById("info_left_down");N=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Pa.date_str();r(y,"quality","string");switch(K.get("quality")){case K.P_ULTRA:var k=0;break;case K.P_HIGH:k=1;break;case K.P_LOW:k=2;break;case K.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");I.set_onclick("reset_memory",A);I.set_onclick("auto_rotate_cam",
eb);I.set_onclick("pause",C);I.set_onclick("resume",v);I.set_onclick("auto_view",W);a=document.getElementById("manifest");if(X){c="";b=(b=I.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home ("+b[b.length-1]+")";c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<X.length;b++){k=X[b];Ea=k.name;for(var k=k.items,P="",P=P+"<div data-role='collapsible' data-mini='true' >",
P=P+("<h6>"+Ea+"</h6>"),P=P+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,P=P+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+Ea)+'">'+m+"</a></li>");P+="</ul>";P+="</div>";c+=P}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";f();r(ea,"anim_active_object",
"string");r(ea,"animation","string");r(ea,"anim_mix_factor","number");r(ea,"anim_slot","number");r(ea,"anim_cyclic","bool");r(ea,"anim_frame_current","number");I.set_onclick("anim_play",Y);I.set_onclick("anim_stop",ta);r(ia,"nla_frame_current","number");I.set_onclick("nla_play",M);I.set_onclick("nla_stop",Z);r(S,"shape_key_obj","string");r(S,"shape_key_name","string");r(S,"shape_key_value","number");r(oa,"material_name","string");aa(oa,"material_diffuse_color");r(oa,"material_reflectivity","number");
r(oa,"material_fresnel","number");r(oa,"material_fresnel_factor","number");r(oa,"material_parallax_scale","number");r(oa,"material_parallax_steps","number");r(G,"material_name","string");r(G,"shore_smoothing","bool");r(G,"absorb_factor","number");r(G,"sss_strength","number");r(G,"sss_width","number");aa(G,"water_fog_color");r(G,"water_fog_density","number");aa(G,"shallow_water_col");r(G,"shallow_water_col_fac","number");aa(G,"shore_water_col");r(G,"shore_water_col_fac","number");r(G,"foam_factor",
"number");r(G,"norm_uv_velocity","number");r(G,"water_dynamic","bool");r(G,"waves_height","number");r(G,"waves_length","number");r(G,"dst_noise_scale0","number");r(G,"dst_noise_scale1","number");r(G,"dst_noise_freq0","number");r(G,"dst_noise_freq1","number");r(G,"dir_min_shore_fac","number");r(G,"dir_freq","number");r(G,"dir_noise_scale","number");r(G,"dir_noise_freq","number");r(G,"dir_min_noise_fac","number");r(G,"dst_min_fac","number");r(G,"waves_hor_fac","number");r(Fa,"environment_energy","string");
aa(Fa,"horizon_color");aa(Fa,"zenith_color");r(pa,"light_name","string");aa(pa,"light_color");r(pa,"pre_light_energy","number");r(pa,"rude_light_energy","number");r(pa,"light_spot_size","number");r(pa,"light_spot_blend","number");r(pa,"light_distance","number");aa(ba,"sky_color");r(ba,"rayleigh_brightness","number");r(ba,"mie_brightness","number");r(ba,"spot_brightness","number");r(ba,"scatter_strength","number");r(ba,"rayleigh_strength","number");r(ba,"mie_strength","number");r(ba,"rayleigh_collection_power",
"number");r(ba,"mie_collection_power","number");r(ba,"mie_distribution","number");r(Ga,"date","string");r(Ga,"day_time","number");r(Qa,"sun_horizontal_position","number");r(Qa,"sun_vertical_position","number");r(fb,"max_sun_angle","number");I.set_onclick("run_sun",gb);I.set_onclick("stop_sun",hb);r(ra,"csm_first_cascade_border","number");r(ra,"csm_last_cascade_border","number");r(ra,"self_shadow_polygon_offset","number");r(ra,"self_shadow_normal_offset","number");r(ra,"first_cascade_blur_radius",
"number");r(ra,"last_cascade_blur_radius","number");r(fa,"ssao_quality","string");r(fa,"ssao_hemisphere","bool");r(fa,"ssao_blur_depth","bool");r(fa,"ssao_blur_discard_value","number");r(fa,"ssao_radius_increase","number");r(fa,"ssao_influence","number");r(fa,"ssao_dist_factor","number");r(fa,"ssao_only","bool");r(fa,"ssao_white","bool");r(Ha,"fog_density","number");r(Ha,"fog_density1000","number");aa(Ha,"fog_color");r(ua,"dof_distance","number");r(ua,"dof_front","number");r(ua,"dof_rear","number");
r(ua,"dof_power","number");r(ua,"dof_on","bool");r(Ia,"god_rays_intensity","number");r(Ia,"god_rays_max_ray_length","number");r(Ia,"god_rays_steps","number");r(za,"brightness","number");r(za,"contrast","number");r(za,"exposure","number");r(za,"saturation","number");r(O,"sfx_mix_mode","bool");a=Number("true"===H.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(L,"anaglyph_use","bool");a=Number("true"===H.get("anaglyph_use"));
document.getElementById("anaglyph_use").options[a].selected=!0;$("#anaglyph_use").slider("refresh");r(ja,"gyro_use","bool");a=Number("true"===H.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Ra,"wind_dir","number");r(Ra,"wind_strength","number");r(Sa,"mb_factor","number");r(Sa,"mb_decay_threshold","number");r(Ja,"bloom_key","number");r(Ja,"bloom_blur","number");r(Ja,"bloom_edge_lum","number");r(Ba,"small_glow_mask_coeff","number");r(Ba,
"large_glow_mask_coeff","number");r(Ba,"small_glow_mask_width","number");r(Ba,"large_glow_mask_width","number");r(ib,"canvas_rf","number");r(Ta,"wireframe_mode","string");aa(Ta,"wireframe_edge_color","object");r(R,"show_hud_debug_info","bool");r(ka,"outlining_overview_mode","bool");a=""==H.get("outlining_overview_mode")?1:Number("true"===H.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");I.set_onclick("make_screenshot",
jb);a=Number("true"===H.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");da();a=d();h(a,!1,!1,g&&g.load)},null)}function da(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));
188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Aa){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=T;d&&x.clear_outline_anim(d);(T=b=x.pick_object(b,a))?Ua(b):Va();c();na||(b?(na=b,c(),I.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){na=null;c();I.disable_object_controls(a)})):g())}}function g(){var a=x.get_active_camera();na=a;c();I.enable_camera_controls();
J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){na=null;c();I.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=T)&&Wa.zoom_object(a,b)})}function c(){if(Aa){var a="CONTROLLED: "+(na?String(na.name):"NONE")+" | SELECTED: "+(T?String(T.name):"NONE"),b=T;b&&(b=x.get_type_mesh_object(b))&&
(a+=" | TYPE: "+b);b=na;T&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+Xa);Aa.innerHTML=a}}function d(){var a=H.get("last_item_name");if(!a)return null;for(var b=0;b<X.length;b++){var c=X[b];if(va.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}
function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){wa=!1;clearTimeout(Ka);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];wa=!1;clearTimeout(Ka);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(N)for(var f=0;f<N.children.length;f++)N.children[f].style.visibility="hidden";if((f=I.get_url_params())&&f.load){var g=f.load.split("/");sa={load_file:f.load,name:g[g.length-
1].split(".")[0],animated_objects:[]}}else sa={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ca=E=null;if(!e)if(b){e=va.keyfind("name",b.category,X)[0];e=va.keyfind("name",b.item,e.items)[0];for(var h in e)sa[h]="load_file"==h?K.get_std_assets_path()+e[h]:e[h];H.set("last_item_name",b.item)}else H.set("last_item_name","");c&&(ma.clear_render_callback(),La.cleanup());ma.get_canvas_elem().removeEventListener("mousedown",a);Q.clear_errors_warnings();b=sa.name;c=
sa.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");La.load(c,l,p,d)}function l(b){ma.get_canvas_elem().addEventListener("mousedown",a,!1);T=null;q(sa);g();I.enable_debug_controls();B()&&kb.enable_mixer_controls();K.get("gyro_use")&&lb.enable_camera_rotation();ma.set_render_callback(w);wa&&(Ka=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(x.get_active_camera(),"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&
T){if(d=T)b=mb,nb.get_object_center(d,!0,b),a=Wa.get_eye(a,ob),Xa=pb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=a.item,a=va.keyfind("name",a.category,X)[0],b=va.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else if(a=X.indexOf(a),a=X[a+1])a={category:a.name,item:a.items[0].name};else{wa=!1;return}}else a=X[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=
a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=Q.get_error_quantity(),d=Q.get_warning_quantity();if(La.is_primary_loaded()){var e=Q.num_vertices(),f=Q.num_triangles(),g=Q.num_draw_calls(),h=Q.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=Q.geometry_stats(),f=Q.num_textures(),g=Q.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+
k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=Q.get_error_quantity();(f=Q.get_warning_quantity())||e?N.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):N.setAttribute("title","Loaded OK");d||c||(N.children[0].style.visibility="hidden",N.children[1].style.visibility="hidden",N.children[2].style.visibility=
"visible")}d&&!c&&(N.children[0].style.visibility="hidden",N.children[1].style.visibility="visible",N.children[2].style.visibility="hidden");c&&(N.children[0].style.visibility="visible",N.children[1].style.visibility="hidden",N.children[2].style.visibility="hidden")}function q(a){for(var c=x.get_active(),d=x.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=ha(f,a);D(f,g)}}g=ha(c,a);D(c,g);Ua=function(a){var c=qa.get_materials_names(a);b("material_name",c);Ya(a,c[0]);a=qa.get_water_material_params(a,
c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");a?(z(c,"enable"),x.get_water_mat_params(a),a.shallow_water_col&&ga("shallow_water_col",
a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&ga("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(ga("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),u("foam_factor",a.foam_factor),u("norm_uv_velocity",a.norm_uv_velocity),u("waves_height",
a.waves_height),u("waves_length",a.waves_length),u("dst_noise_scale0",a.dst_noise_scale0),u("dst_noise_scale1",a.dst_noise_scale1),u("dst_noise_freq0",a.dst_noise_freq0),u("dst_noise_freq1",a.dst_noise_freq1),u("dir_min_shore_fac",a.dir_min_shore_fac),u("dir_freq",a.dir_freq),u("dir_noise_scale",a.dir_noise_scale),u("dir_noise_freq",a.dir_noise_freq),u("dir_min_noise_fac",a.dir_min_noise_fac),u("dst_min_fac",a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):z(c,"disable")};qb();a=x.get_all_objects("LAMP");
c=[];for(e=0;e<a.length;e++)c.push(a[e].name);b("light_name",c);0<a.length&&Za(a[0]);rb();cb();sb();tb();ub();db();vb();wb();xb();yb();zb();Ab();Bb();Va();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);Ga({date:e})}function ha(a,b){function c(a,b){for(var d in a)b[d]=a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;
return e}return b}function D(a,c){x.set_active(a);x.get_active_camera();for(var d=[],e=x.get_all_objects(),f=0;f<e.length;f++){var g=e[f];F.is_animated(g)&&(E||(E=g),d.push(x.get_object_name(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");E?(z(f,"enable"),b("anim_active_object",d),ea({anim_active_object:x.get_object_name(E)})):z(f,"disable");d=["nla_play","nla_stop","nla_status","nla_frame_current","nla_playing"];
f=["nla_frame_range"];if(U.check_nla()){U.check_nla_scripts()?(z(d,"disable"),document.getElementById("nla_status").innerHTML="CONTROLLED BY NLA SCRIPT"):z(d,"enable");z(f,"enable");var d=document.getElementById("nla_frame_current"),f=document.getElementById("nla_frame_range"),g=U.get_frame_start(),h=U.get_frame_end();-1!=g&&-1!=h?(f.innerHTML=g+" - "+h,d.min=""+g,d.max=""+h):f.innerHTML="N/A"}else z(d,"disable"),z(f,"disable");d=[];for(f=0;f<e.length;f++)g=e[f],xa.check_shape_keys(g)&&(ca||(ca=g),
d.push(x.get_object_name(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ca?(z(e,"enable"),b("shape_key_obj",d),S({shape_key_obj:x.get_object_name(ca)})):z(e,"disable")}function w(a,b){x.get_active_camera();if(E){var c=parseInt(document.getElementById("anim_slot").value),d=Math.round(F.get_frame(E,c));parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d);d=document.getElementById("anim_status");F.is_play(E,c)?d.innerHTML="PLAYING":d.innerHTML="STOPPED"}U.check_nla()&&
(U.check_nla_scripts()||(d=document.getElementById("nla_status"),U.is_play()?d.innerHTML="PLAYING":d.innerHTML="STOPPED"),d=parseInt(U.get_frame()),parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function y(a){H.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function A(){H.cleanup();window.location.reload()}function C(){ma.pause()}function v(){ma.resume()}function B(){return"true"===H.get("sfx_mix_mode")?!0:!1}function R(a){H.set("show_hud_debug_info",
a.show_hud_debug_info);window.location.reload()}function O(a){H.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function L(a){H.set("anaglyph_use",a.anaglyph_use);window.location.reload()}function ja(a){H.set("gyro_use",a.gyro_use);window.location.reload()}function ka(a){H.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}function W(){wa=!0;m()}function la(a){I.resize_to_container();a=ma.get_canvas_elem();document.getElementById("info_left_up").innerHTML=
a.width+"x"+a.height+" ("+a.width/a.clientWidth+":1)"}function Y(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&F.play(E,null,b)}function ta(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);F.stop(E,a)}function M(){U.play()}function Z(){U.stop()}function S(a){if("shape_key_obj"in a){ca=x.get_object_by_name(a.shape_key_obj);var c=xa.get_shape_keys_names(ca);c.length?(b("shape_key_name",
c),ya=c[0],c=xa.get_shape_key_value(ca,ya),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&(ya=a.shape_key_name,c=xa.get_shape_key_value(ca,ya),u("shape_key_value",c));"shape_key_value"in a&&xa.set_shape_key_value(ca,ya,a.shape_key_value)}function ia(a){"nla_frame_current"in a&&!U.is_play()&&(a=parseInt(a.nla_frame_current),U.set_frame(a))}function ea(a){if("anim_active_object"in a){E=x.get_object_by_name(a.anim_active_object);var c=F.get_anim_names(E);if(c.length){for(var d=
[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);Na(E,c);Ca(E,c)}else b("animation",["N/A"]);Da(E)}if("anim_slot"in a){if(!E)return;c=a.anim_slot;Na(E,c);Ca(E,c);Da(E)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),F.get_current_anim_name(E,c),"None"==a.animation?F.remove_slot_animation(E,c):(F.apply(E,a.animation,c),F.play(E,null,c)),Ca(E,c),Da(E));"anim_cyclic"in a&&(c=document.getElementById("animation").value,
c=F.get_slot_num_by_anim(E,c),F.set_behavior(E,a.anim_cyclic?F.AB_CYCLIC:F.AB_FINISH_RESET,c));"anim_frame_current"in a&&(c=parseInt(document.getElementById("anim_slot").value),F.is_play(E,c)||(d=parseInt(a.anim_frame_current),F.set_frame(E,d,c)));"anim_mix_factor"in a&&F.set_skel_mix_factor(E,a.anim_mix_factor)}function Na(a,b){for(var c=F.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");
break}}}function Ca(a,b){u("anim_cyclic",Number(F.get_behavior(a,b)==F.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),d=F.get_anim_start_frame(a,b),e=F.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Da(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),d=F.get_anim_type(a,c),c=0;c<b.length;c++){d=F.get_anim_type(a,c);switch(d){case F.OBJ_ANIM_TYPE_ARMATURE:d=
"ARMATURE";break;case F.OBJ_ANIM_TYPE_OBJECT:d="OBJECT";break;case F.OBJ_ANIM_TYPE_PARTICLES:d="PARTICLES";break;case F.OBJ_ANIM_TYPE_VERTEX:d="VERTEX";break;case F.OBJ_ANIM_TYPE_MATERIAL:d="MATERIAL";break;case F.OBJ_ANIM_TYPE_STATIC:d="STATIC";break;default:d="NONE"}b.eq(c);d=c+" ("+d+")";$("#anim_slot").children().eq(c).text(d)}$("#anim_slot").selectmenu();$("#anim_slot").selectmenu("refresh")}function cb(){var a=x.get_ssao_params(),b="ssao_quality ssao_hemisphere ssao_blur_depth ssao_blur_discard_value ssao_radius_increase ssao_influence ssao_dist_factor ssao_only ssao_white".split(" ");
if(a){z(b,"enable");for(var c=document.getElementById("ssao_quality"),b=a.ssao_quality,c=c.options,d=0;d<c.length;d++){var e=c[d];e.selected=e.value==b?!0:!1}$("#ssao_quality").selectmenu("refresh");b=Number(a.ssao_hemisphere);document.getElementById("ssao_hemisphere").options[b].selected=!0;$("#ssao_hemisphere").slider("refresh");b=Number(a.ssao_blur_depth);document.getElementById("ssao_blur_depth").options[b].selected=!0;$("#ssao_blur_depth").slider("refresh");u("ssao_blur_discard_value",a.blur_discard_value);
u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else z(b,"disable")}function fa(a){x.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=$a(document.getElementById("ssao_quality")));"ssao_hemisphere"in
...
x.set_ssao_params(b)}function db(){var a=x.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(z(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):z(b,"disable")}function za(a){var b=x.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),x.set_color_correction_params(b))}function $a(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function sb(){var a=x.get_fog_color_density();.2<a[3]?u("fog_density",a[3]):u("fog_density1000",1E3*a[3]);ga("fog_color",a)}function Ha(a){var b=x.get_fog_color_density();"fog_density"in a&&(b[3]=a.fog_density);"fog_density1000"in a&&(b[3]=a.fog_density1000/1E3);"fog_color"in a&&(b[0]=a.fog_color[0],b[1]=a.fog_color[1],b[2]=a.fog_color[2]);
x.set_fog_color_density(b)}function rb(){var a=x.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return z(b,"disable"),document.getElementById("csm_resolution").innerHTML="",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML=
"",null;z(b,"enable");ab(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",a.last_cascade_blur_radius)):z(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):z(["csm_first_cascade_border",
"csm_last_cascade_border","last_cascade_blur_radius"],"disable")}function ra(a){var b={};"csm_first_cascade_border"in a&&(b.csm_first_cascade_border=a.csm_first_cascade_border);"csm_last_cascade_border"in a&&(b.csm_last_cascade_border=a.csm_last_cascade_border);"self_shadow_polygon_offset"in a&&(b.self_shadow_polygon_offset=a.self_shadow_polygon_offset);"self_shadow_normal_offset"in a&&(b.self_shadow_normal_offset=a.self_shadow_normal_offset);"first_cascade_blur_radius"in a&&(b.first_cascade_blur_radius=
a.first_cascade_blur_radius);"last_cascade_blur_radius"in a&&(b.last_cascade_blur_radius=a.last_cascade_blur_radius);x.set_shadow_params(b);ab(x.get_shadow_params())}function ab(a){document.getElementById("csm_resolution").innerHTML="&nbsp;&nbsp;"+a.csm_resolution;if(a.enable_csm){document.getElementById("csm_num").innerHTML=" "+a.csm_num;for(var b=["csm_borders","blur_radii"],c=0;c<b.length;c++){var d=b[c],e=a[d],d=document.getElementById(d);d.innerHTML="(";for(var f=0;f<e.length;f++)0<f&&(d.innerHTML+=
" __ "),d.innerHTML+=Math.round(10*e[f])/10;d.innerHTML+=")"}}else document.getElementById("cascades-info-block").style.display="none",document.getElementById("csm_first_cascade_border-info-block").style.display="none",document.getElementById("csm_last_cascade_border-info-block").style.display="none",document.getElementById("blur_radii-info-block").style.display="none",document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display=
"none"}function qb(){var a=x.get_environment_colors();u("environment_energy",a[0]);ga("horizon_color",a[1]);ga("zenith_color",a[2])}function Fa(a){"environment_energy"in a&&x.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&x.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&x.set_environment_colors(null,null,a.zenith_color)}function Ta(a){var b={};"string"==typeof a.wireframe_mode&&(b.wireframe_mode=$a(document.getElementById("wireframe_mode")));"object"==
typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);Q.set_debug_params(b)}function jb(){Cb.shot()}function xb(){var a=x.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");if(!a)return z(b,"disable"),null;z(b,"enable");ga("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);
u("spot_brightness",a.spot_brightness);u("scatter_strength",a.scatter_strength);u("rayleigh_strength",a.rayleigh_strength);u("mie_strength",a.mie_strength);u("rayleigh_collection_power",a.rayleigh_collection_power);u("mie_collection_power",a.mie_collection_power);u("mie_distribution",a.mie_distribution)}function ba(a){var b={};"sky_color"in a&&(b.color=a.sky_color);"rayleigh_brightness"in a&&(b.rayleigh_brightness=a.rayleigh_brightness);"mie_brightness"in a&&(b.mie_brightness=a.mie_brightness);"spot_brightness"in
a&&(b.spot_brightness=a.spot_brightness);"scatter_strength"in a&&(b.scatter_strength=a.scatter_strength);"rayleigh_strength"in a&&(b.rayleigh_strength=a.rayleigh_strength);"mie_strength"in a&&(b.mie_strength=a.mie_strength);"rayleigh_collection_power"in a&&(b.rayleigh_collection_power=a.rayleigh_collection_power);"mie_collection_power"in a&&(b.mie_collection_power=a.mie_collection_power);"mie_distribution"in a&&(b.mie_distribution=a.mie_distribution);x.set_sky_params(b)}function Ya(a,b){var c=qa.get_material_extended_params(a,
b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return z(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=qa.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);z(d,"enable");ga("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",
c.parallax_scale);u("material_parallax_steps",c.parallax_steps)}function oa(a){var b=T;"material_name"in a&&Ya(b,a.material_name);if("material_diffuse_color"in a){var c=a.material_diffuse_color.slice();c.push(1);qa.set_diffuse_color(b,$("#material_name").val(),c)}c={};"material_reflectivity"in a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in
a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);qa.set_material_extended_params(b,$("#material_name").val(),c);x.update_scene_materials_params()}function G(a){var b=T,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");if(!b)return null;
var d={},e=$("#water_dynamic").val(),f=$("#shore_smoothing").val();Boolean(Number(e))?z(c,"enable"):z(c,"disable");Boolean(Number(f))?z(["absorb_factor"],"enable"):z(["absorb_factor"],"disable");"shore_smoothing"in a&&(d.shore_smoothing=a.shore_smoothing);"absorb_factor"in a&&(d.absorb_factor=a.absorb_factor);"water_fog_color"in a&&(d.water_fog_color=a.water_fog_color);"water_fog_density"in a&&(d.water_fog_density=a.water_fog_density);"shallow_water_col"in a&&(d.shallow_water_col=a.shallow_water_col);
...
a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!qa.set_water_material_params(b,$("#material_name").val(),d))return null;x.update_scene_materials_params();x.set_water_params(d)}function Za(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);ga("light_color",a.light_color);u("pre_light_energy",
b);u("rude_light_energy",c);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(z(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Db))):z(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(z(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",a.light_distance)):
z(["light_distance"],"disable")}}function pa(a){"light_name"in a&&Za(x.get_object_by_name(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*
Eb));"light_spot_blend"in a&&(b.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(b.light_distance=parseFloat(a.light_distance));a=x.get_object_by_name($("#light_name").val());V.set_light_params(a,b);b=V.get_light_params(a).light_energy.toFixed(2);$("#light_energy").text(b)}function wb(){var a=V.get_sun_params(),b=["sun_horizontal_position","sun_vertical_position"];if(!a)return z(b,"disable"),null;u("sun_horizontal_position",a.hor_position);u("sun_vertical_position",a.vert_position)}
function Qa(a){var b={};"sun_horizontal_position"in a&&(b.hor_position=parseFloat(a.sun_horizontal_position),b.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(b.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),b.vert_position=parseFloat(a.sun_vertical_position));V.set_sun_params(b)}function fb(a){a=parseFloat(a.max_sun_angle);V.set_max_sun_angle(a)}function Ga(a){"day_time"in a&&V.set_day_time(a.day_time);
"date"in a&&V.set_date(new Date(a.date))}function gb(){var a=0,b=parseFloat(document.getElementById("day_time").value),c=J.create_elapsed_sensor(),d=V.get_lamps("SUN")[0];J.create_sensor_manifold(d,"ELAPSED",J.CT_CONTINUOUS,[c],function(a){return a[0]},function(c,d,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,c=J.get_sensor_value(c,d,0),b+=c*a/3600,24<b&&(b-=Math.floor(b)),u("day_time",b))})}function Bb(){var a=V.get_lamps("SUN")[0],b=["sn-ui-grid-b"];V.get_lamps().length?a||z("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),
"disable"):z(b,"disable")}function Va(){z("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");z("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function hb(){var a=V.get_lamps("SUN")[0];J.check_sensor_manifolds(a)&&J.remove_sensor_manifold(a,"ELAPSED")}function tb(){var a=x.get_dof_params(),b="dof_distance dof_object dof_front dof_rear dof_power dof_on".split(" ");if(a){u("dof_front",a.dof_front);u("dof_rear",a.dof_rear);u("dof_power",a.dof_power);$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=a.dof_object.name;$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");
$("#dof_object").parent().removeClass("ui-disabled")}else u("dof_distance",a.dof_distance),b.splice(1,1),$("#dof_distance").parent().removeClass("ui-disabled"),$("#dof_object").parent().addClass("ui-disabled");z(b,"enable");a=0<a.dof_distance?1:0;document.getElementById("dof_on").options[a].selected=!0;$("#dof_on").slider("refresh")}else z(b,"disable")}function ua(a){var b={};"dof_distance"in a&&Number($("#dof_on").val())&&(b.dof_distance=a.dof_distance);"dof_front"in a&&(b.dof_front=a.dof_front);
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean($("#dof_on").val()),b.dof_distance=Number(a.dof_on)?parseFloat($("#dof_distance").val()):0);x.set_dof_params(b)}function ub(){var a=x.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(z(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):z(b,
"disable")}function Ia(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);x.set_god_rays_params(b)}function ib(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),la())}function yb(){var a=x.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(z(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",
a.mb_decay_threshold))):z(b,"disable")}function Sa(a){var b={};"mb_factor"in a&&(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);x.set_mb_params(b)}function zb(){var a=x.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(z(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):z(b,"disable")}function Ja(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=
a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);x.set_bloom_params(b)}function Ab(){var a=x.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(z(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):z(b,"disable")}function Ba(a){var b=
{};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);x.set_glow_material_params(b)}function ga(a,b){var c=Ma.rgb_to_css(b),d=Ma.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",
d)}function vb(){var a=x.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):z(b,"disable")}function Ra(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);x.set_wind_params(b)}function u(a,b){$("#"+a).val(b);$("#"+a).slider("refresh");$("#"+a).trigger("change")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=
parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),null}a(e)})}function aa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Ma.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function eb(){Fb.auto_rotate(.3)}function z(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==
b&&d.addClass("ui-disabled")}}var F=n("animation"),I=n("app"),Oa=n("assets"),Wa=n("camera"),Fb=n("camera_anim"),K=n("config");n("constraints");var J=n("controls"),La=n("data"),Q=n("debug"),xa=n("geometry"),lb=n("gyroscope"),V=n("lights"),ma=n("main"),kb=n("mixer"),qa=n("material"),U=n("nla"),Ma=n("rgb"),Cb=n("screenshooter"),x=n("scenes"),H=n("storage"),nb=n("transform"),va=n("util"),Pa=n("version"),pb=n("vec3"),bb="DEBUG"===Pa.type(),Eb=Math.PI/180,Db=180/Math.PI,mb=new Float32Array(3),ob=new Float32Array(3),
wa=!1,Ka,X=null,E=null,ca=null,ya="",sa=null,Aa=null,N=null,T=null,Ua=function(){},na=null,Xa=null;k.init=function(){H.init("b4w_viewer");var a=H.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("anaglyph_use","true"===H.get("anaglyph_use"));K.set("gyro_use","true"===H.get("gyro_use"));""==H.get("outlining_overview_mode")?K.set("outlining_overview_mode",!0):K.set("outlining_overview_mode",
"true"===H.get("outlining_overview_mode"));I.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===H.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:B(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!bb,assets_min50_available:!bb,console_verbose:!0,physics_enabled:!0,wireframe_debug:!0})}});b4w.require("viewer_main").init();
