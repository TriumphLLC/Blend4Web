...
{setup:function(){if(h)return!1;a(b.start)},teardown:function(){if(h)return!1;a(b.stop)}});b=function(){function b(){var f=d(),c=n(q);f!==q?(F(q=f,c),a(g).trigger("hashchange")):c!==q&&(location.href=location.href.replace(/#.*/,"")+c);e=setTimeout(b,a.fn.hashchange.delay)}var f={},e,q=d(),k=function(a){return a},F=k,n=k;f.start=function(){e||b()};f.stop=function(){e&&clearTimeout(e);e=c};g.attachEvent&&!g.addEventListener&&!h&&function(){var c,e;f.start=function(){c||(e=(e=a.fn.hashchange.src)&&e+
d(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){e||F(d());b()}).attr("src",e||"javascript:0").insertAfter("body")[0].contentWindow,t.onpropertychange=function(){try{"title"===event.propertyName&&(c.document.title=t.title)}catch(a){}})};f.stop=k;n=function(){return d(c.location.href)};F=function(b,f){var e=c.document,d=a.fn.hashchange.domain;b!==f&&(e.title=t.title,e.open(),d&&e.write('<script>document.domain="'+d+'"\x3c/script>'),e.close(),c.location.hash=b)}}();return f}()})(k,
...
q);setTimeout(a.proxy(b,this),0);return a(this)};a.fn.animationComplete.defaultDuration=1E3})(k);(function(a,g,c,d){function b(a){for(;a&&"undefined"!==typeof a.originalEvent;)a=a.originalEvent;return a}function f(b){for(var f={},e,c;b;){e=a.data(b,"virtualMouseBindings");for(c in e)e[c]&&(f[c]=f.hasVirtualBinding=!0);b=b.parentNode}return f}function e(){D&&(clearTimeout(D),D=0);D=setTimeout(function(){O=D=0;da.length=0;ja=!1;X=!0},a.vmouse.resetTimerDuration)}function h(f,e,c){var h,m;if(!(m=c&&
c[f])){if(c=!c)a:{for(c=e.target;c;){if((m=a.data(c,"virtualMouseBindings"))&&(!f||m[f]))break a;c=c.parentNode}c=null}m=c}if(m){h=e;c=h.type;var l,p;h=a.Event(h);h.type=f;f=h.originalEvent;m=a.event.props;-1<c.search(/^(mouse|click)/)&&(m=C);if(f)for(p=m.length,l;p;)l=m[--p],h[l]=f[l];-1<c.search(/mouse(down|up)|click/)&&!h.which&&(h.which=1);if(-1!==c.search(/^touch/)&&(l=b(f),c=l.touches,l=l.changedTouches,f=c&&c.length?c[0]:l&&l.length?l[0]:d))for(c=0,m=t.length;c<m;c++)l=t[c],h[l]=f[l];a(e.target).trigger(h)}return h}
function l(b){var f=a.data(b.target,"virtualTouchID");ja||O&&O===f||!(f=h("v"+b.type,b))||(f.isDefaultPrevented()&&b.preventDefault(),f.isPropagationStopped()&&b.stopPropagation(),f.isImmediatePropagationStopped()&&b.stopImmediatePropagation())}function m(c){var e=b(c).touches,d;e&&1===e.length&&(d=c.target,e=f(d),e.hasVirtualBinding&&(O=ka++,a.data(d,"virtualTouchID",O),D&&(clearTimeout(D),D=0),M=X=!1,d=b(c).touches[0],T=d.pageX,Q=d.pageY,h("vmouseover",c,e),h("vmousedown",c,e)))}function p(a){X||
(M||h("vmousecancel",a,f(a.target)),M=!0,e())}function q(c){if(!X){var d=b(c).touches[0],m=M,l=a.vmouse.moveDistanceThreshold,p=f(c.target);(M=M||Math.abs(d.pageX-T)>l||Math.abs(d.pageY-Q)>l)&&!m&&h("vmousecancel",c,p);h("vmousemove",c,p);e()}}function k(a){if(!X){X=!0;var c=f(a.target),d;h("vmouseup",a,c);M||(d=h("vclick",a,c))&&d.isDefaultPrevented()&&(d=b(a).changedTouches[0],da.push({touchID:O,x:d.clientX,y:d.clientY}),ja=!0);h("vmouseout",a,c);M=!1;e()}}function F(b){b=a.data(b,"virtualMouseBindings");
var f;if(b)for(f in b)if(b[f])return!0;return!1}function n(){}function v(b){var f=b.substr(1);return{setup:function(){F(this)||a.data(this,"virtualMouseBindings",{});a.data(this,"virtualMouseBindings")[b]=!0;y[b]=(y[b]||0)+1;1===y[b]&&Z.bind(f,l);a(this).bind(f,n);W&&(y.touchstart=(y.touchstart||0)+1,1===y.touchstart&&Z.bind("touchstart",m).bind("touchend",k).bind("touchmove",q).bind("scroll",p))},teardown:function(){--y[b];y[b]||Z.unbind(f,l);W&&(--y.touchstart,y.touchstart||Z.unbind("touchstart",
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,n);F(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var t="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),y={},D=0,T=0,Q=0,M=!1,da=[],ja=!1,X=!1,W="addEventListener"in c,Z=a(c),ka=1,O=0,aa,ea;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(ea=0;ea<g.length;ea++)a.event.special[g[ea]]=v(g[ea]);W&&c.addEventListener("click",function(b){var f=da.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,aa=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=da[m],h===c&&Math.abs(l.x-e)<aa&&Math.abs(l.y-d)<aa||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
"body"!==t.activeElement.nodeName.toLowerCase()?a(t.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(C){}v=!1;x&&p&&(p.url&&-1<p.url.indexOf(a.mobile.dialogHashKey)&&this.activePage&&!this.activePage.hasClass("ui-dialog")&&0<a.mobile.navigate.history.activeIndex&&(e.changeHash=!1,v=!0),l=p.url||"",l=!v&&-1<l.indexOf("#")?l+a.mobile.dialogHashKey:l+("#"+a.mobile.dialogHashKey));(A=p?b.jqmData("title")||b.children(":jqmData(role='header')").find(".ui-title").text():
n)&&n===t.title&&(n=A);b.jqmData("title")||b.jqmData("title",n);e.transition=e.transition||(k&&!q?p.transition:g)||(x?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);!k&&v&&(a.mobile.navigate.history.getActive().pageUrl=m);l&&!e.fromHashChange&&(!a.mobile.path.isPath(l)&&0>l.indexOf("#")&&(l="#"+l),m={transition:e.transition,title:n,pageUrl:m,role:e.role},!1!==e.changeHash&&a.mobile.hashListeningEnabled?a.mobile.navigate(this.window[0].encodeURI(l),m,!0):b[0]!==a.mobile.firstPage[0]&&
...
_afterListviewRefresh:a.noop,refresh:function(d){var b,f,e,h,l,g,k,q,n,t,x,v=this.options;f=this.element;var A=!!a.nodeName(f[0],"ol");e=f.attr("start");var C={},y=f.find(".ui-li-count"),D=c(f[0],"counttheme")||this.options.countTheme,D=D?"ui-body-"+D:"ui-body-inherit";v.theme&&f.addClass("ui-group-theme-"+v.theme);A&&(e||0===e)&&(e=parseInt(e,10)-1,f.css("counter-reset","listnumbering "+e));this._beforeListviewRefresh();x=this._getChildrenByTagName(f[0],"li","LI");f=0;for(e=x.length;f<e;f++){h=x.eq(f);
l="";if(d||0>h[0].className.search(/\bui-li-static\b|\bui-li-divider\b/))q=this._getChildrenByTagName(h[0],"a","A"),b="list-divider"===c(h[0],"role"),n=h.attr("value"),g=c(h[0],"theme"),q.length&&0>q[0].className.search(/\bui-btn\b/)&&!b?(b=c(h[0],"icon"),k=!1===b?!1:b||v.icon,q.removeClass("ui-link"),b="ui-btn",g&&(b+=" ui-btn-"+g),1<q.length?(l="ui-li-has-alt",g=q.last(),k=(k=c(g[0],"theme")||v.splitTheme||c(h[0],"theme",!0))?" ui-btn-"+k:"",t=c(g[0],"icon")||c(h[0],"icon")||v.splitIcon,k="ui-btn ui-btn-icon-notext ui-icon-"+
t+k,g.attr("title",a.trim(g.getEncodedText())).addClass(k).empty(),q=q.first()):k&&(b+=" ui-btn-icon-right ui-icon-"+k),q.addClass(b)):b?(l=c(h[0],"theme")||v.dividerTheme||v.theme,l="ui-li-divider ui-bar-"+(l?l:"inherit"),h.attr("role","heading")):0>=q.length&&(l="ui-li-static ui-body-"+(g?g:"inherit")),A&&n&&(n=parseInt(n,10)-1,h.css("counter-reset","listnumbering "+n));C[l]||(C[l]=[]);C[l].push(h[0])}for(l in C)a(C[l]).addClass(l);y.each(function(){a(this).closest("li").addClass("ui-li-has-count")});
D&&y.not("[class*='ui-body-']").addClass(D);this._addThumbClasses(x);this._addThumbClasses(x.find(".ui-btn"));this._afterListviewRefresh();this._addFirstLastClasses(x,this._getVisibles(x,d),d)}},a.mobile.behaviors.addFirstLastClasses))})(k);(function(a,g){a.widget("mobile.listview",a.mobile.listview,{options:{autodividers:!1,autodividersSelector:function(c){c=a.trim(c.text())||null;return c?c=c.slice(0,1).toUpperCase():null}},_beforeListviewRefresh:function(){this.options.autodividers&&(this._replaceDividers(),
...
ha=q.attr("id")||k+"-label",F=d?0:parseFloat(c.attr("min")),x=d?c.find("option").length-1:parseFloat(c.attr("max")),v=n.parseFloat(c.attr("step")||1),A=t.createElement("a"),C=a(A),k=t.createElement("div"),y=a(k),D=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(y)}():!1;q.attr("id",ha);this.isToggleSwitch=d;A.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");A.className="ui-slider-handle";k.appendChild(A);C.attr({role:"slider","aria-valuemin":F,"aria-valuemax":x,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":ha});a.extend(this,{slider:y,handle:C,control:c,type:h,step:v,max:x,min:F,valuebg:D,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
C.focus()});b=t.createElement("div");b.className="ui-slider-inneroffset";f=0;for(e=k.childNodes.length;f<e;f++)b.appendChild(k.childNodes[f]);k.appendChild(b);C.addClass("ui-slider-handle-snapping");k=c.find("option");b=0;for(f=k.length;b<f;b++)e=b?"a":"b",h=b?" "+a.mobile.activeBtnClass:"",m=t.createElement("span"),m.className=["ui-slider-label ui-slider-label-",e,h].join(""),m.setAttribute("role","img"),m.appendChild(t.createTextNode(k[b].innerHTML)),a(m).prependTo(y);this._labels=a(".ui-slider-label",
y)}c.addClass(d?"ui-slider-switch":"ui-slider-input");this._on(c,{change:"_controlChange",keyup:"_controlKeyup",blur:"_controlBlur",vmouseup:"_controlVMouseUp"});y.bind("vmousedown",a.proxy(this._sliderVMouseDown,this)).bind("vclick",!1);this._on(t,{vmousemove:"_preventDocumentDrag"});this._on(y.add(t),{vmouseup:"_sliderVMouseUp"});y.insertAfter(c);d||l||(b=this.options.mini?"<div class='ui-slider ui-mini'>":"<div class='ui-slider'>",c.add(y).wrapAll(b));this._on(this.handle,{vmousedown:"_handleVMouseDown",
...
h?parseFloat(e.attr("min")):0;x=h?parseFloat(e.attr("max")):n.length-1;v=h&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1;if("object"===typeof c){k=c;l=this.slider.offset().left;g=this.slider.width();q=g/((x-F)/v);if(!this.dragging||k.pageX<l-8||k.pageX>l+g+8)return;l=1<q?(k.pageX-l)/g*100:Math.round((k.pageX-l)/g*100)}else null==c&&(c=h?parseFloat(e.val()||0):e[0].selectedIndex),l=(parseFloat(c)-F)/(x-F)*100;if(!isNaN(l)&&(k=l/100*(x-F)+F,A=(k-F)%v,k-=A,2*Math.abs(A)>=v&&(k+=0<A?v:-v),
A=100/((x-F)/v),k=parseFloat(k.toFixed(5)),"undefined"===typeof q&&(q=g/((x-F)/v)),1<q&&h&&(l=1/v*A*(k-F)),0>l&&(l=0),100<l&&(l=100),k<F&&(k=F),k>x&&(k=x),this.handle.css("left",l+"%"),this.handle[0].setAttribute("aria-valuenow",h?k:n.eq(k).attr("value")),this.handle[0].setAttribute("aria-valuetext",h?k:n.eq(k).getEncodedText()),this.handle[0].setAttribute("title",h?k:n.eq(k).getEncodedText()),this.valuebg&&this.valuebg.css("width",l+"%"),this._labels&&(g=this.handle.width()/this.slider.width()*100,
C=l&&g+(100-g)*l/100,y=100===l?0:Math.min(g+100-C,100),this._labels.each(function(){var b=a(this).hasClass("ui-slider-label-a");a(this).width((b?C:y)+"%")})),!b)){b=!1;h?(b=parseFloat(e.val())!==k,e.val(k)):(b=e[0].selectedIndex!==k,e[0].selectedIndex=k);if(!1===this._trigger("beforechange",c))return!1;!d&&b&&e.trigger("change")}},_setHighlight:function(a){(a=!!a)?(this.options.highlight=!!a,this.refresh()):this.valuebg&&(this.valuebg.remove(),this.valuebg=!1)},_setTheme:function(a){this.handle.removeClass("ui-btn-"+
...
this.listbox.one({popupafteropen:a.proxy(this,"_focusMenuItem")})},_buildList:function(){var c=this.options,b=this.placeholder,f=!0,e,h,l;e="data-"+a.mobile.ns;var g=e+"option-index",k=e+"icon",q=e+"role",n=e+"placeholder",F=t.createDocumentFragment(),x=!1,v,A,C,y,D,T,Q,M;this.list.empty().filter(".ui-listview").listview("destroy");e=this._selectOptions();h=e.length;l=this.select[0];for(A=0;A<h;A++,x=!1)C=e[A],y=a(C),y.hasClass("ui-screen-hidden")||(D=C.parentNode,M=[],T=y.text(),Q=t.createElement("a"),
Q.setAttribute("href","#"),Q.appendChild(t.createTextNode(T)),D!==l&&"optgroup"===D.nodeName.toLowerCase()&&(D=D.getAttribute("label"),D!==v&&(v=t.createElement("li"),v.setAttribute(q,"list-divider"),v.setAttribute("role","option"),v.setAttribute("tabindex","-1"),v.appendChild(t.createTextNode(D)),F.appendChild(v),v=D)),!f||C.getAttribute("value")&&0!==T.length&&!y.jqmData("placeholder")||(f=!1,x=!0,null===C.getAttribute(n)&&(this._removePlaceholderAttr=!0),C.setAttribute(n,!0),c.hidePlaceholderMenuItems&&
M.push("ui-screen-hidden"),b!==T&&(b=this.placeholder=T)),y=t.createElement("li"),C.disabled&&(M.push("ui-state-disabled"),y.setAttribute("aria-disabled",!0)),y.setAttribute(g,A),y.setAttribute(k,"false"),x&&y.setAttribute(n,!0),y.className=M.join(" "),y.setAttribute("role","option"),Q.setAttribute("tabindex","-1"),this.isMultiple&&a(Q).addClass("ui-btn ui-checkbox-off ui-btn-icon-right"),y.appendChild(Q),F.appendChild(y));this.list[0].appendChild(F);this.isMultiple||b.length?this.headerTitle.text(this.placeholder):
...
this.listbox.remove(),this.menuPage.remove());this._super()}})})(k);(function(a,g){function c(a){return"-"+a.toLowerCase()}var d={"ui-shadow":"shadow","ui-corner-all":"corners","ui-btn-inline":"inline","ui-shadow-icon":"iconshadow","ui-mini":"mini"},b=function(){var b=a.mobile.getAttribute.apply(this,arguments);return null==b?g:b},f=/[A-Z]/g;a.fn.buttonMarkup=function(e,h){var l,k,p,q,n,t=a.fn.buttonMarkup.defaults;for(l=0;l<this.length;l++){p=this[l];var x;if(h)x={alreadyEnhanced:!1,unknownClasses:[]};
else{x=p.className;var v=k=q=void 0,A=!1,C=!0,y={icon:"",inline:!1,shadow:!1,corners:!1,iconshadow:!1,mini:!1},D=[];x=x.split(" ");for(q=0;q<x.length;q++)v=!0,k=d[x[q]],k!==g?(v=!1,y[k]=!0):0===x[q].indexOf("ui-btn-icon-")?(C=v=!1,y.iconpos=x[q].substring(12)):0===x[q].indexOf("ui-icon-")?(v=!1,y.icon=x[q].substring(8)):0===x[q].indexOf("ui-btn-")&&8===x[q].length?(v=!1,y.theme=x[q].substring(7)):"ui-btn"===x[q]&&(v=!1,A=!0),v&&D.push(x[q]);C&&(y.icon="");x={options:y,unknownClasses:D,alreadyEnhanced:A}}k=
x;q=a.extend({},k.alreadyEnhanced?k.options:{},e);if(!k.alreadyEnhanced)for(n in t)q[n]===g&&(q[n]=b(p,n.replace(f,c)));x=p;q=a.extend({},t,q);k=(k=k.unknownClasses)?k:[];k.push("ui-btn");q.theme&&k.push("ui-btn-"+q.theme);q.icon&&(k=k.concat(["ui-icon-"+q.icon,"ui-btn-icon-"+q.iconpos]),q.iconshadow&&k.push("ui-shadow-icon"));q.inline&&k.push("ui-btn-inline");q.shadow&&k.push("ui-shadow");q.corners&&k.push("ui-corner-all");q.mini&&k.push("ui-mini");x.className=k.join(" ");"button"!==p.tagName.toLowerCase()&&
...
{transition:"none",reverse:!0,changeHash:!1,fromHashChange:!0}))}}),a(function(){a.support.inlineSVG();a.mobile.hideUrlBar&&g.scrollTo(0,1);a.mobile.defaultHomeScroll=a.support.scrollTop&&1!==a.mobile.window.scrollTop()?1:0;a.mobile.autoInitializePage&&a.mobile.initializePage();a.mobile.hideUrlBar&&f.load(a.mobile.silentScroll);a.support.cssPointerEvents||a.mobile.document.delegate(".ui-state-disabled,.ui-disabled","vclick",function(a){a.preventDefault();a.stopImmediatePropagation()})}))})(k,this)});(function(k){var n=function(){var n=65,W={eventName:"click",onShow:function(){},onBeforeShow:function(){},onHide:function(){},onChange:function(){},onSubmit:function(){},color:"ff0000",livePreview:!0,flat:!1},a=function(a,b){var c=aa(a);c.r=Math.round(1E3*Math.pow(c.r/255,2.2))/1E3;c.g=Math.round(1E3*Math.pow(c.g/255,2.2))/1E3;c.b=Math.round(1E3*Math.pow(c.b/255,2.2))/1E3;k(b).data("colorpicker").fields.eq(1).val(c.r).end().eq(2).val(c.g).end().eq(3).val(c.b).end()},g=function(a,b){k(b).data("colorpicker").fields.eq(4).val(a.h).end().eq(5).val(a.s).end().eq(6).val(a.b).end()},
c=function(a,b){k(b).data("colorpicker").fields.eq(0).val(ia(a)).end()},d=function(a,b){k(b).data("colorpicker").selector.css("backgroundColor","#"+ia({h:a.h,s:100,b:100}));k(b).data("colorpicker").selectorIndic.css({left:parseInt(150*a.s/100,10),top:parseInt(150*(100-a.b)/100,10)})},b=function(a,b){k(b).data("colorpicker").hue.css("top",parseInt(150-150*a.h/360,10))},f=function(a,b){k(b).data("colorpicker").currentColor.css("backgroundColor","#"+ia(a))},e=function(a,b){k(b).data("colorpicker").newColor.css("backgroundColor",
"#"+ia(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,n=6-m.length;if(0<n){for(var p=[],q=0;q<n;q++)p.push("0");p.push(m);m=p.join("")}m=O(ka(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=Z({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
10),s:parseInt(h.data("colorpicker").fields.eq(5).val(),10),b:parseInt(h.data("colorpicker").fields.eq(6).val(),10)}):(l=h.data("colorpicker"),m=parseInt(h.data("colorpicker").fields.eq(1).val(),10),n=parseInt(h.data("colorpicker").fields.eq(2).val(),10),p=parseInt(h.data("colorpicker").fields.eq(3).val(),10),m={r:Math.min(255,Math.max(0,m)),g:Math.min(255,Math.max(0,n)),b:Math.min(255,Math.max(0,p))},l.color=l=O(m));f&&(a(l,h.get(0)),c(l,h.get(0)),g(l,h.get(0)));d(l,h.get(0));b(l,h.get(0));e(l,h.get(0));
h.data("colorpicker").onChange.apply(h,[l,ia(l),aa(l)])},m=function(a){k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},p=function(){n=0<this.parentNode.className.indexOf("_hex")?70:65;k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");k(this).parent().addClass("colorpicker_focus")},q=function(a){var b=k(this).parent().find("input").focus();a={el:k(this).parent().addClass("colorpicker_slider"),max:0<this.parentNode.className.indexOf("_hsb_h")?
360:0<this.parentNode.className.indexOf("_hsb")?100:255,y:a.pageY,field:b,val:parseInt(b.val(),10),preview:k(this).parent().parent().data("colorpicker").livePreview};k(document).bind("mouseup",a,F);k(document).bind("mousemove",a,ha)},ha=function(a){a.data.field.val(Math.max(0,Math.min(a.data.max,parseInt(a.data.val+a.pageY-a.data.y,10))));a.data.preview&&l.apply(a.data.field.get(0),[!0]);return!1},F=function(a){l.apply(a.data.field.get(0),[!0]);a.data.el.removeClass("colorpicker_slider").find("input").focus();
k(document).unbind("mouseup",F);k(document).unbind("mousemove",ha);return!1},x=function(a){a.preventDefault();a={cal:k(this).parent(),y:k(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,A);k(document).bind("mousemove touchmove",a,v)},v=function(a){var b=a;"undefined"!==typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,b.pageY-a.data.y)))/150,10)).get(0),
[a.data.preview]);return!1},A=function(b){a(b.data.cal.data("colorpicker").color,b.data.cal.get(0));c(b.data.cal.data("colorpicker").color,b.data.cal.get(0));k(document).unbind("mouseup touchend",A);k(document).unbind("mousemove touchmove",v);return!1},C=function(a){a.preventDefault();a={cal:k(this).parent(),pos:k(this).offset()};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,D);k(document).bind("mousemove touchmove",a,y)},y=function(a){var b=a;"undefined"!==
...
y);return!1},T=function(a){k(this).addClass("colorpicker_focus")},Q=function(a){k(this).removeClass("colorpicker_focus")},M=function(a){a=k(this).parent();var b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;f(b,a.get(0));a.data("colorpicker").onSubmit(b,ia(b),aa(b),a.data("colorpicker").el)},da=function(a){var b=k("body"),c=b.data("colorpickerId"),d=k(this).data("colorpickerId");c&&c===d?(k(document).trigger("mousedown"),b.data("colorpickerId",null)):(ja.call(this,a),b.data("colorpickerId",
...
(f?document.documentElement.clientHeight:document.body.clientHeight))&&(g-=this.offsetHeight+176);e+356>a+c&&(e=Math.max(0,e-356));d.css({left:e+"px",top:g+"px"});0!=d.data("colorpicker").onShow.apply(this,[d.get(0)])&&d.show();k(document).bind("mousedown",{cal:d},X);return!1},X=function(a){Ja(a.data.cal.get(0),a.target,a.data.cal.get(0))||(0!=a.data.cal.data("colorpicker").onHide.apply(this,[a.data.cal.get(0)])&&a.data.cal.hide(),k(document).unbind("mousedown",X))},Ja=function(a,b,c){if(a==b)return!0;
if(a.contains)return a.contains(b);if(a.compareDocumentPosition)return!!(a.compareDocumentPosition(b)&16);for(b=b.parentNode;b&&b!=c;){if(b==a)return!0;b=b.parentNode}return!1},Z=function(a){return{h:Math.round(Math.min(360,Math.max(0,a.h))),s:Math.round(Math.min(100,Math.max(0,a.s))),b:Math.round(Math.min(100,Math.max(0,a.b)))}},ka=function(a){a=parseInt(-1<a.indexOf("#")?a.substring(1):a,16);return{r:a>>16,g:(a&65280)>>8,b:a&255}},O=function(a){var b={h:0,s:0,b:0},c=Math.min(a.r,a.g,a.b),d=Math.max(a.r,
a.g,a.b),c=d-c;b.b=d;b.s=0!=d?255*c/d:0;b.h=0!=b.s?a.r==d?(a.g-a.b)/c:a.g==d?2+(a.b-a.r)/c:4+(a.r-a.g)/c:-1;b.h*=60;0>b.h&&(b.h+=360);b.s*=100/255;b.b*=100/255;b.h=Math.round(b.h);b.s=Math.round(b.s);b.b=Math.round(b.b);return b},aa=function(a){var b,c,d;b=Math.round(a.h);var e=Math.round(255*a.s/100);a=Math.round(255*a.b/100);if(0==e)b=c=d=a;else{var e=(255-e)*a/255,f=b%60*(a-e)/60;360==b&&(b=0);60>b?(b=a,d=e,c=e+f):120>b?(c=a,d=e,b=a-f):180>b?(c=a,b=e,d=e+f):240>b?(d=a,b=e,c=a-f):300>b?(d=a,c=e,
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},ea=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ia=function(a){return ea(aa(a))},Ha=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},W,n||{});
if("string"==typeof n.color)n.color=O(ka(n.color));else if(void 0!=n.color.r&&void 0!=n.color.g&&void 0!=n.color.b)n.color=O(n.color);else if(void 0!=n.color.h&&void 0!=n.color.s&&void 0!=n.color.b)n.color=Z(n.color);else return this;return this.each(function(){if(!k(this).data("colorpickerId")){var t=k.extend({},n);t.origColor=n.color;var v="collorpicker_"+parseInt(1E3*Math.random());k(this).data("colorpickerId",v);v=k('<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>').attr("id",
v);t.flat?v.appendTo(this).show():v.appendTo(document.body);t.fields=v.find("input").bind("keyup",h).bind("change",l).bind("blur",m).bind("focus",p);v.find("span").bind("mousedown touchstart",q).end().find(">div.colorpicker_current_color").bind("click",Ha);t.selector=v.find("div.colorpicker_color").bind("touchstart mousedown",C);t.selectorIndic=t.selector.find("div div");t.el=this;t.hue=v.find("div.colorpicker_hue div");v.find("div.colorpicker_hue").bind("mousedown touchstart",x);t.newColor=v.find("div.colorpicker_new_color");
t.currentColor=v.find("div.colorpicker_current_color");v.data("colorpicker",t);v.find("div.colorpicker_submit").bind("mouseenter touchstart",T).bind("mouseleave touchend",Q).bind("click",M);a(t.color,v.get(0));g(t.color,v.get(0));c(t.color,v.get(0));b(t.color,v.get(0));d(t.color,v.get(0));f(t.color,v.get(0));e(t.color,v.get(0));t.flat?v.css({position:"relative",display:"block"}):k(this).bind(t.eventName,da)}})},showPicker:function(){return this.each(function(){k(this).data("colorpickerId")&&ja.apply(this)})},
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=O(ka(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=O(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=Z(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};window.addEventListener("resize",Ia,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);wa.detect_mobile()||Ua(["gyro_use_tmp"],"disable");La.check()||Ua(["hmd_conf_tmp"],"disable");var g=
I.get_url_params();Va.enqueue([["manifest",Va.AT_JSON,"assets.json"]],function(a,b,c,Ka){Y=a;Ca=document.getElementById("info_left_down");P=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Wa.date_str();r(y,"quality","string");switch(N.get("quality")){case N.P_ULTRA:var k=0;break;case N.P_HIGH:k=1;break;case N.P_LOW:k=2;break;case N.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");I.set_onclick("reset",
D);I.set_onclick("auto_rotate_cam",sb);I.set_onclick("pause",Q);I.set_onclick("resume",M);I.set_onclick("auto_view",mb);I.set_onclick("home",T);a=document.getElementById("manifest");if(Y){c="";b=(b=I.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home - "+b[b.length-1];c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<Y.length;b++){k=Y[b];Ka=k.name;
for(var k=k.items,R="",R=R+"<div data-role='collapsible' data-mini='true' >",R=R+("<h6>"+Ka+"</h6>"),R=R+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,R=R+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+Ka)+'">'+m+"</a></li>");R+="</ul>";R+="</div>";c+=R}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";
f();r(pa,"anim_active_object","string");r(pa,"animation","string");r(pa,"anim_mix_factor","number");r(pa,"anim_slot","number");r(pa,"anim_cyclic","bool");r(pa,"anim_frame_current","number");I.set_onclick("anim_play",nb);I.set_onclick("anim_stop",ob);I.set_onclick("anim_play_all",pb);I.set_onclick("anim_stop_all",qb);r(tb,"nla_frame_current","number");I.set_onclick("nla_play",rb);I.set_onclick("nla_stop",ub);r(Da,"shape_key_obj","string");r(Da,"shape_key_name","string");r(Da,"shape_key_value","number");
r(qa,"material_name","string");fa(qa,"material_diffuse_color");r(qa,"material_reflectivity","number");r(qa,"material_fresnel","number");r(qa,"material_fresnel_factor","number");r(qa,"material_parallax_scale","number");r(qa,"material_parallax_steps","number");r(H,"material_name","string");r(H,"shore_smoothing","bool");r(H,"absorb_factor","number");r(H,"sss_strength","number");r(H,"sss_width","number");fa(H,"water_fog_color");r(H,"water_fog_density","number");fa(H,"shallow_water_col");r(H,"shallow_water_col_fac",
"number");fa(H,"shore_water_col");r(H,"shore_water_col_fac","number");r(H,"foam_factor","number");r(H,"norm_uv_velocity","number");r(H,"water_dynamic","bool");r(H,"waves_height","number");r(H,"waves_length","number");r(H,"dst_noise_scale0","number");r(H,"dst_noise_scale1","number");r(H,"dst_noise_freq0","number");r(H,"dst_noise_freq1","number");r(H,"dir_min_shore_fac","number");r(H,"dir_freq","number");r(H,"dir_noise_scale","number");r(H,"dir_noise_freq","number");r(H,"dir_min_noise_fac","number");
r(H,"dst_min_fac","number");r(H,"waves_hor_fac","number");r(Ma,"environment_energy","string");fa(Ma,"horizon_color");fa(Ma,"zenith_color");r(ra,"light_name","string");fa(ra,"light_color");r(ra,"pre_light_energy","number");r(ra,"rude_light_energy","number");r(ra,"light_spot_size","number");r(ra,"light_spot_blend","number");r(ra,"light_distance","number");fa(ba,"sky_color");r(ba,"rayleigh_brightness","number");r(ba,"mie_brightness","number");r(ba,"spot_brightness","number");r(ba,"scatter_strength",
"number");r(ba,"rayleigh_strength","number");r(ba,"mie_strength","number");r(ba,"rayleigh_collection_power","number");r(ba,"mie_collection_power","number");r(ba,"mie_distribution","number");r(Na,"date","string");r(Na,"day_time","number");r(Xa,"sun_horizontal_position","number");r(Xa,"sun_vertical_position","number");r(vb,"max_sun_angle","number");I.set_onclick("run_sun",wb);I.set_onclick("stop_sun",xb);r(ta,"csm_first_cascade_border","number");r(ta,"csm_last_cascade_border","number");r(ta,"self_shadow_polygon_offset",
"number");r(ta,"self_shadow_normal_offset","number");r(ta,"first_cascade_blur_radius","number");r(ta,"last_cascade_blur_radius","number");r(ga,"ssao_quality","string");r(ga,"ssao_hemisphere","bool");r(ga,"ssao_blur_depth","bool");r(ga,"ssao_blur_discard_value","number");r(ga,"ssao_radius_increase","number");r(ga,"ssao_influence","number");r(ga,"ssao_dist_factor","number");r(ga,"ssao_only","bool");r(ga,"ssao_white","bool");r(la,"dof_distance","number");r(la,"dof_front_start","number");r(la,"dof_front_end",
"number");r(la,"dof_rear_start","number");r(la,"dof_rear_end","number");r(la,"dof_power","number");r(la,"dof_bokeh_intensity","number");r(la,"dof_on","bool");r(Oa,"god_rays_intensity","number");r(Oa,"god_rays_max_ray_length","number");r(Oa,"god_rays_steps","number");r(Ea,"brightness","number");r(Ea,"contrast","number");r(Ea,"exposure","number");r(Ea,"saturation","number");r(Ja,"sfx_mix_mode","bool");a=Number("true"===E.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=
!0;$("#sfx_mix_mode").slider("refresh");r(O,"stereo","string");a=E.get("stereo")||"NONE";L.can_use_device(L.DEVICE_HMD)||(document.getElementById("stereo").options[2].setAttribute("disabled","disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(E.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);I.set_onclick("hmd_settings",aa);r(ea,"gyro_use","bool");a=Number("true"===E.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=
!0;$("#gyro_use").slider("refresh");r(ia,"gmpd_settings","bool");r(Ya,"wind_dir","number");r(Ya,"wind_strength","number");r(Za,"mb_factor","number");r(Za,"mb_decay_threshold","number");r(Pa,"bloom_key","number");r(Pa,"bloom_blur","number");r(Pa,"bloom_edge_lum","number");r(Fa,"small_glow_mask_coeff","number");r(Fa,"large_glow_mask_coeff","number");r(Fa,"small_glow_mask_width","number");r(Fa,"large_glow_mask_width","number");r(yb,"canvas_rf","number");r($a,"debug_view_mode","string");I.set_onclick("debug_change_colors",
zb);r(Ab,"render_time_threshold","number");fa($a,"wireframe_edge_color","object");r(ja,"show_hud_debug_info","bool");r(X,"enable_gl_debug","bool");r(Ha,"outlining_overview_mode","bool");a=""==E.get("outlining_overview_mode")?1:Number("true"===E.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");I.set_onclick("make_screenshot",Bb);a=Number("true"===E.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=
!0;$("#show_hud_debug_info").slider("refresh");a=""==E.get("enable_gl_debug")?0:Number("true"===E.get("enable_gl_debug"));document.getElementById("enable_gl_debug").options[a].selected=!0;$("#enable_gl_debug").slider("refresh");r(Z,"min_capabilities","bool");a=Number(ka());document.getElementById("min_capabilities").options[a].selected=!0;$("#min_capabilities").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",
function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a,b){if(Ca&&z.can_select_objects()){$("#material_warning")[0].style.display="none";var d=U;d&&z.outlining_is_enabled(d)&&z.clear_outline_anim(d);d=z.pick_object(a,b);d&&Cb.is_empty(d)||((U=d)?ab(d):bb(),c(),ma||(d?(ma=d,c(),I.enable_object_controls(d),
K.create_kb_sensor_manifold(d,"QUIT",K.CT_SHOT,K.KEY_Q,function(a,b,d,e){ma=null;c();I.disable_object_controls(a)})):g()))}}function g(){var a=z.get_active_camera();ma=a;c();I.enable_camera_controls(!1,!1,!1,xa.get_container(),!0);K.create_kb_sensor_manifold(a,"QUIT",K.CT_SHOT,K.KEY_Q,function(a,b,d,e){ma=null;c();I.disable_camera_controls(a);K.remove_sensor_manifold(a,"ZOOM_TO")});var b=K.create_keyboard_sensor(K.KEY_Z),d=K.create_keyboard_sensor(K.KEY_DEC_POINT);K.create_sensor_manifold(a,"ZOOM_TO",
K.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&cb.target_zoom_object(a,b)})}function c(){if(Ca){var a=ma?na(ma):"NONE",b=U?na(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=U)&&(b=z.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=ma;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+db);Ca.innerHTML=a}}function d(){var a=E.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];if(ya.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}
function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){za=!1;clearTimeout(Qa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];
za=!1;clearTimeout(Qa);h({category:a,item:b},!0,!1,!1)}}function h(a,b,c,d){if(P)for(var e=0;e<P.children.length;e++)P.children[e].style.visibility="hidden";if((e=I.get_url_params())&&e.load){var f=e.load.split("/");ua={load_file:e.load,name:f[f.length-1].split(".")[0]}}else ua={load_file:N.get_std_assets_path()+"misc/logo.json",name:"Logo"};ca=G=null;if(!d)if(a){d=ya.keyfind("name",a.category,Y)[0];d=ya.keyfind("name",a.item,d.items)[0];for(var g in d)ua[g]="load_file"==g?N.get_std_assets_path()+
d[g]:d[g];E.set("last_item_name",a.item)}else E.set("last_item_name","");b&&(wa.clear_render_callback(),Ga.cleanup());p(!1);J.clear_errors_warnings();a=ua.name;b=ua.load_file;g=document.getElementById("current_file");g.innerHTML=a;g.setAttribute("title",a+" ("+b+")");Ga.load(b,q,F,c)}function l(){var b=xa.get_canvas(),b=L.get_device_by_type_element(L.DEVICE_MOUSE,b),b=L.get_vector_param(b,L.MOUSE_LOCATION,Db);a(b[0],b[1])}function m(b){for(var c=0;c<b.length;c++)a(b[c].clientX,b[c].clientY)}function p(a){var b=
xa.get_canvas(),c=L.get_device_by_type_element(L.DEVICE_MOUSE,b);c&&(a?L.attach_param_cb(c,L.MOUSE_DOWN_WHICH,l):L.detach_param_cb(c,L.MOUSE_DOWN_WHICH,l));(b=L.get_device_by_type_element(L.DEVICE_TOUCH,b))&&(a?L.attach_param_cb(b,L.TOUCH_START,m):L.detach_param_cb(b,L.TOUCH_START,m))}function q(a){p(!0);U=null;x(ua);g();I.enable_debug_controls();da()&&Eb.enable_mixer_controls();"true"===E.get("gyro_use")&&Fb.enable_camera_rotation();"HMD"==N.get("stereo")&&(La.update(),eb.enable_hmd(eb.HMD_ALL_AXES_MOUSE_NONE));
wa.set_render_callback(C);za&&(Qa=setTimeout(ha,1E3));a=K.create_elapsed_sensor();K.create_sensor_manifold(z.get_active_camera(),"TO_OBJ",K.CT_CONTINUOUS,[a],null,function(a,b,d){if(1==d&&U){if(d=U)b=Gb,Hb.get_object_center(d,!0,b),a=cb.get_translation(a,Ib),db=Jb.dist(b,a).toFixed(3);c()}})}function ha(){var a=d();if(a){var b=a.item,a=ya.keyfind("name",a.category,Y)[0],b=ya.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=Y.indexOf(a);b=null;
do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{za=!1;return}}}else a=Y[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function F(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=J.get_error_quantity(),d=J.get_warning_quantity();if(Ga.is_primary_loaded()){Ia();var e=J.get_error_quantity(),f=J.get_warning_quantity();f||e?P.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):
P.setAttribute("title","Loaded OK");d||c||(P.children[0].style.visibility="hidden",P.children[1].style.visibility="hidden",P.children[2].style.visibility="visible")}d&&!c&&(P.children[0].style.visibility="hidden",P.children[1].style.visibility="visible",P.children[2].style.visibility="hidden");c&&(P.children[0].style.visibility="visible",P.children[1].style.visibility="hidden",P.children[2].style.visibility="hidden")}function x(a){for(var c=z.get_active(),d=z.get_scenes(),e=0;e<d.length;e++){var f=
d[e];if(f!==c){var g=v(f,a);A(f,g)}}g=v(c,a);A(c,g);ab=function(a){var c=sa.get_materials_names(a);b("material_name",c);fb(a,c[0]);a=sa.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
a?(w(c,"enable"),z.get_water_mat_params(a),a.shallow_water_col&&oa("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&oa("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(oa("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):w(c,"disable")};Kb();a=z.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(na(a[e]));b("light_name",c);0<a.length&&gb(a[0]);Lb();Mb();Nb();Ob();Pb();Qb();Rb();Sb();Tb();Ub();Vb();Wb();bb();$("#debug_view_mode").val("DV_NONE");$("#debug_view_mode").selectmenu("refresh",!0);w(["debug_change_colors"],"disable");w(["render_time_threshold"],"disable");$("#wireframe_edge_color div").css("backgroundColor","#333");$("#render_time_threshold").trigger("change");
e=new Date(document.getElementById("date").value);Na({date:e})}function v(a,b){function c(a,b){for(var d in a)b[d]=a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function A(a,c){z.set_active(a);z.get_active_camera();for(var d=[],e=z.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(G||(G=g),d.push(na(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");
G?(w(f,"enable"),b("anim_active_object",d),pa({anim_active_object:na(G)})):w(f,"disable");d=["nla_play","nla_stop","nla_status","nla_frame_current","nla_playing"];f=["nla_frame_range"];if(S.check_nla()){S.check_logic_nodes()?(w(d,"disable"),document.getElementById("nla_status").innerHTML="CONTROLLED BY LOGIC NODES"):w(d,"enable");w(f,"enable");var d=document.getElementById("nla_frame_current"),f=document.getElementById("nla_frame_range"),g=S.get_frame_start(),h=S.get_frame_end();-1!=g&&-1!=h?(f.innerHTML=
g+" - "+h,d.min=""+g,d.max=""+h):f.innerHTML="N/A"}else w(d,"disable"),w(f,"disable");d=[];for(f=0;f<e.length;f++)g=e[f],Aa.check_shape_keys(g)&&(ca||(ca=g),d.push(na(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ca?(w(e,"enable"),b("shape_key_obj",d),Da({shape_key_obj:na(ca)})):w(e,"disable")}function C(a,b){z.get_active_camera();if(G){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(G,d)?(d=Math.round(B.get_frame(G,d)),parseInt($("#anim_frame_current").val())!==
d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):c.innerHTML="STOPPED"}S.check_nla()&&(S.check_logic_nodes()||(c=document.getElementById("nla_status"),S.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(S.get_frame().toFixed(0)),S.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function y(a){E.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function D(){E.cleanup();var a=window.location.href.replace(/load=.*?(&|$)/,
"").replace(/(&|\?)$/,"");window.location.href=a}function T(){h(null,!0,!1,!0)}function Q(){wa.pause()}function M(){wa.resume()}function da(){return"true"===E.get("sfx_mix_mode")?!0:!1}function ja(a){E.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function X(a){E.set("enable_gl_debug",a.enable_gl_debug);window.location.reload()}function Ja(a){E.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function Z(a){E.set("min_capabilities",a.min_capabilities);window.location.reload()}
function ka(){return""==E.get("min_capabilities")?!1:"true"===E.get("min_capabilities")}function O(a){E.set("stereo",a.stereo);window.location.reload()}function aa(a){La.show("hmd_container")}function ea(a){E.set("gyro_use",a.gyro_use);window.location.reload()}function ia(a){a.gmpd_settings?hb.show():hb.hide()}function Ha(a){E.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}function mb(){za=!0;ha()}function Ia(a){xa.resize_to_container(!0);a=xa.get_canvas();document.getElementById("info_left_up").innerHTML=
a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)";if(Ga.is_primary_loaded()){a=J.num_vertices();var b=J.num_triangles(),c=J.num_draw_calls(),d=J.num_shaders();document.getElementById("info_right_up").innerHTML=a+" verts, "+b+" tris, "+c+" draw calls, "+d+" shaders";a=J.geometry_stats();var b=J.num_textures(),c=J.num_render_targets(),d=Math.round(10*(a.ibo_memory+a.vbo_memory))/10,e=Math.round(10*b.memory)/10,f=Math.round(10*c.memory)/10,g=Math.round(10*(d+e+f))/10;document.getElementById("info_right_down").innerHTML=
"Geometry: "+d+" MiB ("+a.ibo_number+"+"+a.vbo_number+")<br>Textures: "+e+" MiB ("+b.number+")<br>RTs: "+f+" MiB ("+c.number+")<br><br>Total: "+g+" MiB"}}function nb(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&B.play(G,null,b)}function ob(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);B.stop(G,a)}function pb(){for(var a=document.getElementById("anim_active_object").children,
b=0;b<a.length;b++){var c=va(a[b].value);B.play(c,null,B.SLOT_ALL)}}function qb(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=va(a[b].value);B.stop(c,B.SLOT_ALL)}}function rb(){S.play()}function ub(){S.stop()}function Da(a){if("shape_key_obj"in a){ca=va(a.shape_key_obj);var c=Aa.get_shape_keys_names(ca);c.length?(b("shape_key_name",c),Ba=c[0],c=Aa.get_shape_key_value(ca,Ba),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&(Ba=
a.shape_key_name,c=Aa.get_shape_key_value(ca,Ba),u("shape_key_value",c));"shape_key_value"in a&&Aa.set_shape_key_value(ca,Ba,a.shape_key_value)}function tb(a){"nla_frame_current"in a&&!S.is_play()&&(a=parseInt(a.nla_frame_current),S.set_frame(a))}function pa(a){if("anim_active_object"in a){G=va(a.anim_active_object);var c=B.get_anim_names(G);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);
ib(G,c);Ra(G,c)}else b("animation",["N/A"]);Sa(G)}if("anim_slot"in a){if(!G)return;c=a.anim_slot;ib(G,c);Ra(G,c);Sa(G)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.get_current_anim_name(G,c),"None"==a.animation?B.remove_slot_animation(G,c):(B.apply(G,a.animation,c),B.play(G,null,c)),Ra(G,c),Sa(G));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=B.get_slot_num_by_anim(G,c),B.set_behavior(G,a.anim_cyclic?B.AB_CYCLIC:B.AB_FINISH_RESET,c));"anim_frame_current"in
a&&(c=parseInt(document.getElementById("anim_slot").value),B.is_play(G,c)||(d=parseInt(a.anim_frame_current),B.set_frame(G,d,c)));"anim_mix_factor"in a&&B.set_skel_mix_factor(G,a.anim_mix_factor)}function ib(a,b){for(var c=B.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Ra(a,b){u("anim_cyclic",Number(B.get_behavior(a,b)==B.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),
d=B.get_anim_start_frame(a,b),e=B.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Sa(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),d=B.get_anim_type(a,c),c=0;c<b.length;c++){d=B.get_anim_type(a,c);switch(d){case B.OBJ_ANIM_TYPE_ARMATURE:d="ARMATURE";break;case B.OBJ_ANIM_TYPE_OBJECT:d="OBJECT";break;case B.OBJ_ANIM_TYPE_PARTICLES:d=
"PARTICLES";break;case B.OBJ_ANIM_TYPE_VERTEX:d="VERTEX";break;case B.OBJ_ANIM_TYPE_MATERIAL:d="MATERIAL";break;case B.OBJ_ANIM_TYPE_STATIC:d="STATIC";break;default:d="NONE"}b.eq(c);d=c+" ("+d+")";$("#anim_slot").children().eq(c).text(d)}$("#anim_slot").selectmenu();$("#anim_slot").selectmenu("refresh")}function Mb(){var a=z.get_ssao_params(),b="ssao_quality ssao_hemisphere ssao_blur_depth ssao_blur_discard_value ssao_radius_increase ssao_influence ssao_dist_factor ssao_only ssao_white".split(" ");
if(a){w(b,"enable");for(var c=document.getElementById("ssao_quality"),b=a.ssao_quality,c=c.options,d=0;d<c.length;d++){var e=c[d];e.selected=e.value==b?!0:!1}$("#ssao_quality").selectmenu("refresh");b=Number(a.ssao_hemisphere);document.getElementById("ssao_hemisphere").options[b].selected=!0;$("#ssao_hemisphere").slider("refresh");b=Number(a.ssao_blur_depth);document.getElementById("ssao_blur_depth").options[b].selected=!0;$("#ssao_blur_depth").slider("refresh");u("ssao_blur_discard_value",a.blur_discard_value);
u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else w(b,"disable")}function ga(a){z.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=jb(document.getElementById("ssao_quality")));"ssao_hemisphere"in
a&&(b.ssao_hemisphere=Number(a.ssao_hemisphere));"ssao_blur_depth"in a&&(b.ssao_blur_depth=Number(a.ssao_blur_depth));"ssao_blur_discard_value"in a&&(b.ssao_blur_discard_value=a.ssao_blur_discard_value);"ssao_radius_increase"in a&&(b.ssao_radius_increase=a.ssao_radius_increase);"ssao_influence"in a&&(b.ssao_influence=a.ssao_influence);"ssao_dist_factor"in a&&(b.ssao_dist_factor=a.ssao_dist_factor);"ssao_only"in a&&(b.ssao_only=Number(a.ssao_only));"ssao_white"in a&&(b.ssao_white=Number(a.ssao_white));
z.set_ssao_params(b)}function Pb(){var a=z.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(w(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):w(b,"disable")}function Ea(a){var b=z.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),z.set_color_correction_params(b))}function jb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function Lb(){var a=z.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return w(b,"disable"),document.getElementById("csm_resolution").innerHTML=
"",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML="",null;w(b,"enable");kb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",
a.last_cascade_blur_radius)):w(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):w(["csm_first_cascade_border","csm_last_cascade_border","last_cascade_blur_radius"],"disable")}function ta(a){var b={};"csm_first_cascade_border"in a&&(b.csm_first_cascade_border=a.csm_first_cascade_border);"csm_last_cascade_border"in a&&(b.csm_last_cascade_border=a.csm_last_cascade_border);"self_shadow_polygon_offset"in a&&(b.self_shadow_polygon_offset=a.self_shadow_polygon_offset);"self_shadow_normal_offset"in
a&&(b.self_shadow_normal_offset=a.self_shadow_normal_offset);"first_cascade_blur_radius"in a&&(b.first_cascade_blur_radius=a.first_cascade_blur_radius);"last_cascade_blur_radius"in a&&(b.last_cascade_blur_radius=a.last_cascade_blur_radius);z.set_shadow_params(b);kb(z.get_shadow_params())}function kb(a){document.getElementById("csm_resolution").innerHTML="&nbsp;&nbsp;"+a.csm_resolution;if(a.enable_csm){document.getElementById("csm_num").innerHTML=" "+a.csm_num;for(var b=["csm_borders","blur_radii"],
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function Kb(){var a=z.get_environment_colors();u("environment_energy",a[0]);oa("horizon_color",a[1]);oa("zenith_color",a[2])}function Ma(a){("environment_energy"in a||"horizon_color"in a||"zenith_color"in a)&&z.set_environment_colors(a.environment_energy,a.horizon_color,a.zenith_color)}function $a(a){var b={};if("string"==typeof a.debug_view_mode){var c=
jb(document.getElementById("debug_view_mode"));switch(c){case "DV_NONE":b.debug_view_mode=J.DV_NONE;w(["wireframe_edge_color"],"disable");break;case "DV_OPAQUE_WIREFRAME":b.debug_view_mode=J.DV_OPAQUE_WIREFRAME;w(["wireframe_edge_color"],"enable");break;case "DV_TRANSPARENT_WIREFRAME":b.debug_view_mode=J.DV_TRANSPARENT_WIREFRAME;w(["wireframe_edge_color"],"enable");break;case "DV_FRONT_BACK_VIEW":b.debug_view_mode=J.DV_FRONT_BACK_VIEW;w(["wireframe_edge_color"],"enable");break;case "DV_BOUNDINGS":b.debug_view_mode=
J.DV_BOUNDINGS;w(["wireframe_edge_color"],"disable");break;case "DV_CLUSTERS_VIEW":b.debug_view_mode=J.DV_CLUSTERS_VIEW;w(["wireframe_edge_color"],"disable");break;case "DV_BATCHES_VIEW":b.debug_view_mode=J.DV_BATCHES_VIEW;w(["wireframe_edge_color"],"disable");break;case "DV_RENDER_TIME":b.debug_view_mode=J.DV_RENDER_TIME,w(["wireframe_edge_color"],"disable")}"DV_CLUSTERS_VIEW"==c||"DV_BATCHES_VIEW"==c?w(["debug_change_colors"],"enable"):w(["debug_change_colors"],"disable");"DV_RENDER_TIME"==c?w(["render_time_threshold"],
"enable"):w(["render_time_threshold"],"disable")}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);J.set_debug_params(b)}function zb(){J.set_debug_params({debug_colors_seed:Math.random()})}function Ab(a){"render_time_threshold"in a&&J.set_debug_params({render_time_threshold:a.render_time_threshold})}function Bb(){Xb.shot()}function Sb(){var a=z.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
if(!a)return w(b,"disable"),null;w(b,"enable");oa("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);u("spot_brightness",a.spot_brightness);u("scatter_strength",a.scatter_strength);u("rayleigh_strength",a.rayleigh_strength);u("mie_strength",a.mie_strength);u("rayleigh_collection_power",a.rayleigh_collection_power);u("mie_collection_power",a.mie_collection_power);u("mie_distribution",a.mie_distribution)}function ba(a){var b={};"sky_color"in a&&
...
a&&(b.mie_collection_power=a.mie_collection_power);"mie_distribution"in a&&(b.mie_distribution=a.mie_distribution);z.set_sky_params(b)}function fb(a,b){var c=sa.get_material_extended_params(a,b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return w(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=sa.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);
w(d,"enable");oa("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",c.parallax_scale);u("material_parallax_steps",c.parallax_steps)}function qa(a){var b=U;"material_name"in a&&fb(b,a.material_name);if("material_diffuse_color"in a){var c=a.material_diffuse_color.slice();c.push(1);sa.set_diffuse_color(b,$("#material_name").val(),c)}c={};"material_reflectivity"in
a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);sa.set_material_extended_params(b,$("#material_name").val(),c);z.update_scene_materials_params()}function H(a){var b=U,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");
if(!b)return null;var d={},e=$("#water_dynamic").val(),f=$("#shore_smoothing").val();Boolean(Number(e))?w(c,"enable"):w(c,"disable");Boolean(Number(f))?w(["absorb_factor"],"enable"):w(["absorb_factor"],"disable");"shore_smoothing"in a&&(d.shore_smoothing=a.shore_smoothing);"absorb_factor"in a&&(d.absorb_factor=a.absorb_factor);"water_fog_color"in a&&(d.water_fog_color=a.water_fog_color);"water_fog_density"in a&&(d.water_fog_density=a.water_fog_density);"shallow_water_col"in a&&(d.shallow_water_col=
...
"dir_noise_freq"in a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!sa.set_water_material_params(b,$("#material_name").val(),d))return null;z.update_scene_materials_params();z.set_water_params(d)}function gb(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);oa("light_color",a.light_color);
u("rude_light_energy",c);u("pre_light_energy",b);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(w(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Yb))):w(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(w(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",
a.light_distance)):w(["light_distance"],"disable")}}function ra(a){"light_name"in a&&gb(va(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*
Zb));"light_spot_blend"in a&&(b.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(b.light_distance=parseFloat(a.light_distance));a=va($("#light_name").val());V.set_light_params(a,b);b=V.get_light_params(a).light_energy.toFixed(2);$("#light_energy").text(b)}function Rb(){var a=V.get_sun_params(),b=["sun_horizontal_position","sun_vertical_position"];if(!a)return w(b,"disable"),null;u("sun_horizontal_position",a.hor_position);u("sun_vertical_position",a.vert_position)}function Xa(a){var b=
{};"sun_horizontal_position"in a&&(b.hor_position=parseFloat(a.sun_horizontal_position),b.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(b.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),b.vert_position=parseFloat(a.sun_vertical_position));V.set_sun_params(b)}function vb(a){a=parseFloat(a.max_sun_angle);V.set_max_sun_angle(a)}function Na(a){"day_time"in a&&V.set_day_time(a.day_time);"date"in a&&V.set_date(new Date(a.date))}
function wb(){var a=0,b=parseFloat(document.getElementById("day_time").value),c=K.create_elapsed_sensor(),d=V.get_lamps("SUN")[0];K.create_sensor_manifold(d,"ELAPSED",K.CT_CONTINUOUS,[c],function(a){return a[0]},function(c,d,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,c=K.get_sensor_value(c,d,0),b+=c*a/3600,24<b&&(b-=Math.floor(b)),u("day_time",b))})}function Wb(){var a=V.get_lamps("SUN")[0],b=["sn-ui-grid-b"];V.get_lamps().length?a||w("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),
"disable"):w(b,"disable")}function bb(){w("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");w("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function xb(){var a=V.get_lamps("SUN")[0];K.check_sensor_manifolds(a)&&K.remove_sensor_manifold(a,"ELAPSED")}function Nb(){var a=z.get_dof_params(),b="dof_distance dof_object dof_front_start dof_front_end dof_rear_start dof_rear_end dof_power dof_bokeh_intensity dof_on".split(" ");if(a){u("dof_front_start",a.dof_front_start);u("dof_front_end",a.dof_front_end);u("dof_rear_start",a.dof_rear_start);u("dof_rear_end",a.dof_rear_end);u("dof_power",a.dof_power);u("dof_bokeh_intensity",a.dof_bokeh_intensity);
$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=na(a.dof_object);$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");$("#dof_object").parent().removeClass("ui-disabled")}else u("dof_distance",a.dof_distance),b.splice(1,1),$("#dof_distance").parent().removeClass("ui-disabled"),$("#dof_object").parent().addClass("ui-disabled");w(b,"enable");a=0<a.dof_distance?1:0;document.getElementById("dof_on").options[a].selected=
!0;$("#dof_on").slider("refresh")}else w(b,"disable")}function la(a){var b={};"dof_distance"in a&&Number($("#dof_on").val())&&(b.dof_distance=a.dof_distance);"dof_front_start"in a&&(b.dof_front_start=a.dof_front_start);"dof_front_end"in a&&(b.dof_front_end=a.dof_front_end);"dof_rear_start"in a&&(b.dof_rear_start=a.dof_rear_start);"dof_rear_end"in a&&(b.dof_rear_end=a.dof_rear_end);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_bokeh_intensity"in a&&(b.dof_bokeh_intensity=a.dof_bokeh_intensity);"dof_on"in
a&&(b.dof_on=Boolean(a.dof_on));z.set_dof_params(b)}function Ob(){var a=z.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(w(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):w(b,"disable")}function Oa(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);
"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);z.set_god_rays_params(b)}function yb(a){"canvas_rf"in a&&(N.set("canvas_resolution_factor",a.canvas_rf),Ia())}function Tb(){var a=z.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(w(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",a.mb_decay_threshold))):w(b,"disable")}function Za(a){var b={};"mb_factor"in a&&(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);z.set_mb_params(b)}
function Ub(){var a=z.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(w(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):w(b,"disable")}function Pa(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);z.set_bloom_params(b)}function Vb(){var a=z.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff",
"small_glow_mask_width","large_glow_mask_width"];a?(w(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):w(b,"disable")}function Fa(a){var b={};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=
a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);z.set_glow_material_params(b)}function oa(a,b){var c=Ta.rgb_to_css(b),d=Ta.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",d)}function Qb(){var a=z.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):w(b,"disable")}function Ya(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);
"wind_strength"in a&&(b.wind_strength=a.wind_strength);z.set_wind_params(b)}function u(a,b){var c=$("#"+a);c.val(b);c.slider("refresh")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),null}a(e)})}function fa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor",
"#"+d);c={};e=Ta.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function sb(){$b.auto_rotate(.3)}function w(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function Ua(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]);"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function na(a){return z.get_object_name_hierarchy(a).join("->")}
function va(a){return z.get_object_by_dupli_name_list(a.split("->"))}var B=n("animation"),I=n("app"),Va=n("assets"),cb=n("camera"),$b=n("camera_anim"),N=n("config");n("constraints");var xa=n("container"),K=n("controls"),Ga=n("data"),J=n("debug"),hb=n("gp_conf"),La=n("hmd_conf"),Aa=n("geometry"),Fb=n("gyroscope"),L=n("input"),V=n("lights"),wa=n("main"),eb=n("hmd"),Eb=n("mixer"),sa=n("material"),S=n("nla"),Cb=n("objects"),Ta=n("rgb"),Xb=n("screenshooter"),z=n("scenes"),E=n("storage"),Hb=n("transform"),
ya=n("util"),Wa=n("version"),Jb=n("vec3"),lb="DEBUG"===Wa.type(),Zb=Math.PI/180,Yb=180/Math.PI,Db=new Float32Array(2),Gb=new Float32Array(3),Ib=new Float32Array(3),za=!1,Qa,Y=null,G=null,ca=null,Ba="",ua=null,Ca=null,P=null,U=null,ab=function(){},ma=null,db=null;k.init=function(){E.init("b4w_viewer");var a=E.get("quality");if(a){switch(a){case "ULTRA":var b=N.P_ULTRA;break;case "HIGH":b=N.P_HIGH;break;case "LOW":b=N.P_LOW;break;case "CUSTOM":b=N.P_CUSTOM}N.set("quality",b)}N.set("stereo",E.get("stereo")||
"NONE");""==E.get("outlining_overview_mode")?N.set("outlining_overview_mode",!0):N.set("outlining_overview_mode","true"===E.get("outlining_overview_mode"));I.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:""==E.get("enable_gl_debug")?!1:"true"===E.get("enable_gl_debug"),show_hud_debug_info:"true"===E.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:da(),min_capabilities:ka(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!lb,
assets_min50_available:!lb,console_verbose:!0,physics_enabled:!0,debug_view:!0})}});b4w.require("viewer_main").init();
