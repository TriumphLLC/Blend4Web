...
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,w);E(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var t="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},D=0,P=0,Q=0,M=!1,ha=[],ia=!1,X=!1,W="addEventListener"in c,T=a(c),na=1,N=0,Z,ca;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(ca=0;ca<g.length;ca++)a.event.special[g[ca]]=n(g[ca]);W&&c.addEventListener("click",function(b){var f=ha.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ha[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
"body"!==t.activeElement.nodeName.toLowerCase()?a(t.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(C){}x=!1;w&&p&&(p.url&&-1<p.url.indexOf(a.mobile.dialogHashKey)&&this.activePage&&!this.activePage.hasClass("ui-dialog")&&0<a.mobile.navigate.history.activeIndex&&(e.changeHash=!1,x=!0),l=p.url||"",l=!x&&-1<l.indexOf("#")?l+a.mobile.dialogHashKey:l+("#"+a.mobile.dialogHashKey));(A=p?b.jqmData("title")||b.children(":jqmData(role='header')").find(".ui-title").text():
n)&&n===t.title&&(n=A);b.jqmData("title")||b.jqmData("title",n);e.transition=e.transition||(k&&!q?p.transition:g)||(w?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);!k&&x&&(a.mobile.navigate.history.getActive().pageUrl=m);l&&!e.fromHashChange&&(!a.mobile.path.isPath(l)&&0>l.indexOf("#")&&(l="#"+l),m={transition:e.transition,title:n,pageUrl:m,role:e.role},!1!==e.changeHash&&a.mobile.hashListeningEnabled?a.mobile.navigate(this.window[0].encodeURI(l),m,!0):b[0]!==a.mobile.firstPage[0]&&
...
_afterListviewRefresh:a.noop,refresh:function(d){var b,f,e,h,l,g,k,q,n,t,w,x=this.options;f=this.element;var A=!!a.nodeName(f[0],"ol");e=f.attr("start");var C={},v=f.find(".ui-li-count"),D=c(f[0],"counttheme")||this.options.countTheme,D=D?"ui-body-"+D:"ui-body-inherit";x.theme&&f.addClass("ui-group-theme-"+x.theme);A&&(e||0===e)&&(e=parseInt(e,10)-1,f.css("counter-reset","listnumbering "+e));this._beforeListviewRefresh();w=this._getChildrenByTagName(f[0],"li","LI");f=0;for(e=w.length;f<e;f++){h=w.eq(f);
...
fa=q.attr("id")||k+"-label",E=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),x=n.parseFloat(c.attr("step")||1),A=t.createElement("a"),C=a(A),k=t.createElement("div"),v=a(k),D=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(v)}():!1;q.attr("id",fa);this.isToggleSwitch=d;A.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");A.className="ui-slider-handle";k.appendChild(A);C.attr({role:"slider","aria-valuemin":E,"aria-valuemax":w,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":fa});a.extend(this,{slider:v,handle:C,control:c,type:h,step:x,max:w,min:E,valuebg:D,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
...
h?parseFloat(e.attr("min")):0;w=h?parseFloat(e.attr("max")):n.length-1;x=h&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1;if("object"===typeof c){k=c;l=this.slider.offset().left;g=this.slider.width();q=g/((w-E)/x);if(!this.dragging||k.pageX<l-8||k.pageX>l+g+8)return;l=1<q?(k.pageX-l)/g*100:Math.round((k.pageX-l)/g*100)}else null==c&&(c=h?parseFloat(e.val()||0):e[0].selectedIndex),l=(parseFloat(c)-E)/(w-E)*100;if(!isNaN(l)&&(k=l/100*(w-E)+E,A=(k-E)%x,k-=A,2*Math.abs(A)>=x&&(k+=0<A?x:-x),
A=100/((w-E)/x),k=parseFloat(k.toFixed(5)),"undefined"===typeof q&&(q=g/((w-E)/x)),1<q&&h&&(l=1/x*A*(k-E)),0>l&&(l=0),100<l&&(l=100),k<E&&(k=E),k>w&&(k=w),this.handle.css("left",l+"%"),this.handle[0].setAttribute("aria-valuenow",h?k:n.eq(k).attr("value")),this.handle[0].setAttribute("aria-valuetext",h?k:n.eq(k).getEncodedText()),this.handle[0].setAttribute("title",h?k:n.eq(k).getEncodedText()),this.valuebg&&this.valuebg.css("width",l+"%"),this._labels&&(g=this.handle.width()/this.slider.width()*100,
...
else{w=p.className;var x=k=q=void 0,A=!1,C=!0,v={icon:"",inline:!1,shadow:!1,corners:!1,iconshadow:!1,mini:!1},D=[];w=w.split(" ");for(q=0;q<w.length;q++)x=!0,k=d[w[q]],k!==g?(x=!1,v[k]=!0):0===w[q].indexOf("ui-btn-icon-")?(C=x=!1,v.iconpos=w[q].substring(12)):0===w[q].indexOf("ui-icon-")?(x=!1,v.icon=w[q].substring(8)):0===w[q].indexOf("ui-btn-")&&8===w[q].length?(x=!1,v.theme=w[q].substring(7)):"ui-btn"===w[q]&&(x=!1,A=!0),x&&D.push(w[q]);C&&(v.icon="");w={options:v,unknownClasses:D,alreadyEnhanced:A}}k=
...
h.data("colorpicker").onChange.apply(h,[l,ga(l),Z(l)])},m=function(a){k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},p=function(){n=0<this.parentNode.className.indexOf("_hex")?70:65;k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");k(this).parent().addClass("colorpicker_focus")},q=function(a){var b=k(this).parent().find("input").focus();a={el:k(this).parent().addClass("colorpicker_slider"),max:0<this.parentNode.className.indexOf("_hsb_h")?
...
k(document).unbind("mouseup",E);k(document).unbind("mousemove",fa);return!1},w=function(a){a.preventDefault();a={cal:k(this).parent(),y:k(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,A);k(document).bind("mousemove touchmove",a,x)},x=function(a){var b=a;"undefined"!==typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,b.pageY-a.data.y)))/150,10)).get(0),
[a.data.preview]);return!1},A=function(b){a(b.data.cal.data("colorpicker").color,b.data.cal.get(0));c(b.data.cal.data("colorpicker").color,b.data.cal.get(0));k(document).unbind("mouseup touchend",A);k(document).unbind("mousemove touchmove",x);return!1},C=function(a){a.preventDefault();a={cal:k(this).parent(),pos:k(this).offset()};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,D);k(document).bind("mousemove touchmove",a,v)},v=function(a){var b=a;"undefined"!==
...
v);return!1},P=function(a){k(this).addClass("colorpicker_focus")},Q=function(a){k(this).removeClass("colorpicker_focus")},M=function(a){a=k(this).parent();var b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;f(b,a.get(0));a.data("colorpicker").onSubmit(b,ga(b),Z(b),a.data("colorpicker").el)},ha=function(a){var b=k("body"),c=b.data("colorpickerId"),d=k(this).data("colorpickerId");c&&c===d?(k(document).trigger("mousedown"),b.data("colorpickerId",null)):(ia.call(this,a),b.data("colorpickerId",
...
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},ca=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ga=function(a){return ca(Z(a))},Fa=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},W,n||{});
...
"string");r(ma,"animation","string");r(ma,"anim_mix_factor","number");r(ma,"anim_slot","number");r(ma,"anim_cyclic","bool");r(ma,"anim_frame_current","number");H.set_onclick("anim_play",na);H.set_onclick("anim_stop",N);H.set_onclick("anim_play_all",Z);H.set_onclick("anim_stop_all",ca);r(hb,"nla_frame_current","number");H.set_onclick("nla_play",ga);H.set_onclick("nla_stop",Fa);r(Ba,"shape_key_obj","string");r(Ba,"shape_key_name","string");r(Ba,"shape_key_value","number");r(oa,"material_name","string");
da(oa,"material_diffuse_color");r(oa,"material_reflectivity","number");r(oa,"material_fresnel","number");r(oa,"material_fresnel_factor","number");r(oa,"material_parallax_scale","number");r(oa,"material_parallax_steps","number");r(G,"material_name","string");r(G,"shore_smoothing","bool");r(G,"absorb_factor","number");r(G,"sss_strength","number");r(G,"sss_width","number");da(G,"water_fog_color");r(G,"water_fog_density","number");da(G,"shallow_water_col");r(G,"shallow_water_col_fac","number");da(G,"shore_water_col");
...
"waves_hor_fac","number");r(Ka,"environment_energy","string");da(Ka,"horizon_color");da(Ka,"zenith_color");r(pa,"light_name","string");da(pa,"light_color");r(pa,"pre_light_energy","number");r(pa,"rude_light_energy","number");r(pa,"light_spot_size","number");r(pa,"light_spot_blend","number");r(pa,"light_distance","number");da(aa,"sky_color");r(aa,"rayleigh_brightness","number");r(aa,"mie_brightness","number");r(aa,"spot_brightness","number");r(aa,"scatter_strength","number");r(aa,"rayleigh_strength",
"number");r(aa,"mie_strength","number");r(aa,"rayleigh_collection_power","number");r(aa,"mie_collection_power","number");r(aa,"mie_distribution","number");r(La,"date","string");r(La,"day_time","number");r(Va,"sun_horizontal_position","number");r(Va,"sun_vertical_position","number");r(kb,"max_sun_angle","number");H.set_onclick("run_sun",lb);H.set_onclick("stop_sun",mb);r(ra,"csm_first_cascade_border","number");r(ra,"csm_last_cascade_border","number");r(ra,"self_shadow_polygon_offset","number");r(ra,
...
"number");r(va,"dof_on","bool");r(Ma,"god_rays_intensity","number");r(Ma,"god_rays_max_ray_length","number");r(Ma,"god_rays_steps","number");r(Da,"brightness","number");r(Da,"contrast","number");r(Da,"exposure","number");r(Da,"saturation","number");r(M,"sfx_mix_mode","bool");a=Number("true"===I.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(ha,"stereo","string");a=I.get("stereo")||"NONE";wa.check_browser_support()||(document.getElementById("stereo").options[2].setAttribute("disabled",
"disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(I.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);"HMD"==a&&wa.enable_hmd(wa.HMD_ALL_AXES_MOUSE_NONE);r(ia,"gyro_use","bool");a=Number("true"===I.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Wa,"wind_dir","number");r(Wa,"wind_strength","number");r(Xa,"mb_factor","number");r(Xa,"mb_decay_threshold","number");r(Na,
"bloom_key","number");r(Na,"bloom_blur","number");r(Na,"bloom_edge_lum","number");r(Ea,"small_glow_mask_coeff","number");r(Ea,"large_glow_mask_coeff","number");r(Ea,"small_glow_mask_width","number");r(Ea,"large_glow_mask_width","number");r(nb,"canvas_rf","number");r(Ya,"wireframe_mode","string");da(Ya,"wireframe_edge_color","object");r(Q,"show_hud_debug_info","bool");r(X,"outlining_overview_mode","bool");a=""==I.get("outlining_overview_mode")?1:Number("true"===I.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=
!0;$("#outlining_overview_mode").slider("refresh");H.set_onclick("make_screenshot",ob);a=Number("true"===I.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),
d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ca&&z.can_select_objects()){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=U;d&&z.outlining_is_enabled(d)&&z.clear_outline_anim(d);b=z.pick_object(b,a);b&&pb.is_empty(b)||((U=b)?Za(b):$a(),c(),ja||(b?(ja=b,c(),H.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,
b,d,e){ja=null;c();H.disable_object_controls(a)})):g()))}}function g(){var a=z.get_active_camera();ja=a;c();H.enable_camera_controls();J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ja=null;c();H.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&ab.target_zoom_object(a,
b)})}function c(){if(Ca){var a=ja?ka(ja):"NONE",b=U?ka(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=U)&&(b=z.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=ja;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+bb);Ca.innerHTML=a}}function d(){var a=I.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];if(xa.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=
document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){ya=!1;clearTimeout(Oa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];ya=!1;clearTimeout(Oa);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<
O.children.length;f++)O.children[f].style.visibility="hidden";if((f=H.get_url_params())&&f.load){var g=f.load.split("/");sa={load_file:f.load,name:g[g.length-1].split(".")[0],animated_objects:[]}}else sa={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ba=F=null;if(!e)if(b){e=xa.keyfind("name",b.category,Y)[0];e=xa.keyfind("name",b.item,e.items)[0];for(var h in e)sa[h]="load_file"==h?K.get_std_assets_path()+e[h]:e[h];I.set("last_item_name",b.item)}else I.set("last_item_name",
"");c&&(ua.clear_render_callback(),Pa.cleanup());Qa.get_canvas().removeEventListener("mousedown",a);L.clear_errors_warnings();b=sa.name;c=sa.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Pa.load(c,l,p,d)}function l(b){Qa.get_canvas().addEventListener("mousedown",a,!1);U=null;q(sa);g();H.enable_debug_controls();P()&&qb.enable_mixer_controls();K.get("gyro_use")&&rb.enable_camera_rotation();"HMD"==K.get("stereo")&&wa.enable_hmd(wa.HMD_ALL_AXES_MOUSE_NONE);
ua.set_render_callback(w);ya&&(Oa=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(z.get_active_camera(),"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&U){if(d=U)b=sb,tb.get_object_center(d,!0,b),a=ab.get_translation(a,ub),bb=vb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=a.item,a=xa.keyfind("name",a.category,Y)[0],b=xa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=Y.indexOf(a);b=null;
do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{ya=!1;return}}}else a=Y[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();if(Pa.is_primary_loaded()){T();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=
...
"hidden")}function q(a){for(var c=z.get_active(),d=z.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=fa(f,a);E(f,g)}}g=fa(c,a);E(c,g);Za=function(a){var c=qa.get_materials_names(a);b("material_name",c);cb(a,c[0]);a=qa.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
a?(y(c,"enable"),z.get_water_mat_params(a),a.shallow_water_col&&la("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&la("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(la("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):y(c,"disable")};wb();a=z.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(ka(a[e]));b("light_name",c);0<a.length&&db(a[0]);xb();ib();yb();zb();Ab();Bb();Cb();Db();Eb();Fb();Gb();Hb();$a();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);La({date:e})}function fa(a,b){function c(a,b){for(var d in a)b[d]=
a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function E(a,c){z.set_active(a);z.get_active_camera();for(var d=[],e=z.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(F||(F=g),d.push(ka(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");F?(y(f,"enable"),b("anim_active_object",d),ma({anim_active_object:ka(F)})):y(f,"disable");
...
d=[];for(f=0;f<e.length;f++)g=e[f],za.check_shape_keys(g)&&(ba||(ba=g),d.push(ka(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ba?(y(e,"enable"),b("shape_key_obj",d),Ba({shape_key_obj:ka(ba)})):y(e,"disable")}function w(a,b){z.get_active_camera();if(F){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(F,d)?(d=Math.round(B.get_frame(F,d)),parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):
c.innerHTML="STOPPED"}S.check_nla()&&(S.check_nla_scripts()||(c=document.getElementById("nla_status"),S.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(S.get_frame().toFixed(0)),S.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function x(a){I.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function A(){I.cleanup();var a=window.location.href.replace(/load=.*?(&|$)/,"").replace(/(&|\?)$/,"");window.location.href=a}function C(){h(null,
!0,!1,!0)}function v(){ua.pause()}function D(){ua.resume()}function P(){return"true"===I.get("sfx_mix_mode")?!0:!1}function Q(a){I.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function M(a){I.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function ha(a){I.set("stereo",a.stereo);window.location.reload()}function ia(a){I.set("gyro_use",a.gyro_use);window.location.reload()}function X(a){I.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}
function Ha(){ya=!0;m()}function T(a){H.resize_to_container();a=Qa.get_canvas();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)"}function na(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&B.play(F,null,b)}function N(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);B.stop(F,a)}function Z(){for(var a=document.getElementById("anim_active_object").children,
b=0;b<a.length;b++){var c=ta(a[b].value);B.play(c,null,B.SLOT_ALL)}}function ca(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ta(a[b].value);B.stop(c,null,B.SLOT_ALL)}}function ga(){S.play()}function Fa(){S.stop()}function Ba(a){if("shape_key_obj"in a){ba=ta(a.shape_key_obj);var c=za.get_shape_keys_names(ba);c.length?(b("shape_key_name",c),Aa=c[0],c=za.get_shape_key_value(ba,Aa),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&
(Aa=a.shape_key_name,c=za.get_shape_key_value(ba,Aa),u("shape_key_value",c));"shape_key_value"in a&&za.set_shape_key_value(ba,Aa,a.shape_key_value)}function hb(a){"nla_frame_current"in a&&!S.is_play()&&(a=parseInt(a.nla_frame_current),S.set_frame(a))}function ma(a){if("anim_active_object"in a){F=ta(a.anim_active_object);var c=B.get_anim_names(F);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);
Sa(F,c);Ga(F,c)}else b("animation",["N/A"]);Ia(F)}if("anim_slot"in a){if(!F)return;c=a.anim_slot;Sa(F,c);Ga(F,c);Ia(F)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.get_current_anim_name(F,c),"None"==a.animation?B.remove_slot_animation(F,c):(B.apply(F,a.animation,c),B.play(F,null,c)),Ga(F,c),Ia(F));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=B.get_slot_num_by_anim(F,c),B.set_behavior(F,a.anim_cyclic?B.AB_CYCLIC:B.AB_FINISH_RESET,c));"anim_frame_current"in
...
u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else y(b,"disable")}function ea(a){z.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=eb(document.getElementById("ssao_quality")));"ssao_hemisphere"in
...
z.set_ssao_params(b)}function Ab(){var a=z.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(y(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):y(b,"disable")}function Da(a){var b=z.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),z.set_color_correction_params(b))}function eb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function xb(){var a=z.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return y(b,"disable"),document.getElementById("csm_resolution").innerHTML=
"",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML="",null;y(b,"enable");fb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function wb(){var a=z.get_environment_colors();u("environment_energy",a[0]);la("horizon_color",a[1]);la("zenith_color",a[2])}function Ka(a){("environment_energy"in a||"horizon_color"in a||"zenith_color"in a)&&z.set_environment_colors(a.environment_energy,a.horizon_color,a.zenith_color)}function Ya(a){var b={};if("string"==typeof a.wireframe_mode)switch(eb(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=
L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function ob(){Ib.shot()}function Db(){var a=z.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
if(!a)return y(b,"disable"),null;y(b,"enable");la("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);u("spot_brightness",a.spot_brightness);u("scatter_strength",a.scatter_strength);u("rayleigh_strength",a.rayleigh_strength);u("mie_strength",a.mie_strength);u("rayleigh_collection_power",a.rayleigh_collection_power);u("mie_collection_power",a.mie_collection_power);u("mie_distribution",a.mie_distribution)}function aa(a){var b={};"sky_color"in a&&
...
a&&(b.mie_collection_power=a.mie_collection_power);"mie_distribution"in a&&(b.mie_distribution=a.mie_distribution);z.set_sky_params(b)}function cb(a,b){var c=qa.get_material_extended_params(a,b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return y(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=qa.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);
y(d,"enable");la("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",c.parallax_scale);u("material_parallax_steps",c.parallax_steps)}function oa(a){var b=U;"material_name"in a&&cb(b,a.material_name);if("material_diffuse_color"in a){var c=a.material_diffuse_color.slice();c.push(1);qa.set_diffuse_color(b,$("#material_name").val(),c)}c={};"material_reflectivity"in
a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);qa.set_material_extended_params(b,$("#material_name").val(),c);z.update_scene_materials_params()}function G(a){var b=U,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");
...
"dir_noise_freq"in a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!qa.set_water_material_params(b,$("#material_name").val(),d))return null;z.update_scene_materials_params();z.set_water_params(d)}function db(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);la("light_color",a.light_color);
u("rude_light_energy",c);u("pre_light_energy",b);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(y(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Jb))):y(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(y(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",
a.light_distance)):y(["light_distance"],"disable")}}function pa(a){"light_name"in a&&db(ta(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*
...
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean(a.dof_on));z.set_dof_params(b)}function zb(){var a=z.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(y(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):y(b,"disable")}function Ma(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=
a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);z.set_god_rays_params(b)}function nb(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),T())}function Eb(){var a=z.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(y(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",a.mb_decay_threshold))):y(b,"disable")}function Xa(a){var b={};"mb_factor"in a&&(b.mb_factor=
a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);z.set_mb_params(b)}function Fb(){var a=z.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(y(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):y(b,"disable")}function Na(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);z.set_bloom_params(b)}
function Gb(){var a=z.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(y(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):y(b,"disable")}function Ea(a){var b={};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in
a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);z.set_glow_material_params(b)}function la(a,b){var c=Ra.rgb_to_css(b),d=Ra.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",d)}function Bb(){var a=z.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),
u("wind_strength",a.wind_strength)):y(b,"disable")}function Wa(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);z.set_wind_params(b)}function u(a,b){var c=$("#"+a);c.val(b);c.slider("refresh")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),
null}a(e)})}function da(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Ra.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function jb(){Lb.auto_rotate(.3)}function y(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function ka(a){return z.get_object_name_hierarchy(a).join("->")}function ta(a){return z.get_object_by_dupli_name_list(a.split("->"))}
var B=n("animation"),H=n("app"),Ta=n("assets"),ab=n("camera"),Lb=n("camera_anim"),K=n("config");n("constraints");var Qa=n("container"),J=n("controls"),Pa=n("data"),L=n("debug"),za=n("geometry"),rb=n("gyroscope"),V=n("lights"),ua=n("main"),wa=n("hmd"),qb=n("mixer"),qa=n("material"),S=n("nla"),pb=n("objects"),Ra=n("rgb"),Ib=n("screenshooter"),z=n("scenes"),I=n("storage"),tb=n("transform"),xa=n("util"),Ua=n("version"),vb=n("vec3"),gb="DEBUG"===Ua.type(),Kb=Math.PI/180,Jb=180/Math.PI,sb=new Float32Array(3),
ub=new Float32Array(3),ya=!1,Oa,Y=null,F=null,ba=null,Aa="",sa=null,Ca=null,O=null,U=null,Za=function(){},ja=null,bb=null;k.init=function(){I.init("b4w_viewer");var a=I.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("stereo",I.get("stereo")||"NONE");K.set("gyro_use","true"===I.get("gyro_use"));""==I.get("outlining_overview_mode")?K.set("outlining_overview_mode",!0):K.set("outlining_overview_mode",
"true"===I.get("outlining_overview_mode"));H.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===I.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:P(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!gb,assets_min50_available:!gb,console_verbose:!0,physics_enabled:!0,wireframe_debug:!0})}});b4w.require("viewer_main").init();
