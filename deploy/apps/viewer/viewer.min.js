...
"anaglyph_use","bool");a=Number("true"===I.get("anaglyph_use"));document.getElementById("anaglyph_use").options[a].selected=!0;$("#anaglyph_use").slider("refresh");r(ja,"gyro_use","bool");a=Number("true"===I.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Va,"wind_dir","number");r(Va,"wind_strength","number");r(Wa,"mb_factor","number");r(Wa,"mb_decay_threshold","number");r(Na,"bloom_key","number");r(Na,"bloom_blur","number");r(Na,"bloom_edge_lum",
"number");r(Da,"small_glow_mask_coeff","number");r(Da,"large_glow_mask_coeff","number");r(Da,"small_glow_mask_width","number");r(Da,"large_glow_mask_width","number");r(mb,"canvas_rf","number");r(Xa,"wireframe_mode","string");aa(Xa,"wireframe_edge_color","object");r(Q,"show_hud_debug_info","bool");r(X,"outlining_overview_mode","bool");a=""==I.get("outlining_overview_mode")?1:Number("true"===I.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;
$("#outlining_overview_mode").slider("refresh");H.set_onclick("make_screenshot",nb);a=Number("true"===I.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),
d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ba&&x.can_select_objects()){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=U;d&&x.outlining_is_enabled(d)&&x.clear_outline_anim(d);(U=b=x.pick_object(b,a))?Ya(b):Za();c();la||(b?(la=b,c(),H.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){la=null;
c();H.disable_object_controls(a)})):g())}}function g(){var a=x.get_active_camera();la=a;c();H.enable_camera_controls();J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){la=null;c();H.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&$a.target_zoom_object(a,b)})}function c(){if(Ba){var a=
la?ma(la):"NONE",b=U?ma(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=U)&&(b=x.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=la;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+ab);Ba.innerHTML=a}}function d(){var a=I.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];if(wa.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");
e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){xa=!1;clearTimeout(Oa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];xa=!1;clearTimeout(Oa);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<O.children.length;f++)O.children[f].style.visibility=
"hidden";if((f=H.get_url_params())&&f.load){var g=f.load.split("/");ta={load_file:f.load,name:g[g.length-1].split(".")[0],animated_objects:[]}}else ta={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ca=F=null;if(!e)if(b){e=wa.keyfind("name",b.category,Y)[0];e=wa.keyfind("name",b.item,e.items)[0];for(var h in e)ta[h]="load_file"==h?K.get_std_assets_path()+e[h]:e[h];I.set("last_item_name",b.item)}else I.set("last_item_name","");c&&(ka.clear_render_callback(),Pa.cleanup());
ka.get_canvas_elem().removeEventListener("mousedown",a);L.clear_errors_warnings();b=ta.name;c=ta.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Pa.load(c,l,p,d)}function l(b){ka.get_canvas_elem().addEventListener("mousedown",a,!1);U=null;q(ta);g();H.enable_debug_controls();P()&&ob.enable_mixer_controls();K.get("gyro_use")&&pb.enable_camera_rotation();ka.set_render_callback(w);xa&&(Oa=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(x.get_active_camera(),
"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&U){if(d=U)b=qb,rb.get_object_center(d,!0,b),a=$a.get_translation(a,sb),ab=tb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=a.item,a=wa.keyfind("name",a.category,Y)[0],b=wa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=Y.indexOf(a);b=null;do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{xa=!1;return}}}else a=Y[0],b=a.items[0],
a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();if(Pa.is_primary_loaded()){T();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=Math.round(10*
(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=L.get_error_quantity();(f=L.get_warning_quantity())||e?O.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):O.setAttribute("title","Loaded OK");
d||c||(O.children[0].style.visibility="hidden",O.children[1].style.visibility="hidden",O.children[2].style.visibility="visible")}d&&!c&&(O.children[0].style.visibility="hidden",O.children[1].style.visibility="visible",O.children[2].style.visibility="hidden");c&&(O.children[0].style.visibility="visible",O.children[1].style.visibility="hidden",O.children[2].style.visibility="hidden")}function q(a){for(var c=x.get_active(),d=x.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=ga(f,a);E(f,g)}}g=
ga(c,a);E(c,g);Ya=function(a){var c=ra.get_materials_names(a);b("material_name",c);bb(a,c[0]);a=ra.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):z(c,"disable")};ub();a=x.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(ma(a[e]));b("light_name",c);0<a.length&&cb(a[0]);vb();hb();wb();xb();yb();zb();Ab();Bb();Cb();Db();Eb();Fb();Gb();Za();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);Ka({date:e})}function ga(a,b){function c(a,b){for(var d in a)b[d]=
...
x.set_ssao_params(b)}function zb(){var a=x.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(z(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):z(b,"disable")}function Ca(a){var b=x.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),x.set_color_correction_params(b))}function db(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function wb(){var a=x.get_fog_color_density();.2<a[3]?u("fog_density",a[3]):u("fog_density1000",1E3*a[3]);fa("fog_color",a)}function La(a){var b=x.get_fog_color_density();"fog_density"in a&&(b[3]=a.fog_density);"fog_density1000"in a&&(b[3]=a.fog_density1000/1E3);"fog_color"in a&&(b[0]=a.fog_color[0],b[1]=a.fog_color[1],b[2]=a.fog_color[2]);
x.set_fog_color_density(b)}function vb(){var a=x.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return z(b,"disable"),document.getElementById("csm_resolution").innerHTML="",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML=
"",null;z(b,"enable");eb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",a.last_cascade_blur_radius)):z(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):z(["csm_first_cascade_border",
...
"none"}function ub(){var a=x.get_environment_colors();u("environment_energy",a[0]);fa("horizon_color",a[1]);fa("zenith_color",a[2])}function Ja(a){"environment_energy"in a&&x.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&x.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&x.set_environment_colors(null,null,a.zenith_color)}function Xa(a){var b={};if("string"==typeof a.wireframe_mode)switch(db(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=
L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function nb(){Hb.shot()}function Cb(){var a=x.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
...
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean($("#dof_on").val()),b.dof_distance=Number(a.dof_on)?parseFloat($("#dof_distance").val()):0);x.set_dof_params(b)}function yb(){var a=x.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(z(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):z(b,
"disable")}function Ma(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);x.set_god_rays_params(b)}function mb(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),T())}function Db(){var a=x.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(z(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",
a.mb_decay_threshold))):z(b,"disable")}function Wa(a){var b={};"mb_factor"in a&&(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);x.set_mb_params(b)}function Eb(){var a=x.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(z(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):z(b,"disable")}function Na(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=
a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);x.set_bloom_params(b)}function Fb(){var a=x.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(z(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):z(b,"disable")}function Da(a){var b=
{};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);x.set_glow_material_params(b)}function fa(a,b){var c=Qa.rgb_to_css(b),d=Qa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",
d)}function Ab(){var a=x.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):z(b,"disable")}function Va(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);x.set_wind_params(b)}function u(a,b){$("#"+a).val(b);$("#"+a).slider("refresh");$("#"+a).trigger("change")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=
parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),null}a(e)})}function aa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Qa.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function ib(){Kb.auto_rotate(.3)}function z(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==
b&&d.addClass("ui-disabled")}}function ma(a){return x.get_object_name_hierarchy(a).join("->")}function ua(a){return x.get_object_by_dupli_name_list(a.split("->"))}var B=n("animation"),H=n("app"),Sa=n("assets"),$a=n("camera"),Kb=n("camera_anim"),K=n("config");n("constraints");var J=n("controls"),Pa=n("data"),L=n("debug"),ya=n("geometry"),pb=n("gyroscope"),V=n("lights"),ka=n("main"),ob=n("mixer"),ra=n("material"),S=n("nla"),Qa=n("rgb"),Hb=n("screenshooter"),x=n("scenes"),I=n("storage"),rb=n("transform"),
wa=n("util"),Ta=n("version"),tb=n("vec3"),fb="DEBUG"===Ta.type(),Jb=Math.PI/180,Ib=180/Math.PI,qb=new Float32Array(3),sb=new Float32Array(3),xa=!1,Oa,Y=null,F=null,ca=null,za="",ta=null,Ba=null,O=null,U=null,Ya=function(){},la=null,ab=null;k.init=function(){I.init("b4w_viewer");var a=I.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("anaglyph_use","true"===I.get("anaglyph_use"));
K.set("gyro_use","true"===I.get("gyro_use"));""==I.get("outlining_overview_mode")?K.set("outlining_overview_mode",!0):K.set("outlining_overview_mode","true"===I.get("outlining_overview_mode"));H.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===I.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:P(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!fb,assets_min50_available:!fb,console_verbose:!0,
