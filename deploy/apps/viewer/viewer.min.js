(function(k,n,t){"function"===typeof define&&define.amd?define(["jquery"],function(V){t(V,k,n);return V.mobile}):t(k.jQuery,k,n)})(this,document,function(k,n,t,V){k.mobile={};(function(a,g){function c(b,f){var c,m;c=b.nodeName.toLowerCase();if("area"===c){c=b.parentNode;m=c.name;if(!b.href||!m||"map"!==c.nodeName.toLowerCase())return!1;c=a("img[usemap=#"+m+"]")[0];return!!c&&d(c)}return(/input|select|textarea|button|object/.test(c)?!b.disabled:"a"===c?b.href||f:f)&&d(b)}function d(b){return a.expr.filters.visible(b)&&
...
function l(b){var f=a.data(b.target,"virtualTouchID");ja||N&&N===f||!(f=h("v"+b.type,b))||(f.isDefaultPrevented()&&b.preventDefault(),f.isPropagationStopped()&&b.stopPropagation(),f.isImmediatePropagationStopped()&&b.stopImmediatePropagation())}function m(c){var e=b(c).touches,d;e&&1===e.length&&(d=c.target,e=f(d),e.hasVirtualBinding&&(N=ca++,a.data(d,"virtualTouchID",N),D&&(clearTimeout(D),D=0),M=W=!1,d=b(c).touches[0],P=d.pageX,Q=d.pageY,h("vmouseover",c,e),h("vmousedown",c,e)))}function p(a){W||
(M||h("vmousecancel",a,f(a.target)),M=!0,e())}function q(c){if(!W){var d=b(c).touches[0],m=M,l=a.vmouse.moveDistanceThreshold,p=f(c.target);(M=M||Math.abs(d.pageX-P)>l||Math.abs(d.pageY-Q)>l)&&!m&&h("vmousecancel",c,p);h("vmousemove",c,p);e()}}function k(a){if(!W){W=!0;var c=f(a.target),d;h("vmouseup",a,c);M||(d=h("vclick",a,c))&&d.isDefaultPrevented()&&(d=b(a).changedTouches[0],ia.push({touchID:N,x:d.clientX,y:d.clientY}),ja=!0);h("vmouseout",a,c);M=!1;e()}}function E(b){b=a.data(b,"virtualMouseBindings");
var f;if(b)for(f in b)if(b[f])return!0;return!1}function n(){}function t(b){var f=b.substr(1);return{setup:function(){E(this)||a.data(this,"virtualMouseBindings",{});a.data(this,"virtualMouseBindings")[b]=!0;v[b]=(v[b]||0)+1;1===v[b]&&Y.bind(f,l);a(this).bind(f,n);V&&(v.touchstart=(v.touchstart||0)+1,1===v.touchstart&&Y.bind("touchstart",m).bind("touchend",k).bind("touchmove",q).bind("scroll",p))},teardown:function(){--v[b];v[b]||Y.unbind(f,l);V&&(--v.touchstart,v.touchstart||Y.unbind("touchstart",
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,n);E(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var z="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},D=0,P=0,Q=0,M=!1,ia=[],ja=!1,W=!1,V="addEventListener"in c,Y=a(c),ca=1,N=0,Z,da;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(da=0;da<g.length;da++)a.event.special[g[da]]=t(g[da]);V&&c.addEventListener("click",function(b){var f=ia.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ia[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
"body"!==t.activeElement.nodeName.toLowerCase()?a(t.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(C){}x=!1;w&&p&&(p.url&&-1<p.url.indexOf(a.mobile.dialogHashKey)&&this.activePage&&!this.activePage.hasClass("ui-dialog")&&0<a.mobile.navigate.history.activeIndex&&(e.changeHash=!1,x=!0),l=p.url||"",l=!x&&-1<l.indexOf("#")?l+a.mobile.dialogHashKey:l+("#"+a.mobile.dialogHashKey));(z=p?b.jqmData("title")||b.children(":jqmData(role='header')").find(".ui-title").text():
n)&&n===t.title&&(n=z);b.jqmData("title")||b.jqmData("title",n);e.transition=e.transition||(k&&!q?p.transition:g)||(w?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);!k&&x&&(a.mobile.navigate.history.getActive().pageUrl=m);l&&!e.fromHashChange&&(!a.mobile.path.isPath(l)&&0>l.indexOf("#")&&(l="#"+l),m={transition:e.transition,title:n,pageUrl:m,role:e.role},!1!==e.changeHash&&a.mobile.hashListeningEnabled?a.mobile.navigate(this.window[0].encodeURI(l),m,!0):b[0]!==a.mobile.firstPage[0]&&
...
_afterListviewRefresh:a.noop,refresh:function(d){var b,f,e,h,l,g,k,q,n,t,w,x=this.options;f=this.element;var z=!!a.nodeName(f[0],"ol");e=f.attr("start");var C={},v=f.find(".ui-li-count"),D=c(f[0],"counttheme")||this.options.countTheme,D=D?"ui-body-"+D:"ui-body-inherit";x.theme&&f.addClass("ui-group-theme-"+x.theme);z&&(e||0===e)&&(e=parseInt(e,10)-1,f.css("counter-reset","listnumbering "+e));this._beforeListviewRefresh();w=this._getChildrenByTagName(f[0],"li","LI");f=0;for(e=w.length;f<e;f++){h=w.eq(f);
l="";if(d||0>h[0].className.search(/\bui-li-static\b|\bui-li-divider\b/))q=this._getChildrenByTagName(h[0],"a","A"),b="list-divider"===c(h[0],"role"),n=h.attr("value"),g=c(h[0],"theme"),q.length&&0>q[0].className.search(/\bui-btn\b/)&&!b?(b=c(h[0],"icon"),k=!1===b?!1:b||x.icon,q.removeClass("ui-link"),b="ui-btn",g&&(b+=" ui-btn-"+g),1<q.length?(l="ui-li-has-alt",g=q.last(),k=(k=c(g[0],"theme")||x.splitTheme||c(h[0],"theme",!0))?" ui-btn-"+k:"",t=c(g[0],"icon")||c(h[0],"icon")||x.splitIcon,k="ui-btn ui-btn-icon-notext ui-icon-"+
t+k,g.attr("title",a.trim(g.getEncodedText())).addClass(k).empty(),q=q.first()):k&&(b+=" ui-btn-icon-right ui-icon-"+k),q.addClass(b)):b?(l=c(h[0],"theme")||x.dividerTheme||x.theme,l="ui-li-divider ui-bar-"+(l?l:"inherit"),h.attr("role","heading")):0>=q.length&&(l="ui-li-static ui-body-"+(g?g:"inherit")),z&&n&&(n=parseInt(n,10)-1,h.css("counter-reset","listnumbering "+n));C[l]||(C[l]=[]);C[l].push(h[0])}for(l in C)a(C[l]).addClass(l);v.each(function(){a(this).closest("li").addClass("ui-li-has-count")});
...
ga=q.attr("id")||k+"-label",E=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),x=n.parseFloat(c.attr("step")||1),z=t.createElement("a"),C=a(z),k=t.createElement("div"),v=a(k),D=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(v)}():!1;q.attr("id",ga);this.isToggleSwitch=d;z.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");z.className="ui-slider-handle";k.appendChild(z);C.attr({role:"slider","aria-valuemin":E,"aria-valuemax":w,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":ga});a.extend(this,{slider:v,handle:C,control:c,type:h,step:x,max:w,min:E,valuebg:D,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
...
h?parseFloat(e.attr("min")):0;w=h?parseFloat(e.attr("max")):n.length-1;x=h&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1;if("object"===typeof c){k=c;l=this.slider.offset().left;g=this.slider.width();q=g/((w-E)/x);if(!this.dragging||k.pageX<l-8||k.pageX>l+g+8)return;l=1<q?(k.pageX-l)/g*100:Math.round((k.pageX-l)/g*100)}else null==c&&(c=h?parseFloat(e.val()||0):e[0].selectedIndex),l=(parseFloat(c)-E)/(w-E)*100;if(!isNaN(l)&&(k=l/100*(w-E)+E,z=(k-E)%x,k-=z,2*Math.abs(z)>=x&&(k+=0<z?x:-x),
z=100/((w-E)/x),k=parseFloat(k.toFixed(5)),"undefined"===typeof q&&(q=g/((w-E)/x)),1<q&&h&&(l=1/x*z*(k-E)),0>l&&(l=0),100<l&&(l=100),k<E&&(k=E),k>w&&(k=w),this.handle.css("left",l+"%"),this.handle[0].setAttribute("aria-valuenow",h?k:n.eq(k).attr("value")),this.handle[0].setAttribute("aria-valuetext",h?k:n.eq(k).getEncodedText()),this.handle[0].setAttribute("title",h?k:n.eq(k).getEncodedText()),this.valuebg&&this.valuebg.css("width",l+"%"),this._labels&&(g=this.handle.width()/this.slider.width()*100,
...
else{w=p.className;var x=k=q=void 0,z=!1,C=!0,v={icon:"",inline:!1,shadow:!1,corners:!1,iconshadow:!1,mini:!1},D=[];w=w.split(" ");for(q=0;q<w.length;q++)x=!0,k=d[w[q]],k!==g?(x=!1,v[k]=!0):0===w[q].indexOf("ui-btn-icon-")?(C=x=!1,v.iconpos=w[q].substring(12)):0===w[q].indexOf("ui-icon-")?(x=!1,v.icon=w[q].substring(8)):0===w[q].indexOf("ui-btn-")&&8===w[q].length?(x=!1,v.theme=w[q].substring(7)):"ui-btn"===w[q]&&(x=!1,z=!0),x&&D.push(w[q]);C&&(v.icon="");w={options:v,unknownClasses:D,alreadyEnhanced:z}}k=
...
{transition:"none",reverse:!0,changeHash:!1,fromHashChange:!0}))}}),a(function(){a.support.inlineSVG();a.mobile.hideUrlBar&&g.scrollTo(0,1);a.mobile.defaultHomeScroll=a.support.scrollTop&&1!==a.mobile.window.scrollTop()?1:0;a.mobile.autoInitializePage&&a.mobile.initializePage();a.mobile.hideUrlBar&&f.load(a.mobile.silentScroll);a.support.cssPointerEvents||a.mobile.document.delegate(".ui-state-disabled,.ui-disabled","vclick",function(a){a.preventDefault();a.stopImmediatePropagation()})}))})(k,this)});(function(k){var n=function(){var n=65,V={eventName:"click",onShow:function(){},onBeforeShow:function(){},onHide:function(){},onChange:function(){},onSubmit:function(){},color:"ff0000",livePreview:!0,flat:!1},a=function(a,b){var c=Z(a);c.r=Math.round(1E3*Math.pow(c.r/255,2.2))/1E3;c.g=Math.round(1E3*Math.pow(c.g/255,2.2))/1E3;c.b=Math.round(1E3*Math.pow(c.b/255,2.2))/1E3;k(b).data("colorpicker").fields.eq(1).val(c.r).end().eq(2).val(c.g).end().eq(3).val(c.b).end()},g=function(a,b){k(b).data("colorpicker").fields.eq(4).val(a.h).end().eq(5).val(a.s).end().eq(6).val(a.b).end()},
...
"#"+ha(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,p=6-m.length;if(0<p){for(var q=[],n=0;n<p;n++)q.push("0");q.push(m);m=q.join("")}m=N(ca(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=Y({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
...
k(document).unbind("mouseup",E);k(document).unbind("mousemove",ga);return!1},w=function(a){a.preventDefault();a={cal:k(this).parent(),y:k(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,z);k(document).bind("mousemove touchmove",a,x)},x=function(a){var b=a;"undefined"!==typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,b.pageY-a.data.y)))/150,10)).get(0),
[a.data.preview]);return!1},z=function(b){a(b.data.cal.data("colorpicker").color,b.data.cal.get(0));c(b.data.cal.data("colorpicker").color,b.data.cal.get(0));k(document).unbind("mouseup touchend",z);k(document).unbind("mousemove touchmove",x);return!1},C=function(a){a.preventDefault();a={cal:k(this).parent(),pos:k(this).offset()};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,D);k(document).bind("mousemove touchmove",a,v)},v=function(a){var b=a;"undefined"!==
...
(f?document.documentElement.clientHeight:document.body.clientHeight))&&(g-=this.offsetHeight+176);e+356>a+c&&(e=Math.max(0,e-356));d.css({left:e+"px",top:g+"px"});0!=d.data("colorpicker").onShow.apply(this,[d.get(0)])&&d.show();k(document).bind("mousedown",{cal:d},W);return!1},W=function(a){Ia(a.data.cal.get(0),a.target,a.data.cal.get(0))||(0!=a.data.cal.data("colorpicker").onHide.apply(this,[a.data.cal.get(0)])&&a.data.cal.hide(),k(document).unbind("mousedown",W))},Ia=function(a,b,c){if(a==b)return!0;
if(a.contains)return a.contains(b);if(a.compareDocumentPosition)return!!(a.compareDocumentPosition(b)&16);for(b=b.parentNode;b&&b!=c;){if(b==a)return!0;b=b.parentNode}return!1},Y=function(a){return{h:Math.round(Math.min(360,Math.max(0,a.h))),s:Math.round(Math.min(100,Math.max(0,a.s))),b:Math.round(Math.min(100,Math.max(0,a.b)))}},ca=function(a){a=parseInt(-1<a.indexOf("#")?a.substring(1):a,16);return{r:a>>16,g:(a&65280)>>8,b:a&255}},N=function(a){var b={h:0,s:0,b:0},c=Math.min(a.r,a.g,a.b),d=Math.max(a.r,
...
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=N(ca(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=N(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=Y(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};window.addEventListener("resize",ca,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);ua.detect_mobile()||y(["gyro_use"],"disable");var g=I.get_url_params();Ua.enqueue([["manifest",Ua.AT_JSON,
"assets.json"]],function(a,b,c,La){X=a;Ca=document.getElementById("info_left_down");O=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Va.date_str();r(x,"quality","string");switch(K.get("quality")){case K.P_ULTRA:var k=0;break;case K.P_HIGH:k=1;break;case K.P_LOW:k=2;break;case K.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");I.set_onclick("reset",z);I.set_onclick("auto_rotate_cam",kb);I.set_onclick("pause",
v);I.set_onclick("resume",D);I.set_onclick("auto_view",Y);I.set_onclick("home",C);a=document.getElementById("manifest");if(X){c="";b=(b=I.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home - "+b[b.length-1];c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<X.length;b++){k=X[b];La=k.name;for(var k=k.items,R="",R=R+"<div data-role='collapsible' data-mini='true' >",
R=R+("<h6>"+La+"</h6>"),R=R+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,R=R+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+La)+'">'+m+"</a></li>");R+="</ul>";R+="</div>";c+=R}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";f();r(na,"anim_active_object",
"string");r(na,"animation","string");r(na,"anim_mix_factor","number");r(na,"anim_slot","number");r(na,"anim_cyclic","bool");r(na,"anim_frame_current","number");I.set_onclick("anim_play",N);I.set_onclick("anim_stop",Z);I.set_onclick("anim_play_all",da);I.set_onclick("anim_stop_all",ha);r(jb,"nla_frame_current","number");I.set_onclick("nla_play",Ha);I.set_onclick("nla_stop",ib);r(Ba,"shape_key_obj","string");r(Ba,"shape_key_name","string");r(Ba,"shape_key_value","number");r(oa,"material_name","string");
ea(oa,"material_diffuse_color");r(oa,"material_reflectivity","number");r(oa,"material_fresnel","number");r(oa,"material_fresnel_factor","number");r(oa,"material_parallax_scale","number");r(oa,"material_parallax_steps","number");r(H,"material_name","string");r(H,"shore_smoothing","bool");r(H,"absorb_factor","number");r(H,"sss_strength","number");r(H,"sss_width","number");ea(H,"water_fog_color");r(H,"water_fog_density","number");ea(H,"shallow_water_col");r(H,"shallow_water_col_fac","number");ea(H,"shore_water_col");
r(H,"shore_water_col_fac","number");r(H,"foam_factor","number");r(H,"norm_uv_velocity","number");r(H,"water_dynamic","bool");r(H,"waves_height","number");r(H,"waves_length","number");r(H,"dst_noise_scale0","number");r(H,"dst_noise_scale1","number");r(H,"dst_noise_freq0","number");r(H,"dst_noise_freq1","number");r(H,"dir_min_shore_fac","number");r(H,"dir_freq","number");r(H,"dir_noise_scale","number");r(H,"dir_noise_freq","number");r(H,"dir_min_noise_fac","number");r(H,"dst_min_fac","number");r(H,
"waves_hor_fac","number");r(Ma,"environment_energy","string");ea(Ma,"horizon_color");ea(Ma,"zenith_color");r(pa,"light_name","string");ea(pa,"light_color");r(pa,"pre_light_energy","number");r(pa,"rude_light_energy","number");r(pa,"light_spot_size","number");r(pa,"light_spot_blend","number");r(pa,"light_distance","number");ea(aa,"sky_color");r(aa,"rayleigh_brightness","number");r(aa,"mie_brightness","number");r(aa,"spot_brightness","number");r(aa,"scatter_strength","number");r(aa,"rayleigh_strength",
"number");r(aa,"mie_strength","number");r(aa,"rayleigh_collection_power","number");r(aa,"mie_collection_power","number");r(aa,"mie_distribution","number");r(Na,"date","string");r(Na,"day_time","number");r(Wa,"sun_horizontal_position","number");r(Wa,"sun_vertical_position","number");r(lb,"max_sun_angle","number");I.set_onclick("run_sun",mb);I.set_onclick("stop_sun",nb);r(ra,"csm_first_cascade_border","number");r(ra,"csm_last_cascade_border","number");r(ra,"self_shadow_polygon_offset","number");r(ra,
"self_shadow_normal_offset","number");r(ra,"first_cascade_blur_radius","number");r(ra,"last_cascade_blur_radius","number");r(fa,"ssao_quality","string");r(fa,"ssao_hemisphere","bool");r(fa,"ssao_blur_depth","bool");r(fa,"ssao_blur_discard_value","number");r(fa,"ssao_radius_increase","number");r(fa,"ssao_influence","number");r(fa,"ssao_dist_factor","number");r(fa,"ssao_only","bool");r(fa,"ssao_white","bool");r(va,"dof_distance","number");r(va,"dof_front","number");r(va,"dof_rear","number");r(va,"dof_power",
"number");r(va,"dof_on","bool");r(Oa,"god_rays_intensity","number");r(Oa,"god_rays_max_ray_length","number");r(Oa,"god_rays_steps","number");r(Da,"brightness","number");r(Da,"contrast","number");r(Da,"exposure","number");r(Da,"saturation","number");r(ia,"sfx_mix_mode","bool");a=Number("true"===F.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(ja,"stereo","string");a=F.get("stereo")||"NONE";wa.can_use_device(wa.DEVICE_HMD)||
(document.getElementById("stereo").options[2].setAttribute("disabled","disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(F.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);"HMD"==a&&Ea.enable_hmd(Ea.HMD_ALL_AXES_MOUSE_NONE);r(W,"gyro_use","bool");a=Number("true"===F.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Xa,"wind_dir","number");r(Xa,"wind_strength","number");
r(Ya,"mb_factor","number");r(Ya,"mb_decay_threshold","number");r(Pa,"bloom_key","number");r(Pa,"bloom_blur","number");r(Pa,"bloom_edge_lum","number");r(Fa,"small_glow_mask_coeff","number");r(Fa,"large_glow_mask_coeff","number");r(Fa,"small_glow_mask_width","number");r(Fa,"large_glow_mask_width","number");r(ob,"canvas_rf","number");r(Za,"wireframe_mode","string");ea(Za,"wireframe_edge_color","object");r(Q,"show_hud_debug_info","bool");r(M,"enable_gl_debug","bool");r(Ia,"outlining_overview_mode","bool");
a=""==F.get("outlining_overview_mode")?1:Number("true"===F.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");I.set_onclick("make_screenshot",pb);a=Number("true"===F.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");a=""==F.get("enable_gl_debug")?1:Number("true"===F.get("enable_gl_debug"));document.getElementById("enable_gl_debug").options[a].selected=
!0;$("#enable_gl_debug").slider("refresh");V();a=d();h(a,!1,!1,g&&g.load)},null)}function V(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ca&&A.can_select_objects()){$("#material_warning")[0].style.display=
"none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=T;d&&A.outlining_is_enabled(d)&&A.clear_outline_anim(d);b=A.pick_object(b,a);b&&qb.is_empty(b)||((T=b)?$a(b):ab(),c(),ka||(b?(ka=b,c(),I.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ka=null;c();I.disable_object_controls(a)})):g()))}}function g(){var a=A.get_active_camera();ka=a;c();I.enable_camera_controls(!1,!1,!1,Ga.get_container(),!0);J.create_kb_sensor_manifold(a,
"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ka=null;c();I.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=T)&&bb.target_zoom_object(a,b)})}function c(){if(Ca){var a=ka?la(ka):"NONE",b=T?la(T):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=T)&&(b=A.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=ka;
T&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+cb);Ca.innerHTML=a}}function d(){var a=F.get("last_item_name");if(!a)return null;for(var b=0;b<X.length;b++){var c=X[b];if(xa.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=
document.getElementById("default_scene");a&&(a.onclick=function(){ya=!1;clearTimeout(Qa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];ya=!1;clearTimeout(Qa);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<O.children.length;f++)O.children[f].style.visibility="hidden";if((f=I.get_url_params())&&f.load){var g=f.load.split("/");sa={load_file:f.load,name:g[g.length-1].split(".")[0],
animated_objects:[]}}else sa={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ba=G=null;if(!e)if(b){e=xa.keyfind("name",b.category,X)[0];e=xa.keyfind("name",b.item,e.items)[0];for(var h in e)sa[h]="load_file"==h?K.get_std_assets_path()+e[h]:e[h];F.set("last_item_name",b.item)}else F.set("last_item_name","");c&&(ua.clear_render_callback(),Ra.cleanup());Ga.get_canvas().removeEventListener("mousedown",a);L.clear_errors_warnings();b=sa.name;c=sa.load_file;h=document.getElementById("current_file");
h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Ra.load(c,l,p,d)}function l(b){Ga.get_canvas().addEventListener("mousedown",a,!1);T=null;q(sa);g();I.enable_debug_controls();P()&&rb.enable_mixer_controls();K.get("gyro_use")&&sb.enable_camera_rotation();"HMD"==K.get("stereo")&&(b=wa.get_device_by_type_element(wa.DEVICE_HMD),wa.register_device(b),Ea.enable_hmd(Ea.HMD_ALL_AXES_MOUSE_NONE));ua.set_render_callback(w);ya&&(Qa=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(A.get_active_camera(),
"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&T){if(d=T)b=tb,ub.get_object_center(d,!0,b),a=bb.get_translation(a,vb),cb=wb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=a.item,a=xa.keyfind("name",a.category,X)[0],b=xa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=X.indexOf(a);b=null;do b=X[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{ya=!1;return}}}else a=X[0],b=a.items[0],
a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();if(Ra.is_primary_loaded()){ca();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=
Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=L.get_error_quantity();(f=L.get_warning_quantity())||e?O.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):O.setAttribute("title",
"Loaded OK");d||c||(O.children[0].style.visibility="hidden",O.children[1].style.visibility="hidden",O.children[2].style.visibility="visible")}d&&!c&&(O.children[0].style.visibility="hidden",O.children[1].style.visibility="visible",O.children[2].style.visibility="hidden");c&&(O.children[0].style.visibility="visible",O.children[1].style.visibility="hidden",O.children[2].style.visibility="hidden")}function q(a){for(var c=A.get_active(),d=A.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=
ga(f,a);E(f,g)}}g=ga(c,a);E(c,g);$a=function(a){var c=qa.get_materials_names(a);b("material_name",c);db(a,c[0]);a=qa.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
a?(y(c,"enable"),A.get_water_mat_params(a),a.shallow_water_col&&ma("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&ma("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(ma("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):y(c,"disable")};xb();a=A.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(la(a[e]));b("light_name",c);0<a.length&&eb(a[0]);yb();zb();Ab();Bb();Cb();Db();Eb();Fb();Gb();Hb();Ib();Jb();ab();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);Na({date:e})}function ga(a,b){function c(a,b){for(var d in a)b[d]=
a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function E(a,c){A.set_active(a);A.get_active_camera();for(var d=[],e=A.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(G||(G=g),d.push(la(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");G?(y(f,"enable"),b("anim_active_object",d),na({anim_active_object:la(G)})):y(f,"disable");
d=["nla_play","nla_stop","nla_status","nla_frame_current","nla_playing"];f=["nla_frame_range"];if(S.check_nla()){S.check_nla_scripts()?(y(d,"disable"),document.getElementById("nla_status").innerHTML="CONTROLLED BY NLA SCRIPT"):y(d,"enable");y(f,"enable");var d=document.getElementById("nla_frame_current"),f=document.getElementById("nla_frame_range"),g=S.get_frame_start(),h=S.get_frame_end();-1!=g&&-1!=h?(f.innerHTML=g+" - "+h,d.min=""+g,d.max=""+h):f.innerHTML="N/A"}else y(d,"disable"),y(f,"disable");
d=[];for(f=0;f<e.length;f++)g=e[f],za.check_shape_keys(g)&&(ba||(ba=g),d.push(la(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ba?(y(e,"enable"),b("shape_key_obj",d),Ba({shape_key_obj:la(ba)})):y(e,"disable")}function w(a,b){A.get_active_camera();if(G){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(G,d)?(d=Math.round(B.get_frame(G,d)),parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):
c.innerHTML="STOPPED"}S.check_nla()&&(S.check_nla_scripts()||(c=document.getElementById("nla_status"),S.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(S.get_frame().toFixed(0)),S.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function x(a){F.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function z(){F.cleanup();var a=window.location.href.replace(/load=.*?(&|$)/,"").replace(/(&|\?)$/,"");window.location.href=a}function C(){h(null,
!0,!1,!0)}function v(){ua.pause()}function D(){ua.resume()}function P(){return"true"===F.get("sfx_mix_mode")?!0:!1}function Q(a){F.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function M(a){F.set("enable_gl_debug",a.enable_gl_debug);window.location.reload()}function ia(a){F.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function ja(a){F.set("stereo",a.stereo);window.location.reload()}function W(a){F.set("gyro_use",a.gyro_use);window.location.reload()}function Ia(a){F.set("outlining_overview_mode",
a.outlining_overview_mode);window.location.reload()}function Y(){ya=!0;m()}function ca(a){I.resize_to_container();a=Ga.get_canvas();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)"}function N(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&B.play(G,null,b)}function Z(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);
B.stop(G,a)}function da(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ta(a[b].value);B.play(c,null,B.SLOT_ALL)}}function ha(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ta(a[b].value);B.stop(c,null,B.SLOT_ALL)}}function Ha(){S.play()}function ib(){S.stop()}function Ba(a){if("shape_key_obj"in a){ba=ta(a.shape_key_obj);var c=za.get_shape_keys_names(ba);c.length?(b("shape_key_name",c),Aa=c[0],c=za.get_shape_key_value(ba,
Aa),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&(Aa=a.shape_key_name,c=za.get_shape_key_value(ba,Aa),u("shape_key_value",c));"shape_key_value"in a&&za.set_shape_key_value(ba,Aa,a.shape_key_value)}function jb(a){"nla_frame_current"in a&&!S.is_play()&&(a=parseInt(a.nla_frame_current),S.set_frame(a))}function na(a){if("anim_active_object"in a){G=ta(a.anim_active_object);var c=B.get_anim_names(G);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");
b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);Ta(G,c);Ja(G,c)}else b("animation",["N/A"]);Ka(G)}if("anim_slot"in a){if(!G)return;c=a.anim_slot;Ta(G,c);Ja(G,c);Ka(G)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.get_current_anim_name(G,c),"None"==a.animation?B.remove_slot_animation(G,c):(B.apply(G,a.animation,c),B.play(G,null,c)),Ja(G,c),Ka(G));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=B.get_slot_num_by_anim(G,
c),B.set_behavior(G,a.anim_cyclic?B.AB_CYCLIC:B.AB_FINISH_RESET,c));"anim_frame_current"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.is_play(G,c)||(d=parseInt(a.anim_frame_current),B.set_frame(G,d,c)));"anim_mix_factor"in a&&B.set_skel_mix_factor(G,a.anim_mix_factor)}function Ta(a,b){for(var c=B.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Ja(a,
b){u("anim_cyclic",Number(B.get_behavior(a,b)==B.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),d=B.get_anim_start_frame(a,b),e=B.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Ka(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),d=B.get_anim_type(a,c),c=0;c<b.length;c++){d=B.get_anim_type(a,c);switch(d){case B.OBJ_ANIM_TYPE_ARMATURE:d=
"ARMATURE";break;case B.OBJ_ANIM_TYPE_OBJECT:d="OBJECT";break;case B.OBJ_ANIM_TYPE_PARTICLES:d="PARTICLES";break;case B.OBJ_ANIM_TYPE_VERTEX:d="VERTEX";break;case B.OBJ_ANIM_TYPE_MATERIAL:d="MATERIAL";break;case B.OBJ_ANIM_TYPE_STATIC:d="STATIC";break;default:d="NONE"}b.eq(c);d=c+" ("+d+")";$("#anim_slot").children().eq(c).text(d)}$("#anim_slot").selectmenu();$("#anim_slot").selectmenu("refresh")}function zb(){var a=A.get_ssao_params(),b="ssao_quality ssao_hemisphere ssao_blur_depth ssao_blur_discard_value ssao_radius_increase ssao_influence ssao_dist_factor ssao_only ssao_white".split(" ");
if(a){y(b,"enable");for(var c=document.getElementById("ssao_quality"),b=a.ssao_quality,c=c.options,d=0;d<c.length;d++){var e=c[d];e.selected=e.value==b?!0:!1}$("#ssao_quality").selectmenu("refresh");b=Number(a.ssao_hemisphere);document.getElementById("ssao_hemisphere").options[b].selected=!0;$("#ssao_hemisphere").slider("refresh");b=Number(a.ssao_blur_depth);document.getElementById("ssao_blur_depth").options[b].selected=!0;$("#ssao_blur_depth").slider("refresh");u("ssao_blur_discard_value",a.blur_discard_value);
u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else y(b,"disable")}function fa(a){A.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=fb(document.getElementById("ssao_quality")));"ssao_hemisphere"in
...
A.set_ssao_params(b)}function Cb(){var a=A.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(y(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):y(b,"disable")}function Da(a){var b=A.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),A.set_color_correction_params(b))}function fb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function yb(){var a=A.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return y(b,"disable"),document.getElementById("csm_resolution").innerHTML=
"",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML="",null;y(b,"enable");gb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",
a.last_cascade_blur_radius)):y(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):y(["csm_first_cascade_border","csm_last_cascade_border","last_cascade_blur_radius"],"disable")}function ra(a){var b={};"csm_first_cascade_border"in a&&(b.csm_first_cascade_border=a.csm_first_cascade_border);"csm_last_cascade_border"in a&&(b.csm_last_cascade_border=a.csm_last_cascade_border);"self_shadow_polygon_offset"in a&&(b.self_shadow_polygon_offset=a.self_shadow_polygon_offset);"self_shadow_normal_offset"in
a&&(b.self_shadow_normal_offset=a.self_shadow_normal_offset);"first_cascade_blur_radius"in a&&(b.first_cascade_blur_radius=a.first_cascade_blur_radius);"last_cascade_blur_radius"in a&&(b.last_cascade_blur_radius=a.last_cascade_blur_radius);A.set_shadow_params(b);gb(A.get_shadow_params())}function gb(a){document.getElementById("csm_resolution").innerHTML="&nbsp;&nbsp;"+a.csm_resolution;if(a.enable_csm){document.getElementById("csm_num").innerHTML=" "+a.csm_num;for(var b=["csm_borders","blur_radii"],
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function xb(){var a=A.get_environment_colors();u("environment_energy",a[0]);ma("horizon_color",a[1]);ma("zenith_color",a[2])}function Ma(a){("environment_energy"in a||"horizon_color"in a||"zenith_color"in a)&&A.set_environment_colors(a.environment_energy,a.horizon_color,a.zenith_color)}function Za(a){var b={};if("string"==typeof a.wireframe_mode)switch(fb(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=
L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function pb(){Kb.shot()}function Fb(){var a=A.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
if(!a)return y(b,"disable"),null;y(b,"enable");ma("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);u("spot_brightness",a.spot_brightness);u("scatter_strength",a.scatter_strength);u("rayleigh_strength",a.rayleigh_strength);u("mie_strength",a.mie_strength);u("rayleigh_collection_power",a.rayleigh_collection_power);u("mie_collection_power",a.mie_collection_power);u("mie_distribution",a.mie_distribution)}function aa(a){var b={};"sky_color"in a&&
...
a&&(b.mie_collection_power=a.mie_collection_power);"mie_distribution"in a&&(b.mie_distribution=a.mie_distribution);A.set_sky_params(b)}function db(a,b){var c=qa.get_material_extended_params(a,b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return y(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=qa.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);
y(d,"enable");ma("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",c.parallax_scale);u("material_parallax_steps",c.parallax_steps)}function oa(a){var b=T;"material_name"in a&&db(b,a.material_name);if("material_diffuse_color"in a){var c=a.material_diffuse_color.slice();c.push(1);qa.set_diffuse_color(b,$("#material_name").val(),c)}c={};"material_reflectivity"in
a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);qa.set_material_extended_params(b,$("#material_name").val(),c);A.update_scene_materials_params()}function H(a){var b=T,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");
if(!b)return null;var d={},e=$("#water_dynamic").val(),f=$("#shore_smoothing").val();Boolean(Number(e))?y(c,"enable"):y(c,"disable");Boolean(Number(f))?y(["absorb_factor"],"enable"):y(["absorb_factor"],"disable");"shore_smoothing"in a&&(d.shore_smoothing=a.shore_smoothing);"absorb_factor"in a&&(d.absorb_factor=a.absorb_factor);"water_fog_color"in a&&(d.water_fog_color=a.water_fog_color);"water_fog_density"in a&&(d.water_fog_density=a.water_fog_density);"shallow_water_col"in a&&(d.shallow_water_col=
...
"dir_noise_freq"in a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!qa.set_water_material_params(b,$("#material_name").val(),d))return null;A.update_scene_materials_params();A.set_water_params(d)}function eb(a){if(a=U.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);ma("light_color",a.light_color);
u("rude_light_energy",c);u("pre_light_energy",b);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(y(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Lb))):y(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(y(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",
a.light_distance)):y(["light_distance"],"disable")}}function pa(a){"light_name"in a&&eb(ta(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*
Mb));"light_spot_blend"in a&&(b.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(b.light_distance=parseFloat(a.light_distance));a=ta($("#light_name").val());U.set_light_params(a,b);b=U.get_light_params(a).light_energy.toFixed(2);$("#light_energy").text(b)}function Eb(){var a=U.get_sun_params(),b=["sun_horizontal_position","sun_vertical_position"];if(!a)return y(b,"disable"),null;u("sun_horizontal_position",a.hor_position);u("sun_vertical_position",a.vert_position)}function Wa(a){var b=
{};"sun_horizontal_position"in a&&(b.hor_position=parseFloat(a.sun_horizontal_position),b.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(b.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),b.vert_position=parseFloat(a.sun_vertical_position));U.set_sun_params(b)}function lb(a){a=parseFloat(a.max_sun_angle);U.set_max_sun_angle(a)}function Na(a){"day_time"in a&&U.set_day_time(a.day_time);"date"in a&&U.set_date(new Date(a.date))}
function mb(){var a=0,b=parseFloat(document.getElementById("day_time").value),c=J.create_elapsed_sensor(),d=U.get_lamps("SUN")[0];J.create_sensor_manifold(d,"ELAPSED",J.CT_CONTINUOUS,[c],function(a){return a[0]},function(c,d,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,c=J.get_sensor_value(c,d,0),b+=c*a/3600,24<b&&(b-=Math.floor(b)),u("day_time",b))})}function Jb(){var a=U.get_lamps("SUN")[0],b=["sn-ui-grid-b"];U.get_lamps().length?a||y("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),
"disable"):y(b,"disable")}function ab(){y("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");y("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function nb(){var a=U.get_lamps("SUN")[0];J.check_sensor_manifolds(a)&&J.remove_sensor_manifold(a,"ELAPSED")}function Ab(){var a=A.get_dof_params(),b="dof_distance dof_object dof_front dof_rear dof_power dof_on".split(" ");if(a){u("dof_front",a.dof_front);u("dof_rear",a.dof_rear);u("dof_power",a.dof_power);$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=la(a.dof_object);$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");
$("#dof_object").parent().removeClass("ui-disabled")}else u("dof_distance",a.dof_distance),b.splice(1,1),$("#dof_distance").parent().removeClass("ui-disabled"),$("#dof_object").parent().addClass("ui-disabled");y(b,"enable");a=0<a.dof_distance?1:0;document.getElementById("dof_on").options[a].selected=!0;$("#dof_on").slider("refresh")}else y(b,"disable")}function va(a){var b={};"dof_distance"in a&&Number($("#dof_on").val())&&(b.dof_distance=a.dof_distance);"dof_front"in a&&(b.dof_front=a.dof_front);
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean(a.dof_on));A.set_dof_params(b)}function Bb(){var a=A.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(y(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):y(b,"disable")}function Oa(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=
a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);A.set_god_rays_params(b)}function ob(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),ca())}function Gb(){var a=A.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(y(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",a.mb_decay_threshold))):y(b,"disable")}function Ya(a){var b={};"mb_factor"in a&&
(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);A.set_mb_params(b)}function Hb(){var a=A.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(y(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):y(b,"disable")}function Pa(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);
A.set_bloom_params(b)}function Ib(){var a=A.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(y(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):y(b,"disable")}function Fa(a){var b={};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);
"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);A.set_glow_material_params(b)}function ma(a,b){var c=Sa.rgb_to_css(b),d=Sa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",d)}function Db(){var a=A.get_wind_params(),b=["wind_dir","wind_strength"];a?
(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):y(b,"disable")}function Xa(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);A.set_wind_params(b)}function u(a,b){var c=$("#"+a);c.val(b);c.slider("refresh")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),
null}a(e)})}function ea(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Sa.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function kb(){Nb.auto_rotate(.3)}function y(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function la(a){return A.get_object_name_hierarchy(a).join("->")}function ta(a){return A.get_object_by_dupli_name_list(a.split("->"))}
var B=n("animation"),I=n("app"),Ua=n("assets"),bb=n("camera"),Nb=n("camera_anim"),K=n("config");n("constraints");var Ga=n("container"),J=n("controls"),Ra=n("data"),L=n("debug"),za=n("geometry"),sb=n("gyroscope"),wa=n("input"),U=n("lights"),ua=n("main"),Ea=n("hmd"),rb=n("mixer"),qa=n("material"),S=n("nla"),qb=n("objects"),Sa=n("rgb"),Kb=n("screenshooter"),A=n("scenes"),F=n("storage"),ub=n("transform"),xa=n("util"),Va=n("version"),wb=n("vec3"),hb="DEBUG"===Va.type(),Mb=Math.PI/180,Lb=180/Math.PI,tb=
new Float32Array(3),vb=new Float32Array(3),ya=!1,Qa,X=null,G=null,ba=null,Aa="",sa=null,Ca=null,O=null,T=null,$a=function(){},ka=null,cb=null;k.init=function(){F.init("b4w_viewer");var a=F.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("stereo",F.get("stereo")||"NONE");K.set("gyro_use","true"===F.get("gyro_use"));""==F.get("outlining_overview_mode")?K.set("outlining_overview_mode",
!0):K.set("outlining_overview_mode","true"===F.get("outlining_overview_mode"));I.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:""==F.get("enable_gl_debug")?!0:"true"===F.get("enable_gl_debug"),show_hud_debug_info:"true"===F.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:P(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!hb,assets_min50_available:!hb,console_verbose:!0,physics_enabled:!0,wireframe_debug:!0})}});
