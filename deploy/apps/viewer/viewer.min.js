...
c.data("colorpicker").onChange.apply(c,[h,N(h),X(h)])},pa=function(b){g(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},za=function(){k=0<this.parentNode.className.indexOf("_hex")?70:65;g(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");g(this).parent().addClass("colorpicker_focus")},Aa=function(b){var c=g(this).parent().find("input").focus();b={el:g(this).parent().addClass("colorpicker_slider"),max:0<this.parentNode.className.indexOf("_hsb_h")?
...
g(document).unbind("mouseup",ha);g(document).unbind("mousemove",ia);return!1},Ba=function(b){b.preventDefault();b={cal:g(this).parent(),y:g(this).offset().top};b.preview=b.cal.data("colorpicker").livePreview;g(document).bind("mouseup touchend",b,qa);g(document).bind("mousemove touchmove",b,ra)},ra=function(b){var c=b;"undefined"!==typeof event&&event.touches&&(c=event.touches[0]);O.apply(b.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,c.pageY-b.data.y)))/
150,10)).get(0),[b.data.preview]);return!1},qa=function(b){K(b.data.cal.data("colorpicker").color,b.data.cal.get(0));x(b.data.cal.data("colorpicker").color,b.data.cal.get(0));g(document).unbind("mouseup touchend",qa);g(document).unbind("mousemove touchmove",ra);return!1},Ca=function(b){b.preventDefault();b={cal:g(this).parent(),pos:g(this).offset()};b.preview=b.cal.data("colorpicker").livePreview;g(document).bind("mouseup touchend",b,ja);g(document).bind("mousemove touchmove",b,sa)},sa=function(b){var c=
...
sa);return!1},Da=function(b){g(this).addClass("colorpicker_focus")},Ea=function(b){g(this).removeClass("colorpicker_focus")},Fa=function(b){b=g(this).parent();var c=b.data("colorpicker").color;b.data("colorpicker").origColor=c;ea(c,b.get(0));b.data("colorpicker").onSubmit(c,N(c),X(c),b.data("colorpicker").el)},Ga=function(b){var c=g("body"),h=c.data("colorpickerId"),u=g(this).data("colorpickerId");h&&h===u?(g(document).trigger("mousedown"),c.data("colorpickerId",null)):(ta.call(this,b),c.data("colorpickerId",
u))},ta=function(b){var c,h,u=g("#"+g(this).data("colorpickerId"));u.data("colorpicker").onBeforeShow.apply(this,[u.get(0)]);var k=g(this).offset(),r="CSS1Compat"==document.compatMode;b=window.pageXOffset||(r?document.documentElement.scrollLeft:document.body.scrollLeft);c=window.pageYOffset||(r?document.documentElement.scrollTop:document.body.scrollTop);h=window.innerWidth||(r?document.documentElement.clientWidth:document.body.clientWidth);var x=k.top+this.offsetHeight,k=k.left;x+176>c+(window.innerHeight||
(r?document.documentElement.clientHeight:document.body.clientHeight))&&(x-=this.offsetHeight+176);k+356>b+h&&(k=Math.max(0,k-356));u.css({left:k+"px",top:x+"px"});0!=u.data("colorpicker").onShow.apply(this,[u.get(0)])&&u.show();g(document).bind("mousedown",{cal:u},ua);return!1},ua=function(b){va(b.data.cal.get(0),b.target,b.data.cal.get(0))||(0!=b.data.cal.data("colorpicker").onHide.apply(this,[b.data.cal.get(0)])&&b.data.cal.hide(),g(document).unbind("mousedown",ua))},va=function(b,c,h){if(b==c)return!0;
...
x(b,c.get(0));r(b,c.get(0));T(b,c.get(0));ea(b,c.get(0));Y(b,c.get(0))}})}}}();g.fn.extend({ColorPicker:k.init,ColorPickerHide:k.hidePicker,ColorPickerShow:k.showPicker,ColorPickerSetColor:k.setColor})})(jQuery);b4w.register("viewer_main",function(g,k){function eb(a,d){if(!d)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};v.enable_controls();window.addEventListener("resize",va,!1);var b=document.createEvent("CustomEvent");b.initEvent("resize",!1,!1);window.dispatchEvent(b);Q.detect_mobile()||m(["gyro_use"],"disable");var Pa=v.get_url_params();Qa.enqueue([["manifest",
Qa.AT_JSON,"assets.json"]],function(a,d,b,c){E=a;wa=document.getElementById("info_left_down");z=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Ra.date_str();e(ra,"quality","string");switch(y.get("quality")){case y.P_ULTRA:var G=0;break;case y.P_HIGH:G=1;break;case y.P_LOW:G=2;break;case y.P_CUSTOM:G=3}document.getElementById("quality").options[G].selected=!0;$("#quality").selectmenu("refresh");v.set_onclick("reset_memory",qa);v.set_onclick("auto_rotate_cam",
gb);v.set_onclick("pause",Ca);v.set_onclick("resume",sa);v.set_onclick("auto_view",ua);a=document.getElementById("manifest");if(E){b="";d=(d=v.get_url_params())&&d.load?d.load.split("/"):["misc","logo.json"];d="Home ("+d[d.length-1]+")";b=b+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+d+"</a></h6>");b+="</div>";for(d=0;d<E.length;d++){G=E[d];c=G.name;for(var G=G.items,f="",f=f+"<div data-role='collapsible' data-mini='true' >",
...
e(q,"norm_uv_velocity","number");e(q,"water_dynamic","bool");e(q,"waves_height","number");e(q,"waves_length","number");e(q,"dst_noise_scale0","number");e(q,"dst_noise_scale1","number");e(q,"dst_noise_freq0","number");e(q,"dst_noise_freq1","number");e(q,"dir_min_shore_fac","number");e(q,"dir_freq","number");e(q,"dir_noise_scale","number");e(q,"dir_noise_freq","number");e(q,"dir_min_noise_fac","number");e(q,"dst_min_fac","number");e(q,"waves_hor_fac","number");e(Ha,"environment_energy","string");H(Ha,
"horizon_color");H(Ha,"zenith_color");e(ba,"light_name","string");H(ba,"light_color");e(ba,"light_energy","number");e(ba,"light_spot_size","number");e(ba,"light_spot_blend","number");e(ba,"light_distance","number");H(I,"sky_color");e(I,"rayleigh_brightness","number");e(I,"mie_brightness","number");e(I,"spot_brightness","number");e(I,"scatter_strength","number");e(I,"rayleigh_strength","number");e(I,"mie_strength","number");e(I,"rayleigh_collection_power","number");e(I,"mie_collection_power","number");
e(I,"mie_distribution","number");e(Ia,"date","string");e(Ia,"day_time","number");e(Sa,"sun_horizontal_position","number");e(Sa,"sun_vertical_position","number");e(hb,"max_sun_angle","number");v.set_onclick("run_sun",ib);v.set_onclick("stop_sun",jb);e(ca,"csm_first_cascade_border","number");e(ca,"csm_last_cascade_border","number");e(ca,"self_shadow_polygon_offset","number");e(ca,"self_shadow_normal_offset","number");e(ca,"first_cascade_blur_radius","number");e(ca,"last_cascade_blur_radius","number");
e(A,"ssao_quality","string");e(A,"ssao_hemisphere","bool");e(A,"ssao_blur_depth","bool");e(A,"ssao_blur_discard_value","number");e(A,"ssao_radius_increase","number");e(A,"ssao_influence","number");e(A,"ssao_dist_factor","number");e(A,"ssao_only","bool");e(A,"ssao_white","bool");e(Ja,"fog_density","number");e(Ja,"fog_density1000","number");H(Ja,"fog_color");e(ka,"dof_distance","number");e(ka,"dof_front","number");e(ka,"dof_rear","number");e(ka,"dof_power","number");e(ka,"dof_on","bool");e(Ka,"god_rays_intensity",
"number");e(Ka,"god_rays_max_ray_length","number");e(Ka,"god_rays_steps","number");e(U,"brightness","number");e(U,"contrast","number");e(U,"exposure","number");e(U,"saturation","number");e(Ea,"sfx_mix_mode","bool");a=Number("true"===t.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");e(Fa,"anaglyph_use","bool");a=Number("true"===t.get("anaglyph_use"));document.getElementById("anaglyph_use").options[a].selected=!0;$("#anaglyph_use").slider("refresh");
e(Ga,"gyro_use","bool");a=Number("true"===t.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");e(Ta,"wind_dir","number");e(Ta,"wind_strength","number");e(Ua,"mb_factor","number");e(Ua,"mb_decay_threshold","number");e(La,"bloom_key","number");e(La,"bloom_blur","number");e(La,"bloom_edge_lum","number");e(xa,"small_glow_mask_coeff","number");e(xa,"large_glow_mask_coeff","number");e(xa,"small_glow_mask_width","number");e(xa,"large_glow_mask_width",
"number");e(kb,"canvas_rf","number");e(Va,"wireframe_mode","string");H(Va,"wireframe_edge_color","object");e(Da,"show_hud_debug_info","bool");e(ta,"outlining_overview_mode","bool");a=""==t.get("outlining_overview_mode")?1:Number("true"===t.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");v.set_onclick("make_screenshot",lb);a=Number("true"===t.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=
!0;$("#show_hud_debug_info").slider("refresh");ya();a=T();Z(a,!1,!1,Pa&&Pa.load)},null)}function ya(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var d=this.parentElement.parentElement.children[0].getAttribute("id");if(d){var b=parseFloat(document.getElementById(d).value),c=parseFloat(document.getElementById(d).getAttribute("step"));188==a.keyCode&&f(d,b-c);190==a.keyCode&&f(d,b+c)}})})}function K(a){if(wa){$("#material_warning")[0].style.display=
"none";a.preventDefault&&a.preventDefault();var d=a.clientX;a=a.clientY;var b=C;b&&l.clear_outline_anim(b);(C=d=l.pick_object(d,a))?Wa(d):Xa();x();R||(d?(R=d,x(),v.enable_object_controls(d),w.create_kb_sensor_manifold(d,"QUIT",w.CT_SHOT,w.KEY_Q,function(a,d,b,c){R=null;x();v.disable_object_controls(a)})):S())}}function S(){var a=l.get_active_camera();R=a;x();v.enable_camera_controls();w.create_kb_sensor_manifold(a,"QUIT",w.CT_SHOT,w.KEY_Q,function(a,d,b,c){R=null;x();v.disable_camera_controls(a);
w.remove_sensor_manifold(a,"ZOOM_TO")});var d=w.create_keyboard_sensor(w.KEY_Z),b=w.create_keyboard_sensor(w.KEY_DEC_POINT);w.create_sensor_manifold(a,"ZOOM_TO",w.CT_SHOT,[d,b],function(a){return a[0]||a[1]},function(a,d,b){(d=C)&&Ya.zoom_object(a,d)})}function x(){if(wa){var a="CONTROLLED: "+(R?String(R.name):"NONE")+" | SELECTED: "+(C?String(C.name):"NONE"),d=C;d&&(d=l.get_type_mesh_object(d))&&(a+=" | TYPE: "+d);d=R;C&&d&&"CAMERA"===d.type&&(a+=" | DISTANCE: "+Za);wa.innerHTML=a}}function T(){var a=
t.get("last_item_name");if(!a)return null;for(var d=0;d<E.length;d++){var b=E[d];if(la.keyfind("name",a,b.items)[0])return{category:b.name,item:a}}return null}function r(a,d){var b=document.getElementById(a);b.innerHTML="";for(var c=0;c<d.length;c++){var e=document.createElement("option");e.text=e.value=d[c];0===c&&(e.selected=!0);b.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function ea(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){ma=!1;clearTimeout(Ma);
Z(null,!0,!1,!0)})}function Y(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var d=a.split("__SEPARATOR__");a=d[1];d=d[0].split("MANIFEST_ITEM_")[1];ma=!1;clearTimeout(Ma);Z({category:a,item:d},!0,!1,!1)}}function Z(a,d,b,c){if(z)for(var e=0;e<z.children.length;e++)z.children[e].style.visibility="hidden";if((e=v.get_url_params())&&e.load){var f=e.load.split("/");da={load_file:e.load,name:f[f.length-1].split(".")[0],animated_objects:[]}}else da={load_file:y.get_std_assets_path()+"misc/logo.json",
name:"Logo",animated_objects:[]};J=n=null;if(!c)if(a){c=la.keyfind("name",a.category,E)[0];c=la.keyfind("name",a.item,c.items)[0];for(var g in c)da[g]="load_file"==g?y.get_std_assets_path()+c[g]:c[g];t.set("last_item_name",a.item)}else t.set("last_item_name","");d&&(Q.clear_render_callback(),Na.cleanup());Q.get_canvas_elem().removeEventListener("mousedown",K);B.clear_errors_warnings();a=da.name;d=da.load_file;g=document.getElementById("current_file");g.innerHTML=a;g.setAttribute("title",a+" ("+d+
")");Na.load(d,O,za,b)}function O(a){Q.get_canvas_elem().addEventListener("mousedown",K,!1);C=null;Aa(da);S();v.enable_debug_controls();ja()&&mb.enable_mixer_controls();y.get("gyro_use")&&nb.enable_camera_rotation();Q.set_render_callback(Ba);ma&&(Ma=setTimeout(pa,1E3));a=w.create_elapsed_sensor();w.create_sensor_manifold(l.get_active_camera(),"TO_OBJ",w.CT_CONTINUOUS,[a],null,function(a,b,c){if(1==c&&C){if(c=C)b=ob,pb.get_object_center(c,!0,b),a=Ya.get_eye(a,qb),Za=rb.dist(b,a).toFixed(3);x()}})}
function pa(){var a=T();if(a){var d=a.item,a=la.keyfind("name",a.category,E)[0],d=la.keyfind("name",d,a.items)[0],d=a.items.indexOf(d);if(d=a.items[d+1])a={category:a.name,item:d.name};else if(a=E.indexOf(a),a=E[a+1])a={category:a.name,item:a.items[0].name};else{ma=!1;return}}else a=E[0],d=a.items[0],a={category:a.name,item:d.name};Z(a,!0,!0,!1)}function za(a,d){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*d/1E3)/10+"s)";var b=B.get_error_quantity(),c=B.get_warning_quantity();
if(Na.is_primary_loaded()){var e=B.num_vertices(),f=B.num_triangles(),g=B.num_draw_calls(),h=B.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=B.geometry_stats(),f=B.num_textures(),g=B.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+
"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=B.get_error_quantity();(f=B.get_warning_quantity())||e?z.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):z.setAttribute("title","Loaded OK");c||b||(z.children[0].style.visibility="hidden",z.children[1].style.visibility="hidden",z.children[2].style.visibility="visible")}c&&!b&&(z.children[0].style.visibility="hidden",z.children[1].style.visibility=
"visible",z.children[2].style.visibility="hidden");b&&(z.children[0].style.visibility="visible",z.children[1].style.visibility="hidden",z.children[2].style.visibility="hidden")}function Aa(a){for(var d=l.get_active(),b=l.get_scenes(),c=0;c<b.length;c++){var e=b[c];if(e!==d){var g=ia(e,a);ha(e,g)}}g=ia(d,a);ha(d,g);Wa=function(a){var d=W.get_materials_names(a);r("material_name",d);$a(a,d[0]);a=W.get_water_material_params(a,d[0]);d="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
...
a.dst_min_fac),f("waves_hor_fac",a.waves_hor_fac)):m(d,"disable")};sb();a=l.get_all_objects("LAMP");d=[];for(c=0;c<a.length;c++)d.push(a[c].name);r("light_name",d);0<a.length&&ab(a[0]);tb();u();ub();vb();wb();fb();xb();yb();zb();Ab();Bb();Cb();Db();Xa();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");c=new Date(document.getElementById("date").value);Ia({date:c})}function ia(a,d){function b(a,d){for(var c in a)d[c]=
...
m(e,"disable");b=[];for(e=0;e<c.length;e++)f=c[e],na.check_shape_keys(f)&&(J||(J=f),b.push(l.get_object_name(f)));c=["shape_key_obj","shape_key_name","shape_key_value"];J?(m(c,"enable"),r("shape_key_obj",b),aa({shape_key_obj:l.get_object_name(J)})):m(c,"disable")}function Ba(a,d){l.get_active_camera();if(n){var b=parseInt(document.getElementById("anim_slot").value),c=Math.round(p.get_frame(n,b));parseInt($("#anim_frame_current").val())!==c&&f("anim_frame_current",c);c=document.getElementById("anim_status");
p.is_play(n,b)?c.innerHTML="PLAYING":c.innerHTML="STOPPED"}D.check_nla()&&(D.check_nla_scripts()||(c=document.getElementById("nla_status"),D.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),c=parseInt(D.get_frame()),parseInt($("#nla_frame_current").val())!==c&&f("nla_frame_current",c))}function ra(a){t.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function qa(){t.cleanup();window.location.reload()}function Ca(){Q.pause()}function sa(){Q.resume()}function ja(){return"true"===
t.get("sfx_mix_mode")?!0:!1}function Da(a){t.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function Ea(a){t.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function Fa(a){t.set("anaglyph_use",a.anaglyph_use);window.location.reload()}function Ga(a){t.set("gyro_use",a.gyro_use);window.location.reload()}function ta(a){t.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}function ua(){ma=!0;pa()}function va(a){v.resize_to_container();
...
var d=na.get_shape_keys_names(J);d.length?(r("shape_key_name",d),oa=d[0],d=na.get_shape_key_value(J,oa),f("shape_key_value",d)):r("shape_key_name",["N/K"])}"shape_key_name"in a&&(oa=a.shape_key_name,d=na.get_shape_key_value(J,oa),f("shape_key_value",d));"shape_key_value"in a&&na.set_shape_key_value(J,oa,a.shape_key_value)}function N(a){"nla_frame_current"in a&&!D.is_play()&&(a=parseInt(a.nla_frame_current),D.set_frame(a))}function L(a){if("anim_active_object"in a){n=l.get_object_by_name(a.anim_active_object);
...
"disable")}function A(a){l.get_ssao_params();var d={};"ssao_quality"in a&&(d.ssao_quality=bb(document.getElementById("ssao_quality")));"ssao_hemisphere"in a&&(d.ssao_hemisphere=Number(a.ssao_hemisphere));"ssao_blur_depth"in a&&(d.ssao_blur_depth=Number(a.ssao_blur_depth));"ssao_blur_discard_value"in a&&(d.ssao_blur_discard_value=a.ssao_blur_discard_value);"ssao_radius_increase"in a&&(d.ssao_radius_increase=a.ssao_radius_increase);"ssao_influence"in a&&(d.ssao_influence=a.ssao_influence);"ssao_dist_factor"in
a&&(d.ssao_dist_factor=a.ssao_dist_factor);"ssao_only"in a&&(d.ssao_only=Number(a.ssao_only));"ssao_white"in a&&(d.ssao_white=Number(a.ssao_white));l.set_ssao_params(d)}function fb(){var a=l.get_color_correction_params(),d=["brightness","contrast","exposure","saturation"];a?(m(d,"enable"),f("brightness",a.brightness),f("contrast",a.contrast),f("exposure",a.exposure),f("saturation",a.saturation)):m(d,"disable")}function U(a){var d=l.get_color_correction_params();d&&(d={},"brightness"in a&&(d.brightness=
parseFloat(a.brightness)),"contrast"in a&&(d.contrast=parseFloat(a.contrast)),"exposure"in a&&(d.exposure=parseFloat(a.exposure)),"saturation"in a&&(d.saturation=parseFloat(a.saturation)),l.set_color_correction_params(d))}function bb(a){a=a.options;for(var d=0;d<a.length;d++){var b=a[d];if(b.selected)return b.value}}function ub(){var a=l.get_fog_color_density();.2<a[3]?f("fog_density",a[3]):f("fog_density1000",1E3*a[3]);M("fog_color",a)}function Ja(a){var d=l.get_fog_color_density();"fog_density"in
a&&(d[3]=a.fog_density);"fog_density1000"in a&&(d[3]=a.fog_density1000/1E3);"fog_color"in a&&(d[0]=a.fog_color[0],d[1]=a.fog_color[1],d[2]=a.fog_color[2]);l.set_fog_color_density(d)}function tb(){var a=l.get_shadow_params(),d="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return m(d,"disable"),document.getElementById("csm_resolution").innerHTML=
"",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML="",null;m(d,"enable");cb(a);f("self_shadow_polygon_offset",a.self_shadow_polygon_offset);f("self_shadow_normal_offset",a.self_shadow_normal_offset);f("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(f("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(f("csm_last_cascade_border",a.csm_last_cascade_border),f("last_cascade_blur_radius",
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function sb(){var a=l.get_environment_colors();f("environment_energy",a[0]);M("horizon_color",a[1]);M("zenith_color",a[2])}function Ha(a){"environment_energy"in a&&l.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&l.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&l.set_environment_colors(null,
null,a.zenith_color)}function Va(a){var d={};"string"==typeof a.wireframe_mode&&(d.wireframe_mode=bb(document.getElementById("wireframe_mode")));"object"==typeof a.wireframe_edge_color&&(d.wireframe_edge_color=a.wireframe_edge_color);B.set_debug_params(d)}function lb(){Eb.shot()}function zb(){var a=l.get_sky_params(),d="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
...
"dir_noise_freq"in a&&(c.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(c.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(c.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(c.waves_hor_fac=a.waves_hor_fac);if(!W.set_water_material_params(d,$("#material_name").val(),c))return null;l.update_scene_materials_params();l.set_water_params(c)}function ab(a){if(a=F.get_light_params(a)){M("light_color",a.light_color);f("light_energy",a.light_energy);var d=a.light_type;$("#light_type").text(d);
"SPOT"==a.light_type?(m(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&f("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&f("light_spot_size",Math.round(a.light_spot_size*Fb))):m(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(m(["light_distance"],"enable"),"light_distance"in a&&f("light_distance",a.light_distance)):m(["light_distance"],"disable")}}function ba(a){"light_name"in a&&ab(l.get_object_by_name(a.light_name));
var d={};"light_color"in a&&(d.light_color=a.light_color);"light_energy"in a&&(d.light_energy=parseFloat(a.light_energy));"light_spot_size"in a&&(d.light_spot_size=parseFloat(a.light_spot_size*Gb));"light_spot_blend"in a&&(d.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(d.light_distance=parseFloat(a.light_distance));a=l.get_object_by_name($("#light_name").val());F.set_light_params(a,d)}function yb(){var a=F.get_sun_params(),d=["sun_horizontal_position","sun_vertical_position"];
if(!a)return m(d,"disable"),null;f("sun_horizontal_position",a.hor_position);f("sun_vertical_position",a.vert_position)}function Sa(a){var d={};"sun_horizontal_position"in a&&(d.hor_position=parseFloat(a.sun_horizontal_position),d.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(d.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),d.vert_position=parseFloat(a.sun_vertical_position));F.set_sun_params(d)}function hb(a){a=
parseFloat(a.max_sun_angle);F.set_max_sun_angle(a)}function Ia(a){"day_time"in a&&F.set_day_time(a.day_time);"date"in a&&F.set_date(new Date(a.date))}function ib(){var a=0,d=parseFloat(document.getElementById("day_time").value),b=w.create_elapsed_sensor(),c=F.get_lamps("SUN")[0];w.create_sensor_manifold(c,"ELAPSED",w.CT_CONTINUOUS,[b],function(a){return a[0]},function(b,c,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,b=w.get_sensor_value(b,c,0),d+=b*a/3600,24<d&&(d-=Math.floor(d)),
f("day_time",d))})}function Db(){var a=F.get_lamps("SUN")[0],b=["sn-ui-grid-b"];F.get_lamps().length?a||m("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),"disable"):m(b,"disable")}function Xa(){m("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");m("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function jb(){var a=F.get_lamps("SUN")[0];w.check_sensor_manifolds(a)&&w.remove_sensor_manifold(a,"ELAPSED")}function vb(){var a=l.get_dof_params(),b="dof_distance dof_object dof_front dof_rear dof_power dof_on".split(" ");if(a){f("dof_front",a.dof_front);f("dof_rear",a.dof_rear);f("dof_power",a.dof_power);$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=a.dof_object.name;$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");
$("#dof_object").parent().removeClass("ui-disabled")}else f("dof_distance",a.dof_distance),b.splice(1,1),$("#dof_distance").parent().removeClass("ui-disabled"),$("#dof_object").parent().addClass("ui-disabled");m(b,"enable");a=0<a.dof_distance?1:0;document.getElementById("dof_on").options[a].selected=!0;$("#dof_on").slider("refresh")}else m(b,"disable")}function ka(a){var b={};"dof_distance"in a&&Number($("#dof_on").val())&&(b.dof_distance=a.dof_distance);"dof_front"in a&&(b.dof_front=a.dof_front);
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean($("#dof_on").val()),b.dof_distance=Number(a.dof_on)?parseFloat($("#dof_distance").val()):0);l.set_dof_params(b)}function wb(){var a=l.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(m(b,"enable"),a&&(f("god_rays_intensity",a.god_rays_intensity),f("god_rays_max_ray_length",a.god_rays_max_ray_length),f("god_rays_steps",a.god_rays_steps))):m(b,
"disable")}function Ka(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);l.set_god_rays_params(b)}function kb(a){"canvas_rf"in a&&(y.set("canvas_resolution_factor",a.canvas_rf),va())}function Ab(){var a=l.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(m(b,"enable"),a&&(f("mb_factor",a.mb_factor),f("mb_decay_threshold",
a.mb_decay_threshold))):m(b,"disable")}function Ua(a){var b={};"mb_factor"in a&&(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);l.set_mb_params(b)}function Bb(){var a=l.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(m(b,"enable"),a&&(f("bloom_key",a.bloom_key),f("bloom_blur",a.bloom_blur),f("bloom_edge_lum",a.bloom_edge_lum))):m(b,"disable")}function La(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=
a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);l.set_bloom_params(b)}function Cb(){var a=l.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(m(b,"enable"),f("small_glow_mask_coeff",a.small_glow_mask_coeff),f("large_glow_mask_coeff",a.large_glow_mask_coeff),f("small_glow_mask_width",a.small_glow_mask_width),f("large_glow_mask_width",a.large_glow_mask_width)):m(b,"disable")}function xa(a){var b=
{};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);l.set_glow_material_params(b)}function M(a,b){var c=Oa.rgb_to_css(b),e=Oa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",
e)}function xb(){var a=l.get_wind_params(),b=["wind_dir","wind_strength"];a?(f("wind_dir",a.wind_dir),f("wind_strength",a.wind_strength)):m(b,"disable")}function Ta(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);l.set_wind_params(b)}function f(a,b){$("#"+a).val(b);$("#"+a).slider("refresh");$("#"+a).trigger("change")}function e(a,b,c){$("#"+b).bind("change",function(e){var f={};switch(c){case "string":f[b]=e.target.value;break;case "number":f[b]=
parseFloat(e.target.value);break;case "bool":f[b]=Boolean(Number(e.target.value));break;default:return console.log("wrong value type"),null}a(f)})}function H(a,b){$("#"+b).ColorPicker({onChange:function(c,e,f){$("#"+b+" div").css("backgroundColor","#"+e);c={};f=Oa.css_to_rgb(f.r,f.g,f.b);c[b]=[f[0],f[1],f[2]];a(c)}})}function gb(){Hb.auto_rotate(.3)}function m(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var e=$("#"+a[c]).parent().parent();"enable"==b?e.removeClass("ui-disabled"):"disable"==
b&&e.addClass("ui-disabled")}}var p=k("animation"),v=k("app"),Qa=k("assets"),Ya=k("camera"),Hb=k("camera_anim"),y=k("config");k("constraints");var w=k("controls"),Na=k("data"),B=k("debug"),na=k("geometry"),nb=k("gyroscope"),F=k("lights"),Q=k("main"),mb=k("mixer"),W=k("material"),D=k("nla"),Oa=k("rgb"),Eb=k("screenshooter"),l=k("scenes");k("shaders");var t=k("storage"),pb=k("transform"),la=k("util"),Ra=k("version"),rb=k("vec3"),db="DEBUG"===Ra.type(),Gb=Math.PI/180,Fb=180/Math.PI,ob=new Float32Array(3),
qb=new Float32Array(3),ma=!1,Ma,E=null,n=null,J=null,oa="",da=null,wa=null,z=null,C=null,Wa=function(){},R=null,Za=null;g.init=function(){t.init("b4w_viewer");var a=t.get("quality");if(a){switch(a){case "ULTRA":var b=y.P_ULTRA;break;case "HIGH":b=y.P_HIGH;break;case "LOW":b=y.P_LOW;break;case "CUSTOM":b=y.P_CUSTOM}y.set("quality",b)}y.set("anaglyph_use","true"===t.get("anaglyph_use"));y.set("gyro_use","true"===t.get("gyro_use"));""==t.get("outlining_overview_mode")?y.set("outlining_overview_mode",
!0):y.set("outlining_overview_mode","true"===t.get("outlining_overview_mode"));v.init({canvas_container_id:"main_canvas_container",callback:eb,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===t.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:ja(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!db,assets_min50_available:!db,console_verbose:!0,physics_enabled:!0,wireframe_debug:!0})}});b4w.require("viewer_main").init();
