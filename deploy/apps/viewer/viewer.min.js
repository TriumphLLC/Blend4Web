...
{setup:function(){if(h)return!1;a(b.start)},teardown:function(){if(h)return!1;a(b.stop)}});b=function(){function b(){var f=d(),c=w(q);f!==q?(E(q=f,c),a(g).trigger("hashchange")):c!==q&&(location.href=location.href.replace(/#.*/,"")+c);e=setTimeout(b,a.fn.hashchange.delay)}var f={},e,q=d(),k=function(a){return a},E=k,w=k;f.start=function(){e||b()};f.stop=function(){e&&clearTimeout(e);e=c};g.attachEvent&&!g.addEventListener&&!h&&function(){var c,e;f.start=function(){c||(e=(e=a.fn.hashchange.src)&&e+
d(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){e||E(d());b()}).attr("src",e||"javascript:0").insertAfter("body")[0].contentWindow,t.onpropertychange=function(){try{"title"===event.propertyName&&(c.document.title=t.title)}catch(a){}})};f.stop=k;w=function(){return d(c.location.href)};E=function(b,f){var e=c.document,d=a.fn.hashchange.domain;b!==f&&(e.title=t.title,e.open(),d&&e.write('<script>document.domain="'+d+'"\x3c/script>'),e.close(),c.location.hash=b)}}();return f}()})(k,
...
function l(b){var f=a.data(b.target,"virtualTouchID");ja||N&&N===f||!(f=h("v"+b.type,b))||(f.isDefaultPrevented()&&b.preventDefault(),f.isPropagationStopped()&&b.stopPropagation(),f.isImmediatePropagationStopped()&&b.stopImmediatePropagation())}function m(c){var e=b(c).touches,d;e&&1===e.length&&(d=c.target,e=f(d),e.hasVirtualBinding&&(N=oa++,a.data(d,"virtualTouchID",N),D&&(clearTimeout(D),D=0),M=X=!1,d=b(c).touches[0],P=d.pageX,Q=d.pageY,h("vmouseover",c,e),h("vmousedown",c,e)))}function p(a){X||
(M||h("vmousecancel",a,f(a.target)),M=!0,e())}function q(c){if(!X){var d=b(c).touches[0],m=M,l=a.vmouse.moveDistanceThreshold,p=f(c.target);(M=M||Math.abs(d.pageX-P)>l||Math.abs(d.pageY-Q)>l)&&!m&&h("vmousecancel",c,p);h("vmousemove",c,p);e()}}function k(a){if(!X){X=!0;var c=f(a.target),d;h("vmouseup",a,c);M||(d=h("vclick",a,c))&&d.isDefaultPrevented()&&(d=b(a).changedTouches[0],ia.push({touchID:N,x:d.clientX,y:d.clientY}),ja=!0);h("vmouseout",a,c);M=!1;e()}}function E(b){b=a.data(b,"virtualMouseBindings");
var f;if(b)for(f in b)if(b[f])return!0;return!1}function w(){}function n(b){var f=b.substr(1);return{setup:function(){E(this)||a.data(this,"virtualMouseBindings",{});a.data(this,"virtualMouseBindings")[b]=!0;v[b]=(v[b]||0)+1;1===v[b]&&T.bind(f,l);a(this).bind(f,w);W&&(v.touchstart=(v.touchstart||0)+1,1===v.touchstart&&T.bind("touchstart",m).bind("touchend",k).bind("touchmove",q).bind("scroll",p))},teardown:function(){--v[b];v[b]||T.unbind(f,l);W&&(--v.touchstart,v.touchstart||T.unbind("touchstart",
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,w);E(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var t="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},D=0,P=0,Q=0,M=!1,ia=[],ja=!1,X=!1,W="addEventListener"in c,T=a(c),oa=1,N=0,Z,da;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(da=0;da<g.length;da++)a.event.special[g[da]]=n(g[da]);W&&c.addEventListener("click",function(b){var f=ia.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ia[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
_afterListviewRefresh:a.noop,refresh:function(d){var b,f,e,h,l,g,k,q,n,t,w,y=this.options;f=this.element;var A=!!a.nodeName(f[0],"ol");e=f.attr("start");var C={},v=f.find(".ui-li-count"),D=c(f[0],"counttheme")||this.options.countTheme,D=D?"ui-body-"+D:"ui-body-inherit";y.theme&&f.addClass("ui-group-theme-"+y.theme);A&&(e||0===e)&&(e=parseInt(e,10)-1,f.css("counter-reset","listnumbering "+e));this._beforeListviewRefresh();w=this._getChildrenByTagName(f[0],"li","LI");f=0;for(e=w.length;f<e;f++){h=w.eq(f);
...
ga=q.attr("id")||k+"-label",E=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),y=n.parseFloat(c.attr("step")||1),A=t.createElement("a"),C=a(A),k=t.createElement("div"),v=a(k),D=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(v)}():!1;q.attr("id",ga);this.isToggleSwitch=d;A.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");A.className="ui-slider-handle";k.appendChild(A);C.attr({role:"slider","aria-valuemin":E,"aria-valuemax":w,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":ga});a.extend(this,{slider:v,handle:C,control:c,type:h,step:y,max:w,min:E,valuebg:D,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
...
h?parseFloat(e.attr("min")):0;w=h?parseFloat(e.attr("max")):n.length-1;y=h&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1;if("object"===typeof c){k=c;l=this.slider.offset().left;g=this.slider.width();q=g/((w-E)/y);if(!this.dragging||k.pageX<l-8||k.pageX>l+g+8)return;l=1<q?(k.pageX-l)/g*100:Math.round((k.pageX-l)/g*100)}else null==c&&(c=h?parseFloat(e.val()||0):e[0].selectedIndex),l=(parseFloat(c)-E)/(w-E)*100;if(!isNaN(l)&&(k=l/100*(w-E)+E,A=(k-E)%y,k-=A,2*Math.abs(A)>=y&&(k+=0<A?y:-y),
A=100/((w-E)/y),k=parseFloat(k.toFixed(5)),"undefined"===typeof q&&(q=g/((w-E)/y)),1<q&&h&&(l=1/y*A*(k-E)),0>l&&(l=0),100<l&&(l=100),k<E&&(k=E),k>w&&(k=w),this.handle.css("left",l+"%"),this.handle[0].setAttribute("aria-valuenow",h?k:n.eq(k).attr("value")),this.handle[0].setAttribute("aria-valuetext",h?k:n.eq(k).getEncodedText()),this.handle[0].setAttribute("title",h?k:n.eq(k).getEncodedText()),this.valuebg&&this.valuebg.css("width",l+"%"),this._labels&&(g=this.handle.width()/this.slider.width()*100,
...
M.push("ui-screen-hidden"),b!==P&&(b=this.placeholder=P)),v=t.createElement("li"),C.disabled&&(M.push("ui-state-disabled"),v.setAttribute("aria-disabled",!0)),v.setAttribute(k,A),v.setAttribute(p,"false"),w&&v.setAttribute(n,!0),v.className=M.join(" "),v.setAttribute("role","option"),Q.setAttribute("tabindex","-1"),this.isMultiple&&a(Q).addClass("ui-btn ui-checkbox-off ui-btn-icon-right"),v.appendChild(Q),E.appendChild(v));this.list[0].appendChild(E);this.isMultiple||b.length?this.headerTitle.text(this.placeholder):
...
else{w=p.className;var y=k=q=void 0,A=!1,C=!0,v={icon:"",inline:!1,shadow:!1,corners:!1,iconshadow:!1,mini:!1},D=[];w=w.split(" ");for(q=0;q<w.length;q++)y=!0,k=d[w[q]],k!==g?(y=!1,v[k]=!0):0===w[q].indexOf("ui-btn-icon-")?(C=y=!1,v.iconpos=w[q].substring(12)):0===w[q].indexOf("ui-icon-")?(y=!1,v.icon=w[q].substring(8)):0===w[q].indexOf("ui-btn-")&&8===w[q].length?(y=!1,v.theme=w[q].substring(7)):"ui-btn"===w[q]&&(y=!1,A=!0),y&&D.push(w[q]);C&&(v.icon="");w={options:v,unknownClasses:D,alreadyEnhanced:A}}k=
...
{transition:"none",reverse:!0,changeHash:!1,fromHashChange:!0}))}}),a(function(){a.support.inlineSVG();a.mobile.hideUrlBar&&g.scrollTo(0,1);a.mobile.defaultHomeScroll=a.support.scrollTop&&1!==a.mobile.window.scrollTop()?1:0;a.mobile.autoInitializePage&&a.mobile.initializePage();a.mobile.hideUrlBar&&f.load(a.mobile.silentScroll);a.support.cssPointerEvents||a.mobile.document.delegate(".ui-state-disabled,.ui-disabled","vclick",function(a){a.preventDefault();a.stopImmediatePropagation()})}))})(k,this)});(function(k){var n=function(){var n=65,W={eventName:"click",onShow:function(){},onBeforeShow:function(){},onHide:function(){},onChange:function(){},onSubmit:function(){},color:"ff0000",livePreview:!0,flat:!1},a=function(a,b){var c=Z(a);c.r=Math.round(1E3*Math.pow(c.r/255,2.2))/1E3;c.g=Math.round(1E3*Math.pow(c.g/255,2.2))/1E3;c.b=Math.round(1E3*Math.pow(c.b/255,2.2))/1E3;k(b).data("colorpicker").fields.eq(1).val(c.r).end().eq(2).val(c.g).end().eq(3).val(c.b).end()},g=function(a,b){k(b).data("colorpicker").fields.eq(4).val(a.h).end().eq(5).val(a.s).end().eq(6).val(a.b).end()},
c=function(a,b){k(b).data("colorpicker").fields.eq(0).val(ha(a)).end()},d=function(a,b){k(b).data("colorpicker").selector.css("backgroundColor","#"+ha({h:a.h,s:100,b:100}));k(b).data("colorpicker").selectorIndic.css({left:parseInt(150*a.s/100,10),top:parseInt(150*(100-a.b)/100,10)})},b=function(a,b){k(b).data("colorpicker").hue.css("top",parseInt(150-150*a.h/360,10))},f=function(a,b){k(b).data("colorpicker").currentColor.css("backgroundColor","#"+ha(a))},e=function(a,b){k(b).data("colorpicker").newColor.css("backgroundColor",
"#"+ha(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,p=6-m.length;if(0<p){for(var q=[],n=0;n<p;n++)q.push("0");q.push(m);m=q.join("")}m=N(oa(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=T({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
...
h.data("colorpicker").onChange.apply(h,[l,ha(l),Z(l)])},m=function(a){k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},p=function(){n=0<this.parentNode.className.indexOf("_hex")?70:65;k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");k(this).parent().addClass("colorpicker_focus")},q=function(a){var b=k(this).parent().find("input").focus();a={el:k(this).parent().addClass("colorpicker_slider"),max:0<this.parentNode.className.indexOf("_hsb_h")?
360:0<this.parentNode.className.indexOf("_hsb")?100:255,y:a.pageY,field:b,val:parseInt(b.val(),10),preview:k(this).parent().parent().data("colorpicker").livePreview};k(document).bind("mouseup",a,E);k(document).bind("mousemove",a,ga)},ga=function(a){a.data.field.val(Math.max(0,Math.min(a.data.max,parseInt(a.data.val+a.pageY-a.data.y,10))));a.data.preview&&l.apply(a.data.field.get(0),[!0]);return!1},E=function(a){l.apply(a.data.field.get(0),[!0]);a.data.el.removeClass("colorpicker_slider").find("input").focus();
k(document).unbind("mouseup",E);k(document).unbind("mousemove",ga);return!1},w=function(a){a.preventDefault();a={cal:k(this).parent(),y:k(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,A);k(document).bind("mousemove touchmove",a,y)},y=function(a){var b=a;"undefined"!==typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,b.pageY-a.data.y)))/150,10)).get(0),
...
v);return!1},P=function(a){k(this).addClass("colorpicker_focus")},Q=function(a){k(this).removeClass("colorpicker_focus")},M=function(a){a=k(this).parent();var b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;f(b,a.get(0));a.data("colorpicker").onSubmit(b,ha(b),Z(b),a.data("colorpicker").el)},ia=function(a){var b=k("body"),c=b.data("colorpickerId"),d=k(this).data("colorpickerId");c&&c===d?(k(document).trigger("mousedown"),b.data("colorpickerId",null)):(ja.call(this,a),b.data("colorpickerId",
...
if(a.contains)return a.contains(b);if(a.compareDocumentPosition)return!!(a.compareDocumentPosition(b)&16);for(b=b.parentNode;b&&b!=c;){if(b==a)return!0;b=b.parentNode}return!1},T=function(a){return{h:Math.round(Math.min(360,Math.max(0,a.h))),s:Math.round(Math.min(100,Math.max(0,a.s))),b:Math.round(Math.min(100,Math.max(0,a.b)))}},oa=function(a){a=parseInt(-1<a.indexOf("#")?a.substring(1):a,16);return{r:a>>16,g:(a&65280)>>8,b:a&255}},N=function(a){var b={h:0,s:0,b:0},c=Math.min(a.r,a.g,a.b),d=Math.max(a.r,
...
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},da=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ha=function(a){return da(Z(a))},Ea=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},W,n||{});
if("string"==typeof n.color)n.color=N(oa(n.color));else if(void 0!=n.color.r&&void 0!=n.color.g&&void 0!=n.color.b)n.color=N(n.color);else if(void 0!=n.color.h&&void 0!=n.color.s&&void 0!=n.color.b)n.color=T(n.color);else return this;return this.each(function(){if(!k(this).data("colorpickerId")){var t=k.extend({},n);t.origColor=n.color;var v="collorpicker_"+parseInt(1E3*Math.random());k(this).data("colorpickerId",v);v=k('<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>').attr("id",
...
t.currentColor=v.find("div.colorpicker_current_color");v.data("colorpicker",t);v.find("div.colorpicker_submit").bind("mouseenter touchstart",P).bind("mouseleave touchend",Q).bind("click",M);a(t.color,v.get(0));g(t.color,v.get(0));c(t.color,v.get(0));b(t.color,v.get(0));d(t.color,v.get(0));f(t.color,v.get(0));e(t.color,v.get(0));t.flat?v.css({position:"relative",display:"block"}):k(this).bind(t.eventName,ia)}})},showPicker:function(){return this.each(function(){k(this).data("colorpickerId")&&ja.apply(this)})},
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=N(oa(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=N(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=T(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};H.enable_controls();window.addEventListener("resize",T,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);ka.detect_mobile()||z(["gyro_use"],"disable");var g=H.get_url_params();Ta.enqueue([["manifest",
Ta.AT_JSON,"assets.json"]],function(a,b,c,Ia){Y=a;Ba=document.getElementById("info_left_down");O=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Ua.date_str();r(y,"quality","string");switch(K.get("quality")){case K.P_ULTRA:var k=0;break;case K.P_HIGH:k=1;break;case K.P_LOW:k=2;break;case K.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");H.set_onclick("reset",A);H.set_onclick("auto_rotate_cam",jb);H.set_onclick("pause",
v);H.set_onclick("resume",D);H.set_onclick("auto_view",Ga);H.set_onclick("home",C);a=document.getElementById("manifest");if(Y){c="";b=(b=H.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home - "+b[b.length-1];c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<Y.length;b++){k=Y[b];Ia=k.name;for(var k=k.items,R="",R=R+"<div data-role='collapsible' data-mini='true' >",
R=R+("<h6>"+Ia+"</h6>"),R=R+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,R=R+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+Ia)+'">'+m+"</a></li>");R+="</ul>";R+="</div>";c+=R}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";f();r(na,"anim_active_object",
"string");r(na,"animation","string");r(na,"anim_mix_factor","number");r(na,"anim_slot","number");r(na,"anim_cyclic","bool");r(na,"anim_frame_current","number");H.set_onclick("anim_play",oa);H.set_onclick("anim_stop",N);H.set_onclick("anim_play_all",Z);H.set_onclick("anim_stop_all",da);r(hb,"nla_frame_current","number");H.set_onclick("nla_play",ha);H.set_onclick("nla_stop",Ea);r(Aa,"shape_key_obj","string");r(Aa,"shape_key_name","string");r(Aa,"shape_key_value","number");r(pa,"material_name","string");
aa(pa,"material_diffuse_color");r(pa,"material_reflectivity","number");r(pa,"material_fresnel","number");r(pa,"material_fresnel_factor","number");r(pa,"material_parallax_scale","number");r(pa,"material_parallax_steps","number");r(G,"material_name","string");r(G,"shore_smoothing","bool");r(G,"absorb_factor","number");r(G,"sss_strength","number");r(G,"sss_width","number");aa(G,"water_fog_color");r(G,"water_fog_density","number");aa(G,"shallow_water_col");r(G,"shallow_water_col_fac","number");aa(G,"shore_water_col");
r(G,"shore_water_col_fac","number");r(G,"foam_factor","number");r(G,"norm_uv_velocity","number");r(G,"water_dynamic","bool");r(G,"waves_height","number");r(G,"waves_length","number");r(G,"dst_noise_scale0","number");r(G,"dst_noise_scale1","number");r(G,"dst_noise_freq0","number");r(G,"dst_noise_freq1","number");r(G,"dir_min_shore_fac","number");r(G,"dir_freq","number");r(G,"dir_noise_scale","number");r(G,"dir_noise_freq","number");r(G,"dir_min_noise_fac","number");r(G,"dst_min_fac","number");r(G,
"waves_hor_fac","number");r(Ja,"environment_energy","string");aa(Ja,"horizon_color");aa(Ja,"zenith_color");r(qa,"light_name","string");aa(qa,"light_color");r(qa,"pre_light_energy","number");r(qa,"rude_light_energy","number");r(qa,"light_spot_size","number");r(qa,"light_spot_blend","number");r(qa,"light_distance","number");aa(ba,"sky_color");r(ba,"rayleigh_brightness","number");r(ba,"mie_brightness","number");r(ba,"spot_brightness","number");r(ba,"scatter_strength","number");r(ba,"rayleigh_strength",
"number");r(ba,"mie_strength","number");r(ba,"rayleigh_collection_power","number");r(ba,"mie_collection_power","number");r(ba,"mie_distribution","number");r(Ka,"date","string");r(Ka,"day_time","number");r(Va,"sun_horizontal_position","number");r(Va,"sun_vertical_position","number");r(kb,"max_sun_angle","number");H.set_onclick("run_sun",lb);H.set_onclick("stop_sun",mb);r(sa,"csm_first_cascade_border","number");r(sa,"csm_last_cascade_border","number");r(sa,"self_shadow_polygon_offset","number");r(sa,
"self_shadow_normal_offset","number");r(sa,"first_cascade_blur_radius","number");r(sa,"last_cascade_blur_radius","number");r(ea,"ssao_quality","string");r(ea,"ssao_hemisphere","bool");r(ea,"ssao_blur_depth","bool");r(ea,"ssao_blur_discard_value","number");r(ea,"ssao_radius_increase","number");r(ea,"ssao_influence","number");r(ea,"ssao_dist_factor","number");r(ea,"ssao_only","bool");r(ea,"ssao_white","bool");r(La,"fog_density","number");r(La,"fog_density1000","number");aa(La,"fog_color");r(va,"dof_distance",
"number");r(va,"dof_front","number");r(va,"dof_rear","number");r(va,"dof_power","number");r(va,"dof_on","bool");r(Ma,"god_rays_intensity","number");r(Ma,"god_rays_max_ray_length","number");r(Ma,"god_rays_steps","number");r(Ca,"brightness","number");r(Ca,"contrast","number");r(Ca,"exposure","number");r(Ca,"saturation","number");r(M,"sfx_mix_mode","bool");a=Number("true"===I.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(ia,
"stereo","string");a=I.get("stereo")||"NONE";Na.check_browser_support()||(document.getElementById("stereo").options[2].setAttribute("disabled","disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(I.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);"HMD"==a&&Na.enable_hmd(Na.HMD_ALL_AXES_MOUSE_NONE);r(ja,"gyro_use","bool");a=Number("true"===I.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");
r(Wa,"wind_dir","number");r(Wa,"wind_strength","number");r(Xa,"mb_factor","number");r(Xa,"mb_decay_threshold","number");r(Oa,"bloom_key","number");r(Oa,"bloom_blur","number");r(Oa,"bloom_edge_lum","number");r(Da,"small_glow_mask_coeff","number");r(Da,"large_glow_mask_coeff","number");r(Da,"small_glow_mask_width","number");r(Da,"large_glow_mask_width","number");r(nb,"canvas_rf","number");r(Ya,"wireframe_mode","string");aa(Ya,"wireframe_edge_color","object");r(Q,"show_hud_debug_info","bool");r(X,"outlining_overview_mode",
"bool");a=""==I.get("outlining_overview_mode")?1:Number("true"===I.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");H.set_onclick("make_screenshot",ob);a=Number("true"===I.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");
$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ba&&x.can_select_objects()){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=U;d&&x.outlining_is_enabled(d)&&x.clear_outline_anim(d);
(U=b=x.pick_object(b,a))?Za(b):$a();c();la||(b?(la=b,c(),H.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){la=null;c();H.disable_object_controls(a)})):g())}}function g(){var a=x.get_active_camera();la=a;c();H.enable_camera_controls();J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){la=null;c();H.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);
J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&ab.target_zoom_object(a,b)})}function c(){if(Ba){var a=la?ma(la):"NONE",b=U?ma(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=U)&&(b=x.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=la;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+bb);Ba.innerHTML=a}}function d(){var a=I.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];if(wa.keyfind("name",a,c.items)[0])return{category:c.name,
item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){xa=!1;clearTimeout(Pa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];
xa=!1;clearTimeout(Pa);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<O.children.length;f++)O.children[f].style.visibility="hidden";if((f=H.get_url_params())&&f.load){var g=f.load.split("/");ta={load_file:f.load,name:g[g.length-1].split(".")[0],animated_objects:[]}}else ta={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ca=F=null;if(!e)if(b){e=wa.keyfind("name",b.category,Y)[0];e=wa.keyfind("name",b.item,e.items)[0];for(var h in e)ta[h]=
"load_file"==h?K.get_std_assets_path()+e[h]:e[h];I.set("last_item_name",b.item)}else I.set("last_item_name","");c&&(ka.clear_render_callback(),Qa.cleanup());ka.get_canvas_elem().removeEventListener("mousedown",a);L.clear_errors_warnings();b=ta.name;c=ta.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Qa.load(c,l,p,d)}function l(b){ka.get_canvas_elem().addEventListener("mousedown",a,!1);U=null;q(ta);g();H.enable_debug_controls();P()&&pb.enable_mixer_controls();
K.get("gyro_use")&&qb.enable_camera_rotation();ka.set_render_callback(w);xa&&(Pa=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(x.get_active_camera(),"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&U){if(d=U)b=rb,sb.get_object_center(d,!0,b),a=ab.get_translation(a,tb),bb=ub.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=a.item,a=wa.keyfind("name",a.category,Y)[0],b=wa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,
item:b.name};else{a=Y.indexOf(a);b=null;do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{xa=!1;return}}}else a=Y[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();if(Qa.is_primary_loaded()){T();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=
e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=L.get_error_quantity();(f=L.get_warning_quantity())||
e?O.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):O.setAttribute("title","Loaded OK");d||c||(O.children[0].style.visibility="hidden",O.children[1].style.visibility="hidden",O.children[2].style.visibility="visible")}d&&!c&&(O.children[0].style.visibility="hidden",O.children[1].style.visibility="visible",O.children[2].style.visibility="hidden");c&&(O.children[0].style.visibility="visible",O.children[1].style.visibility="hidden",O.children[2].style.visibility=
"hidden")}function q(a){for(var c=x.get_active(),d=x.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=ga(f,a);E(f,g)}}g=ga(c,a);E(c,g);Za=function(a){var c=ra.get_materials_names(a);b("material_name",c);cb(a,c[0]);a=ra.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
a?(z(c,"enable"),x.get_water_mat_params(a),a.shallow_water_col&&fa("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&fa("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(fa("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):z(c,"disable")};vb();a=x.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(ma(a[e]));b("light_name",c);0<a.length&&db(a[0]);wb();ib();xb();yb();zb();Ab();Bb();Cb();Db();Eb();Fb();Gb();Hb();$a();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);Ka({date:e})}function ga(a,b){function c(a,b){for(var d in a)b[d]=
a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function E(a,c){x.set_active(a);x.get_active_camera();for(var d=[],e=x.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(F||(F=g),d.push(ma(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");F?(z(f,"enable"),b("anim_active_object",d),na({anim_active_object:ma(F)})):z(f,"disable");
d=["nla_play","nla_stop","nla_status","nla_frame_current","nla_playing"];f=["nla_frame_range"];if(S.check_nla()){S.check_nla_scripts()?(z(d,"disable"),document.getElementById("nla_status").innerHTML="CONTROLLED BY NLA SCRIPT"):z(d,"enable");z(f,"enable");var d=document.getElementById("nla_frame_current"),f=document.getElementById("nla_frame_range"),g=S.get_frame_start(),h=S.get_frame_end();-1!=g&&-1!=h?(f.innerHTML=g+" - "+h,d.min=""+g,d.max=""+h):f.innerHTML="N/A"}else z(d,"disable"),z(f,"disable");
d=[];for(f=0;f<e.length;f++)g=e[f],ya.check_shape_keys(g)&&(ca||(ca=g),d.push(ma(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ca?(z(e,"enable"),b("shape_key_obj",d),Aa({shape_key_obj:ma(ca)})):z(e,"disable")}function w(a,b){x.get_active_camera();if(F){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(F,d)?(d=Math.round(B.get_frame(F,d)),parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):
c.innerHTML="STOPPED"}S.check_nla()&&(S.check_nla_scripts()||(c=document.getElementById("nla_status"),S.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(S.get_frame().toFixed(0)),S.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function y(a){I.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function A(){I.cleanup();var a=window.location.href.replace(/load=.*?(&|$)/,"").replace(/(&|\?)$/,"");window.location.href=a}function C(){h(null,
!0,!1,!0)}function v(){ka.pause()}function D(){ka.resume()}function P(){return"true"===I.get("sfx_mix_mode")?!0:!1}function Q(a){I.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function M(a){I.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function ia(a){I.set("stereo",a.stereo);window.location.reload()}function ja(a){I.set("gyro_use",a.gyro_use);window.location.reload()}function X(a){I.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}
function Ga(){xa=!0;m()}function T(a){H.resize_to_container();a=ka.get_canvas_elem();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)"}function oa(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&B.play(F,null,b)}function N(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);B.stop(F,a)}function Z(){for(var a=document.getElementById("anim_active_object").children,
b=0;b<a.length;b++){var c=ua(a[b].value);B.play(c,null,B.SLOT_ALL)}}function da(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ua(a[b].value);B.stop(c,null,B.SLOT_ALL)}}function ha(){S.play()}function Ea(){S.stop()}function Aa(a){if("shape_key_obj"in a){ca=ua(a.shape_key_obj);var c=ya.get_shape_keys_names(ca);c.length?(b("shape_key_name",c),za=c[0],c=ya.get_shape_key_value(ca,za),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&
(za=a.shape_key_name,c=ya.get_shape_key_value(ca,za),u("shape_key_value",c));"shape_key_value"in a&&ya.set_shape_key_value(ca,za,a.shape_key_value)}function hb(a){"nla_frame_current"in a&&!S.is_play()&&(a=parseInt(a.nla_frame_current),S.set_frame(a))}function na(a){if("anim_active_object"in a){F=ua(a.anim_active_object);var c=B.get_anim_names(F);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);
Sa(F,c);Fa(F,c)}else b("animation",["N/A"]);Ha(F)}if("anim_slot"in a){if(!F)return;c=a.anim_slot;Sa(F,c);Fa(F,c);Ha(F)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.get_current_anim_name(F,c),"None"==a.animation?B.remove_slot_animation(F,c):(B.apply(F,a.animation,c),B.play(F,null,c)),Fa(F,c),Ha(F));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=B.get_slot_num_by_anim(F,c),B.set_behavior(F,a.anim_cyclic?B.AB_CYCLIC:B.AB_FINISH_RESET,c));"anim_frame_current"in
a&&(c=parseInt(document.getElementById("anim_slot").value),B.is_play(F,c)||(d=parseInt(a.anim_frame_current),B.set_frame(F,d,c)));"anim_mix_factor"in a&&B.set_skel_mix_factor(F,a.anim_mix_factor)}function Sa(a,b){for(var c=B.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Fa(a,b){u("anim_cyclic",Number(B.get_behavior(a,b)==B.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),
d=B.get_anim_start_frame(a,b),e=B.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Ha(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),d=B.get_anim_type(a,c),c=0;c<b.length;c++){d=B.get_anim_type(a,c);switch(d){case B.OBJ_ANIM_TYPE_ARMATURE:d="ARMATURE";break;case B.OBJ_ANIM_TYPE_OBJECT:d="OBJECT";break;case B.OBJ_ANIM_TYPE_PARTICLES:d=
"PARTICLES";break;case B.OBJ_ANIM_TYPE_VERTEX:d="VERTEX";break;case B.OBJ_ANIM_TYPE_MATERIAL:d="MATERIAL";break;case B.OBJ_ANIM_TYPE_STATIC:d="STATIC";break;default:d="NONE"}b.eq(c);d=c+" ("+d+")";$("#anim_slot").children().eq(c).text(d)}$("#anim_slot").selectmenu();$("#anim_slot").selectmenu("refresh")}function ib(){var a=x.get_ssao_params(),b="ssao_quality ssao_hemisphere ssao_blur_depth ssao_blur_discard_value ssao_radius_increase ssao_influence ssao_dist_factor ssao_only ssao_white".split(" ");
...
u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else z(b,"disable")}function ea(a){x.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=eb(document.getElementById("ssao_quality")));"ssao_hemisphere"in
...
x.set_ssao_params(b)}function Ab(){var a=x.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(z(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):z(b,"disable")}function Ca(a){var b=x.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in
a&&(b.saturation=parseFloat(a.saturation)),x.set_color_correction_params(b))}function eb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function xb(){var a=x.get_fog_color_density();.2<a[3]?u("fog_density",a[3]):u("fog_density1000",1E3*a[3]);fa("fog_color",a)}function La(a){var b=x.get_fog_color_density();"fog_density"in a&&(b[3]=a.fog_density);"fog_density1000"in a&&(b[3]=a.fog_density1000/1E3);"fog_color"in a&&(b[0]=a.fog_color[0],b[1]=a.fog_color[1],b[2]=a.fog_color[2]);
x.set_fog_color_density(b)}function wb(){var a=x.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return z(b,"disable"),document.getElementById("csm_resolution").innerHTML="",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML=
"",null;z(b,"enable");fb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",a.last_cascade_blur_radius)):z(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):z(["csm_first_cascade_border",
"csm_last_cascade_border","last_cascade_blur_radius"],"disable")}function sa(a){var b={};"csm_first_cascade_border"in a&&(b.csm_first_cascade_border=a.csm_first_cascade_border);"csm_last_cascade_border"in a&&(b.csm_last_cascade_border=a.csm_last_cascade_border);"self_shadow_polygon_offset"in a&&(b.self_shadow_polygon_offset=a.self_shadow_polygon_offset);"self_shadow_normal_offset"in a&&(b.self_shadow_normal_offset=a.self_shadow_normal_offset);"first_cascade_blur_radius"in a&&(b.first_cascade_blur_radius=
a.first_cascade_blur_radius);"last_cascade_blur_radius"in a&&(b.last_cascade_blur_radius=a.last_cascade_blur_radius);x.set_shadow_params(b);fb(x.get_shadow_params())}function fb(a){document.getElementById("csm_resolution").innerHTML="&nbsp;&nbsp;"+a.csm_resolution;if(a.enable_csm){document.getElementById("csm_num").innerHTML=" "+a.csm_num;for(var b=["csm_borders","blur_radii"],c=0;c<b.length;c++){var d=b[c],e=a[d],d=document.getElementById(d);d.innerHTML="(";for(var f=0;f<e.length;f++)0<f&&(d.innerHTML+=
...
"none"}function vb(){var a=x.get_environment_colors();u("environment_energy",a[0]);fa("horizon_color",a[1]);fa("zenith_color",a[2])}function Ja(a){"environment_energy"in a&&x.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&x.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&x.set_environment_colors(null,null,a.zenith_color)}function Ya(a){var b={};if("string"==typeof a.wireframe_mode)switch(eb(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=
L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function ob(){Ib.shot()}function Db(){var a=x.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
if(!a)return z(b,"disable"),null;z(b,"enable");fa("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);u("spot_brightness",a.spot_brightness);u("scatter_strength",a.scatter_strength);u("rayleigh_strength",a.rayleigh_strength);u("mie_strength",a.mie_strength);u("rayleigh_collection_power",a.rayleigh_collection_power);u("mie_collection_power",a.mie_collection_power);u("mie_distribution",a.mie_distribution)}function ba(a){var b={};"sky_color"in a&&
...
a&&(b.mie_collection_power=a.mie_collection_power);"mie_distribution"in a&&(b.mie_distribution=a.mie_distribution);x.set_sky_params(b)}function cb(a,b){var c=ra.get_material_extended_params(a,b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return z(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=ra.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);
z(d,"enable");fa("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",c.parallax_scale);u("material_parallax_steps",c.parallax_steps)}function pa(a){var b=U;"material_name"in a&&cb(b,a.material_name);if("material_diffuse_color"in a){var c=a.material_diffuse_color.slice();c.push(1);ra.set_diffuse_color(b,$("#material_name").val(),c)}c={};"material_reflectivity"in
a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);ra.set_material_extended_params(b,$("#material_name").val(),c);x.update_scene_materials_params()}function G(a){var b=U,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");
...
"dir_noise_freq"in a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!ra.set_water_material_params(b,$("#material_name").val(),d))return null;x.update_scene_materials_params();x.set_water_params(d)}function db(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);fa("light_color",a.light_color);
u("pre_light_energy",b);u("rude_light_energy",c);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(z(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Jb))):z(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(z(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",
a.light_distance)):z(["light_distance"],"disable")}}function qa(a){"light_name"in a&&db(ua(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*
Kb));"light_spot_blend"in a&&(b.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(b.light_distance=parseFloat(a.light_distance));a=ua($("#light_name").val());V.set_light_params(a,b);b=V.get_light_params(a).light_energy.toFixed(2);$("#light_energy").text(b)}function Cb(){var a=V.get_sun_params(),b=["sun_horizontal_position","sun_vertical_position"];if(!a)return z(b,"disable"),null;u("sun_horizontal_position",a.hor_position);u("sun_vertical_position",a.vert_position)}function Va(a){var b=
{};"sun_horizontal_position"in a&&(b.hor_position=parseFloat(a.sun_horizontal_position),b.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(b.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),b.vert_position=parseFloat(a.sun_vertical_position));V.set_sun_params(b)}function kb(a){a=parseFloat(a.max_sun_angle);V.set_max_sun_angle(a)}function Ka(a){"day_time"in a&&V.set_day_time(a.day_time);"date"in a&&V.set_date(new Date(a.date))}
function lb(){var a=0,b=parseFloat(document.getElementById("day_time").value),c=J.create_elapsed_sensor(),d=V.get_lamps("SUN")[0];J.create_sensor_manifold(d,"ELAPSED",J.CT_CONTINUOUS,[c],function(a){return a[0]},function(c,d,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,c=J.get_sensor_value(c,d,0),b+=c*a/3600,24<b&&(b-=Math.floor(b)),u("day_time",b))})}function Hb(){var a=V.get_lamps("SUN")[0],b=["sn-ui-grid-b"];V.get_lamps().length?a||z("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),
"disable"):z(b,"disable")}function $a(){z("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");z("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function mb(){var a=V.get_lamps("SUN")[0];J.check_sensor_manifolds(a)&&J.remove_sensor_manifold(a,"ELAPSED")}function yb(){var a=x.get_dof_params(),b="dof_distance dof_object dof_front dof_rear dof_power dof_on".split(" ");if(a){u("dof_front",a.dof_front);u("dof_rear",a.dof_rear);u("dof_power",a.dof_power);$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=ma(a.dof_object);$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");
...
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean($("#dof_on").val()),b.dof_distance=Number(a.dof_on)?parseFloat($("#dof_distance").val()):0);x.set_dof_params(b)}function zb(){var a=x.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(z(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):z(b,
"disable")}function Ma(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);x.set_god_rays_params(b)}function nb(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),T())}function Eb(){var a=x.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(z(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",
a.mb_decay_threshold))):z(b,"disable")}function Xa(a){var b={};"mb_factor"in a&&(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);x.set_mb_params(b)}function Fb(){var a=x.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(z(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):z(b,"disable")}function Oa(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=
a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);x.set_bloom_params(b)}function Gb(){var a=x.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(z(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):z(b,"disable")}function Da(a){var b=
{};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);x.set_glow_material_params(b)}function fa(a,b){var c=Ra.rgb_to_css(b),d=Ra.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",
d)}function Bb(){var a=x.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):z(b,"disable")}function Wa(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);x.set_wind_params(b)}function u(a,b){$("#"+a).val(b);$("#"+a).slider("refresh");$("#"+a).trigger("change")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=
parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),null}a(e)})}function aa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Ra.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function jb(){Lb.auto_rotate(.3)}function z(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==
b&&d.addClass("ui-disabled")}}function ma(a){return x.get_object_name_hierarchy(a).join("->")}function ua(a){return x.get_object_by_dupli_name_list(a.split("->"))}var B=n("animation"),H=n("app"),Ta=n("assets"),ab=n("camera"),Lb=n("camera_anim"),K=n("config");n("constraints");var J=n("controls"),Qa=n("data"),L=n("debug"),ya=n("geometry"),qb=n("gyroscope"),V=n("lights"),ka=n("main"),Na=n("hmd"),pb=n("mixer"),ra=n("material"),S=n("nla"),Ra=n("rgb"),Ib=n("screenshooter"),x=n("scenes"),I=n("storage"),
sb=n("transform"),wa=n("util"),Ua=n("version"),ub=n("vec3"),gb="DEBUG"===Ua.type(),Kb=Math.PI/180,Jb=180/Math.PI,rb=new Float32Array(3),tb=new Float32Array(3),xa=!1,Pa,Y=null,F=null,ca=null,za="",ta=null,Ba=null,O=null,U=null,Za=function(){},la=null,bb=null;k.init=function(){I.init("b4w_viewer");var a=I.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("stereo",I.get("stereo")||
"NONE");K.set("gyro_use","true"===I.get("gyro_use"));""==I.get("outlining_overview_mode")?K.set("outlining_overview_mode",!0):K.set("outlining_overview_mode","true"===I.get("outlining_overview_mode"));H.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===I.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:P(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!gb,assets_min50_available:!gb,console_verbose:!0,
