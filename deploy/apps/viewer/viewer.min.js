...
function l(b){var f=a.data(b.target,"virtualTouchID");la||N&&N===f||!(f=h("v"+b.type,b))||(f.isDefaultPrevented()&&b.preventDefault(),f.isPropagationStopped()&&b.stopPropagation(),f.isImmediatePropagationStopped()&&b.stopImmediatePropagation())}function m(c){var e=b(c).touches,d;e&&1===e.length&&(d=c.target,e=f(d),e.hasVirtualBinding&&(N=da++,a.data(d,"virtualTouchID",N),B&&(clearTimeout(B),B=0),M=W=!1,d=b(c).touches[0],S=d.pageX,P=d.pageY,h("vmouseover",c,e),h("vmousedown",c,e)))}function p(a){W||
(M||h("vmousecancel",a,f(a.target)),M=!0,e())}function q(c){if(!W){var d=b(c).touches[0],m=M,l=a.vmouse.moveDistanceThreshold,p=f(c.target);(M=M||Math.abs(d.pageX-S)>l||Math.abs(d.pageY-P)>l)&&!m&&h("vmousecancel",c,p);h("vmousemove",c,p);e()}}function k(a){if(!W){W=!0;var c=f(a.target),d;h("vmouseup",a,c);M||(d=h("vclick",a,c))&&d.isDefaultPrevented()&&(d=b(a).changedTouches[0],ka.push({touchID:N,x:d.clientX,y:d.clientY}),la=!0);h("vmouseout",a,c);M=!1;e()}}function D(b){b=a.data(b,"virtualMouseBindings");
var f;if(b)for(f in b)if(b[f])return!0;return!1}function w(){}function n(b){var f=b.substr(1);return{setup:function(){D(this)||a.data(this,"virtualMouseBindings",{});a.data(this,"virtualMouseBindings")[b]=!0;v[b]=(v[b]||0)+1;1===v[b]&&Y.bind(f,l);a(this).bind(f,w);ga&&(v.touchstart=(v.touchstart||0)+1,1===v.touchstart&&Y.bind("touchstart",m).bind("touchend",k).bind("touchmove",q).bind("scroll",p))},teardown:function(){--v[b];v[b]||Y.unbind(f,l);ga&&(--v.touchstart,v.touchstart||Y.unbind("touchstart",
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,w);D(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var t="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},B=0,S=0,P=0,M=!1,ka=[],la=!1,W=!1,ga="addEventListener"in c,Y=a(c),da=1,N=0,Z,T;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(T=0;T<g.length;T++)a.event.special[g[T]]=n(g[T]);ga&&c.addEventListener("click",function(b){var f=ka.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ka[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
ia=q.attr("id")||k+"-label",D=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),y=n.parseFloat(c.attr("step")||1),A=t.createElement("a"),C=a(A),k=t.createElement("div"),v=a(k),B=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(v)}():!1;q.attr("id",ia);this.isToggleSwitch=d;A.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");A.className="ui-slider-handle";k.appendChild(A);C.attr({role:"slider","aria-valuemin":D,"aria-valuemax":w,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":ia});a.extend(this,{slider:v,handle:C,control:c,type:h,step:y,max:w,min:D,valuebg:B,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
...
c=function(a,b){k(b).data("colorpicker").fields.eq(0).val(ja(a)).end()},d=function(a,b){k(b).data("colorpicker").selector.css("backgroundColor","#"+ja({h:a.h,s:100,b:100}));k(b).data("colorpicker").selectorIndic.css({left:parseInt(150*a.s/100,10),top:parseInt(150*(100-a.b)/100,10)})},b=function(a,b){k(b).data("colorpicker").hue.css("top",parseInt(150-150*a.h/360,10))},f=function(a,b){k(b).data("colorpicker").currentColor.css("backgroundColor","#"+ja(a))},e=function(a,b){k(b).data("colorpicker").newColor.css("backgroundColor",
"#"+ja(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,p=6-m.length;if(0<p){for(var q=[],n=0;n<p;n++)q.push("0");q.push(m);m=q.join("")}m=N(ua(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=Y({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
...
h.data("colorpicker").onChange.apply(h,[l,ja(l),Z(l)])},m=function(a){k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus")},p=function(){n=0<this.parentNode.className.indexOf("_hex")?70:65;k(this).parent().parent().data("colorpicker").fields.parent().removeClass("colorpicker_focus");k(this).parent().addClass("colorpicker_focus")},q=function(a){var b=k(this).parent().find("input").focus();a={el:k(this).parent().addClass("colorpicker_slider"),max:0<this.parentNode.className.indexOf("_hsb_h")?
360:0<this.parentNode.className.indexOf("_hsb")?100:255,y:a.pageY,field:b,val:parseInt(b.val(),10),preview:k(this).parent().parent().data("colorpicker").livePreview};k(document).bind("mouseup",a,D);k(document).bind("mousemove",a,ia)},ia=function(a){a.data.field.val(Math.max(0,Math.min(a.data.max,parseInt(a.data.val+a.pageY-a.data.y,10))));a.data.preview&&l.apply(a.data.field.get(0),[!0]);return!1},D=function(a){l.apply(a.data.field.get(0),[!0]);a.data.el.removeClass("colorpicker_slider").find("input").focus();
k(document).unbind("mouseup",D);k(document).unbind("mousemove",ia);return!1},w=function(a){a.preventDefault();a={cal:k(this).parent(),y:k(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;k(document).bind("mouseup touchend",a,A);k(document).bind("mousemove touchmove",a,y)},y=function(a){var b=a;"undefined"!==typeof event&&event.touches&&(b=event.touches[0]);l.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,b.pageY-a.data.y)))/150,10)).get(0),
...
v);return!1},S=function(a){k(this).addClass("colorpicker_focus")},P=function(a){k(this).removeClass("colorpicker_focus")},M=function(a){a=k(this).parent();var b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;f(b,a.get(0));a.data("colorpicker").onSubmit(b,ja(b),Z(b),a.data("colorpicker").el)},ka=function(a){var b=k("body"),c=b.data("colorpickerId"),d=k(this).data("colorpickerId");c&&c===d?(k(document).trigger("mousedown"),b.data("colorpickerId",null)):(la.call(this,a),b.data("colorpickerId",
d))},la=function(a){var b,c,d=k("#"+k(this).data("colorpickerId"));d.data("colorpicker").onBeforeShow.apply(this,[d.get(0)]);var e=k(this).offset(),f="CSS1Compat"==document.compatMode;a=window.pageXOffset||(f?document.documentElement.scrollLeft:document.body.scrollLeft);b=window.pageYOffset||(f?document.documentElement.scrollTop:document.body.scrollTop);c=window.innerWidth||(f?document.documentElement.clientWidth:document.body.clientWidth);var g=e.top+this.offsetHeight,e=e.left;g+176>b+(window.innerHeight||
(f?document.documentElement.clientHeight:document.body.clientHeight))&&(g-=this.offsetHeight+176);e+356>a+c&&(e=Math.max(0,e-356));d.css({left:e+"px",top:g+"px"});0!=d.data("colorpicker").onShow.apply(this,[d.get(0)])&&d.show();k(document).bind("mousedown",{cal:d},W);return!1},W=function(a){ga(a.data.cal.get(0),a.target,a.data.cal.get(0))||(0!=a.data.cal.data("colorpicker").onHide.apply(this,[a.data.cal.get(0)])&&a.data.cal.hide(),k(document).unbind("mousedown",W))},ga=function(a,b,c){if(a==b)return!0;
...
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},T=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ja=function(a){return T(Z(a))},ea=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},da,n||{});
...
"string");r(ea,"animation","string");r(ea,"anim_mix_factor","number");r(ea,"anim_slot","number");r(ea,"anim_cyclic","bool");r(ea,"anim_frame_current","number");I.set_onclick("anim_play",Y);I.set_onclick("anim_stop",ua);r(ja,"nla_frame_current","number");I.set_onclick("nla_play",N);I.set_onclick("nla_stop",Z);r(T,"shape_key_obj","string");r(T,"shape_key_name","string");r(T,"shape_key_value","number");r(pa,"material_name","string");aa(pa,"material_diffuse_color");r(pa,"material_reflectivity","number");
...
document.getElementById("anaglyph_use").options[a].selected=!0;$("#anaglyph_use").slider("refresh");r(ka,"gyro_use","bool");a=Number("true"===H.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Ta,"wind_dir","number");r(Ta,"wind_strength","number");r(Ua,"mb_factor","number");r(Ua,"mb_decay_threshold","number");r(La,"bloom_key","number");r(La,"bloom_blur","number");r(La,"bloom_edge_lum","number");r(Ca,"small_glow_mask_coeff","number");r(Ca,
"large_glow_mask_coeff","number");r(Ca,"small_glow_mask_width","number");r(Ca,"large_glow_mask_width","number");r(kb,"canvas_rf","number");r(Va,"wireframe_mode","string");aa(Va,"wireframe_edge_color","object");r(S,"show_hud_debug_info","bool");r(la,"outlining_overview_mode","bool");a=""==H.get("outlining_overview_mode")?1:Number("true"===H.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");I.set_onclick("make_screenshot",
...
h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();if(Na.is_primary_loaded()){ga();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/
...
a?(z(c,"enable"),x.get_water_mat_params(a),a.shallow_water_col&&ha("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&ha("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(ha("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
H.get("sfx_mix_mode")?!0:!1}function S(a){H.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function P(a){H.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function M(a){H.set("anaglyph_use",a.anaglyph_use);window.location.reload()}function ka(a){H.set("gyro_use",a.gyro_use);window.location.reload()}function la(a){H.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}function W(){xa=!0;m()}function ga(a){I.resize_to_container();a=
ma.get_canvas_elem();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)"}function Y(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&F.play(E,null,b)}function ua(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);F.stop(E,a)}function N(){R.play()}function Z(){R.stop()}function T(a){if("shape_key_obj"in a){ca=Da(a.shape_key_obj);
var c=ya.get_shape_keys_names(ca);c.length?(b("shape_key_name",c),za=c[0],c=ya.get_shape_key_value(ca,za),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&(za=a.shape_key_name,c=ya.get_shape_key_value(ca,za),u("shape_key_value",c));"shape_key_value"in a&&ya.set_shape_key_value(ca,za,a.shape_key_value)}function ja(a){"nla_frame_current"in a&&!R.is_play()&&(a=parseInt(a.nla_frame_current),R.set_frame(a))}function ea(a){if("anim_active_object"in a){E=Da(a.anim_active_object);
var c=F.get_anim_names(E);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);Pa(E,c);Ea(E,c)}else b("animation",["N/A"]);Fa(E)}if("anim_slot"in a){if(!E)return;c=a.anim_slot;Pa(E,c);Ea(E,c);Fa(E)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),F.get_current_anim_name(E,c),"None"==a.animation?F.remove_slot_animation(E,c):(F.apply(E,a.animation,c),F.play(E,null,c)),
Ea(E,c),Fa(E));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=F.get_slot_num_by_anim(E,c),F.set_behavior(E,a.anim_cyclic?F.AB_CYCLIC:F.AB_FINISH_RESET,c));"anim_frame_current"in a&&(c=parseInt(document.getElementById("anim_slot").value),F.is_play(E,c)||(d=parseInt(a.anim_frame_current),F.set_frame(E,d,c)));"anim_mix_factor"in a&&F.set_skel_mix_factor(E,a.anim_mix_factor)}function Pa(a,b){for(var c=F.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<
e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Ea(a,b){u("anim_cyclic",Number(F.get_behavior(a,b)==F.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),d=F.get_anim_start_frame(a,b),e=F.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Fa(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),
...
parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in a&&(b.saturation=parseFloat(a.saturation)),x.set_color_correction_params(b))}function bb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function ub(){var a=x.get_fog_color_density();.2<a[3]?u("fog_density",a[3]):u("fog_density1000",1E3*a[3]);ha("fog_color",a)}function Ja(a){var b=x.get_fog_color_density();"fog_density"in
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function sb(){var a=x.get_environment_colors();u("environment_energy",a[0]);ha("horizon_color",a[1]);ha("zenith_color",a[2])}function Ha(a){"environment_energy"in a&&x.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&x.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&x.set_environment_colors(null,
...
b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return z(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=ra.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);z(d,"enable");ha("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",
...
"disable")}function Ka(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);x.set_god_rays_params(b)}function kb(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),ga())}function Ab(){var a=x.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(z(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",
