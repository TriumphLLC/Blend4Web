...
"body"!==t.activeElement.nodeName.toLowerCase()?a(t.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(C){}v=!1;w&&p&&(p.url&&-1<p.url.indexOf(a.mobile.dialogHashKey)&&this.activePage&&!this.activePage.hasClass("ui-dialog")&&0<a.mobile.navigate.history.activeIndex&&(e.changeHash=!1,v=!0),l=p.url||"",l=!v&&-1<l.indexOf("#")?l+a.mobile.dialogHashKey:l+("#"+a.mobile.dialogHashKey));(A=p?b.jqmData("title")||b.children(":jqmData(role='header')").find(".ui-title").text():
n)&&n===t.title&&(n=A);b.jqmData("title")||b.jqmData("title",n);e.transition=e.transition||(k&&!q?p.transition:g)||(w?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);!k&&v&&(a.mobile.navigate.history.getActive().pageUrl=m);l&&!e.fromHashChange&&(!a.mobile.path.isPath(l)&&0>l.indexOf("#")&&(l="#"+l),m={transition:e.transition,title:n,pageUrl:m,role:e.role},!1!==e.changeHash&&a.mobile.hashListeningEnabled?a.mobile.navigate(this.window[0].encodeURI(l),m,!0):b[0]!==a.mobile.firstPage[0]&&
...
_afterListviewRefresh:a.noop,refresh:function(d){var b,f,e,h,l,g,k,q,n,t,w,v=this.options;f=this.element;var A=!!a.nodeName(f[0],"ol");e=f.attr("start");var C={},y=f.find(".ui-li-count"),D=c(f[0],"counttheme")||this.options.countTheme,D=D?"ui-body-"+D:"ui-body-inherit";v.theme&&f.addClass("ui-group-theme-"+v.theme);A&&(e||0===e)&&(e=parseInt(e,10)-1,f.css("counter-reset","listnumbering "+e));this._beforeListviewRefresh();w=this._getChildrenByTagName(f[0],"li","LI");f=0;for(e=w.length;f<e;f++){h=w.eq(f);
...
D&&y.not("[class*='ui-body-']").addClass(D);this._addThumbClasses(w);this._addThumbClasses(w.find(".ui-btn"));this._afterListviewRefresh();this._addFirstLastClasses(w,this._getVisibles(w,d),d)}},a.mobile.behaviors.addFirstLastClasses))})(k);(function(a,g){a.widget("mobile.listview",a.mobile.listview,{options:{autodividers:!1,autodividersSelector:function(c){c=a.trim(c.text())||null;return c?c=c.slice(0,1).toUpperCase():null}},_beforeListviewRefresh:function(){this.options.autodividers&&(this._replaceDividers(),
...
ha=q.attr("id")||k+"-label",E=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),v=n.parseFloat(c.attr("step")||1),A=t.createElement("a"),C=a(A),k=t.createElement("div"),y=a(k),D=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(y)}():!1;q.attr("id",ha);this.isToggleSwitch=d;A.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
"ui-slider-track ui-shadow-inset ",m,b,f,e].join("");A.className="ui-slider-handle";k.appendChild(A);C.attr({role:"slider","aria-valuemin":E,"aria-valuemax":w,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":ha});a.extend(this,{slider:y,handle:C,control:c,type:h,step:v,max:w,min:E,valuebg:D,isRangeslider:l,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(d){(b=c.attr("tabindex"))&&C.attr("tabindex",b);c.attr("tabindex","-1").focus(function(){a(this).blur();
...
h?parseFloat(e.attr("min")):0;w=h?parseFloat(e.attr("max")):n.length-1;v=h&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1;if("object"===typeof c){k=c;l=this.slider.offset().left;g=this.slider.width();q=g/((w-E)/v);if(!this.dragging||k.pageX<l-8||k.pageX>l+g+8)return;l=1<q?(k.pageX-l)/g*100:Math.round((k.pageX-l)/g*100)}else null==c&&(c=h?parseFloat(e.val()||0):e[0].selectedIndex),l=(parseFloat(c)-E)/(w-E)*100;if(!isNaN(l)&&(k=l/100*(w-E)+E,A=(k-E)%v,k-=A,2*Math.abs(A)>=v&&(k+=0<A?v:-v),
A=100/((w-E)/v),k=parseFloat(k.toFixed(5)),"undefined"===typeof q&&(q=g/((w-E)/v)),1<q&&h&&(l=1/v*A*(k-E)),0>l&&(l=0),100<l&&(l=100),k<E&&(k=E),k>w&&(k=w),this.handle.css("left",l+"%"),this.handle[0].setAttribute("aria-valuenow",h?k:n.eq(k).attr("value")),this.handle[0].setAttribute("aria-valuetext",h?k:n.eq(k).getEncodedText()),this.handle[0].setAttribute("title",h?k:n.eq(k).getEncodedText()),this.valuebg&&this.valuebg.css("width",l+"%"),this._labels&&(g=this.handle.width()/this.slider.width()*100,
...
else{w=p.className;var v=k=q=void 0,A=!1,C=!0,y={icon:"",inline:!1,shadow:!1,corners:!1,iconshadow:!1,mini:!1},D=[];w=w.split(" ");for(q=0;q<w.length;q++)v=!0,k=d[w[q]],k!==g?(v=!1,y[k]=!0):0===w[q].indexOf("ui-btn-icon-")?(C=v=!1,y.iconpos=w[q].substring(12)):0===w[q].indexOf("ui-icon-")?(v=!1,y.icon=w[q].substring(8)):0===w[q].indexOf("ui-btn-")&&8===w[q].length?(v=!1,y.theme=w[q].substring(7)):"ui-btn"===w[q]&&(v=!1,A=!0),v&&D.push(w[q]);C&&(y.icon="");w={options:y,unknownClasses:D,alreadyEnhanced:A}}k=
...
"#"+ia(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,n=6-m.length;if(0<n){for(var p=[],q=0;q<n;q++)p.push("0");p.push(m);m=p.join("")}m=O(na(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=Z({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
...
(f?document.documentElement.clientHeight:document.body.clientHeight))&&(g-=this.offsetHeight+176);e+356>a+c&&(e=Math.max(0,e-356));d.css({left:e+"px",top:g+"px"});0!=d.data("colorpicker").onShow.apply(this,[d.get(0)])&&d.show();k(document).bind("mousedown",{cal:d},X);return!1},X=function(a){Ha(a.data.cal.get(0),a.target,a.data.cal.get(0))||(0!=a.data.cal.data("colorpicker").onHide.apply(this,[a.data.cal.get(0)])&&a.data.cal.hide(),k(document).unbind("mousedown",X))},Ha=function(a,b,c){if(a==b)return!0;
if(a.contains)return a.contains(b);if(a.compareDocumentPosition)return!!(a.compareDocumentPosition(b)&16);for(b=b.parentNode;b&&b!=c;){if(b==a)return!0;b=b.parentNode}return!1},Z=function(a){return{h:Math.round(Math.min(360,Math.max(0,a.h))),s:Math.round(Math.min(100,Math.max(0,a.s))),b:Math.round(Math.min(100,Math.max(0,a.b)))}},na=function(a){a=parseInt(-1<a.indexOf("#")?a.substring(1):a,16);return{r:a>>16,g:(a&65280)>>8,b:a&255}},O=function(a){var b={h:0,s:0,b:0},c=Math.min(a.r,a.g,a.b),d=Math.max(a.r,
...
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=O(na(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=O(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=Z(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};window.addEventListener("resize",va,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);wa.detect_mobile()||Ta(["gyro_use_tmp"],"disable");Ja.check()||Ta(["hmd_conf_tmp"],"disable");var g=
I.get_url_params();Ua.enqueue([["manifest",Ua.AT_JSON,"assets.json"]],function(a,b,c,Ia){Y=a;Ea=document.getElementById("info_left_down");P=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Va.date_str();r(y,"quality","string");switch(N.get("quality")){case N.P_ULTRA:var k=0;break;case N.P_HIGH:k=1;break;case N.P_LOW:k=2;break;case N.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");I.set_onclick("reset",
D);I.set_onclick("auto_rotate_cam",rb);I.set_onclick("pause",Q);I.set_onclick("resume",M);I.set_onclick("auto_view",ia);I.set_onclick("home",T);a=document.getElementById("manifest");if(Y){c="";b=(b=I.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home - "+b[b.length-1];c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<Y.length;b++){k=Y[b];Ia=k.name;
for(var k=k.items,R="",R=R+"<div data-role='collapsible' data-mini='true' >",R=R+("<h6>"+Ia+"</h6>"),R=R+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,R=R+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+Ia)+'">'+m+"</a></li>");R+="</ul>";R+="</div>";c+=R}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";
f();r(oa,"anim_active_object","string");r(oa,"animation","string");r(oa,"anim_mix_factor","number");r(oa,"anim_slot","number");r(oa,"anim_cyclic","bool");r(oa,"anim_frame_current","number");I.set_onclick("anim_play",lb);I.set_onclick("anim_stop",mb);I.set_onclick("anim_play_all",nb);I.set_onclick("anim_stop_all",ob);r(sb,"nla_frame_current","number");I.set_onclick("nla_play",pb);I.set_onclick("nla_stop",qb);r(Da,"shape_key_obj","string");r(Da,"shape_key_name","string");r(Da,"shape_key_value","number");
r(pa,"material_name","string");fa(pa,"material_diffuse_color");r(pa,"material_reflectivity","number");r(pa,"material_fresnel","number");r(pa,"material_fresnel_factor","number");r(pa,"material_parallax_scale","number");r(pa,"material_parallax_steps","number");r(H,"material_name","string");r(H,"shore_smoothing","bool");r(H,"absorb_factor","number");r(H,"sss_strength","number");r(H,"sss_width","number");fa(H,"water_fog_color");r(H,"water_fog_density","number");fa(H,"shallow_water_col");r(H,"shallow_water_col_fac",
...
r(H,"dst_min_fac","number");r(H,"waves_hor_fac","number");r(Ka,"environment_energy","string");fa(Ka,"horizon_color");fa(Ka,"zenith_color");r(qa,"light_name","string");fa(qa,"light_color");r(qa,"pre_light_energy","number");r(qa,"rude_light_energy","number");r(qa,"light_spot_size","number");r(qa,"light_spot_blend","number");r(qa,"light_distance","number");fa(ba,"sky_color");r(ba,"rayleigh_brightness","number");r(ba,"mie_brightness","number");r(ba,"spot_brightness","number");r(ba,"scatter_strength",
"number");r(ba,"rayleigh_strength","number");r(ba,"mie_strength","number");r(ba,"rayleigh_collection_power","number");r(ba,"mie_collection_power","number");r(ba,"mie_distribution","number");r(La,"date","string");r(La,"day_time","number");r(Wa,"sun_horizontal_position","number");r(Wa,"sun_vertical_position","number");r(tb,"max_sun_angle","number");I.set_onclick("run_sun",ub);I.set_onclick("stop_sun",vb);r(sa,"csm_first_cascade_border","number");r(sa,"csm_last_cascade_border","number");r(sa,"self_shadow_polygon_offset",
"number");r(sa,"self_shadow_normal_offset","number");r(sa,"first_cascade_blur_radius","number");r(sa,"last_cascade_blur_radius","number");r(ga,"ssao_quality","string");r(ga,"ssao_hemisphere","bool");r(ga,"ssao_blur_depth","bool");r(ga,"ssao_blur_discard_value","number");r(ga,"ssao_radius_increase","number");r(ga,"ssao_influence","number");r(ga,"ssao_dist_factor","number");r(ga,"ssao_only","bool");r(ga,"ssao_white","bool");r(xa,"dof_distance","number");r(xa,"dof_front","number");r(xa,"dof_rear","number");
r(xa,"dof_power","number");r(xa,"dof_on","bool");r(Ma,"god_rays_intensity","number");r(Ma,"god_rays_max_ray_length","number");r(Ma,"god_rays_steps","number");r(Fa,"brightness","number");r(Fa,"contrast","number");r(Fa,"exposure","number");r(Fa,"saturation","number");r(Ha,"sfx_mix_mode","bool");a=Number("true"===F.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(Z,"stereo","string");a=F.get("stereo")||"NONE";L.can_use_device(L.DEVICE_HMD)||
(document.getElementById("stereo").options[2].setAttribute("disabled","disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(F.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);I.set_onclick("hmd_settings",na);r(O,"gyro_use","bool");a=Number("true"===F.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(aa,"gmpd_settings","bool");r(Xa,"wind_dir","number");r(Xa,"wind_strength",
"number");r(Ya,"mb_factor","number");r(Ya,"mb_decay_threshold","number");r(Na,"bloom_key","number");r(Na,"bloom_blur","number");r(Na,"bloom_edge_lum","number");r(Ga,"small_glow_mask_coeff","number");r(Ga,"large_glow_mask_coeff","number");r(Ga,"small_glow_mask_width","number");r(Ga,"large_glow_mask_width","number");r(wb,"canvas_rf","number");r(Za,"debug_view_mode","string");I.set_onclick("debug_change_colors",xb);r(yb,"render_time_threshold","number");fa(Za,"wireframe_edge_color","object");r(ja,"show_hud_debug_info",
"bool");r(X,"enable_gl_debug","bool");r(ea,"outlining_overview_mode","bool");a=""==F.get("outlining_overview_mode")?1:Number("true"===F.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");I.set_onclick("make_screenshot",zb);a=Number("true"===F.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");a=""==F.get("enable_gl_debug")?
1:Number("true"===F.get("enable_gl_debug"));document.getElementById("enable_gl_debug").options[a].selected=!0;$("#enable_gl_debug").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));
188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a,b){if(Ea&&z.can_select_objects()){$("#material_warning")[0].style.display="none";var d=U;d&&z.outlining_is_enabled(d)&&z.clear_outline_anim(d);d=z.pick_object(a,b);d&&Ab.is_empty(d)||((U=d)?$a(d):ab(),c(),ka||(d?(ka=d,c(),I.enable_object_controls(d),K.create_kb_sensor_manifold(d,"QUIT",K.CT_SHOT,K.KEY_Q,function(a,b,d,e){ka=null;c();I.disable_object_controls(a)})):g()))}}function g(){var a=z.get_active_camera();ka=a;c();I.enable_camera_controls(!1,
!1,!1,ya.get_container(),!0);K.create_kb_sensor_manifold(a,"QUIT",K.CT_SHOT,K.KEY_Q,function(a,b,d,e){ka=null;c();I.disable_camera_controls(a);K.remove_sensor_manifold(a,"ZOOM_TO")});var b=K.create_keyboard_sensor(K.KEY_Z),d=K.create_keyboard_sensor(K.KEY_DEC_POINT);K.create_sensor_manifold(a,"ZOOM_TO",K.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&bb.target_zoom_object(a,b)})}function c(){if(Ea){var a=ka?la(ka):"NONE",b=U?la(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=
U)&&(b=z.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=ka;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+cb);Ea.innerHTML=a}}function d(){var a=F.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];if(za.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+a).selectmenu();
$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){Aa=!1;clearTimeout(Oa);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];Aa=!1;clearTimeout(Oa);h({category:a,item:b},!0,!1,!1)}}function h(a,b,c,d){if(P)for(var e=0;e<P.children.length;e++)P.children[e].style.visibility="hidden";if((e=I.get_url_params())&&e.load){var f=e.load.split("/");
ta={load_file:e.load,name:f[f.length-1].split(".")[0]}}else ta={load_file:N.get_std_assets_path()+"misc/logo.json",name:"Logo"};ca=G=null;if(!d)if(a){d=za.keyfind("name",a.category,Y)[0];d=za.keyfind("name",a.item,d.items)[0];for(var g in d)ta[g]="load_file"==g?N.get_std_assets_path()+d[g]:d[g];F.set("last_item_name",a.item)}else F.set("last_item_name","");b&&(wa.clear_render_callback(),Pa.cleanup());p(!1);J.clear_errors_warnings();a=ta.name;b=ta.load_file;g=document.getElementById("current_file");
g.innerHTML=a;g.setAttribute("title",a+" ("+b+")");Pa.load(b,q,E,c)}function l(){var b=ya.get_canvas(),b=L.get_device_by_type_element(L.DEVICE_MOUSE,b),b=L.get_vector_param(b,L.MOUSE_LOCATION,Bb);a(b[0],b[1])}function m(b){for(var c=0;c<b.length;c++)a(b[c].clientX,b[c].clientY)}function p(a){var b=ya.get_canvas(),c=L.get_device_by_type_element(L.DEVICE_MOUSE,b);c&&(a?L.attach_param_cb(c,L.MOUSE_DOWN_WHICH,l):L.detach_param_cb(c,L.MOUSE_DOWN_WHICH,l));(b=L.get_device_by_type_element(L.DEVICE_TOUCH,
b))&&(a?L.attach_param_cb(b,L.TOUCH_START,m):L.detach_param_cb(b,L.TOUCH_START,m))}function q(a){p(!0);U=null;w(ta);g();I.enable_debug_controls();da()&&Cb.enable_mixer_controls();"true"===F.get("gyro_use")&&Db.enable_camera_rotation();"HMD"==N.get("stereo")&&(Ja.update(),db.enable_hmd(db.HMD_ALL_AXES_MOUSE_NONE));wa.set_render_callback(C);Aa&&(Oa=setTimeout(ha,1E3));a=K.create_elapsed_sensor();K.create_sensor_manifold(z.get_active_camera(),"TO_OBJ",K.CT_CONTINUOUS,[a],null,function(a,b,d){if(1==d&&
U){if(d=U)b=Eb,Fb.get_object_center(d,!0,b),a=bb.get_translation(a,Gb),cb=Hb.dist(b,a).toFixed(3);c()}})}function ha(){var a=d();if(a){var b=a.item,a=za.keyfind("name",a.category,Y)[0],b=za.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=Y.indexOf(a);b=null;do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{Aa=!1;return}}}else a=Y[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function E(a,
b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=J.get_error_quantity(),d=J.get_warning_quantity();if(Pa.is_primary_loaded()){va();var e=J.num_vertices(),f=J.num_triangles(),g=J.num_draw_calls(),h=J.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=J.geometry_stats(),f=J.num_textures(),g=J.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*
f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=J.get_error_quantity();(f=J.get_warning_quantity())||e?P.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):P.setAttribute("title","Loaded OK");d||c||(P.children[0].style.visibility="hidden",
P.children[1].style.visibility="hidden",P.children[2].style.visibility="visible")}d&&!c&&(P.children[0].style.visibility="hidden",P.children[1].style.visibility="visible",P.children[2].style.visibility="hidden");c&&(P.children[0].style.visibility="visible",P.children[1].style.visibility="hidden",P.children[2].style.visibility="hidden")}function w(a){for(var c=z.get_active(),d=z.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=v(f,a);A(f,g)}}g=v(c,a);A(c,g);$a=function(a){var c=ra.get_materials_names(a);
b("material_name",c);eb(a,c[0]);a=ra.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");a?(x(c,"enable"),
z.get_water_mat_params(a),a.shallow_water_col&&ma("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&ma("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(ma("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),u("foam_factor",
a.foam_factor),u("norm_uv_velocity",a.norm_uv_velocity),u("waves_height",a.waves_height),u("waves_length",a.waves_length),u("dst_noise_scale0",a.dst_noise_scale0),u("dst_noise_scale1",a.dst_noise_scale1),u("dst_noise_freq0",a.dst_noise_freq0),u("dst_noise_freq1",a.dst_noise_freq1),u("dir_min_shore_fac",a.dir_min_shore_fac),u("dir_freq",a.dir_freq),u("dir_noise_scale",a.dir_noise_scale),u("dir_noise_freq",a.dir_noise_freq),u("dir_min_noise_fac",a.dir_min_noise_fac),u("dst_min_fac",a.dst_min_fac),u("waves_hor_fac",
a.waves_hor_fac)):x(c,"disable")};Ib();a=z.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(la(a[e]));b("light_name",c);0<a.length&&fb(a[0]);Jb();Kb();Lb();Mb();Nb();Ob();Pb();Qb();Rb();Sb();Tb();Ub();ab();$("#debug_view_mode").val("DV_NONE");$("#debug_view_mode").selectmenu("refresh",!0);x(["debug_change_colors"],"disable");x(["render_time_threshold"],"disable");$("#wireframe_edge_color div").css("backgroundColor","#333");$("#render_time_threshold").trigger("change");e=new Date(document.getElementById("date").value);
La({date:e})}function v(a,b){function c(a,b){for(var d in a)b[d]=a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function A(a,c){z.set_active(a);z.get_active_camera();for(var d=[],e=z.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(G||(G=g),d.push(la(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");G?(x(f,"enable"),b("anim_active_object",
d),oa({anim_active_object:la(G)})):x(f,"disable");d=["nla_play","nla_stop","nla_status","nla_frame_current","nla_playing"];f=["nla_frame_range"];if(S.check_nla()){S.check_nla_scripts()?(x(d,"disable"),document.getElementById("nla_status").innerHTML="CONTROLLED BY NLA SCRIPT"):x(d,"enable");x(f,"enable");var d=document.getElementById("nla_frame_current"),f=document.getElementById("nla_frame_range"),g=S.get_frame_start(),h=S.get_frame_end();-1!=g&&-1!=h?(f.innerHTML=g+" - "+h,d.min=""+g,d.max=""+h):
f.innerHTML="N/A"}else x(d,"disable"),x(f,"disable");d=[];for(f=0;f<e.length;f++)g=e[f],Ba.check_shape_keys(g)&&(ca||(ca=g),d.push(la(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ca?(x(e,"enable"),b("shape_key_obj",d),Da({shape_key_obj:la(ca)})):x(e,"disable")}function C(a,b){z.get_active_camera();if(G){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(G,d)?(d=Math.round(B.get_frame(G,d)),parseInt($("#anim_frame_current").val())!==
d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):c.innerHTML="STOPPED"}S.check_nla()&&(S.check_nla_scripts()||(c=document.getElementById("nla_status"),S.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(S.get_frame().toFixed(0)),S.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function y(a){F.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function D(){F.cleanup();var a=window.location.href.replace(/load=.*?(&|$)/,
"").replace(/(&|\?)$/,"");window.location.href=a}function T(){h(null,!0,!1,!0)}function Q(){wa.pause()}function M(){wa.resume()}function da(){return"true"===F.get("sfx_mix_mode")?!0:!1}function ja(a){F.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function X(a){F.set("enable_gl_debug",a.enable_gl_debug);window.location.reload()}function Ha(a){F.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function Z(a){F.set("stereo",a.stereo);window.location.reload()}function na(a){Ja.show("hmd_container")}
function O(a){F.set("gyro_use",a.gyro_use);window.location.reload()}function aa(a){a.gmpd_settings?gb.show():gb.hide()}function ea(a){F.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}function ia(){Aa=!0;ha()}function va(a){ya.resize_to_container(!0);a=ya.get_canvas();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+(a.width/a.clientWidth).toFixed(2)+":1.00)"}function lb(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);
"None"!==a&&B.play(G,null,b)}function mb(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);B.stop(G,a)}function nb(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ua(a[b].value);B.play(c,null,B.SLOT_ALL)}}function ob(){for(var a=document.getElementById("anim_active_object").children,b=0;b<a.length;b++){var c=ua(a[b].value);B.stop(c,B.SLOT_ALL)}}function pb(){S.play()}function qb(){S.stop()}function Da(a){if("shape_key_obj"in
a){ca=ua(a.shape_key_obj);var c=Ba.get_shape_keys_names(ca);c.length?(b("shape_key_name",c),Ca=c[0],c=Ba.get_shape_key_value(ca,Ca),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&(Ca=a.shape_key_name,c=Ba.get_shape_key_value(ca,Ca),u("shape_key_value",c));"shape_key_value"in a&&Ba.set_shape_key_value(ca,Ca,a.shape_key_value)}function sb(a){"nla_frame_current"in a&&!S.is_play()&&(a=parseInt(a.nla_frame_current),S.set_frame(a))}function oa(a){if("anim_active_object"in a){G=
ua(a.anim_active_object);var c=B.get_anim_names(G);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);hb(G,c);Qa(G,c)}else b("animation",["N/A"]);Ra(G)}if("anim_slot"in a){if(!G)return;c=a.anim_slot;hb(G,c);Qa(G,c);Ra(G)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.get_current_anim_name(G,c),"None"==a.animation?B.remove_slot_animation(G,c):(B.apply(G,a.animation,
c),B.play(G,null,c)),Qa(G,c),Ra(G));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=B.get_slot_num_by_anim(G,c),B.set_behavior(G,a.anim_cyclic?B.AB_CYCLIC:B.AB_FINISH_RESET,c));"anim_frame_current"in a&&(c=parseInt(document.getElementById("anim_slot").value),B.is_play(G,c)||(d=parseInt(a.anim_frame_current),B.set_frame(G,d,c)));"anim_mix_factor"in a&&B.set_skel_mix_factor(G,a.anim_mix_factor)}function hb(a,b){for(var c=B.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),
e=d.children(),f=0;f<e.length;f++){var g=e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Qa(a,b){u("anim_cyclic",Number(B.get_behavior(a,b)==B.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),d=B.get_anim_start_frame(a,b),e=B.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Ra(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),
...
"disable")}function ga(a){z.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=ib(document.getElementById("ssao_quality")));"ssao_hemisphere"in a&&(b.ssao_hemisphere=Number(a.ssao_hemisphere));"ssao_blur_depth"in a&&(b.ssao_blur_depth=Number(a.ssao_blur_depth));"ssao_blur_discard_value"in a&&(b.ssao_blur_discard_value=a.ssao_blur_discard_value);"ssao_radius_increase"in a&&(b.ssao_radius_increase=a.ssao_radius_increase);"ssao_influence"in a&&(b.ssao_influence=a.ssao_influence);"ssao_dist_factor"in
a&&(b.ssao_dist_factor=a.ssao_dist_factor);"ssao_only"in a&&(b.ssao_only=Number(a.ssao_only));"ssao_white"in a&&(b.ssao_white=Number(a.ssao_white));z.set_ssao_params(b)}function Nb(){var a=z.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(x(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):x(b,"disable")}function Fa(a){var b=z.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=
parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in a&&(b.saturation=parseFloat(a.saturation)),z.set_color_correction_params(b))}function ib(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function Jb(){var a=z.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");
...
"none",document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function Ib(){var a=z.get_environment_colors();u("environment_energy",a[0]);ma("horizon_color",a[1]);ma("zenith_color",a[2])}function Ka(a){("environment_energy"in a||"horizon_color"in a||"zenith_color"in a)&&z.set_environment_colors(a.environment_energy,a.horizon_color,a.zenith_color)}function Za(a){var b={};if("string"==typeof a.debug_view_mode){var c=
ib(document.getElementById("debug_view_mode"));switch(c){case "DV_NONE":b.debug_view_mode=J.DV_NONE;break;case "DV_OPAQUE_WIREFRAME":b.debug_view_mode=J.DV_OPAQUE_WIREFRAME;break;case "DV_TRANSPARENT_WIREFRAME":b.debug_view_mode=J.DV_TRANSPARENT_WIREFRAME;break;case "DV_FRONT_BACK_VIEW":b.debug_view_mode=J.DV_FRONT_BACK_VIEW;break;case "DV_DEBUG_SPHERES":b.debug_view_mode=J.DV_DEBUG_SPHERES;break;case "DV_CLUSTERS_VIEW":b.debug_view_mode=J.DV_CLUSTERS_VIEW;break;case "DV_BATCHES_VIEW":b.debug_view_mode=
J.DV_BATCHES_VIEW;break;case "DV_RENDER_TIME":b.debug_view_mode=J.DV_RENDER_TIME}"DV_CLUSTERS_VIEW"==c||"DV_BATCHES_VIEW"==c?x(["debug_change_colors"],"enable"):x(["debug_change_colors"],"disable");"DV_RENDER_TIME"==c?x(["render_time_threshold"],"enable"):x(["render_time_threshold"],"disable")}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);J.set_debug_params(b)}function xb(){J.set_debug_params({debug_colors_seed:Math.random()})}function yb(a){"render_time_threshold"in
a&&J.set_debug_params({render_time_threshold:a.render_time_threshold})}function zb(){Vb.shot()}function Qb(){var a=z.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");if(!a)return x(b,"disable"),null;x(b,"enable");ma("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);u("spot_brightness",a.spot_brightness);
...
a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!ra.set_water_material_params(b,$("#material_name").val(),d))return null;z.update_scene_materials_params();z.set_water_params(d)}function fb(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);ma("light_color",a.light_color);u("rude_light_energy",
c);u("pre_light_energy",b);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(x(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Wb))):x(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(x(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",a.light_distance)):
x(["light_distance"],"disable")}}function qa(a){"light_name"in a&&fb(ua(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*Xb));"light_spot_blend"in
a&&(b.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(b.light_distance=parseFloat(a.light_distance));a=ua($("#light_name").val());V.set_light_params(a,b);b=V.get_light_params(a).light_energy.toFixed(2);$("#light_energy").text(b)}function Pb(){var a=V.get_sun_params(),b=["sun_horizontal_position","sun_vertical_position"];if(!a)return x(b,"disable"),null;u("sun_horizontal_position",a.hor_position);u("sun_vertical_position",a.vert_position)}function Wa(a){var b={};"sun_horizontal_position"in
a&&(b.hor_position=parseFloat(a.sun_horizontal_position),b.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(b.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),b.vert_position=parseFloat(a.sun_vertical_position));V.set_sun_params(b)}function tb(a){a=parseFloat(a.max_sun_angle);V.set_max_sun_angle(a)}function La(a){"day_time"in a&&V.set_day_time(a.day_time);"date"in a&&V.set_date(new Date(a.date))}function ub(){var a=
0,b=parseFloat(document.getElementById("day_time").value),c=K.create_elapsed_sensor(),d=V.get_lamps("SUN")[0];K.create_sensor_manifold(d,"ELAPSED",K.CT_CONTINUOUS,[c],function(a){return a[0]},function(c,d,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,c=K.get_sensor_value(c,d,0),b+=c*a/3600,24<b&&(b-=Math.floor(b)),u("day_time",b))})}function Ub(){var a=V.get_lamps("SUN")[0],b=["sn-ui-grid-b"];V.get_lamps().length?a||x("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),
"disable"):x(b,"disable")}function ab(){x("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");x("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function vb(){var a=V.get_lamps("SUN")[0];K.check_sensor_manifolds(a)&&K.remove_sensor_manifold(a,"ELAPSED")}function Lb(){var a=z.get_dof_params(),b="dof_distance dof_object dof_front dof_rear dof_power dof_on".split(" ");if(a){u("dof_front",a.dof_front);u("dof_rear",a.dof_rear);u("dof_power",a.dof_power);$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=la(a.dof_object);$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");
$("#dof_object").parent().removeClass("ui-disabled")}else u("dof_distance",a.dof_distance),b.splice(1,1),$("#dof_distance").parent().removeClass("ui-disabled"),$("#dof_object").parent().addClass("ui-disabled");x(b,"enable");a=0<a.dof_distance?1:0;document.getElementById("dof_on").options[a].selected=!0;$("#dof_on").slider("refresh")}else x(b,"disable")}function xa(a){var b={};"dof_distance"in a&&Number($("#dof_on").val())&&(b.dof_distance=a.dof_distance);"dof_front"in a&&(b.dof_front=a.dof_front);
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean(a.dof_on));z.set_dof_params(b)}function Mb(){var a=z.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(x(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):x(b,"disable")}function Ma(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=
a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);z.set_god_rays_params(b)}function wb(a){"canvas_rf"in a&&(N.set("canvas_resolution_factor",a.canvas_rf),va())}function Rb(){var a=z.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(x(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",a.mb_decay_threshold))):x(b,"disable")}function Ya(a){var b={};"mb_factor"in a&&
(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);z.set_mb_params(b)}function Sb(){var a=z.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(x(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):x(b,"disable")}function Na(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);
z.set_bloom_params(b)}function Tb(){var a=z.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(x(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):x(b,"disable")}function Ga(a){var b={};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);
"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);z.set_glow_material_params(b)}function ma(a,b){var c=Sa.rgb_to_css(b),d=Sa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",d)}function Ob(){var a=z.get_wind_params(),b=["wind_dir","wind_strength"];a?
(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):x(b,"disable")}function Xa(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);z.set_wind_params(b)}function u(a,b){var c=$("#"+a);c.val(b);c.slider("refresh")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),
null}a(e)})}function fa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Sa.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function rb(){Yb.auto_rotate(.3)}function x(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function Ta(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]);"enable"==b?d.removeClass("ui-disabled"):
"disable"==b&&d.addClass("ui-disabled")}}function la(a){return z.get_object_name_hierarchy(a).join("->")}function ua(a){return z.get_object_by_dupli_name_list(a.split("->"))}var B=n("animation"),I=n("app"),Ua=n("assets"),bb=n("camera"),Yb=n("camera_anim"),N=n("config");n("constraints");var ya=n("container"),K=n("controls"),Pa=n("data"),J=n("debug"),gb=n("gp_conf"),Ja=n("hmd_conf"),Ba=n("geometry"),Db=n("gyroscope"),L=n("input"),V=n("lights"),wa=n("main"),db=n("hmd"),Cb=n("mixer"),ra=n("material"),
S=n("nla"),Ab=n("objects"),Sa=n("rgb"),Vb=n("screenshooter"),z=n("scenes"),F=n("storage"),Fb=n("transform"),za=n("util"),Va=n("version"),Hb=n("vec3"),kb="DEBUG"===Va.type(),Xb=Math.PI/180,Wb=180/Math.PI,Bb=new Float32Array(2),Eb=new Float32Array(3),Gb=new Float32Array(3),Aa=!1,Oa,Y=null,G=null,ca=null,Ca="",ta=null,Ea=null,P=null,U=null,$a=function(){},ka=null,cb=null;k.init=function(){F.init("b4w_viewer");var a=F.get("quality");if(a){switch(a){case "ULTRA":var b=N.P_ULTRA;break;case "HIGH":b=N.P_HIGH;
break;case "LOW":b=N.P_LOW;break;case "CUSTOM":b=N.P_CUSTOM}N.set("quality",b)}N.set("stereo",F.get("stereo")||"NONE");""==F.get("outlining_overview_mode")?N.set("outlining_overview_mode",!0):N.set("outlining_overview_mode","true"===F.get("outlining_overview_mode"));I.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:""==F.get("enable_gl_debug")?!0:"true"===F.get("enable_gl_debug"),show_hud_debug_info:"true"===F.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:da(),
show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!kb,assets_min50_available:!kb,console_verbose:!0,physics_enabled:!0,debug_view:!0})}});b4w.require("viewer_main").init();
