...
var f;if(b)for(f in b)if(b[f])return!0;return!1}function n(){}function t(b){var f=b.substr(1);return{setup:function(){E(this)||a.data(this,"virtualMouseBindings",{});a.data(this,"virtualMouseBindings")[b]=!0;v[b]=(v[b]||0)+1;1===v[b]&&T.bind(f,l);a(this).bind(f,n);W&&(v.touchstart=(v.touchstart||0)+1,1===v.touchstart&&T.bind("touchstart",m).bind("touchend",k).bind("touchmove",q).bind("scroll",p))},teardown:function(){--v[b];v[b]||T.unbind(f,l);W&&(--v.touchstart,v.touchstart||T.unbind("touchstart",
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,n);E(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var z="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},D=0,P=0,Q=0,M=!1,ha=[],ia=!1,X=!1,W="addEventListener"in c,T=a(c),na=1,N=0,Z,ca;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(ca=0;ca<g.length;ca++)a.event.special[g[ca]]=t(g[ca]);W&&c.addEventListener("click",function(b){var f=ha.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ha[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
fa=q.attr("id")||k+"-label",E=d?0:parseFloat(c.attr("min")),w=d?c.find("option").length-1:parseFloat(c.attr("max")),x=n.parseFloat(c.attr("step")||1),z=t.createElement("a"),C=a(z),k=t.createElement("div"),v=a(k),D=this.options.highlight&&!d?function(){var b=t.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass;return a(b).prependTo(v)}():!1;q.attr("id",fa);this.isToggleSwitch=d;z.setAttribute("href","#");k.setAttribute("role","application");k.className=[this.isToggleSwitch?"ui-slider ui-slider-track ui-shadow-inset ":
...
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},ca=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ga=function(a){return ca(Z(a))},Ha=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},W,n||{});
...
"waves_hor_fac","number");r(Ma,"environment_energy","string");da(Ma,"horizon_color");da(Ma,"zenith_color");r(pa,"light_name","string");da(pa,"light_color");r(pa,"pre_light_energy","number");r(pa,"rude_light_energy","number");r(pa,"light_spot_size","number");r(pa,"light_spot_blend","number");r(pa,"light_distance","number");da(aa,"sky_color");r(aa,"rayleigh_brightness","number");r(aa,"mie_brightness","number");r(aa,"spot_brightness","number");r(aa,"scatter_strength","number");r(aa,"rayleigh_strength",
...
"number");r(va,"dof_on","bool");r(Oa,"god_rays_intensity","number");r(Oa,"god_rays_max_ray_length","number");r(Oa,"god_rays_steps","number");r(Da,"brightness","number");r(Da,"contrast","number");r(Da,"exposure","number");r(Da,"saturation","number");r(M,"sfx_mix_mode","bool");a=Number("true"===I.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(ha,"stereo","string");a=I.get("stereo")||"NONE";wa.can_use_device(wa.DEVICE_HMD)||
(document.getElementById("stereo").options[2].setAttribute("disabled","disabled"),$("#stereo").selectmenu("refresh"),"HMD"==a&&(I.set("stereo","NONE"),a="NONE"));$("#stereo").val(a).selectmenu("refresh");$("#stereo").selectmenu("refresh",!0);"HMD"==a&&Ea.enable_hmd(Ea.HMD_ALL_AXES_MOUSE_NONE);r(ia,"gyro_use","bool");a=Number("true"===I.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Xa,"wind_dir","number");r(Xa,"wind_strength","number");
r(Ya,"mb_factor","number");r(Ya,"mb_decay_threshold","number");r(Pa,"bloom_key","number");r(Pa,"bloom_blur","number");r(Pa,"bloom_edge_lum","number");r(Fa,"small_glow_mask_coeff","number");r(Fa,"large_glow_mask_coeff","number");r(Fa,"small_glow_mask_width","number");r(Fa,"large_glow_mask_width","number");r(ob,"canvas_rf","number");r(Za,"wireframe_mode","string");da(Za,"wireframe_edge_color","object");r(Q,"show_hud_debug_info","bool");r(X,"outlining_overview_mode","bool");a=""==I.get("outlining_overview_mode")?
1:Number("true"===I.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");H.set_onclick("make_screenshot",pb);a=Number("true"===I.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");W();a=d();h(a,!1,!1,g&&g.load)},null)}function W(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",
function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ca&&A.can_select_objects()){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=U;d&&A.outlining_is_enabled(d)&&A.clear_outline_anim(d);b=A.pick_object(b,a);b&&qb.is_empty(b)||
((U=b)?$a(b):ab(),c(),ja||(b?(ja=b,c(),H.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ja=null;c();H.disable_object_controls(a)})):g()))}}function g(){var a=A.get_active_camera();ja=a;c();H.enable_camera_controls(!1,!1,!1,Ga.get_container(),!0);J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){ja=null;c();H.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);
J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&bb.target_zoom_object(a,b)})}function c(){if(Ca){var a=ja?ka(ja):"NONE",b=U?ka(U):"NONE",a="CONTROLLED: "+a+" | SELECTED: "+b;(b=U)&&(b=A.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=ja;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+cb);Ca.innerHTML=a}}function d(){var a=I.get("last_item_name");if(!a)return null;for(var b=0;b<Y.length;b++){var c=Y[b];if(xa.keyfind("name",a,c.items)[0])return{category:c.name,
...
ya=!1;clearTimeout(Qa);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<O.children.length;f++)O.children[f].style.visibility="hidden";if((f=H.get_url_params())&&f.load){var g=f.load.split("/");sa={load_file:f.load,name:g[g.length-1].split(".")[0],animated_objects:[]}}else sa={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ba=F=null;if(!e)if(b){e=xa.keyfind("name",b.category,Y)[0];e=xa.keyfind("name",b.item,e.items)[0];for(var h in e)sa[h]=
"load_file"==h?K.get_std_assets_path()+e[h]:e[h];I.set("last_item_name",b.item)}else I.set("last_item_name","");c&&(ua.clear_render_callback(),Ra.cleanup());Ga.get_canvas().removeEventListener("mousedown",a);L.clear_errors_warnings();b=sa.name;c=sa.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Ra.load(c,l,p,d)}function l(b){Ga.get_canvas().addEventListener("mousedown",a,!1);U=null;q(sa);g();H.enable_debug_controls();P()&&rb.enable_mixer_controls();
K.get("gyro_use")&&sb.enable_camera_rotation();"HMD"==K.get("stereo")&&(b=wa.get_device_by_type_element(wa.DEVICE_HMD),wa.register_device(b),Ea.enable_hmd(Ea.HMD_ALL_AXES_MOUSE_NONE));ua.set_render_callback(w);ya&&(Qa=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(A.get_active_camera(),"TO_OBJ",J.CT_CONTINUOUS,[b],null,function(a,b,d){if(1==d&&U){if(d=U)b=tb,ub.get_object_center(d,!0,b),a=bb.get_translation(a,vb),cb=wb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=
a.item,a=xa.keyfind("name",a.category,Y)[0],b=xa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=Y.indexOf(a);b=null;do b=Y[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{ya=!1;return}}}else a=Y[0],b=a.items[0],a={category:a.name,item:b.name};h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();
if(Ra.is_primary_loaded()){T();var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+
"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=L.get_error_quantity();(f=L.get_warning_quantity())||e?O.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):O.setAttribute("title","Loaded OK");d||c||(O.children[0].style.visibility="hidden",O.children[1].style.visibility="hidden",O.children[2].style.visibility="visible")}d&&!c&&(O.children[0].style.visibility="hidden",O.children[1].style.visibility=
"visible",O.children[2].style.visibility="hidden");c&&(O.children[0].style.visibility="visible",O.children[1].style.visibility="hidden",O.children[2].style.visibility="hidden")}function q(a){for(var c=A.get_active(),d=A.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=fa(f,a);E(f,g)}}g=fa(c,a);E(c,g);$a=function(a){var c=qa.get_materials_names(a);b("material_name",c);db(a,c[0]);a=qa.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
a?(y(c,"enable"),A.get_water_mat_params(a),a.shallow_water_col&&la("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&la("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(la("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):y(c,"disable")};xb();a=A.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(ka(a[e]));b("light_name",c);0<a.length&&eb(a[0]);yb();jb();zb();Ab();Bb();Cb();Db();Eb();Fb();Gb();Hb();Ib();ab();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);Na({date:e})}function fa(a,b){function c(a,b){for(var d in a)b[d]=
a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function E(a,c){A.set_active(a);A.get_active_camera();for(var d=[],e=A.get_all_objects(),f=0;f<e.length;f++){var g=e[f];B.is_animated(g)&&(F||(F=g),d.push(ka(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");F?(y(f,"enable"),b("anim_active_object",d),ma({anim_active_object:ka(F)})):y(f,"disable");
...
d=[];for(f=0;f<e.length;f++)g=e[f],za.check_shape_keys(g)&&(ba||(ba=g),d.push(ka(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ba?(y(e,"enable"),b("shape_key_obj",d),Ba({shape_key_obj:ka(ba)})):y(e,"disable")}function w(a,b){A.get_active_camera();if(F){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);B.is_play(F,d)?(d=Math.round(B.get_frame(F,d)),parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):
c.innerHTML="STOPPED"}S.check_nla()&&(S.check_nla_scripts()||(c=document.getElementById("nla_status"),S.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(S.get_frame().toFixed(0)),S.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function x(a){I.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function z(){I.cleanup();var a=window.location.href.replace(/load=.*?(&|$)/,"").replace(/(&|\?)$/,"");window.location.href=a}function C(){h(null,
...
u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else y(b,"disable")}function ea(a){A.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=fb(document.getElementById("ssao_quality")));"ssao_hemisphere"in
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function xb(){var a=A.get_environment_colors();u("environment_energy",a[0]);la("horizon_color",a[1]);la("zenith_color",a[2])}function Ma(a){("environment_energy"in a||"horizon_color"in a||"zenith_color"in a)&&A.set_environment_colors(a.environment_energy,a.horizon_color,a.zenith_color)}function Za(a){var b={};if("string"==typeof a.wireframe_mode)switch(fb(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=
L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function pb(){Jb.shot()}function Eb(){var a=A.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");
...
a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);qa.set_material_extended_params(b,$("#material_name").val(),c);A.update_scene_materials_params()}function G(a){var b=U,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");
...
"dir_noise_freq"in a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!qa.set_water_material_params(b,$("#material_name").val(),d))return null;A.update_scene_materials_params();A.set_water_params(d)}function eb(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);la("light_color",a.light_color);
u("rude_light_energy",c);u("pre_light_energy",b);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(y(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Kb))):y(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(y(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",
...
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean(a.dof_on));A.set_dof_params(b)}function Ab(){var a=A.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(y(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):y(b,"disable")}function Oa(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=
a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);A.set_god_rays_params(b)}function ob(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),T())}function Fb(){var a=A.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(y(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",a.mb_decay_threshold))):y(b,"disable")}function Ya(a){var b={};"mb_factor"in a&&(b.mb_factor=
a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);A.set_mb_params(b)}function Gb(){var a=A.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(y(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):y(b,"disable")}function Pa(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);A.set_bloom_params(b)}
function Hb(){var a=A.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(y(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):y(b,"disable")}function Fa(a){var b={};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in
a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);A.set_glow_material_params(b)}function la(a,b){var c=Sa.rgb_to_css(b),d=Sa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",d)}function Cb(){var a=A.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),
u("wind_strength",a.wind_strength)):y(b,"disable")}function Xa(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);A.set_wind_params(b)}function u(a,b){var c=$("#"+a);c.val(b);c.slider("refresh")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),
null}a(e)})}function da(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Sa.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function kb(){Mb.auto_rotate(.3)}function y(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==b&&d.addClass("ui-disabled")}}function ka(a){return A.get_object_name_hierarchy(a).join("->")}function ta(a){return A.get_object_by_dupli_name_list(a.split("->"))}
var B=n("animation"),H=n("app"),Ua=n("assets"),bb=n("camera"),Mb=n("camera_anim"),K=n("config");n("constraints");var Ga=n("container"),J=n("controls"),Ra=n("data"),L=n("debug"),za=n("geometry"),sb=n("gyroscope"),wa=n("input"),V=n("lights"),ua=n("main"),Ea=n("hmd"),rb=n("mixer"),qa=n("material"),S=n("nla"),qb=n("objects"),Sa=n("rgb"),Jb=n("screenshooter"),A=n("scenes"),I=n("storage"),ub=n("transform"),xa=n("util"),Va=n("version"),wb=n("vec3"),hb="DEBUG"===Va.type(),Lb=Math.PI/180,Kb=180/Math.PI,tb=
new Float32Array(3),vb=new Float32Array(3),ya=!1,Qa,Y=null,F=null,ba=null,Aa="",sa=null,Ca=null,O=null,U=null,$a=function(){},ja=null,cb=null;k.init=function(){I.init("b4w_viewer");var a=I.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("stereo",I.get("stereo")||"NONE");K.set("gyro_use","true"===I.get("gyro_use"));""==I.get("outlining_overview_mode")?K.set("outlining_overview_mode",
!0):K.set("outlining_overview_mode","true"===I.get("outlining_overview_mode"));H.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===I.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:P(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!hb,assets_min50_available:!hb,console_verbose:!0,physics_enabled:!0,wireframe_debug:!0})}});b4w.require("viewer_main").init();
