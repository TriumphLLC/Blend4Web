...
function l(b){var f=a.data(b.target,"virtualTouchID");ka||N&&N===f||!(f=h("v"+b.type,b))||(f.isDefaultPrevented()&&b.preventDefault(),f.isPropagationStopped()&&b.stopPropagation(),f.isImmediatePropagationStopped()&&b.stopImmediatePropagation())}function m(c){var e=b(c).touches,d;e&&1===e.length&&(d=c.target,e=f(d),e.hasVirtualBinding&&(N=da++,a.data(d,"virtualTouchID",N),B&&(clearTimeout(B),B=0),M=W=!1,d=b(c).touches[0],S=d.pageX,P=d.pageY,h("vmouseover",c,e),h("vmousedown",c,e)))}function p(a){W||
(M||h("vmousecancel",a,f(a.target)),M=!0,e())}function q(c){if(!W){var d=b(c).touches[0],m=M,l=a.vmouse.moveDistanceThreshold,p=f(c.target);(M=M||Math.abs(d.pageX-S)>l||Math.abs(d.pageY-P)>l)&&!m&&h("vmousecancel",c,p);h("vmousemove",c,p);e()}}function k(a){if(!W){W=!0;var c=f(a.target),d;h("vmouseup",a,c);M||(d=h("vclick",a,c))&&d.isDefaultPrevented()&&(d=b(a).changedTouches[0],ja.push({touchID:N,x:d.clientX,y:d.clientY}),ka=!0);h("vmouseout",a,c);M=!1;e()}}function D(b){b=a.data(b,"virtualMouseBindings");
...
m).unbind("touchmove",q).unbind("touchend",k).unbind("scroll",p));var c=a(this),e=a.data(this,"virtualMouseBindings");e&&(e[b]=!1);c.unbind(f,w);D(this)||c.removeData("virtualMouseBindings")}}}g="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" ");var t="clientX clientY pageX pageY screenX screenY".split(" "),C=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},B=0,S=0,P=0,M=!1,ja=[],ka=!1,W=!1,la="addEventListener"in c,Y=a(c),da=1,N=0,Z,T;a.vmouse=
{moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(T=0;T<g.length;T++)a.event.special[g[T]]=n(g[T]);la&&c.addEventListener("click",function(b){var f=ja.length,c=b.target,e,d,h,m,l;if(f)for(e=b.clientX,d=b.clientY,Z=a.vmouse.clickDistanceThreshold,h=c;h;){for(m=0;m<f;m++)if(l=ja[m],h===c&&Math.abs(l.x-e)<Z&&Math.abs(l.y-d)<Z||a.data(h,"virtualTouchID")===l.touchID){b.preventDefault();b.stopPropagation();return}h=h.parentNode}},!0)})(k,n,t);(function(a,g,c){function d(b,
...
this.listbox.one({popupafteropen:a.proxy(this,"_focusMenuItem")})},_buildList:function(){var c=this.options,b=this.placeholder,f=!0,e,h,g;e="data-"+a.mobile.ns;var k=e+"option-index",p=e+"icon",q=e+"role",n=e+"placeholder",D=t.createDocumentFragment(),w=!1,y,A,C,v,B,S,P,M;this.list.empty().filter(".ui-listview").listview("destroy");e=this._selectOptions();h=e.length;g=this.select[0];for(A=0;A<h;A++,w=!1)C=e[A],v=a(C),v.hasClass("ui-screen-hidden")||(B=C.parentNode,M=[],S=v.text(),P=t.createElement("a"),
P.setAttribute("href","#"),P.appendChild(t.createTextNode(S)),B!==g&&"optgroup"===B.nodeName.toLowerCase()&&(B=B.getAttribute("label"),B!==y&&(y=t.createElement("li"),y.setAttribute(q,"list-divider"),y.setAttribute("role","option"),y.setAttribute("tabindex","-1"),y.appendChild(t.createTextNode(B)),D.appendChild(y),y=B)),!f||C.getAttribute("value")&&0!==S.length&&!v.jqmData("placeholder")||(f=!1,w=!0,null===C.getAttribute(n)&&(this._removePlaceholderAttr=!0),C.setAttribute(n,!0),c.hidePlaceholderMenuItems&&
M.push("ui-screen-hidden"),b!==S&&(b=this.placeholder=S)),v=t.createElement("li"),C.disabled&&(M.push("ui-state-disabled"),v.setAttribute("aria-disabled",!0)),v.setAttribute(k,A),v.setAttribute(p,"false"),w&&v.setAttribute(n,!0),v.className=M.join(" "),v.setAttribute("role","option"),P.setAttribute("tabindex","-1"),this.isMultiple&&a(P).addClass("ui-btn ui-checkbox-off ui-btn-icon-right"),v.appendChild(P),D.appendChild(v));this.list[0].appendChild(D);this.isMultiple||b.length?this.headerTitle.text(this.placeholder):
...
"#"+ia(a))},h=function(a){a=a.charCode||a.keyCode||-1;if(a>n&&90>=a||32==a)return!1;!0===k(this).parent().parent().data("colorpicker").livePreview&&l.apply(this)},l=function(f){var h=k(this).parent().parent(),l;if(0<this.parentNode.className.indexOf("_hex")){l=h.data("colorpicker");var m=this.value,p=6-m.length;if(0<p){for(var q=[],n=0;n<p;n++)q.push("0");q.push(m);m=q.join("")}m=N(ua(m));l.color=l=m}else 0<this.parentNode.className.indexOf("_hsb")?h.data("colorpicker").color=l=Y({h:parseInt(h.data("colorpicker").fields.eq(4).val(),
10),s:parseInt(h.data("colorpicker").fields.eq(5).val(),10),b:parseInt(h.data("colorpicker").fields.eq(6).val(),10)}):(l=h.data("colorpicker"),m=parseInt(h.data("colorpicker").fields.eq(1).val(),10),p=parseInt(h.data("colorpicker").fields.eq(2).val(),10),q=parseInt(h.data("colorpicker").fields.eq(3).val(),10),m={r:Math.min(255,Math.max(0,m)),g:Math.min(255,Math.max(0,p)),b:Math.min(255,Math.max(0,q))},l.color=l=N(m));f&&(a(l,h.get(0)),c(l,h.get(0)),g(l,h.get(0)));d(l,h.get(0));b(l,h.get(0));e(l,h.get(0));
...
v);return!1},S=function(a){k(this).addClass("colorpicker_focus")},P=function(a){k(this).removeClass("colorpicker_focus")},M=function(a){a=k(this).parent();var b=a.data("colorpicker").color;a.data("colorpicker").origColor=b;f(b,a.get(0));a.data("colorpicker").onSubmit(b,ia(b),Z(b),a.data("colorpicker").el)},ja=function(a){var b=k("body"),c=b.data("colorpickerId"),d=k(this).data("colorpickerId");c&&c===d?(k(document).trigger("mousedown"),b.data("colorpickerId",null)):(ka.call(this,a),b.data("colorpickerId",
...
b=e+f):360>b?(b=a,c=e,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}},T=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];k.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")},ia=function(a){return T(Z(a))},ea=function(){var f=k(this).parent(),h=f.data("colorpicker").origColor;f.data("colorpicker").color=h;a(h,f.get(0));c(h,f.get(0));g(h,f.get(0));d(h,f.get(0));b(h,f.get(0));e(h,f.get(0))};return{init:function(n){n=k.extend({},da,n||{});
if("string"==typeof n.color)n.color=N(ua(n.color));else if(void 0!=n.color.r&&void 0!=n.color.g&&void 0!=n.color.b)n.color=N(n.color);else if(void 0!=n.color.h&&void 0!=n.color.s&&void 0!=n.color.b)n.color=Y(n.color);else return this;return this.each(function(){if(!k(this).data("colorpickerId")){var t=k.extend({},n);t.origColor=n.color;var v="collorpicker_"+parseInt(1E3*Math.random());k(this).data("colorpickerId",v);v=k('<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>').attr("id",
...
t.currentColor=v.find("div.colorpicker_current_color");v.data("colorpicker",t);v.find("div.colorpicker_submit").bind("mouseenter touchstart",S).bind("mouseleave touchend",P).bind("click",M);a(t.color,v.get(0));g(t.color,v.get(0));c(t.color,v.get(0));b(t.color,v.get(0));d(t.color,v.get(0));f(t.color,v.get(0));e(t.color,v.get(0));t.flat?v.css({position:"relative",display:"block"}):k(this).bind(t.eventName,ja)}})},showPicker:function(){return this.each(function(){k(this).data("colorpickerId")&&ka.apply(this)})},
hidePicker:function(){return this.each(function(){k(this).data("colorpickerId")&&k("#"+k(this).data("colorpickerId")).hide()})},setColor:function(h){if("string"==typeof h)h=N(ua(h));else if(void 0!=h.r&&void 0!=h.g&&void 0!=h.b)h=N(h);else if(void 0!=h.h&&void 0!=h.s&&void 0!=h.b)h=Y(h);else return this;return this.each(function(){if(k(this).data("colorpickerId")){var l=k("#"+k(this).data("colorpickerId"));l.data("colorpicker").color=h;l.data("colorpicker").origColor=h;a(h,l.get(0));g(h,l.get(0));
c(h,l.get(0));b(h,l.get(0));d(h,l.get(0));f(h,l.get(0));e(h,l.get(0))}})}}}();k.fn.extend({ColorPicker:n.init,ColorPickerHide:n.hidePicker,ColorPickerShow:n.showPicker,ColorPickerSetColor:n.setColor})})(jQuery);b4w.register("viewer_main",function(k,n){function t(a,b){if(!b)return console.log("b4w init failure"),null;window.oncontextmenu=function(a){a.preventDefault();a.stopPropagation();return!1};window.ondragstart=function(a){a.preventDefault();a.stopPropagation();return!1};I.enable_controls();window.addEventListener("resize",la,!1);var c=document.createEvent("CustomEvent");c.initEvent("resize",!1,!1);window.dispatchEvent(c);ma.detect_mobile()||z(["gyro_use"],"disable");var g=I.get_url_params();Qa.enqueue([["manifest",
Qa.AT_JSON,"assets.json"]],function(a,b,c,Ga){X=a;Ba=document.getElementById("info_left_down");O=document.getElementById("lights_cont");document.getElementById("build_date").innerHTML=Ra.date_str();r(y,"quality","string");switch(K.get("quality")){case K.P_ULTRA:var k=0;break;case K.P_HIGH:k=1;break;case K.P_LOW:k=2;break;case K.P_CUSTOM:k=3}document.getElementById("quality").options[k].selected=!0;$("#quality").selectmenu("refresh");I.set_onclick("reset_memory",A);I.set_onclick("auto_rotate_cam",
gb);I.set_onclick("pause",C);I.set_onclick("resume",v);I.set_onclick("auto_view",W);a=document.getElementById("manifest");if(X){c="";b=(b=I.get_url_params())&&b.load?b.load.split("/"):["misc","logo.json"];b="Home ("+b[b.length-1]+")";c=c+"<div class='min_font' id='default_scene'>"+("<h6 class='ui-collapsible-heading'><a class='ui-mini ui-btn ui-btn-icon-right ui-icon-home'>"+b+"</a></h6>");c+="</div>";for(b=0;b<X.length;b++){k=X[b];Ga=k.name;for(var k=k.items,Q="",Q=Q+"<div data-role='collapsible' data-mini='true' >",
Q=Q+("<h6>"+Ga+"</h6>"),Q=Q+"<ul data-role='listview' data-mini='true' data-inset='true' style='margin: -10px 0;'>",l=0;l<k.length;l++)var m=k[l].name,Q=Q+("<li data-mini='true'><a href='#' class='min_font' id=\""+("MANIFEST_ITEM_"+m+"__SEPARATOR__"+Ga)+'">'+m+"</a></li>");Q+="</ul>";Q+="</div>";c+=Q}$("#"+a.id).append(c);$("#"+a.id).trigger("create");a.addEventListener("mouseup",e,!1)}else a.innerHTML="<p style='color: red;'>Failed loading scenes list.</p><p>Maybe a syntax error?</p>";f();r(ea,"anim_active_object",
"string");r(ea,"animation","string");r(ea,"anim_mix_factor","number");r(ea,"anim_slot","number");r(ea,"anim_cyclic","bool");r(ea,"anim_frame_current","number");I.set_onclick("anim_play",Y);I.set_onclick("anim_stop",ua);r(ia,"nla_frame_current","number");I.set_onclick("nla_play",N);I.set_onclick("nla_stop",Z);r(T,"shape_key_obj","string");r(T,"shape_key_name","string");r(T,"shape_key_value","number");r(pa,"material_name","string");aa(pa,"material_diffuse_color");r(pa,"material_reflectivity","number");
r(pa,"material_fresnel","number");r(pa,"material_fresnel_factor","number");r(pa,"material_parallax_scale","number");r(pa,"material_parallax_steps","number");r(G,"material_name","string");r(G,"shore_smoothing","bool");r(G,"absorb_factor","number");r(G,"sss_strength","number");r(G,"sss_width","number");aa(G,"water_fog_color");r(G,"water_fog_density","number");aa(G,"shallow_water_col");r(G,"shallow_water_col_fac","number");aa(G,"shore_water_col");r(G,"shore_water_col_fac","number");r(G,"foam_factor",
"number");r(G,"norm_uv_velocity","number");r(G,"water_dynamic","bool");r(G,"waves_height","number");r(G,"waves_length","number");r(G,"dst_noise_scale0","number");r(G,"dst_noise_scale1","number");r(G,"dst_noise_freq0","number");r(G,"dst_noise_freq1","number");r(G,"dir_min_shore_fac","number");r(G,"dir_freq","number");r(G,"dir_noise_scale","number");r(G,"dir_noise_freq","number");r(G,"dir_min_noise_fac","number");r(G,"dst_min_fac","number");r(G,"waves_hor_fac","number");r(Ha,"environment_energy","string");
aa(Ha,"horizon_color");aa(Ha,"zenith_color");r(qa,"light_name","string");aa(qa,"light_color");r(qa,"pre_light_energy","number");r(qa,"rude_light_energy","number");r(qa,"light_spot_size","number");r(qa,"light_spot_blend","number");r(qa,"light_distance","number");aa(ba,"sky_color");r(ba,"rayleigh_brightness","number");r(ba,"mie_brightness","number");r(ba,"spot_brightness","number");r(ba,"scatter_strength","number");r(ba,"rayleigh_strength","number");r(ba,"mie_strength","number");r(ba,"rayleigh_collection_power",
"number");r(ba,"mie_collection_power","number");r(ba,"mie_distribution","number");r(Ia,"date","string");r(Ia,"day_time","number");r(Sa,"sun_horizontal_position","number");r(Sa,"sun_vertical_position","number");r(hb,"max_sun_angle","number");I.set_onclick("run_sun",ib);I.set_onclick("stop_sun",jb);r(sa,"csm_first_cascade_border","number");r(sa,"csm_last_cascade_border","number");r(sa,"self_shadow_polygon_offset","number");r(sa,"self_shadow_normal_offset","number");r(sa,"first_cascade_blur_radius",
"number");r(sa,"last_cascade_blur_radius","number");r(fa,"ssao_quality","string");r(fa,"ssao_hemisphere","bool");r(fa,"ssao_blur_depth","bool");r(fa,"ssao_blur_discard_value","number");r(fa,"ssao_radius_increase","number");r(fa,"ssao_influence","number");r(fa,"ssao_dist_factor","number");r(fa,"ssao_only","bool");r(fa,"ssao_white","bool");r(Ja,"fog_density","number");r(Ja,"fog_density1000","number");aa(Ja,"fog_color");r(va,"dof_distance","number");r(va,"dof_front","number");r(va,"dof_rear","number");
r(va,"dof_power","number");r(va,"dof_on","bool");r(Ka,"god_rays_intensity","number");r(Ka,"god_rays_max_ray_length","number");r(Ka,"god_rays_steps","number");r(Aa,"brightness","number");r(Aa,"contrast","number");r(Aa,"exposure","number");r(Aa,"saturation","number");r(P,"sfx_mix_mode","bool");a=Number("true"===H.get("sfx_mix_mode"));document.getElementById("sfx_mix_mode").options[a].selected=!0;$("#sfx_mix_mode").slider("refresh");r(M,"anaglyph_use","bool");a=Number("true"===H.get("anaglyph_use"));
document.getElementById("anaglyph_use").options[a].selected=!0;$("#anaglyph_use").slider("refresh");r(ja,"gyro_use","bool");a=Number("true"===H.get("gyro_use"));document.getElementById("gyro_use").options[a].selected=!0;$("#gyro_use").slider("refresh");r(Ta,"wind_dir","number");r(Ta,"wind_strength","number");r(Ua,"mb_factor","number");r(Ua,"mb_decay_threshold","number");r(La,"bloom_key","number");r(La,"bloom_blur","number");r(La,"bloom_edge_lum","number");r(Ca,"small_glow_mask_coeff","number");r(Ca,
"large_glow_mask_coeff","number");r(Ca,"small_glow_mask_width","number");r(Ca,"large_glow_mask_width","number");r(kb,"canvas_rf","number");r(Va,"wireframe_mode","string");aa(Va,"wireframe_edge_color","object");r(S,"show_hud_debug_info","bool");r(ka,"outlining_overview_mode","bool");a=""==H.get("outlining_overview_mode")?1:Number("true"===H.get("outlining_overview_mode"));document.getElementById("outlining_overview_mode").options[a].selected=!0;$("#outlining_overview_mode").slider("refresh");I.set_onclick("make_screenshot",
lb);a=Number("true"===H.get("show_hud_debug_info"));document.getElementById("show_hud_debug_info").options[a].selected=!0;$("#show_hud_debug_info").slider("refresh");da();a=d();h(a,!1,!1,g&&g.load)},null)}function da(){$(document).ready(function(){$(".ui-slider-handle").off("keydown");$(".ui-slider-handle").on("keydown",function(a){var b=this.parentElement.parentElement.children[0].getAttribute("id");if(b){var c=parseFloat(document.getElementById(b).value),d=parseFloat(document.getElementById(b).getAttribute("step"));
188==a.keyCode&&u(b,c-d);190==a.keyCode&&u(b,c+d)}})})}function a(a){if(Ba&&x.can_select_objects()){$("#material_warning")[0].style.display="none";a.preventDefault&&a.preventDefault();var b=a.clientX;a=a.clientY;var d=U;d&&x.outlining_is_enabled(d)&&x.clear_outline_anim(d);(U=b=x.pick_object(b,a))?Wa(b):Xa();c();na||(b?(na=b,c(),I.enable_object_controls(b),J.create_kb_sensor_manifold(b,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){na=null;c();I.disable_object_controls(a)})):g())}}function g(){var a=
x.get_active_camera();na=a;c();I.enable_camera_controls();J.create_kb_sensor_manifold(a,"QUIT",J.CT_SHOT,J.KEY_Q,function(a,b,d,e){na=null;c();I.disable_camera_controls(a);J.remove_sensor_manifold(a,"ZOOM_TO")});var b=J.create_keyboard_sensor(J.KEY_Z),d=J.create_keyboard_sensor(J.KEY_DEC_POINT);J.create_sensor_manifold(a,"ZOOM_TO",J.CT_SHOT,[b,d],function(a){return a[0]||a[1]},function(a,b,c){(b=U)&&Ya.zoom_object(a,b)})}function c(){if(Ba){var a=na?oa(na):"NONE",b=U?oa(U):"NONE",a="CONTROLLED: "+
a+" | SELECTED: "+b;(b=U)&&(b=x.get_type_mesh_object(b))&&(a+=" | TYPE: "+b);b=na;U&&b&&"CAMERA"===b.type&&(a+=" | DISTANCE: "+Za);Ba.innerHTML=a}}function d(){var a=H.get("last_item_name");if(!a)return null;for(var b=0;b<X.length;b++){var c=X[b];if(wa.keyfind("name",a,c.items)[0])return{category:c.name,item:a}}return null}function b(a,b){var c=document.getElementById(a);c.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.text=e.value=b[d];0===d&&(e.selected=!0);c.appendChild(e)}$("#"+
a).selectmenu();$("#"+a).selectmenu("refresh")}function f(){var a=document.getElementById("default_scene");a&&(a.onclick=function(){xa=!1;clearTimeout(Ma);h(null,!0,!1,!0)})}function e(a){a=a.target.id;if(-1!=a.indexOf("MANIFEST_ITEM_")){var b=a.split("__SEPARATOR__");a=b[1];b=b[0].split("MANIFEST_ITEM_")[1];xa=!1;clearTimeout(Ma);h({category:a,item:b},!0,!1,!1)}}function h(b,c,d,e){if(O)for(var f=0;f<O.children.length;f++)O.children[f].style.visibility="hidden";if((f=I.get_url_params())&&f.load){var g=
f.load.split("/");ta={load_file:f.load,name:g[g.length-1].split(".")[0],animated_objects:[]}}else ta={load_file:K.get_std_assets_path()+"misc/logo.json",name:"Logo",animated_objects:[]};ca=E=null;if(!e)if(b){e=wa.keyfind("name",b.category,X)[0];e=wa.keyfind("name",b.item,e.items)[0];for(var h in e)ta[h]="load_file"==h?K.get_std_assets_path()+e[h]:e[h];H.set("last_item_name",b.item)}else H.set("last_item_name","");c&&(ma.clear_render_callback(),Na.cleanup());ma.get_canvas_elem().removeEventListener("mousedown",
a);L.clear_errors_warnings();b=ta.name;c=ta.load_file;h=document.getElementById("current_file");h.innerHTML=b;h.setAttribute("title",b+" ("+c+")");Na.load(c,l,p,d)}function l(b){ma.get_canvas_elem().addEventListener("mousedown",a,!1);U=null;q(ta);g();I.enable_debug_controls();B()&&mb.enable_mixer_controls();K.get("gyro_use")&&nb.enable_camera_rotation();ma.set_render_callback(w);xa&&(Ma=setTimeout(m,1E3));b=J.create_elapsed_sensor();J.create_sensor_manifold(x.get_active_camera(),"TO_OBJ",J.CT_CONTINUOUS,
[b],null,function(a,b,d){if(1==d&&U){if(d=U)b=ob,pb.get_object_center(d,!0,b),a=Ya.get_eye(a,qb),Za=rb.dist(b,a).toFixed(3);c()}})}function m(){var a=d();if(a){var b=a.item,a=wa.keyfind("name",a.category,X)[0],b=wa.keyfind("name",b,a.items)[0],b=a.items.indexOf(b);if(b=a.items[b+1])a={category:a.name,item:b.name};else{a=X.indexOf(a);b=null;do b=X[++a];while(b&&0==b.items.length);if(b)a={category:b.name,item:b.items[0].name};else{xa=!1;return}}}else a=X[0],b=a.items[0],a={category:a.name,item:b.name};
h(a,!0,!0,!1)}function p(a,b){document.getElementById("loading_progress").innerHTML=a+"% ("+Math.round(10*b/1E3)/10+"s)";var c=L.get_error_quantity(),d=L.get_warning_quantity();if(Na.is_primary_loaded()){var e=L.num_vertices(),f=L.num_triangles(),g=L.num_draw_calls(),h=L.num_shaders();document.getElementById("info_right_up").innerHTML=e+" verts, "+f+" tris, "+g+" draw calls, "+h+" shaders";var e=L.geometry_stats(),f=L.num_textures(),g=L.num_render_targets(),h=Math.round(10*(e.ibo_memory+e.vbo_memory))/
10,k=Math.round(10*f.memory)/10,l=Math.round(10*g.memory)/10,m=Math.round(10*(h+k+l))/10;document.getElementById("info_right_down").innerHTML="Geometry: "+h+" MiB ("+e.ibo_number+"+"+e.vbo_number+")<br>Textures: "+k+" MiB ("+f.number+")<br>RTs: "+l+" MiB ("+g.number+")<br><br>Total: "+m+" MiB";e=L.get_error_quantity();(f=L.get_warning_quantity())||e?O.setAttribute("title","Errors: "+e+", Warnings: "+f+"\nSee browser console for more info"):O.setAttribute("title","Loaded OK");d||c||(O.children[0].style.visibility=
"hidden",O.children[1].style.visibility="hidden",O.children[2].style.visibility="visible")}d&&!c&&(O.children[0].style.visibility="hidden",O.children[1].style.visibility="visible",O.children[2].style.visibility="hidden");c&&(O.children[0].style.visibility="visible",O.children[1].style.visibility="hidden",O.children[2].style.visibility="hidden")}function q(a){for(var c=x.get_active(),d=x.get_scenes(),e=0;e<d.length;e++){var f=d[e];if(f!==c){var g=ha(f,a);D(f,g)}}g=ha(c,a);D(c,g);Wa=function(a){var c=
ra.get_materials_names(a);b("material_name",c);$a(a,c[0]);a=ra.get_water_material_params(a,c[0]);c="shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" ");
a?(z(c,"enable"),x.get_water_mat_params(a),a.shallow_water_col&&ga("shallow_water_col",a.shallow_water_col),a.shallow_water_col_fac&&u("shallow_water_col_fac",a.shallow_water_col_fac),a.shore_water_col&&ga("shore_water_col",a.shore_water_col),a.shore_water_col_fac&&u("shore_water_col_fac",a.shore_water_col_fac),a.water_fog_color&&(ga("water_fog_color",a.water_fog_color),u("water_fog_density",a.water_fog_density)),u("absorb_factor",a.absorb_factor),u("sss_strength",a.sss_strength),u("sss_width",a.sss_width),
...
a.dst_min_fac),u("waves_hor_fac",a.waves_hor_fac)):z(c,"disable")};sb();a=x.get_all_objects("LAMP");c=[];for(e=0;e<a.length;e++)c.push(oa(a[e]));b("light_name",c);0<a.length&&ab(a[0]);tb();eb();ub();vb();wb();fb();xb();yb();zb();Ab();Bb();Cb();Db();Xa();$("#wireframe_mode").val("WM_NONE");$("#wireframe_mode").selectmenu("refresh",!0);$("#wireframe_edge_color div").css("backgroundColor","#333");e=new Date(document.getElementById("date").value);Ia({date:e})}function ha(a,b){function c(a,b){for(var d in a)b[d]=
a[d];return b}var d=b.scene_settings;if(d&&d[a]){var e={};c(b,e);c(d[a],e);delete e.scene_settings;return e}return b}function D(a,c){x.set_active(a);x.get_active_camera();for(var d=[],e=x.get_all_objects(),f=0;f<e.length;f++){var g=e[f];F.is_animated(g)&&(E||(E=g),d.push(oa(g)))}f="anim_active_object anim_slot animation anim_cyclic anim_frame_range anim_mix_factor anim_frame_current anim_play anim_stop".split(" ");E?(z(f,"enable"),b("anim_active_object",d),ea({anim_active_object:oa(E)})):z(f,"disable");
d=["nla_play","nla_stop","nla_status","nla_frame_current","nla_playing"];f=["nla_frame_range"];if(R.check_nla()){R.check_nla_scripts()?(z(d,"disable"),document.getElementById("nla_status").innerHTML="CONTROLLED BY NLA SCRIPT"):z(d,"enable");z(f,"enable");var d=document.getElementById("nla_frame_current"),f=document.getElementById("nla_frame_range"),g=R.get_frame_start(),h=R.get_frame_end();-1!=g&&-1!=h?(f.innerHTML=g+" - "+h,d.min=""+g,d.max=""+h):f.innerHTML="N/A"}else z(d,"disable"),z(f,"disable");
d=[];for(f=0;f<e.length;f++)g=e[f],ya.check_shape_keys(g)&&(ca||(ca=g),d.push(oa(g)));e=["shape_key_obj","shape_key_name","shape_key_value"];ca?(z(e,"enable"),b("shape_key_obj",d),T({shape_key_obj:oa(ca)})):z(e,"disable")}function w(a,b){x.get_active_camera();if(E){var c=document.getElementById("anim_status"),d=parseInt(document.getElementById("anim_slot").value);F.is_play(E,d)?(d=Math.round(F.get_frame(E,d)),parseInt($("#anim_frame_current").val())!==d&&u("anim_frame_current",d),c.innerHTML="PLAYING"):
c.innerHTML="STOPPED"}R.check_nla()&&(R.check_nla_scripts()||(c=document.getElementById("nla_status"),R.is_play()?c.innerHTML="PLAYING":c.innerHTML="STOPPED"),d=parseInt(R.get_frame().toFixed(0)),R.is_play()&&parseInt($("#nla_frame_current").val())!==d&&u("nla_frame_current",d))}function y(a){H.set("quality",a.quality);setTimeout(function(){window.location.reload()},100)}function A(){H.cleanup();window.location.reload()}function C(){ma.pause()}function v(){ma.resume()}function B(){return"true"===
H.get("sfx_mix_mode")?!0:!1}function S(a){H.set("show_hud_debug_info",a.show_hud_debug_info);window.location.reload()}function P(a){H.set("sfx_mix_mode",a.sfx_mix_mode);window.location.reload()}function M(a){H.set("anaglyph_use",a.anaglyph_use);window.location.reload()}function ja(a){H.set("gyro_use",a.gyro_use);window.location.reload()}function ka(a){H.set("outlining_overview_mode",a.outlining_overview_mode);window.location.reload()}function W(){xa=!0;m()}function la(a){I.resize_to_container();a=
ma.get_canvas_elem();document.getElementById("info_left_up").innerHTML=a.width+"x"+a.height+" ("+a.width/a.clientWidth+":1)"}function Y(){var a=document.getElementById("animation").value,b=parseInt(document.getElementById("anim_slot").value);"None"!==a&&F.play(E,null,b)}function ua(){document.getElementById("animation");var a=parseInt(document.getElementById("anim_slot").value);F.stop(E,a)}function N(){R.play()}function Z(){R.stop()}function T(a){if("shape_key_obj"in a){ca=Da(a.shape_key_obj);var c=
ya.get_shape_keys_names(ca);c.length?(b("shape_key_name",c),za=c[0],c=ya.get_shape_key_value(ca,za),u("shape_key_value",c)):b("shape_key_name",["N/K"])}"shape_key_name"in a&&(za=a.shape_key_name,c=ya.get_shape_key_value(ca,za),u("shape_key_value",c));"shape_key_value"in a&&ya.set_shape_key_value(ca,za,a.shape_key_value)}function ia(a){"nla_frame_current"in a&&!R.is_play()&&(a=parseInt(a.nla_frame_current),R.set_frame(a))}function ea(a){if("anim_active_object"in a){E=Da(a.anim_active_object);var c=
F.get_anim_names(E);if(c.length){for(var d=[],e=0;e<c.length&&8>e;e++)d.push(e);c.push("None");b("animation",c);b("anim_slot",d);c=parseInt(document.getElementById("anim_slot").value);Pa(E,c);Ea(E,c)}else b("animation",["N/A"]);Fa(E)}if("anim_slot"in a){if(!E)return;c=a.anim_slot;Pa(E,c);Ea(E,c);Fa(E)}"animation"in a&&(c=parseInt(document.getElementById("anim_slot").value),F.get_current_anim_name(E,c),"None"==a.animation?F.remove_slot_animation(E,c):(F.apply(E,a.animation,c),F.play(E,null,c)),Ea(E,
c),Fa(E));"anim_cyclic"in a&&(c=document.getElementById("animation").value,c=F.get_slot_num_by_anim(E,c),F.set_behavior(E,a.anim_cyclic?F.AB_CYCLIC:F.AB_FINISH_RESET,c));"anim_frame_current"in a&&(c=parseInt(document.getElementById("anim_slot").value),F.is_play(E,c)||(d=parseInt(a.anim_frame_current),F.set_frame(E,d,c)));"anim_mix_factor"in a&&F.set_skel_mix_factor(E,a.anim_mix_factor)}function Pa(a,b){for(var c=F.get_current_anim_name(a,b),c=c||"None",d=$("#animation"),e=d.children(),f=0;f<e.length;f++){var g=
e[f];if(g.value==c){g.selected=!0;d.selectmenu();d.selectmenu("refresh");break}}}function Ea(a,b){u("anim_cyclic",Number(F.get_behavior(a,b)==F.AB_CYCLIC));var c=document.getElementById("anim_frame_range"),d=F.get_anim_start_frame(a,b),e=F.get_anim_length(a,b);-1!=d&&-1!=e?(e=d+e,c.innerHTML=d+" - "+e,c=document.getElementById("anim_frame_current"),c.min=""+d,c.max=""+e):c.innerHTML="N/A"}function Fa(a){for(var b=$("#anim_slot-listbox").find("a"),c=parseInt(document.getElementById("anim_slot").value),
d=F.get_anim_type(a,c),c=0;c<b.length;c++){d=F.get_anim_type(a,c);switch(d){case F.OBJ_ANIM_TYPE_ARMATURE:d="ARMATURE";break;case F.OBJ_ANIM_TYPE_OBJECT:d="OBJECT";break;case F.OBJ_ANIM_TYPE_PARTICLES:d="PARTICLES";break;case F.OBJ_ANIM_TYPE_VERTEX:d="VERTEX";break;case F.OBJ_ANIM_TYPE_MATERIAL:d="MATERIAL";break;case F.OBJ_ANIM_TYPE_STATIC:d="STATIC";break;default:d="NONE"}b.eq(c);d=c+" ("+d+")";$("#anim_slot").children().eq(c).text(d)}$("#anim_slot").selectmenu();$("#anim_slot").selectmenu("refresh")}
function eb(){var a=x.get_ssao_params(),b="ssao_quality ssao_hemisphere ssao_blur_depth ssao_blur_discard_value ssao_radius_increase ssao_influence ssao_dist_factor ssao_only ssao_white".split(" ");if(a){z(b,"enable");for(var c=document.getElementById("ssao_quality"),b=a.ssao_quality,c=c.options,d=0;d<c.length;d++){var e=c[d];e.selected=e.value==b?!0:!1}$("#ssao_quality").selectmenu("refresh");b=Number(a.ssao_hemisphere);document.getElementById("ssao_hemisphere").options[b].selected=!0;$("#ssao_hemisphere").slider("refresh");
b=Number(a.ssao_blur_depth);document.getElementById("ssao_blur_depth").options[b].selected=!0;$("#ssao_blur_depth").slider("refresh");u("ssao_blur_discard_value",a.blur_discard_value);u("ssao_radius_increase",a.radius_increase);u("ssao_influence",a.influence);u("ssao_dist_factor",a.dist_factor);b=Number(a.ssao_only);document.getElementById("ssao_only").options[b].selected=!0;$("#ssao_only").slider("refresh");b=Number(a.ssao_white);document.getElementById("ssao_white").options[b].selected=!0;$("#ssao_white").slider("refresh")}else z(b,
"disable")}function fa(a){x.get_ssao_params();var b={};"ssao_quality"in a&&(b.ssao_quality=bb(document.getElementById("ssao_quality")));"ssao_hemisphere"in a&&(b.ssao_hemisphere=Number(a.ssao_hemisphere));"ssao_blur_depth"in a&&(b.ssao_blur_depth=Number(a.ssao_blur_depth));"ssao_blur_discard_value"in a&&(b.ssao_blur_discard_value=a.ssao_blur_discard_value);"ssao_radius_increase"in a&&(b.ssao_radius_increase=a.ssao_radius_increase);"ssao_influence"in a&&(b.ssao_influence=a.ssao_influence);"ssao_dist_factor"in
a&&(b.ssao_dist_factor=a.ssao_dist_factor);"ssao_only"in a&&(b.ssao_only=Number(a.ssao_only));"ssao_white"in a&&(b.ssao_white=Number(a.ssao_white));x.set_ssao_params(b)}function fb(){var a=x.get_color_correction_params(),b=["brightness","contrast","exposure","saturation"];a?(z(b,"enable"),u("brightness",a.brightness),u("contrast",a.contrast),u("exposure",a.exposure),u("saturation",a.saturation)):z(b,"disable")}function Aa(a){var b=x.get_color_correction_params();b&&(b={},"brightness"in a&&(b.brightness=
parseFloat(a.brightness)),"contrast"in a&&(b.contrast=parseFloat(a.contrast)),"exposure"in a&&(b.exposure=parseFloat(a.exposure)),"saturation"in a&&(b.saturation=parseFloat(a.saturation)),x.set_color_correction_params(b))}function bb(a){a=a.options;for(var b=0;b<a.length;b++){var c=a[b];if(c.selected)return c.value}}function ub(){var a=x.get_fog_color_density();.2<a[3]?u("fog_density",a[3]):u("fog_density1000",1E3*a[3]);ga("fog_color",a)}function Ja(a){var b=x.get_fog_color_density();"fog_density"in
a&&(b[3]=a.fog_density);"fog_density1000"in a&&(b[3]=a.fog_density1000/1E3);"fog_color"in a&&(b[0]=a.fog_color[0],b[1]=a.fog_color[1],b[2]=a.fog_color[2]);x.set_fog_color_density(b)}function tb(){var a=x.get_shadow_params(),b="csm_first_cascade_border csm_last_cascade_border self_shadow_polygon_offset self_shadow_normal_offset first_cascade_blur_radius last_cascade_blur_radius res_ui-block-b num_ui-block-b blur_ui-block-b".split(" ");if(!a)return z(b,"disable"),document.getElementById("csm_resolution").innerHTML=
"",document.getElementById("csm_num").innerHTML="",document.getElementById("csm_borders").innerHTML="",document.getElementById("blur_radii").innerHTML="",null;z(b,"enable");cb(a);u("self_shadow_polygon_offset",a.self_shadow_polygon_offset);u("self_shadow_normal_offset",a.self_shadow_normal_offset);u("first_cascade_blur_radius",a.first_cascade_blur_radius);a.enable_csm?(u("csm_first_cascade_border",a.csm_first_cascade_border),1<a.csm_num?(u("csm_last_cascade_border",a.csm_last_cascade_border),u("last_cascade_blur_radius",
a.last_cascade_blur_radius)):z(["csm_last_cascade_border","last_cascade_blur_radius"],"disable")):z(["csm_first_cascade_border","csm_last_cascade_border","last_cascade_blur_radius"],"disable")}function sa(a){var b={};"csm_first_cascade_border"in a&&(b.csm_first_cascade_border=a.csm_first_cascade_border);"csm_last_cascade_border"in a&&(b.csm_last_cascade_border=a.csm_last_cascade_border);"self_shadow_polygon_offset"in a&&(b.self_shadow_polygon_offset=a.self_shadow_polygon_offset);"self_shadow_normal_offset"in
a&&(b.self_shadow_normal_offset=a.self_shadow_normal_offset);"first_cascade_blur_radius"in a&&(b.first_cascade_blur_radius=a.first_cascade_blur_radius);"last_cascade_blur_radius"in a&&(b.last_cascade_blur_radius=a.last_cascade_blur_radius);x.set_shadow_params(b);cb(x.get_shadow_params())}function cb(a){document.getElementById("csm_resolution").innerHTML="&nbsp;&nbsp;"+a.csm_resolution;if(a.enable_csm){document.getElementById("csm_num").innerHTML=" "+a.csm_num;for(var b=["csm_borders","blur_radii"],
...
document.getElementById("first_cascade_blur_radius-label").innerHTML="Blur radius",document.getElementById("last_cascade_blur_radius-info-block").style.display="none"}function sb(){var a=x.get_environment_colors();u("environment_energy",a[0]);ga("horizon_color",a[1]);ga("zenith_color",a[2])}function Ha(a){"environment_energy"in a&&x.set_environment_colors(a.environment_energy,null,null);"horizon_color"in a&&x.set_environment_colors(null,a.horizon_color,null);"zenith_color"in a&&x.set_environment_colors(null,
null,a.zenith_color)}function Va(a){var b={};if("string"==typeof a.wireframe_mode)switch(bb(document.getElementById("wireframe_mode"))){case "WM_NONE":b.wireframe_mode=L.WM_NONE;break;case "WM_OPAQUE_WIREFRAME":b.wireframe_mode=L.WM_OPAQUE_WIREFRAME;break;case "WM_TRANSPARENT_WIREFRAME":b.wireframe_mode=L.WM_TRANSPARENT_WIREFRAME;break;case "WM_FRONT_BACK_VIEW":b.wireframe_mode=L.WM_FRONT_BACK_VIEW;break;case "WM_DEBUG_SPHERES":b.wireframe_mode=L.WM_DEBUG_SPHERES}"object"==typeof a.wireframe_edge_color&&
(b.wireframe_edge_color=a.wireframe_edge_color);L.set_debug_params(b)}function lb(){Eb.shot()}function zb(){var a=x.get_sky_params(),b="sky_color rayleigh_brightness mie_brightness spot_brightness scatter_strength rayleigh_strength mie_strength rayleigh_collection_power mie_collection_power mie_distribution".split(" ");if(!a)return z(b,"disable"),null;z(b,"enable");ga("sky_color",a.color);u("rayleigh_brightness",a.rayleigh_brightness);u("mie_brightness",a.mie_brightness);u("spot_brightness",a.spot_brightness);
u("scatter_strength",a.scatter_strength);u("rayleigh_strength",a.rayleigh_strength);u("mie_strength",a.mie_strength);u("rayleigh_collection_power",a.rayleigh_collection_power);u("mie_collection_power",a.mie_collection_power);u("mie_distribution",a.mie_distribution)}function ba(a){var b={};"sky_color"in a&&(b.color=a.sky_color);"rayleigh_brightness"in a&&(b.rayleigh_brightness=a.rayleigh_brightness);"mie_brightness"in a&&(b.mie_brightness=a.mie_brightness);"spot_brightness"in a&&(b.spot_brightness=
a.spot_brightness);"scatter_strength"in a&&(b.scatter_strength=a.scatter_strength);"rayleigh_strength"in a&&(b.rayleigh_strength=a.rayleigh_strength);"mie_strength"in a&&(b.mie_strength=a.mie_strength);"rayleigh_collection_power"in a&&(b.rayleigh_collection_power=a.rayleigh_collection_power);"mie_collection_power"in a&&(b.mie_collection_power=a.mie_collection_power);"mie_distribution"in a&&(b.mie_distribution=a.mie_distribution);x.set_sky_params(b)}function $a(a,b){var c=ra.get_material_extended_params(a,
b),d="material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" ");if(!c)return z(d,"disable"),$("#material_warning")[0].style.display="block",null;var e=ra.get_diffuse_color(a,b);c.diffuse_color=e.subarray(0,3);z(d,"enable");ga("material_diffuse_color",c.diffuse_color);u("material_reflectivity",c.reflect_factor);u("material_fresnel",c.fresnel);u("material_fresnel_factor",c.fresnel_factor);u("material_parallax_scale",
c.parallax_scale);u("material_parallax_steps",c.parallax_steps)}function pa(a){var b=U;"material_name"in a&&$a(b,a.material_name);if("material_diffuse_color"in a){var c=a.material_diffuse_color.slice();c.push(1);ra.set_diffuse_color(b,$("#material_name").val(),c)}c={};"material_reflectivity"in a&&(c.material_reflectivity=a.material_reflectivity);"material_fresnel"in a&&(c.material_fresnel=a.material_fresnel);"material_fresnel_factor"in a&&(c.material_fresnel_factor=a.material_fresnel_factor);"material_parallax_scale"in
a&&(c.material_parallax_scale=a.material_parallax_scale);"material_parallax_steps"in a&&(c.material_parallax_steps=a.material_parallax_steps);ra.set_material_extended_params(b,$("#material_name").val(),c);x.update_scene_materials_params()}function G(a){var b=U,c="waves_height waves_length sss_strength sss_width dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac".split(" ");if(!b)return null;
...
a&&(d.dir_noise_freq=a.dir_noise_freq);"dir_min_noise_fac"in a&&(d.dir_min_noise_fac=a.dir_min_noise_fac);"dst_min_fac"in a&&(d.dst_min_fac=a.dst_min_fac);"waves_hor_fac"in a&&(d.waves_hor_fac=a.waves_hor_fac);if(!ra.set_water_material_params(b,$("#material_name").val(),d))return null;x.update_scene_materials_params();x.set_water_params(d)}function ab(a){if(a=V.get_light_params(a)){var b=a.light_energy-Math.floor(a.light_energy),c=Math.floor(a.light_energy);ga("light_color",a.light_color);u("pre_light_energy",
b);u("rude_light_energy",c);b=c+b;$("#light_energy").text(b);b=a.light_type;$("#light_type").text(b);"SPOT"==a.light_type?(z(["light_spot_blend","light_spot_size"],"enable"),"light_spot_blend"in a&&u("light_spot_blend",a.light_spot_blend),"light_spot_size"in a&&u("light_spot_size",Math.round(a.light_spot_size*Fb))):z(["light_spot_blend","light_spot_size"],"disable");"SPOT"==a.light_type||"POINT"==a.light_type?(z(["light_distance"],"enable"),"light_distance"in a&&u("light_distance",a.light_distance)):
z(["light_distance"],"disable")}}function qa(a){"light_name"in a&&ab(Da(a.light_name));var b={};"light_color"in a&&(b.light_color=a.light_color);"pre_light_energy"in a&&(b.light_energy=parseFloat(a.pre_light_energy)+parseFloat(document.getElementById("rude_light_energy").value));"rude_light_energy"in a&&(b.light_energy=parseFloat(a.rude_light_energy)+parseFloat(document.getElementById("pre_light_energy").value));"light_spot_size"in a&&(b.light_spot_size=parseFloat(a.light_spot_size*Gb));"light_spot_blend"in
a&&(b.light_spot_blend=parseFloat(a.light_spot_blend));"light_distance"in a&&(b.light_distance=parseFloat(a.light_distance));a=Da($("#light_name").val());V.set_light_params(a,b);b=V.get_light_params(a).light_energy.toFixed(2);$("#light_energy").text(b)}function yb(){var a=V.get_sun_params(),b=["sun_horizontal_position","sun_vertical_position"];if(!a)return z(b,"disable"),null;u("sun_horizontal_position",a.hor_position);u("sun_vertical_position",a.vert_position)}function Sa(a){var b={};"sun_horizontal_position"in
a&&(b.hor_position=parseFloat(a.sun_horizontal_position),b.vert_position=parseFloat(document.getElementById("sun_vertical_position").value));"sun_vertical_position"in a&&(b.hor_position=parseFloat(document.getElementById("sun_horizontal_position").value),b.vert_position=parseFloat(a.sun_vertical_position));V.set_sun_params(b)}function hb(a){a=parseFloat(a.max_sun_angle);V.set_max_sun_angle(a)}function Ia(a){"day_time"in a&&V.set_day_time(a.day_time);"date"in a&&V.set_date(new Date(a.date))}function ib(){var a=
0,b=parseFloat(document.getElementById("day_time").value),c=J.create_elapsed_sensor(),d=V.get_lamps("SUN")[0];J.create_sensor_manifold(d,"ELAPSED",J.CT_CONTINUOUS,[c],function(a){return a[0]},function(c,d,e){1==e&&(a=document.getElementById("sun_time_multiplier").value,c=J.get_sensor_value(c,d,0),b+=c*a/3600,24<b&&(b-=Math.floor(b)),u("day_time",b))})}function Db(){var a=V.get_lamps("SUN")[0],b=["sn-ui-grid-b"];V.get_lamps().length?a||z("run_sun stop_sun date sun_time_multiplier day_time max_sun_angle".split(" "),
"disable"):z(b,"disable")}function Xa(){z("material_diffuse_color material_name material_reflectivity material_fresnel material_fresnel_factor material_parallax_scale material_parallax_steps".split(" "),"disable");z("shallow_water_col shallow_water_col_fac shore_water_col shore_water_col_fac water_fog_color water_fog_density absorb_factor sss_strength sss_width foam_factor norm_uv_velocity waves_height waves_length dst_noise_scale0 dst_noise_scale1 dst_noise_freq0 dst_noise_freq1 dir_min_shore_fac dir_freq dir_noise_scale dir_noise_freq dir_min_noise_fac dst_min_fac waves_hor_fac water_dynamic shore_smoothing".split(" "),
"disable")}function jb(){var a=V.get_lamps("SUN")[0];J.check_sensor_manifolds(a)&&J.remove_sensor_manifold(a,"ELAPSED")}function vb(){var a=x.get_dof_params(),b="dof_distance dof_object dof_front dof_rear dof_power dof_on".split(" ");if(a){u("dof_front",a.dof_front);u("dof_rear",a.dof_rear);u("dof_power",a.dof_power);$("#dof_distance").parent().parent().parent().removeClass("ui-disabled");if(a.dof_object){var c=oa(a.dof_object);$("#dof_object").text(c);b.splice(0,1);$("#dof_distance").parent().addClass("ui-disabled");
$("#dof_object").parent().removeClass("ui-disabled")}else u("dof_distance",a.dof_distance),b.splice(1,1),$("#dof_distance").parent().removeClass("ui-disabled"),$("#dof_object").parent().addClass("ui-disabled");z(b,"enable");a=0<a.dof_distance?1:0;document.getElementById("dof_on").options[a].selected=!0;$("#dof_on").slider("refresh")}else z(b,"disable")}function va(a){var b={};"dof_distance"in a&&Number($("#dof_on").val())&&(b.dof_distance=a.dof_distance);"dof_front"in a&&(b.dof_front=a.dof_front);
"dof_rear"in a&&(b.dof_rear=a.dof_rear);"dof_power"in a&&(b.dof_power=a.dof_power);"dof_on"in a&&(b.dof_on=Boolean($("#dof_on").val()),b.dof_distance=Number(a.dof_on)?parseFloat($("#dof_distance").val()):0);x.set_dof_params(b)}function wb(){var a=x.get_god_rays_params(),b=["god_rays_intensity","god_rays_max_ray_length","god_rays_steps"];a?(z(b,"enable"),a&&(u("god_rays_intensity",a.god_rays_intensity),u("god_rays_max_ray_length",a.god_rays_max_ray_length),u("god_rays_steps",a.god_rays_steps))):z(b,
"disable")}function Ka(a){var b={};"god_rays_intensity"in a&&(b.god_rays_intensity=a.god_rays_intensity);"god_rays_max_ray_length"in a&&(b.god_rays_max_ray_length=a.god_rays_max_ray_length);"god_rays_steps"in a&&(b.god_rays_steps=a.god_rays_steps);x.set_god_rays_params(b)}function kb(a){"canvas_rf"in a&&(K.set("canvas_resolution_factor",a.canvas_rf),la())}function Ab(){var a=x.get_mb_params(),b=["mb_factor","mb_decay_threshold"];a?(z(b,"enable"),a&&(u("mb_factor",a.mb_factor),u("mb_decay_threshold",
a.mb_decay_threshold))):z(b,"disable")}function Ua(a){var b={};"mb_factor"in a&&(b.mb_factor=a.mb_factor);"mb_decay_threshold"in a&&(b.mb_decay_threshold=a.mb_decay_threshold);x.set_mb_params(b)}function Bb(){var a=x.get_bloom_params(),b=["bloom_key","bloom_blur","bloom_edge_lum"];a?(z(b,"enable"),a&&(u("bloom_key",a.bloom_key),u("bloom_blur",a.bloom_blur),u("bloom_edge_lum",a.bloom_edge_lum))):z(b,"disable")}function La(a){var b={};"bloom_key"in a&&(b.bloom_key=a.bloom_key);"bloom_blur"in a&&(b.bloom_blur=
a.bloom_blur);"bloom_edge_lum"in a&&(b.bloom_edge_lum=a.bloom_edge_lum);x.set_bloom_params(b)}function Cb(){var a=x.get_glow_material_params(),b=["small_glow_mask_coeff","large_glow_mask_coeff","small_glow_mask_width","large_glow_mask_width"];a?(z(b,"enable"),u("small_glow_mask_coeff",a.small_glow_mask_coeff),u("large_glow_mask_coeff",a.large_glow_mask_coeff),u("small_glow_mask_width",a.small_glow_mask_width),u("large_glow_mask_width",a.large_glow_mask_width)):z(b,"disable")}function Ca(a){var b=
{};"small_glow_mask_coeff"in a&&(b.small_glow_mask_coeff=a.small_glow_mask_coeff);"large_glow_mask_coeff"in a&&(b.large_glow_mask_coeff=a.large_glow_mask_coeff);"small_glow_mask_width"in a&&(b.small_glow_mask_width=a.small_glow_mask_width);"large_glow_mask_width"in a&&(b.large_glow_mask_width=a.large_glow_mask_width);x.set_glow_material_params(b)}function ga(a,b){var c=Oa.rgb_to_css(b),d=Oa.rgb_to_css_hex(b),c={r:c[0],g:c[1],b:c[2]};$("#"+a).ColorPickerSetColor(c);$("#"+a+" div").css("backgroundColor",
d)}function xb(){var a=x.get_wind_params(),b=["wind_dir","wind_strength"];a?(u("wind_dir",a.wind_dir),u("wind_strength",a.wind_strength)):z(b,"disable")}function Ta(a){var b={};"wind_dir"in a&&(b.wind_dir=a.wind_dir);"wind_strength"in a&&(b.wind_strength=a.wind_strength);x.set_wind_params(b)}function u(a,b){$("#"+a).val(b);$("#"+a).slider("refresh");$("#"+a).trigger("change")}function r(a,b,c){$("#"+b).bind("change",function(d){var e={};switch(c){case "string":e[b]=d.target.value;break;case "number":e[b]=
parseFloat(d.target.value);break;case "bool":e[b]=Boolean(Number(d.target.value));break;default:return console.log("wrong value type"),null}a(e)})}function aa(a,b){$("#"+b).ColorPicker({onChange:function(c,d,e){$("#"+b+" div").css("backgroundColor","#"+d);c={};e=Oa.css_to_rgb(e.r,e.g,e.b);c[b]=[e[0],e[1],e[2]];a(c)}})}function gb(){Hb.auto_rotate(.3)}function z(a,b){if(!a)return null;for(var c=0;c<a.length;c++){var d=$("#"+a[c]).parent().parent();"enable"==b?d.removeClass("ui-disabled"):"disable"==
b&&d.addClass("ui-disabled")}}function oa(a){return x.get_object_name_hierarchy(a).join("->")}function Da(a){return x.get_object_by_dupli_name_list(a.split("->"))}var F=n("animation"),I=n("app"),Qa=n("assets"),Ya=n("camera"),Hb=n("camera_anim"),K=n("config");n("constraints");var J=n("controls"),Na=n("data"),L=n("debug"),ya=n("geometry"),nb=n("gyroscope"),V=n("lights"),ma=n("main"),mb=n("mixer"),ra=n("material"),R=n("nla"),Oa=n("rgb"),Eb=n("screenshooter"),x=n("scenes"),H=n("storage"),pb=n("transform"),
wa=n("util"),Ra=n("version"),rb=n("vec3"),db="DEBUG"===Ra.type(),Gb=Math.PI/180,Fb=180/Math.PI,ob=new Float32Array(3),qb=new Float32Array(3),xa=!1,Ma,X=null,E=null,ca=null,za="",ta=null,Ba=null,O=null,U=null,Wa=function(){},na=null,Za=null;k.init=function(){H.init("b4w_viewer");var a=H.get("quality");if(a){switch(a){case "ULTRA":var b=K.P_ULTRA;break;case "HIGH":b=K.P_HIGH;break;case "LOW":b=K.P_LOW;break;case "CUSTOM":b=K.P_CUSTOM}K.set("quality",b)}K.set("anaglyph_use","true"===H.get("anaglyph_use"));
K.set("gyro_use","true"===H.get("gyro_use"));""==H.get("outlining_overview_mode")?K.set("outlining_overview_mode",!0):K.set("outlining_overview_mode","true"===H.get("outlining_overview_mode"));I.init({canvas_container_id:"main_canvas_container",callback:t,autoresize:!1,gl_debug:!0,show_hud_debug_info:"true"===H.get("show_hud_debug_info")?!0:!1,sfx_mix_mode:B(),show_fps:!0,fps_elem_id:"fps_logger",fps_wrapper_id:"fps_container",alpha:!0,assets_dds_available:!db,assets_min50_available:!db,console_verbose:!0,
physics_enabled:!0,wireframe_debug:!0})}});b4w.require("viewer_main").init();
