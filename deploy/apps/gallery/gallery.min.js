...
w(e.P_HIGH)});p("ultra_mode_button",function(){q("ultra_mode_button");w(e.P_ULTRA)});e.set("glow",!1);var b=n.get("last_scene_id");b&&M(b,m)&&!C?x(b):x(r)}else console.log("b4w init failure")},physics_enabled:!1,alpha:!1,gl_debug:!1,show_hud_debug_info:!1,show_fps:!0,fps_elem_id:"status_bar_fps",console_verbose:y,assets_dds_available:!y,assets_min50_available:!y,all_objs_selectable:!1,error_purge_elements:["control_panel_over","status_bar"]},S=.1,N=e.get_std_assets_path(),d=[{icon:"icons/logo.png",
name:"Logo",b:"dev/logo.json",a:["all","nothing","car","naturemorte"]},{icon:"icons/milk.png",name:"Bottle",b:"fridge/bottle/bottle.json",a:["all","naturemorte"]},{icon:"icons/naturmort.png",name:"Naturemorte",b:"fridge/naturmort/naturmort.json",a:["all","naturemorte"]}],t,F,H,k,I,v=!1,r=null,m=null,C=null;J.init=function(){n.init("b4w_gallery_storage");var a=n.get("quality");a&&"CUSTOM"!=a||(a="LOW",n.set("quality",a));switch(a){case "LOW":var c=e.P_LOW;break;case "HIGH":c=e.P_HIGH;break;case "ULTRA":c=
e.P_ULTRA}e.set("quality",c);l.init(W)}});b4w.require("gallery_main").init();
