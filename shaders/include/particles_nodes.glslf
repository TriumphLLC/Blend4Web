#ifndef PARTICLES_NODES_GLSLF
#define PARTICLES_NODES_GLSLF
...
#node GEOMETRY_OR
    ...
    orco = 2.0 * vec3(v_texcoord, _0_0) - vec3(_1_0);
#endnode
...
#node BSDF_END
    ...
    nout_color = color_in.rgb + specular_in;
...
#node_if USE_OUT_uv_cycles
    uv_cycles = vec3(v_texcoord, _0_0);
#node_endif
#endnode
...
#node TEX_COORD_GE
    ...
    generated = vec3(v_texcoord, _0_0);
#endnode
...
#node TEXTURE_ENVIRONMENT
    ...
    vec4 texval = GLSL_TEXTURE_CUBE(texture, coords);
