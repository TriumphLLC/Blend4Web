...
#if (!NODES || USE_NODE_B4W_REFRACTION && USE_REFRACTION && NODES) && REFRACTIVE && USE_REFRACTION_CORRECTION
...
#if REFRACTIVE && !NODES || USE_NODE_B4W_REFRACTION && USE_REFRACTION && NODES
...
# endif
#else
# if SSAO_ONLY && SHADOW_USAGE == SHADOW_MAPPING_OPAQUE && !SHADELESS
