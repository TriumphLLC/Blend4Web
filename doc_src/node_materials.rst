...
Дополнительные ноды расширяют функционал стандартных с учётом специфики работы движка. Ноды оформляются в виде нодовых групп (``Node groups`` или ``Node tree``) со специально выбранным именем и форматом входов. Для удобства, все дополнительные ноды собраны в файл ``external/blender/dev_nodes/special_nodes.blend``.

.. seealso:: :ref:`node_anim`

LINEAR_TO_SRGB и SRGB_TO_LINEAR
-------------------------------
...
*Edge0*
    Первое eначениe для интерполяции.
*Edge1*
